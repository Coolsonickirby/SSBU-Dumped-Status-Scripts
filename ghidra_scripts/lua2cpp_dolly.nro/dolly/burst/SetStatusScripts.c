...
void __thiscall L2CWeaponDollyBurst::SetStatusScripts(L2CWeaponDollyBurst *this)

{
  ...
  iVar1 = _WEAPON_DOLLY_BURST_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DOLLY_BURST_STATUS_KIND_REGULAR);
