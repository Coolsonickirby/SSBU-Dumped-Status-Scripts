...
void __thiscall L2CWeaponDollyCap::SetStatusScripts(L2CWeaponDollyCap *this)

{
  ...
  iVar1 = _WEAPON_DOLLY_CAP_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DOLLY_CAP_STATUS_KIND_REGULAR);
