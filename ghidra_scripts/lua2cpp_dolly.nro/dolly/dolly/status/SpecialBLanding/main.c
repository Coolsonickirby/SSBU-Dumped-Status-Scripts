...
void __thiscall
L2CFighterDolly::status::SpecialBLanding_main(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x110427f601);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialBLanding_main_loop);
