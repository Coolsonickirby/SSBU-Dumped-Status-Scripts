...
void __thiscall
L2CFighterDolly::status::FinalEnd_main_loop(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_7100011b80;
    }
    iVar4 = 1;
    goto LAB_71000120ec;
  }
  lib::L2CValue::_L2CValue(aLStack96);
LAB_7100011b80:
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_DOLLY_STATUS_FINAL_END_WORK_FLAG_GROUND_CORRECT_SET);
...
LAB_7100011d64:
    ...
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_DOLLY_STATUS_FINAL_END_WORK_FLAG_GROUND_CORRECT_ON);
    ...
    if ((uVar6 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue
                (aLStack80,_FIGHTER_DOLLY_STATUS_FINAL_END_WORK_FLAG_GROUND_CORRECT_SET);
      iVar4 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar4);
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DOLLY_STATUS_FINAL_END_WORK_FLAG_GROUND_CORRECT_ON)
      ;
      iVar4 = lib::L2CValue::as_integer(aLStack80);
...
LAB_71000120ec:
  ...
  uVar6 = lib::L2CValue::operator__(aLStack96,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar6 & 1) == 0) goto LAB_7100011f78;
...
LAB_7100011f78:
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar6 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DOLLY_STATUS_FINAL_END_WORK_FLAG_GROUND_CORRECT_SET);
    iVar4 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar4);
    lib::L2CValue::_L2CValue(aLStack80);
  }
  ...
  if ((uVar6 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DOLLY_FINAL_MODULE_END_EXEC);
    pFVar8 = (Fighter *)lib::L2CValue::as_pointer(pLVar7);
    iVar4 = lib::L2CValue::as_integer(aLStack80);
    app::FighterSpecializer_Dolly::call_final_module(pFVar8,iVar4);
    lib::L2CValue::_L2CValue(aLStack80);
  }
