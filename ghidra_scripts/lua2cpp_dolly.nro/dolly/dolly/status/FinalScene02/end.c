...
void __thiscall
L2CFighterDolly::status::FinalScene02_end(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DOLLY_FINAL_MODULE_SCENE_02_EXIT);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DOLLY_STATUS_KIND_FINAL_SCENE03);
