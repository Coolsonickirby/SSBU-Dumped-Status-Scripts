...
void __thiscall
L2CFighterDolly::status::WalkBack_main_loop(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack176,&DAT_71000267d0);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_71000265e0;
