...
void __thiscall
L2CFighterDolly::status::TurnRunBack_main(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    FUN_7100022990(aLStack112,this,aLStack128);
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
  }
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100022b90);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) goto LAB_710000ad08;
