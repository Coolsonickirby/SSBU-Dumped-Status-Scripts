...
void __thiscall
L2CFighterDolly::status::TurnRunBack_main_loop(L2CFighterDolly *this,L2CValue *return_value)
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack160);
        if ((uVar5 & 1) == 0) goto LAB_7100022db8;
      }
...
LAB_7100023194:
          ...
          if ((bVar1 & 1U) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack288);
            lib::L2CValue::_L2CValue(aLStack256);
            if ((uVar5 & 1) != 0) goto LAB_71000233b8;
          }
          else {
            lib::L2CValue::_L2CValue(aLStack256);
LAB_71000233b8:
