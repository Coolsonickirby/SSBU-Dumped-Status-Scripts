...
void __thiscall
L2CFighterDolly::status::SpecialHiJump_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_DOLLY_STATUS_SPECIAL_COMMON_WORK_FLAG_COMMAND);
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_DOLLY_SPECIAL_HI_JUMP);
  ...
  lib::L2CValue::L2CValue
            (aLStack264,
             ...
             _FS_SUCCEEDS_KEEP_RUMBLE | _FS_SUCCEEDS_KEEP_EFFECT);
