...
void __thiscall
L2CFighterDolly::status::SpecialHiLanding_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_GROUND_STOP);
