...
void __thiscall
L2CFighterDolly::status::FinalScene03_main(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DOLLY_FINAL_MODULE_SCENE_03_INIT);
