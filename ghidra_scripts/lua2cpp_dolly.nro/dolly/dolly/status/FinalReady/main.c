...
void __thiscall
L2CFighterDolly::status::FinalReady_main(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_DOLLY_FINAL_MODULE_READY_INIT);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  uVar7 = lib::L2CValue::operator_(aLStack80,aLStack64);
  if ((uVar7 & 1) != 0) {
    lib::L2CValue::operator_(aLStack64,aLStack80);
  }
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DOLLY_STATUS_FINAL_WORK_INT_ATTACK_FRAME);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
