...
void __thiscall
L2CFighterDolly::status::SpecialLwCommand_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  if ((uVar13 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_DOLLY_INSTANCE_WORK_ID_FLAG_DISABLE_AIR_SPECIAL_LW);
