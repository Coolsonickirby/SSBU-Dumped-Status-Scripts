...
void __thiscall
L2CFighterDolly::status::SpecialLwLanding_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_DOLLY_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_LANDING_FLAG);
