...
void __thiscall L2CFighterDolly::status::TurnDash_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  app::FighterSpecializer_Dolly::update_opponent_lr_1on1(pBVar3,iVar1);
