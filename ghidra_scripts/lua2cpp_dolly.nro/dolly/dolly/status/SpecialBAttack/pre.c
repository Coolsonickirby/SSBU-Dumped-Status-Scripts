...
void __thiscall
L2CFighterDolly::status::SpecialBAttack_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  if ((uVar13 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_DOLLY_INSTANCE_WORK_ID_FLAG_DISABLE_AIR_SPECIAL_S);
    iVar5 = lib::L2CValue::as_integer(aLStack120);
    app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar5);
    lib::L2CValue::_L2CValue(aLStack120);
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_DOLLY_STATUS_SPECIAL_S_WORK_FLAG_AIR_ATTACK);
    iVar5 = lib::L2CValue::as_integer(aLStack120);
    app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar5);
    lib::L2CValue::_L2CValue(aLStack120);
  }
