...
void __thiscall L2CFighterDolly::status::Wait_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  app::FighterSpecializer_Dolly::update_opponent_lr_1on1(pBVar5,iVar2);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      FUN_7100005050(aLStack96,aLStack160);
      ...
      if ((uVar3 & 1) != 0) {
        ...
        if ((uVar3 & 1) == 0) {
          ...
          uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar3 & 1) != 0) goto LAB_7100028b28;
        }
        else {
LAB_7100028b28:
...
LAB_7100028c54:
            ...
            lib::L2CValue::_L2CValue(aLStack80);
            lib::L2CValue::_L2CValue(aLStack96);
            if ((uVar3 & 1) == 0) goto LAB_7100028c54;
          ...
          if ((uVar3 & 1) == 0) goto LAB_7100028ccc;
        }
