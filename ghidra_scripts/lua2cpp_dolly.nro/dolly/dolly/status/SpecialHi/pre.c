...
void __thiscall
L2CFighterDolly::status::SpecialHiCommand_pre(L2CFighterDolly *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_DOLLY_STATUS_KIND_SPECIAL_HI_COMMAND);
