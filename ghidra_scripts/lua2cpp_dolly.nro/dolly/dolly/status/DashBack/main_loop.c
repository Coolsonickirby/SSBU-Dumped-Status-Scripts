...
void __thiscall
L2CFighterDolly::status::DashBack_main_loop(L2CFighterDolly *this,L2CValue *return_value)
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((bVar1 & 1) != 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack208);
        lib::L2CValue::_L2CValue(aLStack192);
        if ((uVar6 & 1) == 0) goto LAB_7100024434;
      }
      else {
        lib::L2CValue::_L2CValue(aLStack160);
        lib::L2CValue::_L2CValue(aLStack208);
...
LAB_7100024f74:
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack208);
      lib::L2CValue::_L2CValue(aLStack160);
      if ((uVar6 & 1) == 0) goto LAB_7100025390;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack160);
    }
      ...
      if ((uVar6 & 1) != 0) {
        ...
        lib::L2CValue::L2CValue
                  (aLStack96,
                   ...
                   _FIGHTER_PAD_CMD_CAT1_FLAG_ATTACK_LW4 | FIGHTER_PAD_CMD_CAT1_FLAG_ATTACK_S3 |
                   FIGHTER_PAD_CMD_CAT1_FLAG_ATTACK_HI3 | _FIGHTER_PAD_CMD_CAT1_FLAG_ATTACK_LW3 |
                   _FIGHTER_PAD_CMD_CAT1_FLAG_ATTACK_N | FIGHTER_STATUS_KIND_SPECIAL_LW._4_4_ |
