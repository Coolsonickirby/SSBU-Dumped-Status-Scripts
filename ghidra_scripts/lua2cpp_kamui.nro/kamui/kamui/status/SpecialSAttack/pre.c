...
void __thiscall
L2CFighterKamui::status::SpecialSAttack_pre(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KAMUI_INSTANCE_WORK_ID_FLAG_SPECIAL_S_ATTACK_START);
