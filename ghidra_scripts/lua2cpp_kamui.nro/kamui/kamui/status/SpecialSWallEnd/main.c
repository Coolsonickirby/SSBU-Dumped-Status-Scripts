...
void __thiscall
L2CFighterKamui::status::SpecialSWallEnd_main(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12730c8318);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSWallEnd_main_loop);
