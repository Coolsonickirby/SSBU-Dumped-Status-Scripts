...
void __thiscall
L2CFighterKamui::status::SpecialNHold_end(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KAMUI_STATUS_KIND_SPECIAL_N_SHOOT);
