...
void __thiscall
L2CFighterKamui::status::SpecialNHold_main_loop(L2CFighterKamui *this,L2CValue *return_value)
...
LAB_7100020c14:
  lib::L2CValue::L2CValue(aLStack288,0xe06860a20);
  lib::L2CValue::L2CValue(aLStack304,0x1244d4ffef);
  ...
  lib::L2CValue::L2CValue(aLStack384,_FIGHTER_KINETIC_TYPE_GROUND_STOP);
  lib::L2CValue::L2CValue(aLStack400,_FIGHTER_KINETIC_TYPE_AIR_STOP);
  lib::L2CValue::L2CValue(aLStack416,_GROUND_CORRECT_KIND_GROUND_CLIFF_STOP_ATTACK);
  lib::L2CValue::L2CValue(aLStack432,GROUND_CORRECT_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack464,0xf899192aa);
  lib::L2CValue::L2CValue(aLStack480,0xec7acfd87);
