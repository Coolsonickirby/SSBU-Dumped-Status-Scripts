...
void __thiscall
L2CFighterKamui::status::SpecialNShoot_main_loop(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack272,_FIGHTER_KAMUI_STATUS_KIND_SPECIAL_N_BITE);
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack320);
        lib::L2CValue::L2CValue(aLStack352,_FIGHTER_KAMUI_STATUS_KIND_SPECIAL_N_BITE);
  ...
  FUN_710001ebe0(aLStack256,this,aLStack384,aLStack400,aLStack416,aLStack432,aLStack448,aLStack464,
                 aLStack480);
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::L2CValue(aLStack256,0x1203c0fb27);
          ...
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KAMUI_GENERATE_ARTICLE_DRAGONHAND);
          lib::L2CValue::L2CValue(aLStack256,0xe41920ee8);
          lib::L2CValue::L2CValue(aLStack304,true);
          iVar3 = lib::L2CValue::as_integer(aLStack96);
          HVar8 = lib::L2CValue::as_hash(aLStack256);
          bVar1 = lib::L2CValue::as_bool(aLStack304);
