...
void __thiscall
L2CFighterKamui::status::SpecialNBite_main_loop(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack224);
      lib::L2CValue::_L2CValue(aLStack192);
      if ((uVar4 & 1) != 0) goto LAB_710001db9c;
    }
...
LAB_710001db9c:
  ...
  FUN_710001ebe0(aLStack192,this,aLStack288,aLStack304,aLStack320,aLStack336,aLStack352,aLStack368,
                 aLStack384);
  lib::L2CValue::L2CValue(aLStack80,true);
  uVar4 = lib::L2CValue::operator__(aLStack192,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
...
LAB_710001e1ac:
      ...
      uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) == 0) goto LAB_710001e12c;
