...
void __thiscall
L2CFighterKamui::status::SpecialSWallAttackBLanding_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0x1a23885b68);
  ...
  lib::L2CValue::L2CValue(aLStack144,0xf7fc9bc27);
  ...
  lib::L2CValue::L2CValue(aLStack128,0x155e7f8a0e);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack128,SpecialSWallAttackBLanding_main_loop);
