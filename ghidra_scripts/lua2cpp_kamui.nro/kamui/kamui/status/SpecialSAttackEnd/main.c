...
void __thiscall
L2CFighterKamui::status::SpecialSAttackEnd_main(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x148161f9d3);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialSAttackEnd_main_loop);
