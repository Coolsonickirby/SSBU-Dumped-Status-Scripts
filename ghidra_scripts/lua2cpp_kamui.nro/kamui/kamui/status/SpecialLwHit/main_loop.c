...
void __thiscall
L2CFighterKamui::status::SpecialLwHit_main_loop(L2CFighterKamui *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_7100015030;
    }
    iVar5 = 1;
    goto LAB_710001526c;
  }
...
LAB_71000150f0:
      ...
      if ((uVar3 & 1) == 0) {
        ...
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar3 & 1) != 0) goto LAB_7100015160;
      }
    }
    else {
      pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71000150f0;
LAB_7100015160:
      FUN_7100014070(this);
      FUN_7100014800(this);
    }
