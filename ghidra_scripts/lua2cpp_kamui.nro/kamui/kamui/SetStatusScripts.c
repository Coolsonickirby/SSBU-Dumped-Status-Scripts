...
void __thiscall L2CFighterKamui::SetStatusScripts(L2CFighterKamui *this)

{
  ...
  iVar1 = _FIGHTER_KAMUI_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100003820);
  lib::L2CValue::operator_(pLVar3,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  pLVar4 = (L2CValue *)lib::L2CValue::operator__(pLVar4,0x39);
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100003910);
