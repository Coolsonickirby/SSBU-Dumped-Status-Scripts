...
void __thiscall
L2CWeaponKamuiRyusensya::status::Regular_main_loop
          (L2CWeaponKamuiRyusensya *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack64,_WEAPON_KAMUI_RYUSENSYA_INSTANCE_WORK_ID_FLAG_WN_REMOVED);
