...
void __thiscall L2CWeaponKamuiRyusensya::SetStatusScripts(L2CWeaponKamuiRyusensya *this)

{
  ...
  iVar1 = _WEAPON_KAMUI_RYUSENSYA_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KAMUI_RYUSENSYA_STATUS_KIND_REGULAR);
