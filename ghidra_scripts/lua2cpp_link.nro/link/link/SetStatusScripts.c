...
void __thiscall L2CFighterLink::SetStatusScripts(L2CFighterLink *this)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100005ab0);
  lib::L2CValue::operator_(pLVar3,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  pLVar3 = (L2CValue *)lib::L2CValue::operator__(pLVar5,0x26);
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100005b90);
  lib::L2CValue::operator_(pLVar3,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  pLVar3 = (L2CValue *)lib::L2CValue::operator__(pLVar5,0x28);
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100005c70);
  lib::L2CValue::operator_(pLVar3,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  pLVar5 = (L2CValue *)lib::L2CValue::operator__(pLVar5,0x2d);
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100005c80);
