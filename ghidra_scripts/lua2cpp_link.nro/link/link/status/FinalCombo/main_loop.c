...
void __thiscall
L2CFighterLink::status::FinalCombo_main_loop(L2CFighterLink *this,L2CValue *return_value)
...
LAB_710000f8f4:
        ...
        if ((uVar5 & 1) == 0) goto LAB_710000f98c;
        iVar7 = 0;
      }
      else {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) != 0) goto LAB_710000f8f4;
LAB_710000f98c:
        iVar7 = 1;
      }
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) == 0) goto LAB_710000f9d4;
      goto LAB_710000f610;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
