...
void __thiscall L2CFighterLink::status::FinalCombo_pre(L2CFighterLink *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_GROUND_CORRECT_KIND_NONE);
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_LINK_FINAL_COMBO);
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE);
