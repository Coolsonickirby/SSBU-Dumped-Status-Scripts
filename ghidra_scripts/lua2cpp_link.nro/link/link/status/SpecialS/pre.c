...
void __thiscall L2CFighterLink::status::SpecialS_pre(L2CFighterLink *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_LINK_INSTANCE_WORK_ID_FLAG_BOOMERANG);
