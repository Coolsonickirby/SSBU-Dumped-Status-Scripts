...
void __thiscall L2CFighterLink::status::Final_main_loop(L2CFighterLink *this,L2CValue *return_value)
...
LAB_710001126c:
      ...
      if ((uVar6 & 1) == 0) {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::_L2CValue(aLStack96);
          if ((uVar6 & 1) != 0) goto LAB_71000112b4;
        }
        else {
          lib::L2CValue::_L2CValue(aLStack96);
        }
...
LAB_7100011894:
        ...
        if ((uVar6 & 1) == 0) goto LAB_71000119b4;
        iVar5 = 0;
      }
      else {
        lib::L2CValue::L2CValue(aLStack96,0);
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar6 & 1) != 0) goto LAB_7100011440;
LAB_71000119b4:
        iVar5 = 1;
      }
...
LAB_71000111ec:
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((bVar4 & 1U) == 0) goto LAB_710001126c;
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((bVar4 & 1U) == 0) goto LAB_71000111ec;
    ...
    if ((uVar6 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) == 0) goto LAB_71000119c8;
      goto LAB_71000110f0;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack416);
