...
void __thiscall
L2CFighterLink::status::FinalDash_main_loop(L2CFighterLink *this,L2CValue *return_value)
...
LAB_71000107f8:
        ...
        if ((uVar4 & 1) == 0) goto LAB_7100010848;
        iVar3 = 0;
      }
      else {
        ...
        lib::L2CValue::_L2CValue(aLStack96);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar4 & 1) != 0) goto LAB_7100010600;
LAB_7100010848:
        iVar3 = 1;
      }
    ...
    if ((uVar4 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar4 & 1) == 0) goto LAB_710001085c;
      goto LAB_71000102f4;
    }
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack192);
