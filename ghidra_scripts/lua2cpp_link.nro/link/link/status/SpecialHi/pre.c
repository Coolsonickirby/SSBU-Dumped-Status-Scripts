...
void __thiscall L2CFighterLink::status::SpecialHi_pre(L2CFighterLink *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack184,(int)GROUND_CLIFF_CHECK_KIND_ON_DROP_BOTH_SIDES);
