...
void __thiscall
L2CFighterLink::status::SpecialHi_main_loop(L2CFighterLink *this,L2CValue *return_value)

{
    ...
    if ((bVar1 & 1U) != 0) {
      ...
      if ((uVar6 & 1) != 0) {
        ...
        if ((uVar6 & 1) != 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack160);
          lib::L2CValue::_L2CValue(aLStack144);
          lib::L2CValue::L2CValue(aLStack144,&DAT_710001b780);
  ...
  FUN_7100012b50(aLStack144,this);
...
LAB_710001b110:
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack144);
      if ((uVar6 & 1) == 0) goto LAB_710001b1a8;
    }
    else {
      pLVar8 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x16);
      ...
      uVar6 = lib::L2CValue::operator__(pLVar8,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_710001b110;
      lib::L2CValue::_L2CValue(aLStack144);
    }
    bVar2 = app::lua_bind::StatusModule__is_changing_impl(*ppBVar10);
    lib::L2CValue::L2CValue(aLStack144,(bool)(bVar2 & 1));
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack96,&DAT_710001b780);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack144);
    if ((uVar6 & 1) == 0) goto LAB_710001b0b4;
