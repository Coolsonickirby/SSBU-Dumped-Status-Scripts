...
void __thiscall L2CFighterLink::status::SpecialN_exec(L2CFighterLink *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    uVar6 = lib::L2CValue::operator__(aLStack128,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar6 & 1) == 0) goto LAB_7100007784;
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack176);
    if ((bVar2 & 1U) == 0) goto LAB_7100007784;
