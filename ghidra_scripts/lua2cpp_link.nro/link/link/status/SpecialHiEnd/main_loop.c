...
void __thiscall
L2CFighterLink::status::SpecialHiEnd_main_loop(L2CFighterLink *this,L2CValue *return_value)
...
LAB_7100012274:
      FUN_7100012b50(aLStack112,this);
      ...
      if ((bVar1 & 1U) != 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          app::lua_bind::WorkModule__unable_transition_term_impl(*ppBVar8,iVar3);
          lib::L2CValue::_L2CValue(aLStack96);
          lib::L2CValue::L2CValue(aLStack96,&DAT_7100012d10);
...
LAB_7100012894:
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar5 & 1) != 0) goto LAB_7100012274;
      }
    }
    iVar3 = 0;
  }
