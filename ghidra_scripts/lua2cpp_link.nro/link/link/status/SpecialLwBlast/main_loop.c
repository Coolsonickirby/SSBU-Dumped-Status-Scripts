...
void __thiscall
L2CFighterLink::status::SpecialLwBlast_main_loop(L2CFighterLink *this,L2CValue *return_value)
...
LAB_71000191dc:
        ...
        uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar6 & 1) == 0) goto LAB_71000191dc;
      ...
      if ((bVar1 & 1U) != 0) {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          if ((uVar6 & 1) == 0) {
            ...
            if ((bVar1 & 1U) == 0) goto LAB_71000195d0;
...
LAB_71000195d0:
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack128);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar6 & 1) != 0) goto LAB_71000190d0;
      }
    }
    iVar4 = 0;
  }
