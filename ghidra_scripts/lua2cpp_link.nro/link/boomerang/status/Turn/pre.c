...
void __thiscall
L2CWeaponLinkBoomerang::status::Turn_pre(L2CWeaponLinkBoomerang *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_LINK_BOOMERANG_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_LINK_BOOMERANG_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_LINK_BOOMERANG_FLOAT);
