...
void __thiscall L2CWeaponSamusdTransportation::SetStatusScripts(L2CWeaponSamusdTransportation *this)

{
  ...
  iVar1 = _WEAPON_SAMUS_TRANSPORTATION_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SAMUS_TRANSPORTATION_STATUS_KIND_DUMMY);
