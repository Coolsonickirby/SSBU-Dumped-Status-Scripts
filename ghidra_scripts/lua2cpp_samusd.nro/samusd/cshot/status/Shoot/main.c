...
void __thiscall
L2CWeaponSamusdCshot::status::Shoot_main(L2CWeaponSamusdCshot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_SAMUS_CSHOT_INSTANCE_WORK_ID_FLOAT_CHARGE);
