...
void __thiscall
L2CFighterSamusd::status::FinalEndA_main_loop(L2CFighterSamusd *this,L2CValue *return_value)
...
LAB_710001b48c:
      ...
      if ((uVar3 & 1) == 0) {
        ...
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar3 & 1) == 0) goto LAB_710001b48c;
...
LAB_710001b400:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_710001b2e0;
  }
  iVar5 = 1;
LAB_710001b40c:
