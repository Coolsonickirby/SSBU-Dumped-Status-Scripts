...
void __thiscall
L2CFighterSamusd::status::SpecialS1g_main(L2CFighterSamusd *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack96,0x74c6b3fe3);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  FUN_710001de00(this);
  lib::L2CValue::L2CValue(aLStack96,SpecialS1g_main_loop);
