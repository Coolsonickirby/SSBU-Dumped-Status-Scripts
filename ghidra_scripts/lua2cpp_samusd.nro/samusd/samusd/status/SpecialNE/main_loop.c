...
void __thiscall
L2CFighterSamusd::status::SpecialNE_main_loop(L2CFighterSamusd *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar4 & 1) != 0) goto LAB_7100020190;
    }
    iVar3 = 1;
    goto LAB_71000203f4;
  }
...
LAB_7100020350:
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  if ((uVar4 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,&DAT_71000204c0);
