...
void __thiscall
L2CFighterSamusd::status::SpecialS1a_main_loop(L2CFighterSamusd *this,L2CValue *return_value)
...
LAB_710001f350:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar5 & 1) == 0) goto LAB_710001f654;
        lib::L2CValue::L2CValue(aLStack80,0x74c6b3fe3);
...
LAB_710001f654:
        ...
        if ((uVar5 & 1) != 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar5 & 1) == 0) {
            lib::L2CValue::L2CValue(aLStack80,0xbe39552ad);
            HVar7 = lib::L2CValue::as_hash(aLStack80);
            app::lua_bind::MotionModule__change_motion_inherit_frame_impl
                      (this->moduleAccessor,HVar7,-1.0,1.0,0.0,false,false);
            lib::L2CValue::_L2CValue(aLStack80);
...
LAB_710001f824:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) != 0) goto LAB_710001f350;
  }
  iVar3 = 1;
LAB_710001f830:
