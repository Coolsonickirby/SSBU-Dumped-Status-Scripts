...
void __thiscall
L2CFighterSamusd::status::SpecialS1a_main(L2CFighterSamusd *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack96,0xbe39552ad);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  FUN_710001de00(this);
  lib::L2CValue::L2CValue(aLStack96,SpecialS1a_main_loop);
