...
void __thiscall
L2CFighterSamusd::status::AirLassoHang_pre(L2CFighterSamusd *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_HANG_FLAG);
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_HANG_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_HANG_FLOAT);
