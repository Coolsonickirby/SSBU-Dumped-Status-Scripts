...
void __thiscall
L2CFighterSamusd::status::SpecialNF_main_loop(L2CFighterSamusd *this,L2CValue *return_value)
...
LAB_710002079c:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar4 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack80,&DAT_7100020c80);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar4 & 1) != 0) goto LAB_710002079c;
    }
