...
void __thiscall
L2CFighterSamusd::status::AirLassoFailure_pre(L2CFighterSamusd *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack168,GROUND_CLIFF_CHECK_KIND_ALWAYS);
  lib::L2CValue::L2CValue(aLStack184,false);
  lib::L2CValue::L2CValue(aLStack200,FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_FAILURE_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_FAILURE_INT);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_FAILURE_FLOAT);
