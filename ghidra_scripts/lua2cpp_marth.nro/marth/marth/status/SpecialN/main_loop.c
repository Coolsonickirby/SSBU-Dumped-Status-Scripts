...
void __thiscall
L2CFighterMarth::status::SpecialN_main_loop(L2CFighterMarth *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) == 0) goto LAB_710001c50c;
      goto LAB_710001c0bc;
    }
    pLVar6 = aLStack112;
  }
...
LAB_710001c50c:
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    if ((bVar2 & 1U) == 0) {
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MARTH_STATUS_KIND_SPECIAL_N_LOOP);
