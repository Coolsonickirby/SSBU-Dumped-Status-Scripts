...
void __thiscall L2CFighterMarth::status::SpecialS_main(L2CFighterMarth *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MARTH_STATUS_KIND_SPECIAL_S2);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MARTH_STATUS_SPECIAL_S_WORK_INT_CHANGE_STATUS);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MARTH_STATUS_SPECIAL_S_WORK_INT_MOTION_KIND);
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MARTH_STATUS_SPECIAL_S_WORK_INT_MOTION_KIND_AIR);
  lVar5 = lib::L2CValue::as_integer(aLStack64);
  iVar2 = lib::L2CValue::as_integer(aLStack128);
  app::lua_bind::WorkModule__set_int64_impl(this->moduleAccessor,lVar5,iVar2);
  lib::L2CValue::_L2CValue(aLStack128);
