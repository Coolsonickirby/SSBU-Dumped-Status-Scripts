...
void __thiscall
L2CFighterReflet::status::SpecialHi_pre(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  if (pvVar14 == (void *)0x0) {
    ...
    lib::L2CValue::L2CValue(aLStack120,pvVar14);
  }
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_REFLET_MAGIC_KIND_EL_WIND);
