...
void __thiscall
L2CFighterReflet::status::SpecialNHold_main_loop(L2CFighterReflet *this,L2CValue *return_value)
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack112);
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_REFLET_STATUS_KIND_SPECIAL_N_CANCEL);
      ...
      if ((uVar6 & 1) == 0) {
        ...
        if ((uVar6 & 1) != 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack112);
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_REFLET_STATUS_KIND_SPECIAL_N_JUMP_CANCEL);
...
LAB_7100027264:
      ...
      FUN_7100007080(this,aLStack128);
      lib::L2CValue::_L2CValue(aLStack128);
