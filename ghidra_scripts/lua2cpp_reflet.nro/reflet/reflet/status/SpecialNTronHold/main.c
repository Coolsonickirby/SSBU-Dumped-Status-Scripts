...
void __thiscall
L2CFighterReflet::status::SpecialNTronHold_main(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_7100006bb0(aLStack64,this);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack80,SpecialNTronHold_main_loop);
