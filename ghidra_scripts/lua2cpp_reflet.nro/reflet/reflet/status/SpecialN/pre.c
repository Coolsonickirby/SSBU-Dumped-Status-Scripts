...
void __thiscall
L2CFighterReflet::status::SpecialN_pre(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  bVar1 = (uVar14 & 1) != 0;
  if (bVar1) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_REFLET_STATUS_KIND_SPECIAL_N_TRON_START);
