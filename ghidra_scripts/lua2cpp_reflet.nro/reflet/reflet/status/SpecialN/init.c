...
void __thiscall
L2CFighterReflet::status::SpecialNTronHold_init(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_REFLET_STATUS_KIND_SPECIAL_N_HOLD);
  ...
  if ((uVar4 & 1) == 0) {
    ...
    uVar4 = lib::L2CValue::operator__(aLStack96,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar4 & 1) != 0) goto LAB_7100008258;
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_REFLET_STATUS_KIND_SPECIAL_N_SHOOT);
    uVar4 = lib::L2CValue::operator__(aLStack96,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar4 & 1) != 0) {
LAB_71000084e0:
    ...
    uVar4 = lib::L2CValue::operator__(aLStack96,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar4 & 1) != 0) goto LAB_71000084e0;
  }
  else {
LAB_7100008258:
    ...
    FUN_710000ab10(this,aLStack160,aLStack176,aLStack192,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
