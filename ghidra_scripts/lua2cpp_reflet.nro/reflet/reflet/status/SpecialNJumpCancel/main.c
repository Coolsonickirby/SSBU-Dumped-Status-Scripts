...
void __thiscall
L2CFighterReflet::status::SpecialNJumpCancel_main(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack112,SpecialNJumpCancel_main_loop);
