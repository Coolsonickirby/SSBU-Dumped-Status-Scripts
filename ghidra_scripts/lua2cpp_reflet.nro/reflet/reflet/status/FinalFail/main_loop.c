...
void __thiscall
L2CFighterReflet::status::FinalFail_main_loop(L2CFighterReflet *this,L2CValue *return_value)
...
LAB_710001cdf0:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) == 0) goto LAB_710001cf14;
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710001cf14;
