...
void __thiscall
L2CFighterReflet::status::SpecialHiFail_pre(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_REFLET_MAGIC_KIND_EL_WIND);
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_REFLET_INSTANCE_WORK_ID_INT_LAST_USED_MAGIC_KIND);
