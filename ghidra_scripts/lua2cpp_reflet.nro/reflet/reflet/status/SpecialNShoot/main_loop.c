...
void __thiscall
L2CFighterReflet::status::SpecialNShoot_main_loop(L2CFighterReflet *this,L2CValue *return_value)
        ...
        if ((uVar5 & 1) == 0) {
          ...
          if ((uVar5 & 1) == 0) {
            ...
            if ((uVar5 & 1) == 0) {
              ...
              uVar5 = lib::L2CValue::operator__(aLStack80,aLStack112);
              lib::L2CValue::_L2CValue(aLStack80);
              if ((uVar5 & 1) == 0) goto LAB_71000257e8;
...
LAB_71000257e8:
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack160);
        if ((uVar5 & 1) != 0) goto LAB_71000254d8;
      }
      lib::L2CValue::_L2CValue(aLStack144);
    }
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_REFLET_STATUS_SPECIAL_N_SHOOT_FLAG_TRY);
  ...
  FUN_7100007080(this,aLStack144);
  lib::L2CValue::_L2CValue(aLStack144);
  FUN_7100023bd0(this);
