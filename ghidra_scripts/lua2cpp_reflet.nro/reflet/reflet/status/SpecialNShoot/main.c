...
void __thiscall
L2CFighterReflet::status::SpecialNShoot_main(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  FUN_7100024a60(aLStack80,this,aLStack144);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar5 & 1) == 0) goto LAB_7100011904;
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,5);
