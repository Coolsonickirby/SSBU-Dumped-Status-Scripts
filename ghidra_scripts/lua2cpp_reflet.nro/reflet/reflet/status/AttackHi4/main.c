...
void __thiscall
L2CFighterReflet::status::AttackHi4_main(L2CFighterReflet *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,0xc2194ab4b);
    lua2cpp::L2CFighterCommon::status_AttackHi4_common(this,(L2CValue)0xb0);
  }
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_LOG_ATTACK_KIND_ADDITIONS_ATTACK_04);
    lib::L2CValue::operator_(aLStack96,aLStack64);
  }
  lib::L2CValue::_L2CValue(aLStack64);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack128,AttackHi4_main_loop);
