...
void __thiscall
L2CWeaponRefletThunder::status::Tron1_pre(L2CWeaponRefletThunder *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_GROUND_CORRECT_KIND_AIR_PASSABLE_OFF);
