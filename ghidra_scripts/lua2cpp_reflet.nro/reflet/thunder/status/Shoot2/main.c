...
void __thiscall
L2CWeaponRefletThunder::status::Shoot2_main(L2CWeaponRefletThunder *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0x1b255c1b46);
  ...
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar1,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Shoot2_main_loop);
