...
void __thiscall
L2CWeaponRefletThunder::status::Tron0_main(L2CWeaponRefletThunder *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x5956a239d);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Tron0_main_loop);
