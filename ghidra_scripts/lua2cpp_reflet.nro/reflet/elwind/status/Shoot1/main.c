...
void __thiscall
L2CWeaponRefletElwind::status::Shoot1_main(L2CWeaponRefletElwind *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0xceda66d52);
  lib::L2CValue::L2CValue(aLStack112,0x9275d8824);
  ...
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar1,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Shoot1_main_loop);
