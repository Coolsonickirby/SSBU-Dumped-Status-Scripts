...
void __thiscall
L2CWeaponRefletChrom::status::FinalEntry_main(L2CWeaponRefletChrom *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xb2a39cee0);
  ...
  lib::L2CValue::L2CValue(aLStack80,FinalEntry_main_loop);
