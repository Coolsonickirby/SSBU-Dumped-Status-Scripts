...
void __thiscall
L2CWeaponRefletChrom::status::FinalLaunch_main(L2CWeaponRefletChrom *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xc89b9dce2);
  ...
  lib::L2CValue::L2CValue(aLStack80,FinalLaunch_main_loop);
