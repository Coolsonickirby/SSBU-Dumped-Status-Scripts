...
void __thiscall L2CFighterLucario::status::Dash_pre(L2CFighterLucario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_DASH);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_DISABLE_GROUND_FRICTION | _FIGHTER_STATUS_ATTR_INTO_DOOR);
