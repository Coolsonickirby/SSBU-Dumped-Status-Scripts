...
void __thiscall
L2CFighterLucario::status::SpecialNCancel_main_loop(L2CFighterLucario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LUCARIO_SPECIAL_N_STATUS_WORK_ID_INT_CANCEL_STATUS);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_71000217d0;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack112);
    }
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) != 0) goto LAB_71000215e4;
    }
...
LAB_71000217d0:
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LUCARIO_SPECIAL_N_STATUS_WORK_ID_INT_CANCEL_STATUS);
...
LAB_71000218f8:
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue
                (aLStack112,_FIGHTER_LUCARIO_SPECIAL_N_STATUS_WORK_ID_INT_CANCEL_STATUS);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar5 & 1) == 0) goto LAB_7100021a00;
      lib::L2CValue::L2CValue(aLStack80,true);
...
LAB_7100021b8c:
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_7100021ab8;
      lib::L2CValue::_L2CValue(aLStack112);
LAB_7100021b38:
      FUN_7100021340(this);
      lib::L2CValue::L2CValue(aLStack80,_STATUS_KIND_NONE);
...
LAB_7100021ab8:
    ...
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) != 0) goto LAB_7100021af0;
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar5 & 1) != 0) goto LAB_7100021b38;
  }
  lib::L2CValue::L2CValue((L2CValue *)return_value,0);
LAB_7100021b9c:
