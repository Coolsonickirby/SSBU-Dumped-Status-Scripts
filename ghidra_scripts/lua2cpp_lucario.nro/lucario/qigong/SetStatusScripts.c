...
void __thiscall L2CWeaponLucarioQigong::SetStatusScripts(L2CWeaponLucarioQigong *this)

{
  ...
  iVar1 = _WEAPON_LUCARIO_QIGONG_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_LUCARIO_QIGONG_STATUS_KIND_SHOOT);
