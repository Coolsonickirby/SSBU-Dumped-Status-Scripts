...
void __thiscall
L2CWeaponShizueFishingrod::status::Start_pre(L2CWeaponShizueFishingrod *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,BATTLE_OBJECT_CATEGORY_INVALID);
  lib::L2CValue::L2CValue
            (aLStack136,_WEAPON_SHIZUE_FISHINGROD_INSTANCE_WORK_ID_INT_TARGET_OBJECT_CATEGORY);
  ...
  lib::L2CValue::L2CValue
            (aLStack136,_WEAPON_SHIZUE_FISHINGROD_INSTANCE_WORK_ID_INT_TARGET_OBJECT_ID);
  iVar3 = lib::L2CValue::as_integer(aLStack120);
  iVar6 = lib::L2CValue::as_integer(aLStack136);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar3,iVar6);
  lib::L2CValue::_L2CValue(aLStack136);
