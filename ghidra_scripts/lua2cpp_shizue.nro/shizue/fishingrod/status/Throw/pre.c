...
void __thiscall
L2CWeaponShizueFishingrod::status::Throw_pre(L2CWeaponShizueFishingrod *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_SEARCH);
