...
void __thiscall
L2CWeaponShizueFishingrod::status::Cut_main(L2CWeaponShizueFishingrod *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x3b0f094fd);
  ...
  app::WeaponSpecializer_ShizueFishingrod::start_cut(pBVar3);
  lib::L2CValue::L2CValue(aLStack80,Cut_main_loop);
