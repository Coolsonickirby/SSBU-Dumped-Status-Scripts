...
void __thiscall L2CWeaponShizueFishingline::SetStatusScripts(L2CWeaponShizueFishingline *this)

{
  ...
  iVar1 = _WEAPON_SHIZUE_FISHINGLINE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SHIZUE_FISHINGLINE_STATUS_KIND_REACH);
