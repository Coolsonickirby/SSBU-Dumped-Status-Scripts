...
void __thiscall
L2CWeaponShizueFishingline::status::Reach_main
          (L2CWeaponShizueFishingline *this,L2CValue *return_value)

{
  ...
  app::lua_bind::PhysicsModule__set_2nd_flip_impl(this->moduleAccessor,(bool)(bVar1 & 1));
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Reach_main_loop);
