...
void __thiscall
L2CFighterShizue::status::SpecialNPocket_main_loop(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  if ((bVar3 & 1U) != 0) {
    ...
    if ((bVar3 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar3 & 1U) != 0) goto LAB_710002a59c;
...
LAB_710002a6f0:
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar2 & 1) != 0) goto LAB_710002a708;
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MURABITO_STATUS_SPECIAL_N_FLAG_TAKEOUT_INPUT);
      iVar4 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar4);
      pLVar7 = aLStack80;
...
LAB_710002addc:
    bVar3 = lib::L2CValue::operator_cast_to_bool(aLStack96);
    if ((bVar3 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack272,_FIGHTER_MURABITO_STATUS_KIND_SPECIAL_N_TAKE_OUT);
    ...
    if ((uVar8 & 1) != 0) {
      ...
      if ((uVar8 & 1) != 0) {
        ...
        if ((uVar8 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack304);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar8 & 1) != 0) goto LAB_710002af7c;
        }
        lib::L2CValue::L2CValue((L2CValue *)return_value,1);
        goto LAB_710002b3b0;
      }
...
LAB_710002af7c:
    ...
    if ((uVar8 & 1) != 0) {
      ...
      if ((bVar3 & 1U) != 0) {
        ...
        if ((bVar3 & 1U) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack128);
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MURABITO_STATUS_KIND_SPECIAL_N_TAKE_OUT);
          lib::L2CValue::operator_(aLStack112,aLStack80);
        }
        lib::L2CValue::_L2CValue(aLStack80);
    ...
    FUN_710001a8d0(aLStack352,this,aLStack368,aLStack384,aLStack400,aLStack416,aLStack432,aLStack448
                   ,aLStack464);
    ...
    if (((bVar3 & 1U) != 0) ||
      ...
      if ((uVar8 & 1) != 0) {
        ...
        pvVar9 = (void *)app::lua_bind::ItemManager__find_active_item_from_id_impl
                                   (FIGHTER_STATUS_WORK_KEEP_FLAG_AIR_LASSO_HANG_FLAG,uVar5);
        if (pvVar9 == (void *)0x0) {
          lib::L2CValue::L2CValue
                    (aLStack80,(L2CValue *)&FIGHTER_INSTANCE_WORK_ID_FLOAT_LANDING_FRAME);
        }
        else {
    ...
    lib::L2CValue::L2CValue(aLStack240,_FIGHTER_MURABITO_STATUS_KIND_SPECIAL_N_FAILURE);
