...
void __thiscall
L2CFighterShizue::status::SpecialHi_main(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,(int)FIGHTER_INSTANCE_WORK_ID_FLOAT_LANDING_FRAME);
