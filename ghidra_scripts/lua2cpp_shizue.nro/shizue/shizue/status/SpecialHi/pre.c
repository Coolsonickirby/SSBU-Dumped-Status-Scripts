...
void __thiscall
L2CFighterShizue::status::SpecialHi_pre(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON | _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_HI
            );
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_ATTR_INTO_DOOR | _FIGHTER_STATUS_ATTR_START_TURN);
