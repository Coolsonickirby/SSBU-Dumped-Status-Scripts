...
void __thiscall
L2CFighterShizue::status::SpecialSEnd_pre(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,FIGHTER_STATUS_AIR_LASSO_REACH_FLAG_RAY_CHECK._4_4_);
  ...
  lib::L2CValue::_L2CValue(aLStack136);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack136,0xfea97fe73);
  lib::L2CValue::L2CValue(aLStack152,0xef3f6081d);
  ...
  lib::L2CValue::L2CValue(aLStack120,fVar15);
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this[1].functions,0xef3f6081d);
