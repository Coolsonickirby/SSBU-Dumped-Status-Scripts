...
void __thiscall
L2CFighterShizue::status::SpecialSThrow_main_loop(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71000238e0;
    }
    iVar5 = 1;
    goto LAB_7100023aa8;
  }
...
LAB_71000238e0:
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((bVar2 & 1U) == 0) {
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this[1].moduleAccessor,0x181021879c)
    ;
    lib::L2CValue::L2CValue(aLStack96,pLVar4);
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this[1].moduleAccessor,0x15c13eab83)
    ;
