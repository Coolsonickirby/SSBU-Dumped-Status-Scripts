...
void __thiscall
L2CFighterShizue::status::SpecialLwFire_pre(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON | _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_LW
