...
void __thiscall
L2CFighterShizue::status::FinalSurprise_main_loop(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  FUN_710001a8d0(aLStack80,this,aLStack160,aLStack176,aLStack192,aLStack208,aLStack224,aLStack240,
                 aLStack256);
  lib::L2CValue::_L2CValue(aLStack80);
