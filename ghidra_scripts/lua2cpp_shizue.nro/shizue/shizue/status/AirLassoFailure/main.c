...
void __thiscall
L2CFighterShizue::status::AirLassoFailure_main(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710002edf0);
  lib::L2CValue::L2CValue(aLStack80,0x1158d0953d);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_SHIZUE_FISHINGLINE_STATUS_KIND_REWIND);
