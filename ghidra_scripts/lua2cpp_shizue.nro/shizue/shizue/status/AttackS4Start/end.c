...
void __thiscall
L2CFighterShizue::status::AttackS4Start_end(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SHIZUE_GENERATE_ARTICLE_CRACKER);
