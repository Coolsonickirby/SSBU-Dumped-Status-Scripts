...
void __thiscall
L2CFighterShizue::status::SpecialNTakeOut_main(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    uVar4 = lib::L2CValue::operator__(aLStack96,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) == 0) goto LAB_710000b740;
...
LAB_710000b740:
  ...
  FUN_7100029250(this,aLStack160,aLStack176);
