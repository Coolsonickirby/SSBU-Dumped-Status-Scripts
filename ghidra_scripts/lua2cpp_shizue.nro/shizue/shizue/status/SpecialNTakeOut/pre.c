...
void __thiscall
L2CFighterShizue::status::SpecialNTakeOut_pre(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_MURABITO_STATUS_SPECIAL_N_INT_STATUS_ATTR);
