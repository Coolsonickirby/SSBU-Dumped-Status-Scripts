...
void __thiscall
L2CFighterShizue::status::SpecialNTakeOut_on_change_lr
          (L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_STATUS_ITEM_THROW_WORK_FLOAT_LR);
