...
void __thiscall
L2CFighterShizue::status::SpecialSCut_main_loop(L2CFighterShizue *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_7100023c90;
    }
    iVar5 = 1;
    goto LAB_7100023e3c;
  }
...
LAB_7100023c90:
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((bVar2 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack96,0xd08b19158);
    lib::L2CValue::L2CValue(aLStack112,0x11e8dc3271);
