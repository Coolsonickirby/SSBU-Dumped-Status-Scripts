...
void __thiscall
L2CWeaponShizueBalloon::status::Detach_main_loop
          (L2CWeaponShizueBalloon *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    FUN_71000037c0(aLStack80,this,aLStack96,aLStack112,aLStack128,aLStack144,aLStack160,aLStack176,
