...
void __thiscall L2CWeaponShizuePicopicohammer::SetStatusScripts(L2CWeaponShizuePicopicohammer *this)

{
  ...
  iVar1 = _WEAPON_SHIZUE_PICOPICOHAMMER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SHIZUE_PICOPICOHAMMER_STATUS_KIND_ATTACK);
