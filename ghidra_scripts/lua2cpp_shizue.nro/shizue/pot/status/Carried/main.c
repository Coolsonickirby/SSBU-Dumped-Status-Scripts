...
void __thiscall
L2CWeaponShizuePot::status::Carried_main(L2CWeaponShizuePot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x7b3ed444d);
  ...
  lib::L2CValue::L2CValue(aLStack80,Carried_main_loop);
