...
void __thiscall
L2CWeaponShizuePot::status::Throwed_pre(L2CWeaponShizuePot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_MURABITO_FLOWERPOT_THROW);
