...
void __thiscall
L2CWeaponShizuePot::status::Throwed_main_loop(L2CWeaponShizuePot *this,L2CValue *return_value)
...
LAB_710003bc2c:
        ...
        if ((uVar6 & 1) != 0) goto LAB_710003b970;
        lib::L2CValue::L2CValue(aLStack128,0xa9bd4aeb6);
        FUN_710003b3d0(aLStack112,this,aLStack128);
        lib::L2CValue::_L2CValue(aLStack128);
