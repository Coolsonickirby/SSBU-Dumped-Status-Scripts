...
void __thiscall
L2CWeaponFalcoBlaster::status::Stay_main(L2CWeaponFalcoBlaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack144,_WEAPON_FALCO_BLASTER_BULLET_INSTANCE_WORK_ID_INT_EFFECT_ID);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack160,_WEAPON_FALCO_BLASTER_BULLET_INSTANCE_WORK_ID_INT_EFFECT_ID);
    iVar2 = lib::L2CValue::as_integer(aLStack144);
