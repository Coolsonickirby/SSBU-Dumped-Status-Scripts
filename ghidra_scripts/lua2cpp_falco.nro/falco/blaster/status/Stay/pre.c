...
void __thiscall
L2CWeaponFalcoBlaster::status::Stay_pre(L2CWeaponFalcoBlaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,FIGHTER_KINETIC_TYPE_FALL._4_4_);
