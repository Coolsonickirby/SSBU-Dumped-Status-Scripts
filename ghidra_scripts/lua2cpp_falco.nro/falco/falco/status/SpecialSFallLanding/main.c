...
void __thiscall
L2CFighterFalco::status::SpecialSFallLanding_main(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x16500a0622);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialSFallLanding_main_loop);
