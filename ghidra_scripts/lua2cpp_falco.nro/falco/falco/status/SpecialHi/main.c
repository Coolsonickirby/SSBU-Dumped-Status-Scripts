...
void __thiscall
L2CFighterFalco::status::SpecialHi_main(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar4 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_FALCO_FIRE_STATUS_WORK_ID_INT_STOP_Y_FRAME);
    iVar2 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_71000193e0);
