...
void __thiscall
L2CFighterFalco::status::SpecialN_main_loop(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack240);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar6 & 1) != 0) goto LAB_71000176bc;
    }
...
LAB_71000176bc:
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  if ((bVar2 & 1U) == 0) goto LAB_7100017cbc;
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar6 & 1) != 0) {
          FUN_7100018c40(aLStack112,this);
          bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((bVar2 & 1U) != 0) {
            lib::L2CValue::L2CValue((L2CValue *)return_value,0);
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        uVar6 = lib::L2CValue::operator__(pLVar7,aLStack112);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar6 & 1) == 0) goto LAB_7100017cbc;
        lib::L2CValue::L2CValue(aLStack112,true);
        lib::L2CValue::operator_(aLStack176,aLStack112);
      }
      else {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          uVar6 = lib::L2CValue::operator__(aLStack224,aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar6 & 1) == 0) goto LAB_71000188a8;
          lib::L2CValue::L2CValue(aLStack112,1.0);
          fVar10 = (float)lib::L2CValue::as_number(aLStack112);
          app::lua_bind::MotionModule__set_whole_rate_impl(*ppBVar9,fVar10);
          lib::L2CValue::_L2CValue(aLStack112);
