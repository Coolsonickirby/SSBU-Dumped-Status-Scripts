...
void __thiscall L2CFighterFalco::status::Attack_pre(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_INT);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_FLOAT);
