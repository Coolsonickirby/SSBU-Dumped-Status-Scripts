...
void __thiscall
L2CFighterFalco::status::SpecialHiRush_main_loop(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_FALCO_FIRE_STATUS_WORK_ID_INT_RUSH_FRAME);
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if (((bVar1 & 1U) != 0) ||
         (bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack128), (bVar1 & 1U) != 0)) {
        pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x16);
        lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
        uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) == 0) {
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_FALCO_FIRE_STATUS_WORK_ID_FLAG_AIR);
          ...
          lib::L2CValue::_L2CValue(aLStack96);
          lib::L2CValue::L2CValue(aLStack144,_FIGHTER_FALCO_FIRE_STATUS_WORK_ID_FLAG_CONTINUE);
          iVar3 = lib::L2CValue::as_integer(aLStack144);
          ...
          if ((bVar1 & 1U) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack144);
            lib::L2CValue::_L2CValue(aLStack96);
            lib::L2CValue::L2CValue(aLStack96,_FIGHTER_FALCO_FIRE_STATUS_WORK_ID_FLAG_CONTINUE);
            iVar3 = lib::L2CValue::as_integer(aLStack96);
            app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar3);
          }
          else {
      ...
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_FALCO_STATUS_KIND_SPECIAL_HI_RUSH_END);
