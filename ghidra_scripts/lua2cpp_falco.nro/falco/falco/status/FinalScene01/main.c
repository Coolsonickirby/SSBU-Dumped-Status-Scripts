...
void __thiscall
L2CFighterFalco::status::FinalScene01_main(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIND_FALCO);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::FighterManager__start_finalbg_impl
            (FIGHTER_INSTANCE_WORK_ID_INT_AIR_LASSO_HANG_DATA,iVar2,1.0);
  lib::L2CValue::_L2CValue(aLStack80);
