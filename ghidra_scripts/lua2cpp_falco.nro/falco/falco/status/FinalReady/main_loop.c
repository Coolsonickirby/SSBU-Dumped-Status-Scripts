...
void __thiscall
L2CFighterFalco::status::FinalReady_main_loop(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar4 & 1) == 0) goto LAB_71000135f8;
...
LAB_71000135f8:
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  if ((uVar4 & 1) != 0) {
    app::FighterSpecializer_Falco::final_remove_screen_effect();
  }
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xe);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  if ((uVar4 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_FALCO_STATUS_WORK_ID_FLAG_FINAL_RESERVE_CLEAR_SLOW);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    app::FighterSpecializer_Falco::final_ready_exit_pre(pFVar7);
  }
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xe);
  lib::L2CValue::L2CValue(aLStack112,0xdf05c072b);
