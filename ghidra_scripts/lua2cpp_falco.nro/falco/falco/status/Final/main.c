...
void __thiscall L2CFighterFalco::status::Final_main(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_FALCO_STATUS_WORK_ID_FLAG_FINAL_ZOOM_START);
  iVar2 = lib::L2CValue::as_integer(aLStack128);
  app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack128);
