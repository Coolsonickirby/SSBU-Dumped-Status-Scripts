...
void __thiscall L2CFighterFalco::status::AttackS4_pre(L2CFighterFalco *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_4_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_4_INT);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_4_FLOAT);
  lib::L2CValue::L2CValue
            (aLStack248,
             _FS_SUCCEEDS_KEEP_HIT | FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_NO_REACTION);
  ...
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_4);
