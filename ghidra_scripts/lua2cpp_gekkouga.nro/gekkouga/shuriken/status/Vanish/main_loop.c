...
void __thiscall
L2CWeaponGekkougaShuriken::status::Vanish_main_loop
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xeca3f6a74);
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_GEKKOUGA_SHURIKEN_INSTANCE_WORK_ID_INT_VANISH_COUNT);
