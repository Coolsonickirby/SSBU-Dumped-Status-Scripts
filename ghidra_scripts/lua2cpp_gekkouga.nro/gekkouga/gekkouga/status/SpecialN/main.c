...
void __thiscall
L2CFighterGekkouga::status::SpecialN_main(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_GEKKOUGA_STATUS_KIND_SPECIAL_N_MAX_START);
