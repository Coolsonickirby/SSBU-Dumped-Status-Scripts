...
void __thiscall
L2CFighterGekkouga::status::SpecialLwEnd_pre(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_GEKKOUGA_STATUS_WORK_KEEP_FLOAT_RUSH_DIR_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_GEKKOUGA_STATUS_WORK_KEEP_FLOAT_RUSH_DIR_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_GEKKOUGA_STATUS_WORK_KEEP_FLOAT_RUSH_DIR_FLOAT);
