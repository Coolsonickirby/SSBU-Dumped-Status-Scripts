...
void __thiscall
L2CFighterGekkouga::status::FinalEnd_pre(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_INHERIT_CAMERA_RANGE |
