...
void __thiscall
L2CFighterGekkouga::status::SpecialS_init(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,0x108fb28963);
    ...
    lib::L2CValue::L2CValue(aLStack160,0x10986fa03e);
