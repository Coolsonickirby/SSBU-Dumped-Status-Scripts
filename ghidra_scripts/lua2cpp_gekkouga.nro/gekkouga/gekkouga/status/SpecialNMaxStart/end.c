...
void __thiscall
L2CFighterGekkouga::status::SpecialNMaxStart_end(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_GEKKOUGA_STATUS_KIND_SPECIAL_N_MAX_SHOT);
