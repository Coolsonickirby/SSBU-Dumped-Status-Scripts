...
void __thiscall
L2CFighterGekkouga::status::SpecialNMaxStart_main(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_710002b9b0(this);
  lib::L2CValue::L2CValue(aLStack80,SpecialNMaxStart_main_loop);
