...
void __thiscall
L2CFighterGekkouga::status::SpecialLwBound_main(L2CFighterGekkouga *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x10d5e0df26);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialLwBound_main_loop);
