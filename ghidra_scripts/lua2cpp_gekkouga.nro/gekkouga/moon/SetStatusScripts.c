...
void __thiscall L2CWeaponGekkougaMoon::SetStatusScripts(L2CWeaponGekkougaMoon *this)

{
  ...
  iVar1 = _WEAPON_GEKKOUGA_MOON_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_GEKKOUGA_MOON_STATUS_KIND_MOVE);
