...
void __thiscall
L2CWeaponGekkougaGekkougas::status::FinalEnd_main_loop
...

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) == 0) goto LAB_71000325dc;
      goto LAB_7100032488;
    }
  }
  else {
...
LAB_71000325dc:
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_GEKKOUGA_GEKKOUGAS_INSTANCE_WORK_ID_FLAG_HIT);
