...
void __thiscall L2CWeaponBuddyPad::status::Bound_pre(L2CWeaponBuddyPad *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_BUDDY_PAD_STATUS_WORK_KEEP_FLAG_BOUND_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_BUDDY_PAD_STATUS_WORK_KEEP_FLAG_BOUND_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_BUDDY_PAD_STATUS_WORK_KEEP_FLAG_BOUND_FLOAT);
