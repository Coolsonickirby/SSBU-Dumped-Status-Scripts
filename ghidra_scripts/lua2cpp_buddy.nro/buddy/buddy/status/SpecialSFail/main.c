...
void __thiscall
L2CFighterBuddy::status::SpecialSFail_main(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x126271c8e4);
  ...
  lib::L2CValue::L2CValue(aLStack208,SpecialSFail_main_loop);
