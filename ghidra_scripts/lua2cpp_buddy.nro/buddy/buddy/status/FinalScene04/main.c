...
void __thiscall
L2CFighterBuddy::status::FinalScene04_main(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,0x156d4e579b);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack112,0xfee1383eb);
  ...
  lib::L2CValue::L2CValue(aLStack112,0x1b31896071);
  iVar3 = lib::L2CValue::as_integer(aLStack96);
  HVar4 = lib::L2CValue::as_hash(aLStack112);
