...
void __thiscall
L2CFighterBuddy::status::FinalScene03_main_loop(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_BUDDY_FINAL_MODULE_SCENE_03_EXEC_FIX_POS);
        ...
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BUDDY_STATUS_KIND_FINAL_SCENE04);
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_BUDDY_STATUS_KIND_FINAL_SCENE04);
