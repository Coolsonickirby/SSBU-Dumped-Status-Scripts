...
void __thiscall L2CFighterBuddy::status::Final_main(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_BUDDY_STATUS_FINAL_WORK_INT_BIGBIRD_OBJECT_ID_01);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  ...
  lib::L2CValue::_L2CValue(aLStack128);
  pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_BUDDY_STATUS_FINAL_WORK_INT_START_SITUATION);
  iVar2 = lib::L2CValue::as_integer(pLVar5);
  iVar3 = lib::L2CValue::as_integer(aLStack128);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_BUDDY_STATUS_FINAL_FLAG_HIT);
  iVar2 = lib::L2CValue::as_integer(aLStack128);
