...
void __thiscall
L2CFighterBuddy::status::SpecialNShootJumpSquat_main(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::operator_(pLVar5,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,0x1937b726a4);
  ...
  if ((uVar8 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar8 & 1) == 0) goto LAB_710000c9ec;
  }
...
LAB_710000c9ec:
  ...
  lib::L2CValue::L2CValue(aLStack96,SpecialNShootJumpSquat_main_loop);
