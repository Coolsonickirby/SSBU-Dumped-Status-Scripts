...
void __thiscall
L2CFighterBuddy::status::Throw_main_loop(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  if ((uVar8 & 1) == 0) goto LAB_710001a340;
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_BUDDY_STATUS_THROW_LW_FLAG_BURY_SET_CLATTER);
  ...
  if ((bVar2 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_BUDDY_STATUS_THROW_LW_FLAG_BURY);
    iVar3 = lib::L2CValue::as_integer(aLStack144);
    bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
    lib::L2CValue::L2CValue(aLStack96,(bool)(bVar1 & 1));
    bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack144);
    if ((bVar2 & 1U) == 0) goto LAB_710001a340;
    ...
    lib::L2CValue::L2CValue(aLStack208,_FIGHTER_STATUS_THROW_WORK_INT_TARGET_HIT_GROUP);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BUDDY_STATUS_THROW_LW_FLAG_BURY);
    iVar3 = lib::L2CValue::as_integer(aLStack96);
    app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar3);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BUDDY_STATUS_THROW_LW_FLAG_BURY_SET_CLATTER);
    iVar3 = lib::L2CValue::as_integer(aLStack96);
    ...
    if ((bVar2 & 1U) == 0) {
      lib::L2CValue::L2CValue(aLStack144,LINK_NO_CAPTURE);
      lib::L2CValue::L2CValue(aLStack176,_FIGHTER_STATUS_THROW_WORK_INT_TARGET_OBJECT);
      ...
      if ((bVar2 & 1U) != 0) {
        lib::L2CValue::L2CValue(aLStack144,LINK_NO_CAPTURE);
        lib::L2CValue::L2CValue(aLStack160,0x1cbbfade13);
        iVar3 = lib::L2CValue::as_integer(aLStack144);
      ...
      lib::L2CValue::L2CValue(aLStack144,0x1cbbfade13);
      iVar3 = lib::L2CValue::as_integer(aLStack96);
