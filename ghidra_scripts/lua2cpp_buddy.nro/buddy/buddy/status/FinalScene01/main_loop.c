...
void __thiscall
L2CFighterBuddy::status::FinalScene01_main_loop(L2CFighterBuddy *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_BUDDY_FINAL_MODULE_SCENE_01_EXEC_FIX_POS);
        ...
        lib::L2CValue::L2CValue(aLStack112,0x198e9074a0);
        ...
        lib::L2CValue::_L2CValue(aLStack96);
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BUDDY_STATUS_KIND_FINAL_SCENE02);
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_BUDDY_STATUS_KIND_FINAL_SCENE02);
