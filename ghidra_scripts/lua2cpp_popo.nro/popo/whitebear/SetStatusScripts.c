...
void __thiscall L2CWeaponPopoWhitebear::SetStatusScripts(L2CWeaponPopoWhitebear *this)

{
  ...
  iVar1 = _WEAPON_POPO_WHITEBEAR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_POPO_WHITEBEAR_STATUS_KIND_DUMMY);
