...
void __thiscall
L2CWeaponPopoIceberg::status::Decline_pre(L2CWeaponPopoIceberg *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_POPO_ICEBERG_DECLINE);
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_POPO_ICEBERG_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_POPO_ICEBERG_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_POPO_ICEBERG_FLOAT);
