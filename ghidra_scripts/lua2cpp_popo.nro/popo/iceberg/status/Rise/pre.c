...
void __thiscall
L2CWeaponPopoIceberg::status::Rise_pre(L2CWeaponPopoIceberg *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_POPO_ICEBERG_RISE);
