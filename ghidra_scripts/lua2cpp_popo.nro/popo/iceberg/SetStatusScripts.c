...
void __thiscall L2CWeaponPopoIceberg::SetStatusScripts(L2CWeaponPopoIceberg *this)

{
  ...
  iVar1 = _WEAPON_POPO_ICEBERG_WIND_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_POPO_ICEBERG_WIND_STATUS_KIND_DUMMY);
