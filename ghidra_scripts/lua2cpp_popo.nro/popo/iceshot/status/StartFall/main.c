...
void __thiscall
L2CWeaponPopoIceshot::status::StartFall_main(L2CWeaponPopoIceshot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xac4e9b2ce);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,StartFall_main_loop);
