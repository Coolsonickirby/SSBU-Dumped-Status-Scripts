...
void __thiscall
L2CWeaponPopoIceshot::status::StartFall_pre(L2CWeaponPopoIceshot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_POPO_ICESHOT_START_FALL);
