...
void __thiscall L2CFighterPopo::status::PlateWait_init(L2CFighterPopo *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_50,_FIGHTER_POPO_LINK_NO_PARTNER);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::L2CValue((L2CValue *)&local_50,_FIGHTER_KIND_POPO);
