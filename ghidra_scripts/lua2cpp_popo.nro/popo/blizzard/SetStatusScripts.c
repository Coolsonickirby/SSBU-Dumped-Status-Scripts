...
void __thiscall L2CWeaponPopoBlizzard::SetStatusScripts(L2CWeaponPopoBlizzard *this)

{
  ...
  iVar1 = _WEAPON_POPO_BLIZZARD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_POPO_BLIZZARD_STATUS_KIND_DUMMY);
