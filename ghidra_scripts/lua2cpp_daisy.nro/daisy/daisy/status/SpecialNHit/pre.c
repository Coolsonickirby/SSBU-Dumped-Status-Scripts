...
void __thiscall
L2CFighterDaisy::status::SpecialNHit_pre(L2CFighterDaisy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_N_HIT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_N_HIT_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_N_HIT_FLOAT);
