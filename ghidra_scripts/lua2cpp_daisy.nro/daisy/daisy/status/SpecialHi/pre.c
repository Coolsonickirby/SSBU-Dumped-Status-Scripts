...
void __thiscall L2CFighterDaisy::status::SpecialHi_pre(L2CFighterDaisy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_MOTION_AIR);
