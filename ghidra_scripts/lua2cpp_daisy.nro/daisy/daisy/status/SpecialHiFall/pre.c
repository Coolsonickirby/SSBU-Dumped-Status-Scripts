...
void __thiscall
L2CFighterDaisy::status::SpecialHiFall_pre(L2CFighterDaisy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_PEACH_SPECIAL_HI_FALL);
  lib::L2CValue::L2CValue(aLStack168,GROUND_CORRECT_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack184,_GROUND_CLIFF_CHECK_KIND_ON_DROP);
  lib::L2CValue::L2CValue(aLStack200,true);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_HI_FALL_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_HI_FALL_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_HI_FALL_FLOAT);
