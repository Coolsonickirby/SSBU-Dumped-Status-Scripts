...
void __thiscall
L2CFighterNess::status::SpecialHiEnd_main(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    FUN_7100016380(aLStack112,this,aLStack128);
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
  }
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack80,&DAT_71000165c0);
