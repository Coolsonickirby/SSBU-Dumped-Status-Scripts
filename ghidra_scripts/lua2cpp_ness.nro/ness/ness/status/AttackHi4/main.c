...
void __thiscall L2CFighterNess::status::AttackHi4_main(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::status_AttackHi4_common(this,(L2CValue)0xb0);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_NESS_GENERATE_ARTICLE_YOYO_HEAD);
  lib::L2CValue::L2CValue(aLStack112,_WEAPON_NESS_YOYO_HEAD_STATUS_KIND_TAKEUP);
  iVar1 = lib::L2CValue::as_integer(aLStack96);
  iVar2 = lib::L2CValue::as_integer(aLStack112);
  app::lua_bind::ArticleModule__change_status_impl(this->moduleAccessor,iVar1,iVar2,0);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_NESS_GENERATE_ARTICLE_YOYO);
  lib::L2CValue::L2CValue(aLStack112,_WEAPON_NESS_YOYO_STATUS_KIND_TAKEUP);
  iVar1 = lib::L2CValue::as_integer(aLStack96);
  iVar2 = lib::L2CValue::as_integer(aLStack112);
  app::lua_bind::ArticleModule__change_status_impl(this->moduleAccessor,iVar1,iVar2,0);
  lib::L2CValue::_L2CValue(aLStack112);
