...
void __thiscall L2CFighterNess::status::Final_pre(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_NESS_FINAL_AIR);
