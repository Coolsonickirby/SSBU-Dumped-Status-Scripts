...
void __thiscall
L2CFighterNess::status::SpecialHiAttack_init(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack320,_FIGHTER_NESS_STATUS_SPECIAL_HI_WORK_FLOAT_DIR);
  lib::L2CValue::L2CValue(aLStack336,0xcd16a7bf2);
  lib::L2CValue::L2CValue(aLStack352,_FIGHTER_NESS_STATUS_SPECIAL_HI_FLAG_ATTACK_AIR);
  lib::L2CValue::L2CValue(aLStack368,_FIGHTER_KINETIC_TYPE_NESS_SPECIAL_HI_ATTACK);
  lib::L2CValue::L2CValue(aLStack384,_FIGHTER_KINETIC_TYPE_NESS_SPECIAL_AIR_HI_ATTACK);
  lib::L2CValue::L2CValue(aLStack400,_FIGHTER_NESS_STATUS_SPECIAL_HI_WORK_FLOAT_TARGET_ANGLE);
  lib::L2CValue::L2CValue(aLStack416,_FIGHTER_NESS_STATUS_SPECIAL_HI_WORK_FLOAT_START_ANGLE);
