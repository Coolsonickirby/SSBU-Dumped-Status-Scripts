...
void __thiscall L2CFighterNess::status::SpecialLw_main(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_50,0x32de6245ed);
  ...
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_NESS_STATUS_SPECIAL_LW_WORK_INT_TIME);
  ...
  iVar2 = app::lua_bind::WorkModule__get_param_int_impl(this->moduleAccessor,uVar4,uVar5);
  lib::L2CValue::L2CValue((L2CValue *)&local_50,iVar2);
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_NESS_STATUS_SPECIAL_LW_WORK_INT_STOP_Y_TIME);
  iVar2 = lib::L2CValue::as_integer((L2CValue *)&local_50);
  iVar3 = lib::L2CValue::as_integer(aLStack144);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack144);
