...
void __thiscall L2CFighterNess::status::AttackS4_main(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_NESS_STATUS_ATTACK_S4_FLAG_REFLECT_START);
