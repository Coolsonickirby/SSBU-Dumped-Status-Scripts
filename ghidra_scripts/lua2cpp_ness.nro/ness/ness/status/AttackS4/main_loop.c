...
void __thiscall
L2CFighterNess::status::AttackS4_main_loop(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_NESS_STATUS_ATTACK_S4_FLAG_REFLECT_START);
    ...
    if ((bVar1 & 1U) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_NESS_REFLECTOR_KIND_BAT);
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_NESS_STATUS_ATTACK_S4_FLAG_REFLECT_END);
    ...
    if ((bVar1 & 1U) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_NESS_REFLECTOR_KIND_BAT);
