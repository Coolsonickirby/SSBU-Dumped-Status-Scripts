...
void __thiscall
L2CFighterNess::status::SpecialLwHit_main_loop(L2CFighterNess *this,L2CValue *return_value)
...
LAB_7100010c44:
      ...
      lib::L2CValue::L2CValue(aLStack160,_FIGHTER_NESS_STATUS_SPECIAL_LW_WORK_INT_TIME);
      ...
      lib::L2CValue::L2CValue(aLStack176,_FIGHTER_NESS_STATUS_SPECIAL_LW_FLAG_BUTTON_RELEASE);
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      if ((bVar3 & 1U) != 0) {
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_NESS_STATUS_KIND_SPECIAL_LW_END);
  ...
  if ((bVar3 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_NESS_STATUS_SPECIAL_LW_WORK_INT_WAIT_MTRANS_KIND);
    FUN_7100010240(aLStack96,this,aLStack128);
    bVar3 = lib::L2CValue::operator_cast_to_bool(aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((bVar3 & 1U) != 0) goto LAB_7100011404;
  }
  else {
LAB_7100011404:
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_NESS_STATUS_SPECIAL_LW_WORK_INT_WAIT_MTRANS_KIND);
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_NESS_STATUS_SPECIAL_LW_FLAG_MOT_CHANGE);
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_KINETIC_TYPE_GROUND_STOP);
    lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KINETIC_TYPE_NESS_AIR_STOP_X_NORMAL_MAX_SPECIAL_LW);
    ...
    FUN_7100011890(this,aLStack96,aLStack144,aLStack160,aLStack176,aLStack192,aLStack208,aLStack224)
    ;
    lib::L2CValue::_L2CValue(aLStack224);
    lib::L2CValue::_L2CValue(aLStack208);
    lib::L2CValue::_L2CValue(aLStack192);
