...
void __thiscall L2CFighterNess::status::JumpAerial_pre(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  if (!bVar1) {
    ...
    lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_JUMP_AERIAL_MOTION);
