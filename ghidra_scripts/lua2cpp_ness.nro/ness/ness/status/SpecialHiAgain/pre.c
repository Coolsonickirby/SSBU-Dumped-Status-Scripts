...
void __thiscall
L2CFighterNess::status::SpecialHiAgain_pre(L2CFighterNess *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_NESS_SPECIAL_HI_AGAIN_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_NESS_SPECIAL_HI_AGAIN_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_NESS_SPECIAL_HI_AGAIN_FLOAT);
