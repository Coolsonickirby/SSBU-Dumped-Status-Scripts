...
void __thiscall
L2CWeaponNessYoyohead::status::Shot_pre(L2CWeaponNessYoyohead *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_NESS_YOYOHEAD_KINETIC_TYPE_SHOT);
