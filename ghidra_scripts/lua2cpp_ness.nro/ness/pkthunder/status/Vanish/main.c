...
void __thiscall
L2CWeaponNessPkthunder::status::Vanish_main(L2CWeaponNessPkthunder *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_NESS_PK_THUNDER_STATUS_WORK_ID_INT_VANISH_COUNT);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,0x1d1e79b667);
    iVar3 = lib::L2CValue::as_integer(aLStack64);
