...
void __thiscall L2CWeaponNessPkstarstorm::SetStatusScripts(L2CWeaponNessPkstarstorm *this)

{
  ...
  iVar1 = _WEAPON_NESS_PK_STARSTORM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_NESS_PK_STARSTORM_STATUS_KIND_MOVE);
