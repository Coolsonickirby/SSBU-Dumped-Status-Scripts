...
void __thiscall L2CWeaponNessYoyo::SetStatusScripts(L2CWeaponNessYoyo *this)

{
  ...
  iVar1 = _WEAPON_NESS_YOYO_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_NESS_YOYO_STATUS_KIND_SHOT);
