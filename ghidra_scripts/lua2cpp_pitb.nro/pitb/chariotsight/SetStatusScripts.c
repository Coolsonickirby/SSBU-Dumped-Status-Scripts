...
void __thiscall L2CWeaponPitbChariotsight::SetStatusScripts(L2CWeaponPitbChariotsight *this)

{
  ...
  iVar1 = _WEAPON_PIT_CHARIOTSIGHT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIT_CHARIOTSIGHT_STATUS_KIND_FINAL);
