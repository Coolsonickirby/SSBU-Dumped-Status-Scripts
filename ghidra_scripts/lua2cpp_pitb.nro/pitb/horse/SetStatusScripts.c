...
void __thiscall L2CWeaponPitbHorse::SetStatusScripts(L2CWeaponPitbHorse *this)

{
  ...
  iVar1 = _WEAPON_PIT_HORSE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIT_HORSE_STATUS_KIND_FINAL);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIT_HORSE_STATUS_KIND_FINAL_ATTACK);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
