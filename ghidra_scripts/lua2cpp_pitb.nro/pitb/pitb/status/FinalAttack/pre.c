...
void __thiscall L2CFighterPitb::status::FinalAttack_pre(L2CFighterPitb *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,_FS_SUCCEEDS_KEEP_EFFECT | _FS_SUCCEEDS_KEEP_HIT | FS_SUCCEEDS_KEEP_SOUND);
