...
void __thiscall L2CFighterPitb::status::SpecialNDir_pre(L2CFighterPitb *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_N_CHARGE_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_N_CHARGE_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_N_CHARGE_FLOAT);
  lib::L2CValue::L2CValue(aLStack248,FS_SUCCEEDS_KEEP_SOUND);
