...
void __thiscall
L2CWeaponPitbBowarrow::status::Fly_pre(L2CWeaponPitbBowarrow *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIT_BOW_ARROW_FLY_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIT_BOW_ARROW_FLY_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIT_BOW_ARROW_FLY_FLOAT);
