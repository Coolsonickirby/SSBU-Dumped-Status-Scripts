...
void __thiscall L2CFighterSamus::status::SpecialN_pre(L2CFighterSamus *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_SAMUS_INSTANCE_WORK_ID_FLAG_ST_INIT);
