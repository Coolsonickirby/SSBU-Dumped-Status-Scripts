...
void __thiscall L2CWeaponSamusGun::status::S4s_main(L2CWeaponSamusGun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x3dbd0dc6a);
  ...
  lib::L2CValue::L2CValue(aLStack80,S4s_main_loop);
