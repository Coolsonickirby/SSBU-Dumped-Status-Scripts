...
void __thiscall
L2CWeaponLucasPkfreeze::status::Move_main_loop(L2CWeaponLucasPkfreeze *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((bVar2 & 1U) == 0) goto LAB_7100027370;
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack112,_WEAPON_LUCAS_PK_FREEZE_INSTANCE_WORK_ID_INT_NO_BOMB_FRAME)
      ;
    ...
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack64,_WEAPON_LUCAS_PK_FREEZE_STATUS_KIND_NO_BANG);
