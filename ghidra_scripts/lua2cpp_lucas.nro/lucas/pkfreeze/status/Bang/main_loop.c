...
void __thiscall
L2CWeaponLucasPkfreeze::status::Bang_main_loop(L2CWeaponLucasPkfreeze *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack80,_WEAPON_LUCAS_PK_FREEZE_INSTANCE_WORK_ID_INT_POWER);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
