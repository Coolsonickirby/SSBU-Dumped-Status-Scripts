...
void __thiscall
L2CWeaponLucasHimohebi::status::Pull_pre(L2CWeaponLucasHimohebi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_LASSO_STATUS_WORK_KEEP_FLAG_PULL_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_LASSO_STATUS_WORK_KEEP_FLAG_PULL_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_LASSO_STATUS_WORK_KEEP_FLAG_PULL_FLOAT);
