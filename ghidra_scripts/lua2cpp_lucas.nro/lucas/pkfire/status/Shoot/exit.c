...
void __thiscall
L2CWeaponLucasPkfire::status::Shoot_exit(L2CWeaponLucasPkfire *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_50,_WEAPON_LUCAS_PK_FIRE_STATUS_KIND_PILLAR);
