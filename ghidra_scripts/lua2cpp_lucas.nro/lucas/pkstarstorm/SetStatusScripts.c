...
void __thiscall L2CWeaponLucasPkstarstorm::SetStatusScripts(L2CWeaponLucasPkstarstorm *this)

{
  ...
  iVar1 = _WEAPON_LUCAS_PK_STARSTORM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_LUCAS_PK_STARSTORM_STATUS_KIND_MOVE);
