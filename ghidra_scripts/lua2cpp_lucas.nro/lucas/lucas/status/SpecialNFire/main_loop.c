...
void __thiscall
L2CFighterLucas::status::SpecialNFire_main_loop(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar4 & 1) != 0) goto LAB_710001ef78;
    }
...
LAB_710001ef78:
  ...
  if ((uVar4 & 1) == 0) {
    ...
    FUN_71000130a0(aLStack80,this,aLStack128);
    bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((bVar2 & 1U) != 0) goto LAB_710001f1e4;
  }
  else {
LAB_710001f1e4:
    ...
    FUN_7100014770(this,aLStack144,aLStack176,aLStack192,aLStack208,aLStack224,aLStack240,aLStack256
                  );
