...
void __thiscall L2CFighterLucas::status::Final_pre(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_LUCAS_FINAL_AIR);
