...
void __thiscall
L2CFighterLucas::status::SpecialHiEnd_init(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_FLOAT_ANGLE);
  lib::L2CValue::L2CValue(aLStack192,aLStack160);
  lib::L2CValue::L2CValue(aLStack208,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_FLOAT_DEC_ANGLE);
  ...
  lVar3 = lib::L2CValue::as_number(aLStack128);
  ...
  uVar6 = app::lua_bind::MotionModule__end_frame_from_hash_impl(this->moduleAccessor,HVar4);
