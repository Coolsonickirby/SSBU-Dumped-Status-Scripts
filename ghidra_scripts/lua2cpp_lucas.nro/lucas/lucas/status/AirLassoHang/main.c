...
void __thiscall
L2CFighterLucas::status::AirLassoHang_main(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x664f937cc);
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_LUCAS_CLIFF_HANG_DATA_AIR_LASSO_HANG);
