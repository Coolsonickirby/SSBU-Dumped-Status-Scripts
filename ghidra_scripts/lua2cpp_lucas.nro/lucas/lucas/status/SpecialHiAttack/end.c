...
void __thiscall
L2CFighterLucas::status::SpecialHiAttack_end(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack160,_FIGHTER_LUCAS_STATUS_KIND_SPECIAL_HI_END);
