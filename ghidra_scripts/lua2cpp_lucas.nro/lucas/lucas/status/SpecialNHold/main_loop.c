...
void __thiscall
L2CFighterLucas::status::SpecialNHold_main_loop(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar2 & 1U) != 0) goto LAB_710001f76c;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack64);
LAB_710001f76c:
    ...
    FUN_7100014770(this,aLStack96,aLStack128,aLStack144,aLStack160,aLStack176,aLStack192,aLStack208)
    ;
