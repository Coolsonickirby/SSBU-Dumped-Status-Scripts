...
void __thiscall
L2CFighterLucas::status::SpecialHiHold_end(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_LUCAS_LINK_NO_PK_THUNDER);
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_LUCAS_GENERATE_ARTICLE_PK_THUNDER);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_INT_GUIDE_EFFECT_HANDLE);
