...
void __thiscall
L2CFighterLucas::status::SpecialHiHold_main_loop(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LUCAS_GENERATE_ARTICLE_PK_THUNDER);
...
LAB_710001abb8:
    ...
    bVar2 = false;
LAB_710001aad8:
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_INT_TIME);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack192,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_INT_STOP_TIME);
...
LAB_710001aca0:
    ...
    lib::L2CValue::L2CValue(aLStack448,_FIGHTER_KINETIC_TYPE_LUCAS_AIR_STOP_X_NORMAL_MAX_SPECIAL_HI)
    ;
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_LUCAS_PK_THUNDER_HIT_STATUS_NONE);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LUCAS_PK_THUNDER_HIT_STATUS_NEVERHIT);
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_FLOAT_UD);
  lib::L2CValue::L2CValue(aLStack160,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_FLOAT_DIR);
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_FLAG_ATTACK_AIR);
  lib::L2CValue::L2CValue(aLStack192,0xcdecdc00d);
  lib::L2CValue::L2CValue(aLStack208,0xcd16a7bf2);
  lib::L2CValue::L2CValue(aLStack224,_FIGHTER_LUCAS_STATUS_KIND_SPECIAL_HI_REFLECT);
  lib::L2CValue::L2CValue(aLStack240,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_FLAG_REFLECT_GROUND);
  lib::L2CValue::L2CValue(aLStack256,_FIGHTER_LUCAS_STATUS_KIND_SPECIAL_HI_ATTACK);
  lib::L2CValue::L2CValue(aLStack272,_FIGHTER_LUCAS_PK_THUNDER_HIT_STATUS_HIT);
  lib::L2CValue::L2CValue(aLStack288,0xd4635c187);
  lib::L2CValue::L2CValue(aLStack304,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_INT_GUIDE_EFFECT_HANDLE);
  lib::L2CValue::L2CValue(aLStack320,_FIGHTER_LUCAS_GENERATE_ARTICLE_PK_THUNDER);
  lib::L2CValue::L2CValue(aLStack336,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_FLAG_THUNDER_VANISH);
