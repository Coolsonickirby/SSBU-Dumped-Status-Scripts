...
void __thiscall
L2CFighterLucas::status::SpecialHiReflect_main(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LUCAS_STATUS_SPECIAL_HI_WORK_INT_NEXT_STATUS);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_LUCAS_STATUS_KIND_SPECIAL_HI_HOLD);
  uVar4 = lib::L2CValue::operator__(pLVar7,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
  if ((uVar4 & 1) == 0) {
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,10);
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_LUCAS_STATUS_KIND_SPECIAL_HI_ATTACK);
    uVar4 = lib::L2CValue::operator__(pLVar7,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) == 0) goto LAB_710000fa44;
  }
