...
void __thiscall
L2CFighterLucas::status::AirLassoFailure_main(L2CFighterLucas *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_71000120c0);
  lib::L2CValue::L2CValue(aLStack80,0x9e7d3cd80);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_LUCAS_HIMOHEBI2_STATUS_KIND_REWIND);
