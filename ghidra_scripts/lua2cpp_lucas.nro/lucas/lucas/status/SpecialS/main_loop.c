...
void __thiscall
L2CFighterLucas::status::SpecialS_main_loop(L2CFighterLucas *this,L2CValue *return_value)
...
LAB_7100020c50:
    lib::L2CValue::L2CValue(aLStack112,_FIGHTER_LUCAS_STATUS_SPECIAL_S_WORK_INT_START_SITUATION);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        if ((bVar2 & 1U) == 0) goto LAB_7100020e70;
...
LAB_7100020ee0:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) goto LAB_7100020c50;
  }
  iVar3 = 1;
LAB_7100020eec:
