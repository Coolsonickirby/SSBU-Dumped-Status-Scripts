...
void __thiscall
L2CWeaponPfushigisouLeafcutter::status::Move_end
...

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_WEAPON_PFUSHIGISOU_LEAFCUTTER_STATUS_KIND_CLASH);
  uVar2 = lib::L2CValue::operator__(this_00,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  if ((uVar2 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack64,0x1467053df6);
