...
void __thiscall
L2CFighterPfushigisou::status::AirLassoFailure_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_71000043f0);
  lib::L2CValue::L2CValue(aLStack80,0x9e7d3cd80);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_PFUSHIGISOU_VINE_STATUS_KIND_REWIND);
