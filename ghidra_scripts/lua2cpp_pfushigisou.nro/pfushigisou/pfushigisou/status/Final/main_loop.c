...
void __thiscall
L2CFighterPfushigisou::status::Final_main_loop(L2CFighterPfushigisou *this,L2CValue *return_value)
...
LAB_710000423c:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar2 & 1U) == 0) goto LAB_7100004324;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100004324;
      goto LAB_710000423c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
