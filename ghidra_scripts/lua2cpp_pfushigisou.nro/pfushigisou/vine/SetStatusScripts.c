...
void __thiscall L2CWeaponPfushigisouVine::SetStatusScripts(L2CWeaponPfushigisouVine *this)

{
  ...
  iVar1 = _WEAPON_PFUSHIGISOU_VINE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_LASSO_STATUS_KIND_REACH);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_LASSO_STATUS_KIND_REWIND);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_STATUS_MAIN);
  lua2cpp::L2CAgentBase::sv_set_status_func
