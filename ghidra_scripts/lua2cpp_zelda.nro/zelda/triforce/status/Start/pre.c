...
void __thiscall
L2CWeaponZeldaTriforce::status::Start_pre(L2CWeaponZeldaTriforce *this,L2CValue *return_value)

{
  ...
  pLVar11 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this[1].field_0x50,0xb38b339df);
  lib::L2CValue::operator_(pLVar11,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::_L2CValue(aLStack152);
  lib::L2CValue::_L2CValue(aLStack136);
  lib::L2CValue::L2CValue(aLStack136,0xe1534ea62);
  lib::L2CValue::L2CValue(aLStack152,0xc060ed533);
  uVar9 = lib::L2CValue::as_integer(aLStack136);
  uVar10 = lib::L2CValue::as_integer(aLStack152);
  iVar3 = app::lua_bind::WorkModule__get_param_int_impl(this->moduleAccessor,uVar9,uVar10);
  lib::L2CValue::L2CValue(aLStack120,iVar3);
  pLVar11 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this[1].field_0x50,0xc060ed533);
  lib::L2CValue::operator_(pLVar11,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::_L2CValue(aLStack152);
  lib::L2CValue::_L2CValue(aLStack136);
