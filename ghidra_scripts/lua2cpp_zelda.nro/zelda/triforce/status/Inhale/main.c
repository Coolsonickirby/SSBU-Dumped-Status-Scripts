...
void __thiscall
L2CWeaponZeldaTriforce::status::Inhale_main(L2CWeaponZeldaTriforce *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x6fb2cf99a);
  ...
  lib::L2CValue::L2CValue(aLStack80,Inhale_main_loop);
