...
void __thiscall
L2CWeaponZeldaPhantom::status::Attack_pre(L2CWeaponZeldaPhantom *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_ZELDA_PHANTOM_ATTACK);
