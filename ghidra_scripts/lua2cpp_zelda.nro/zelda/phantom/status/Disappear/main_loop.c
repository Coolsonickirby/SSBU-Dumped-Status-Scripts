...
void __thiscall
L2CWeaponZeldaPhantom::status::Disappear_main_loop
          (L2CWeaponZeldaPhantom *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,_WEAPON_ZELDA_PHANTOM_INSTANCE_WORK_ID_FLAG_END);
