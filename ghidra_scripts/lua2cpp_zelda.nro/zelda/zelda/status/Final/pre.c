...
void __thiscall L2CFighterZelda::status::Final_pre(L2CFighterZelda *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,0xede1c2524);
  ...
  pLVar15 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xede1c2524);
  lib::L2CValue::operator_(pLVar15,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::_L2CValue(aLStack152);
  lib::L2CValue::_L2CValue(aLStack136);
  lib::L2CValue::L2CValue(aLStack136,0xdf05c072b);
  lib::L2CValue::L2CValue(aLStack152,0xea91b15b2);
  uVar13 = lib::L2CValue::as_integer(aLStack136);
  uVar14 = lib::L2CValue::as_integer(aLStack152);
  fVar16 = (float)app::lua_bind::WorkModule__get_param_float_impl
                            (this->moduleAccessor,uVar13,uVar14);
  lib::L2CValue::L2CValue(aLStack120,fVar16);
  pLVar15 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xea91b15b2);
  lib::L2CValue::operator_(pLVar15,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::_L2CValue(aLStack152);
  lib::L2CValue::_L2CValue(aLStack136);
