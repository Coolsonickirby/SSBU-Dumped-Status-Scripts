...
void __thiscall L2CFighterZelda::status::FinalEnd_end(L2CFighterZelda *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_ZELDA_GENERATE_ARTICLE_TRIFORCE);
