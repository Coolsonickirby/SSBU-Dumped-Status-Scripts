...
void __thiscall
L2CFighterZelda::status::SpecialS_main_loop(L2CFighterZelda *this,L2CValue *return_value)
...
LAB_71000136c0:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::L2CValue(aLStack208,_FIGHTER_ZELDA_GENERATE_ARTICLE_DEIN);
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ZELDA_STATUS_KIND_SPECIAL_S_LOOP);
