...
void __thiscall L2CWeaponZeldaDein::SetStatusScripts(L2CWeaponZeldaDein *this)

{
  ...
  iVar1 = _WEAPON_ZELDA_DEIN_S_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ZELDA_DEIN_S_STATUS_KIND_BANG);
