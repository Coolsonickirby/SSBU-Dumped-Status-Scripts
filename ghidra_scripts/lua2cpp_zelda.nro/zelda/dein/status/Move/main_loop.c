...
void __thiscall
L2CWeaponZeldaDein::status::Move_main_loop(L2CWeaponZeldaDein *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) goto LAB_7100016574;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  lib::L2CValue::L2CValue(aLStack64,_WEAPON_ZELDA_DEIN_STATUS_KIND_TAME);
