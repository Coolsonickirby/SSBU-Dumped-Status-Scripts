...
void __thiscall
L2CWeaponNanaIceshot::status::Move_pre(L2CWeaponNanaIceshot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_POPO_ICESHOT_MOVE_AIR);
