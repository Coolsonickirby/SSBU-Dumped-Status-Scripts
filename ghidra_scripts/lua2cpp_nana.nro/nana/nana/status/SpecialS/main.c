...
void __thiscall L2CFighterNana::status::SpecialS_main(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_POPO_STATUS_WORK_INT_MOT_KIND);
  ...
  if ((uVar5 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_POPO_STATUS_SPECIAL_S_WORK_INT_SPEED_UP_Y_COUNT);
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710001e970);
