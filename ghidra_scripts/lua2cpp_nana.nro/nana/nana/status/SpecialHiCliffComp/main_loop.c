...
void __thiscall
L2CFighterNana::status::SpecialHiCliffComp_main_loop(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::sub_transition_group_check_air_cliff_force(this);
