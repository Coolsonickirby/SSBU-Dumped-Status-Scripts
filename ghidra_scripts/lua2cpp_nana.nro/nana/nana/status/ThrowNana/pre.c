...
void __thiscall L2CFighterNana::status::ThrowNana_pre(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_INHERIT_CURSOR | _FIGHTER_STATUS_ATTR_INTO_DOOR |
