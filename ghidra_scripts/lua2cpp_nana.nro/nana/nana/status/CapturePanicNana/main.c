...
void __thiscall
L2CFighterNana::status::CapturePanicNana_main(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12239ad417);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,CapturePanicNana_main_loop);
