...
void __thiscall L2CFighterNana::status::CliffWait_pre(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_SITUATION_KIND_CLIFF);
  lib::L2CValue::L2CValue(aLStack136,FIGHTER_KINETIC_TYPE_MOTION_CLIFF);
  lib::L2CValue::L2CValue(aLStack152,GROUND_CORRECT_KIND_CLIFF);
  lib::L2CValue::L2CValue(aLStack168,GROUND_CLIFF_CHECK_KIND_NONE);
  lib::L2CValue::L2CValue(aLStack184,true);
  lib::L2CValue::L2CValue(aLStack200,FIGHTER_STATUS_WORK_KEEP_FLAG_CLIFF_WAIT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_CLIFF_WAIT_INT);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_CLIFF_WAIT_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             ...
             _FIGHTER_STATUS_ATTR_ENABLE_ROCKETBELT_EJECT |
