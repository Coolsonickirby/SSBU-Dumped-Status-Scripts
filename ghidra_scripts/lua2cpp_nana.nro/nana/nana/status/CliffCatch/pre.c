...
void __thiscall L2CFighterNana::status::CliffCatch_pre(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_POPO_CLIFF_CATCH_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_POPO_CLIFF_CATCH_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_POPO_CLIFF_CATCH_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_WARP | FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE);
