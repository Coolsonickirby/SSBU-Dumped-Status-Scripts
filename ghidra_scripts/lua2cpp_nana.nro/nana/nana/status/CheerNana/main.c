...
void __thiscall L2CFighterNana::status::CheerNana_main(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0xb2feea709);
  ...
  if ((uVar2 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack80,0xbd5e19a6a);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,CheerNana_main_loop);
