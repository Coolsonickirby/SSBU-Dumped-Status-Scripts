...
void __thiscall
L2CFighterNana::status::SpecialHiCliffPullPartner_pre(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_WARP);
