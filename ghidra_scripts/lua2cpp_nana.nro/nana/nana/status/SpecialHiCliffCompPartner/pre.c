...
void __thiscall
L2CFighterNana::status::SpecialHiCliffCompPartner_pre(L2CFighterNana *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_POPO_SPECIAL_HI_CLIFF_COMP_PARTNER);
