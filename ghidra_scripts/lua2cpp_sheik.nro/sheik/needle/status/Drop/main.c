...
void __thiscall
L2CWeaponSheikNeedle::status::Drop_main(L2CWeaponSheikNeedle *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_WEAPON_SHEIK_NEEDLE_INSTANCE_WORK_ID_INT_NEXT_STATUS_KIND);
  ...
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack96,0x470150522);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,Drop_main_loop);
