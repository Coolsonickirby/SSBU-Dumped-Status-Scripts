...
void __thiscall
L2CFighterSheik::status::SpecialLwAttack_pre(L2CFighterSheik *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_SHEIK_SPECIAL_LW_ATTACK);
