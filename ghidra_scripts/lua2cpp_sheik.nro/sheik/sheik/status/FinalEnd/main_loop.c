...
void __thiscall
L2CFighterSheik::status::FinalEnd_main_loop(L2CFighterSheik *this,L2CValue *return_value)
...
LAB_71000191f0:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      if ((uVar3 & 1) != 0) {
        ...
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar3 & 1) != 0) goto LAB_710001922c;
      }
      pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
      lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      ...
      if ((uVar3 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar3 & 1) != 0) goto LAB_7100019234;
      }
      else {
        lib::L2CValue::_L2CValue(aLStack96);
      }
...
LAB_7100019234:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) == 0) goto LAB_7100019428;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_7100019428;
      goto LAB_71000191f0;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
