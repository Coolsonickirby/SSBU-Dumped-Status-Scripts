...
void __thiscall L2CFighterSheik::status::FinalEnd_main(L2CFighterSheik *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0xf58d2a2a2);
  ...
  lib::L2CValue::L2CValue(aLStack128,0x1190ab2757);
  lib::L2CValue::L2CValue(aLStack144,true);
