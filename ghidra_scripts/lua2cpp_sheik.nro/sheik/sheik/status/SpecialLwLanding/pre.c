...
void __thiscall
L2CFighterSheik::status::SpecialLwLanding_pre(L2CFighterSheik *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_SHEIK_STATUS_SPECIAL_LW_FLAG_LANDING_NORMAL);
