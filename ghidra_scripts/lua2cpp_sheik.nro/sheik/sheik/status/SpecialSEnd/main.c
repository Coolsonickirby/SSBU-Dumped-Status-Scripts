...
void __thiscall
L2CFighterSheik::status::SpecialSEnd_main(L2CFighterSheik *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KINETIC_TYPE_SHEIK_SPECIAL_AIR_S);
    ...
    app::lua_bind::GroundModule__correct_impl(this->moduleAccessor,GVar2);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KINETIC_TYPE_SHEIK_SPECIAL_S);
    iVar3 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::KineticModule__change_kinetic_impl(this->moduleAccessor,iVar3);
    lib::L2CValue::_L2CValue(aLStack80);
