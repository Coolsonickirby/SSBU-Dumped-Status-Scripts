...
void __thiscall
L2CFighterSheik::status::SpecialHiMove_pre(L2CFighterSheik *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack264,_FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_ATTACK);
