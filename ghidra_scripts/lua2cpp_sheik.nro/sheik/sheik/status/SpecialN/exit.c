...
void __thiscall L2CFighterSheik::status::SpecialN_exit(L2CFighterSheik *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) goto LAB_7100002940;
  ...
  if ((uVar8 & 1) != 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xb);
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SHEIK_STATUS_KIND_SPECIAL_N_LOOP);
      uVar8 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar8 & 1) == 0) {
        pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xb);
