...
void __thiscall L2CWeaponKoopajrRemainclown::SetStatusScripts(L2CWeaponKoopajrRemainclown *this)

{
  ...
  iVar1 = _WEAPON_KOOPAJR_REMAINCLOWN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KOOPAJR_REMAINCLOWN_STATUS_KIND_FALL);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KOOPAJR_REMAINCLOWN_STATUS_KIND_BURST);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
