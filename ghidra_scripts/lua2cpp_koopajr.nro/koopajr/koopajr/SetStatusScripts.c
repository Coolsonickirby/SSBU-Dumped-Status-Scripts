...
void __thiscall L2CFighterKoopajr::SetStatusScripts(L2CFighterKoopajr *this)

{
  ...
  iVar1 = _FIGHTER_KOOPAJR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100003640);
