...
void __thiscall
L2CFighterKoopajr::status::SpecialSJump_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_KOOPAJR_SPECIAL_S_JUMP);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_S_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_S_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_S_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             ...
             FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_ATTACK | _FIGHTER_STATUS_ATTR_INTO_DOOR |
