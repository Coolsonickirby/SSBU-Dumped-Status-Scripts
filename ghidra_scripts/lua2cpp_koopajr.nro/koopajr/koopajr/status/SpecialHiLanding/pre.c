...
void __thiscall
L2CFighterKoopajr::status::SpecialHiLanding_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_LANDING_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_LANDING_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_LANDING_FLOAT);
