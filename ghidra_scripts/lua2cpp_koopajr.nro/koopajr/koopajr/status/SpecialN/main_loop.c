...
void __thiscall
L2CFighterKoopajr::status::SpecialN_main_loop(L2CFighterKoopajr *this,L2CValue *return_value)
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack64);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((bVar2 & 1U) != 0) goto LAB_7100017940;
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KOOPAJR_STATUS_KIND_SPECIAL_N_HOLD);
        ...
        lib::L2CValue::_L2CValue(aLStack112);
LAB_7100017940:
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KOOPAJR_STATUS_KIND_SPECIAL_N_SHOOT);
        lib::L2CValue::operator_(aLStack96,aLStack64);
      }
      lib::L2CValue::_L2CValue(aLStack64);
