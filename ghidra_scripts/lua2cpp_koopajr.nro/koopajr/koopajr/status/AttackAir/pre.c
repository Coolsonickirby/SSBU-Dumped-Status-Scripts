...
void __thiscall
L2CFighterKoopajr::status::AttackAir_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) == 0) {
      lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KOOPAJR_STATUS_KIND_SPECIAL_HI_ATTACK);
