...
void __thiscall L2CFighterKoopajr::status::Dead_main(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KOOPAJR_GENERATE_ARTICLE_BATTEN);
    ...
    if ((bVar2 & 1U) == 0) goto LAB_710000e70c;
