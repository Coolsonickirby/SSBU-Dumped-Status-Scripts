...
void __thiscall
L2CFighterKoopajr::status::SpecialHiShoot_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_KOOPAJR_SPECIAL_HI_SHOOT);
