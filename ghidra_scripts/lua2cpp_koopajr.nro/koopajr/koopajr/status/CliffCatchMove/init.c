...
void __thiscall
L2CFighterKoopajr::status::CliffCatchMove_init(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    FUN_710000f410(this);
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KOOPAJR_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_CLIFF_CATCH)
    ;
