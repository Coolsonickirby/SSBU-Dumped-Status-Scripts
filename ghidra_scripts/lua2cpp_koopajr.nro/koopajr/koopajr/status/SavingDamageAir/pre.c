...
void __thiscall
L2CFighterKoopajr::status::SavingDamageAir_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KOOPAJR_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_INTERRUPT);
  ...
  if ((bVar2 & 1U) == 0) {
    lua2cpp::L2CFighterCommon::status_pre_DamageAir(this);
  }
  else {
    lib::L2CValue::L2CValue(aLStack120,SITUATION_KIND_AIR);
    lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_DAMAGE_AIR);
    ...
    lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_DAMAGE_FLAG);
    lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_DAMAGE_INT);
    lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_DAMAGE_FLOAT);
    ...
    lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_HI);
    lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_DAMAGE);
