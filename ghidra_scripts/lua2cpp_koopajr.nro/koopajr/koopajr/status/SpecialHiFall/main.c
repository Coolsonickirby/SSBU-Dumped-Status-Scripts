...
void __thiscall
L2CFighterKoopajr::status::SpecialHiFall_main(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12b06739bc);
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100011210);
