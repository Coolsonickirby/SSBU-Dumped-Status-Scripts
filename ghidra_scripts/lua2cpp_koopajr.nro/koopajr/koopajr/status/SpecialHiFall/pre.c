...
void __thiscall
L2CFighterKoopajr::status::SpecialHiFall_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_KOOPAJR_SPECIAL_HI_FALL);
  ...
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_WORK_KEEP_FLAG_FALL_INT);
