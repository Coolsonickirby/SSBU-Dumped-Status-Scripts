...
void __thiscall
L2CFighterKoopajr::status::SpecialS_end(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_40,_FIGHTER_KOOPAJR_STATUS_KIND_SPECIAL_S_DASH);
