...
void __thiscall
L2CFighterKoopajr::status::DamageFall_pre(L2CFighterKoopajr *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    lua2cpp::L2CFighterCommon::status_pre_DamageFall(this);
  }
  else {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_INSTANCE_WORK_ID_FLAG_REFLECT_LR_REVERSE_MOTION);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
      bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
      lib::L2CValue::L2CValue(aLStack64,(bool)(bVar1 & 1));
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack64);
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack64);
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_INSTANCE_WORK_ID_FLAG_REFLECT_LR_REVERSE_MOTION);
        iVar3 = lib::L2CValue::as_integer(aLStack64);
        app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar3);
        lib::L2CValue::_L2CValue(aLStack64);
      }
      lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KOOPAJR_STATUS_KIND_SPECIAL_HI_DAMAGE_END);
      iVar3 = lib::L2CValue::as_integer(aLStack64);
      app::lua_bind::StatusModule__set_status_kind_interrupt_impl(this->moduleAccessor,iVar3);
    }
    lib::L2CValue::_L2CValue(aLStack64);
