...
void __thiscall
L2CWeaponKoopajrCannonball::status::Hop_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_WEAPON_KOOPAJR_CANNONBALL_INSTANCE_WORK_ID_FLAG_HOP);
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack80,_WEAPON_KOOPAJR_CANNONBALL_INSTANCE_WORK_ID_INT_BOUND_NUM);
    iVar3 = lib::L2CValue::as_integer(aLStack80);
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100018d40);
