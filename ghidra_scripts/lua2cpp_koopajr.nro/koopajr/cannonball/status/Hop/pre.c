...
void __thiscall
L2CWeaponKoopajrCannonball::status::Hop_pre(L2CWeaponKoopajrCannonball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_KOOPAJR_CANNONBALL_HOP);
