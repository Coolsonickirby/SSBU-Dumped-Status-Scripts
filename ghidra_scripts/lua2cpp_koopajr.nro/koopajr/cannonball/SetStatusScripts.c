...
void __thiscall L2CWeaponKoopajrCannonball::SetStatusScripts(L2CWeaponKoopajrCannonball *this)

{
  ...
  iVar1 = _WEAPON_KOOPAJR_CANNONBALL_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KOOPAJR_CANNONBALL_STATUS_KIND_SHOOT);
