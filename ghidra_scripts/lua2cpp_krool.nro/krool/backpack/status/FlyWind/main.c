...
void __thiscall
L2CWeaponKroolBackpack::status::FlyWind_main(L2CWeaponKroolBackpack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x8a991df35);
  ...
  lib::L2CValue::L2CValue(aLStack80,FlyWind_main_loop);
