...
void __thiscall
L2CWeaponKroolBackpack::status::DamageEnd_main(L2CWeaponKroolBackpack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa3e419928);
  ...
  lib::L2CValue::L2CValue(aLStack80,DamageEnd_main_loop);
