...
void __thiscall
L2CFighterKrool::status::SpecialNSuction_end(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KROOL_STATUS_KIND_SPECIAL_N_LOOP);
