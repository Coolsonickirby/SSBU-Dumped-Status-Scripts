...
void __thiscall
L2CFighterKrool::status::FinalScene01_main(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIND_KROOL);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::FighterManager__start_finalbg_impl
            (FIGHTER_STATUS_AIR_LASSO_HANG_FLAG_EXTEND_ARM,iVar2,1.0);
  lib::L2CValue::_L2CValue(aLStack80);
