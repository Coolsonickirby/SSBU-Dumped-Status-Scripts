...
void __thiscall
L2CFighterKrool::status::SpecialNSpit_main_loop(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar8,aLStack112);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) != 0) goto LAB_7100026a38;
    }
    pLVar8 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack112,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar8,aLStack112);
    ...
    if ((uVar5 & 1) != 0) goto LAB_7100026a40;
  }
  else {
LAB_7100026a38:
    lib::L2CValue::_L2CValue(aLStack128);
LAB_7100026a40:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        FUN_7100027ed0(this,aLStack192,aLStack208);
      ...
      FUN_7100027ed0(this,aLStack160,aLStack176);
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        if ((uVar5 & 1) != 0) {
          ...
          FUN_7100027ed0(this,aLStack336,aLStack352);
        ...
        FUN_7100027ed0(this,aLStack304,aLStack320);
...
LAB_7100027548:
      ...
      if ((bVar3 & 1U) != 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack128);
          lib::L2CValue::_L2CValue(aLStack144);
          if ((uVar5 & 1) == 0) goto LAB_7100027768;
...
LAB_7100027768:
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack368);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar5 & 1) != 0) goto LAB_7100027848;
    }
    iVar4 = 1;
    goto LAB_7100027ad8;
  }
...
LAB_7100027984:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar8,aLStack112);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) == 0) goto LAB_7100027984;
