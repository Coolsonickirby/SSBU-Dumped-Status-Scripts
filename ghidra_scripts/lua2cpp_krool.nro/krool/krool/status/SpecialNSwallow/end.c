...
void __thiscall
L2CFighterKrool::status::SpecialNSwallow_end(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KROOL_STATUS_KIND_SPECIAL_N_SPIT);
    uVar3 = lib::L2CValue::operator__(aLStack80,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar3 & 1) == 0) {
