...
void __thiscall
L2CFighterKrool::status::SpecialLwTurn_exec(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KROOL_STATUS_KIND_SPECIAL_LW_HIT);
    uVar3 = lib::L2CValue::operator__(aLStack96,aLStack176);
    lib::L2CValue::_L2CValue(aLStack176);
    if ((uVar3 & 1) != 0) goto LAB_7100008f60;
    lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KROOL_STATUS_KIND_SPECIAL_LW_TURN);
    ...
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_KROOL_STATUS_SPECIAL_LW_WORK_INT_SITUATION_PREV);
