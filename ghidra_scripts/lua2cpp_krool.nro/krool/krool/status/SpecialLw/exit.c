...
void __thiscall
L2CFighterKrool::status::SpecialLwTurn_exit(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KROOL_SHIELD_GROUP_KIND_SPECIAL_LW_GUARD);
