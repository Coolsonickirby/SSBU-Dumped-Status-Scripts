...
void __thiscall
L2CFighterKrool::status::SpecialHiAirEnd_end(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KROOL_STATUS_KIND_SPECIAL_HI_FALL);
  ...
  if ((uVar4 & 1) == 0) {
    ...
    app::lua_bind::MotionAnimcmdModule__call_script_single_impl(this->moduleAccessor,iVar1,HVar5,-1)
    ;
