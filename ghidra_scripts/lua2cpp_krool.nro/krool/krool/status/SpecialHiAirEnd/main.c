...
void __thiscall
L2CFighterKrool::status::SpecialHiAirEnd_main(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1254e781ec);
  lib::L2CValue::L2CValue(aLStack96,0x1254e781ec);
  lib::L2CValue::L2CValue(aLStack112,true);
  FUN_710001dba0(this,aLStack80,aLStack96,aLStack112);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack128,0x1254e781ec);
  lib::L2CValue::L2CValue(aLStack144,0x14b05fccb8);
  lib::L2CValue::L2CValue(aLStack160,0x14b73208a1);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SpecialHiAirEnd_main_loop);
