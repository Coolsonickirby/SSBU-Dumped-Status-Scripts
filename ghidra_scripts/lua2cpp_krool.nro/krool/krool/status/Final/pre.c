...
void __thiscall L2CFighterKrool::status::Final_pre(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             ...
             FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT | _FIGHTER_STATUS_ATTR_FINAL);
