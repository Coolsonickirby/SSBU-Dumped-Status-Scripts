...
void __thiscall
L2CFighterKrool::status::FinalDash_main(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KROOL_STATUS_FINAL_WORK_INT_DASH_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  ...
  iVar2 = app::lua_bind::WorkModule__get_param_int_impl(this->moduleAccessor,uVar5,uVar6);
  lib::L2CValue::L2CValue(aLStack96,iVar2);
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KROOL_STATUS_FINAL_WORK_INT_DASH_CLIFF_CHECK_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  iVar3 = lib::L2CValue::as_integer(aLStack176);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack176);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    FUN_710001ad30(aLStack144,this,aLStack160);
    lib::L2CValue::_L2CValue(aLStack144);
    lib::L2CValue::_L2CValue(aLStack160);
  }
  this_00 = &this->globalTable;
  pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x15);
  lib::L2CValue::L2CValue(aLStack96,&DAT_710001af70);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) == 0) goto LAB_7100013fb0;
