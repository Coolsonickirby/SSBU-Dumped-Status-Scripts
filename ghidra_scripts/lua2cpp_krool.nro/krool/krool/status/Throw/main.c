...
void __thiscall L2CFighterKrool::status::Throw_main(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KROOL_STATUS_THROW_LW_FLAG_BURY);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
  app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar1);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,FIGHTER_STATUS_CATCH_WAIT_WORK_INT_MOTION_KIND);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if (pvVar8 == (void *)0x0) {
      lib::L2CValue::L2CValue(aLStack64,(L2CValue *)&LINK_ATTRIBUTE_REFERENCE_PARENT_SLOW);
    }
    else {
    ...
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_KROOL_STATUS_THROW_INT_CLATTER_FRAME);
