...
void __thiscall L2CFighterKrool::status::FinalEnd_main(L2CFighterKrool *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KROOL_STATUS_WORK_ID_FLAG_FINAL_END_EXIT);
  ...
  app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  app::lua_bind::FighterManager__exit_finalbg_impl(FIGHTER_STATUS_AIR_LASSO_HANG_FLAG_EXTEND_ARM);
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x16);
  lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
  uVar5 = lib::L2CValue::operator__(pLVar4,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
