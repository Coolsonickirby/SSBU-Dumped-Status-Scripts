...
void __thiscall
L2CWeaponKroolIronball::status::Hop_pre(L2CWeaponKroolIronball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_KROOL_IRONBALL_HOP);
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_ATTACK | _FS_SUCCEEDS_KEEP_EFFECT);
