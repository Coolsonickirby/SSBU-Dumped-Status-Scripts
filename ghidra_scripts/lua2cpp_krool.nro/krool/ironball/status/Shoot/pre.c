...
void __thiscall
L2CWeaponKroolIronball::status::Shoot_pre(L2CWeaponKroolIronball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_KROOL_IRONBALL_SHOOT);
