...
void __thiscall
L2CWeaponKroolCrown::status::Hop_pre(L2CWeaponKroolCrown *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_KROOL_CROWN_HOP);
