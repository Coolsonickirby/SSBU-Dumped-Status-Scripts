...
void __thiscall
L2CWeaponKroolBlunderbuss::status::Swallow_main
          (L2CWeaponKroolBlunderbuss *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x7eea09f44);
  ...
  lib::L2CValue::L2CValue(aLStack80,Swallow_main_loop);
