...
void __thiscall L2CFighterSimon::status::FinalEnd_main(L2CFighterSimon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  app::lua_bind::FighterManager__exit_finalbg_impl(BATTLE_OBJECT_CATEGORY_FIGHTER);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SIMON_FINAL_MODULE_END_INIT);
  pFVar6 = (Fighter *)lib::L2CValue::as_pointer(pLVar3);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_Simon::call_final_module(pFVar6,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
