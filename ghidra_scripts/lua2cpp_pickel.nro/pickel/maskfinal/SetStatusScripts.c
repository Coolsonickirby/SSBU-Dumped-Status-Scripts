...
void __thiscall L2CWeaponPickelMaskfinal::SetStatusScripts(L2CWeaponPickelMaskfinal *this)

{
  ...
  iVar1 = _WEAPON_PICKEL_MASKFINAL_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PICKEL_MASKFINAL_STATUS_KIND_REGULAR);
