...
void __thiscall L2CWeaponPickelFence::SetStatusScripts(L2CWeaponPickelFence *this)

{
  ...
  iVar1 = _WEAPON_PICKEL_FENCE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PICKEL_FENCE_STATUS_KIND_REGULAR);
