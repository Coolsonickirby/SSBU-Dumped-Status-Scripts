...
void __thiscall
L2CFighterPickel::status::AttackFall_init(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PICKEL_STATUS_KIND_ATTACK_WALK);
