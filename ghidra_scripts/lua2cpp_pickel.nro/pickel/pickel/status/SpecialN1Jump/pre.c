...
void __thiscall
L2CFighterPickel::status::SpecialN1Jump_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  if ((uVar14 & 1) == 0) {
    ...
    if ((uVar14 & 1) == 0) {
      pLVar13 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,10);
      lib::L2CValue::L2CValue(aLStack312,_FIGHTER_PICKEL_STATUS_KIND_SPECIAL_N3_JUMP);
      uVar14 = lib::L2CValue::operator__(pLVar13,aLStack312);
      lib::L2CValue::_L2CValue(aLStack312);
      lib::L2CValue::_L2CValue(aLStack200);
      if ((uVar14 & 1) == 0) goto LAB_710000badc;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack200);
    }
    ...
    FUN_7100069ea0(aLStack312,aLStack200);
    lib::L2CValue::operator_(aLStack120,aLStack312);
