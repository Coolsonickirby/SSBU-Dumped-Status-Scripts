...
void __thiscall
L2CFighterPickel::status::SpecialS_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_PICKEL_GENERATE_ARTICLE_TROLLEY);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    bVar1 = app::FighterSpecializer_Pickel::check_material_special_s_generate_trolley(pBVar14);
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue
                (aLStack216,
                 FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_WARP | _FIGHTER_STATUS_ATTR_START_TURN);
      ...
      app::lua_bind::FighterStatusModuleImpl__set_fighter_status_data_impl
                (this->moduleAccessor,(bool)(bVar1 & 1),iVar6,(bool)(bVar3 & 1),(bool)(bVar4 & 1),
                 (bool)(bVar5 & 1),uVar15,uVar8,uVar13,in_stack_fffffffffffffef4);
      lib::L2CValue::_L2CValue(aLStack248);
      lib::L2CValue::_L2CValue(aLStack232);
      lib::L2CValue::_L2CValue(aLStack216);
      lib::L2CValue::_L2CValue(aLStack200);
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_PICKEL_STATUS_KIND_SPECIAL_S_FAILED);
