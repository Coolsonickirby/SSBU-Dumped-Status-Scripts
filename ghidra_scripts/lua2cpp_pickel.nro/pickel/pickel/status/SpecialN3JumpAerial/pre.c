...
void __thiscall
L2CFighterPickel::status::SpecialN3JumpAerial_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  FUN_710004c830(aLStack200,aLStack216);
  ...
  if ((uVar14 & 1) != 0) {
    ...
    FUN_7100055910(aLStack312,aLStack232);
    lib::L2CValue::operator_(aLStack120,aLStack312);
