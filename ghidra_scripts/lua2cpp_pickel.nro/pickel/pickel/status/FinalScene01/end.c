...
void __thiscall
L2CFighterPickel::status::FinalScene01_end(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_FINAL_MODULE_SCENE_01_EXIT);
  pFVar5 = (Fighter *)lib::L2CValue::as_pointer(pLVar3);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Pickel::call_final_module(pFVar5,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_GENERATE_ARTICLE_MASKFINAL);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::ArticleModule__remove_exist_impl(this->moduleAccessor,iVar2,0);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0.0);
  fVar6 = (float)lib::L2CValue::as_number(aLStack80);
  app::lua_bind::MotionModule__set_skip_rate_impl(this->moduleAccessor,fVar6,false);
  lib::L2CValue::_L2CValue(aLStack80);
