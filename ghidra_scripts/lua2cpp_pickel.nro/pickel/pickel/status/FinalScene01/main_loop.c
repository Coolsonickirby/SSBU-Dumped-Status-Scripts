...
void __thiscall
L2CFighterPickel::status::FinalScene01_main_loop(L2CFighterPickel *this,L2CValue *return_value)
...
LAB_710007e73c:
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_FINAL_MODULE_SCENE_01_EXEC);
    pFVar7 = (Fighter *)lib::L2CValue::as_pointer(pLVar6);
    iVar3 = lib::L2CValue::as_integer(aLStack80);
    app::FighterSpecializer_Pickel::call_final_module(pFVar7,iVar3);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack112,_FIGHTER_PICKEL_STATUS_FINAL_FLAG_CLEAR_COLOR);
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_710007ea1c;
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_PICKEL_STATUS_FINAL_FLAG_CLEAR_COLOR);
    ...
    lib::L2CValue::L2CValue(aLStack112,_FIGHTER_PICKEL_STATUS_FINAL_FLAG_SCENE01_SYNC);
    iVar3 = lib::L2CValue::as_integer(aLStack112);
    bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((bVar2 & 1U) == 0) goto LAB_710007e73c;
