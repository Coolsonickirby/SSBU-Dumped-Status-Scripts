...
void __thiscall
L2CFighterPickel::status::AttackAirLwEnd_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1107ac4521);
  ...
  lib::L2CValue::L2CValue(aLStack80,AttackAirLwEnd_main_loop);
