...
void __thiscall
L2CFighterPickel::status::AttackAirLwEnd_main_loop(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) == 0) goto LAB_710007f954;
  }
...
LAB_710007f8bc:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710007f8bc;
