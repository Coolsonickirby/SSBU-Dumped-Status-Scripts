...
void __thiscall
L2CFighterPickel::status::AttackWalk_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack392,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_3);
