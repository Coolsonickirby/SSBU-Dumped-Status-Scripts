...
void __thiscall
L2CFighterPickel::status::AttackWalk_main_loop(L2CFighterPickel *this,L2CValue *return_value)
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      if ((uVar3 & 1) == 0) {
        ...
        fVar5 = (float)app::lua_bind::GroundModule__get_down_friction_impl(this->moduleAccessor);
        lib::L2CValue::L2CValue(aLStack160,fVar5);
