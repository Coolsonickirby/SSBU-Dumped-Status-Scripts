...
void __thiscall
L2CFighterPickel::status::AttackLandingLight_exec(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PICKEL_STATUS_KIND_ATTACK_LANDING_LIGHT);
