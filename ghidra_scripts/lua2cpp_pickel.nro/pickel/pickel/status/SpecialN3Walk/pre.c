...
void __thiscall
L2CFighterPickel::status::SpecialN3Walk_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  FUN_710004c830(aLStack216,aLStack232);
  ...
  if ((uVar14 & 1) != 0) {
    ...
    FUN_7100055910(aLStack328,aLStack216);
    lib::L2CValue::operator_(aLStack120,aLStack328);
