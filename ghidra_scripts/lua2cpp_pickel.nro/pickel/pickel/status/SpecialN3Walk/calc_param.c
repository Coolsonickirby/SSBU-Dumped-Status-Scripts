...
void __thiscall
L2CFighterPickel::status::SpecialN3Walk_calc_param(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xb4fb275bd);
  lib::L2CValue::L2CValue(aLStack96,0x9eeaf3544);
