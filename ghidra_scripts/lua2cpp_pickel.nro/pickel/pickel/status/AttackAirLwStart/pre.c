...
void __thiscall
L2CFighterPickel::status::AttackAirLwStart_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_ATTACK_AIR_LW |
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             ...
             _FIGHTER_STATUS_ATTR_CLEAR_MOTION_ENERGY);
