...
void __thiscall
L2CFighterPickel::status::SpecialLwBomb_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PICKEL_INSTANCE_WORK_ID_FLAG_SPECIAL_LW_SITUATION_AIR);
  ...
  if ((uVar4 & 1) != 0) {
    lib::L2CValue::L2CValue
              (aLStack64,_FIGHTER_PICKEL_INSTANCE_WORK_ID_FLAG_SPECIAL_LW_SITUATION_AIR);
  ...
  lib::L2CValue::L2CValue(aLStack192,_FIGHTER_PICKEL_STATUS_SPECIAL_LW_INT_PLATE_PARENT_ID);
  iVar2 = lib::L2CValue::as_integer(aLStack176);
  iVar3 = lib::L2CValue::as_integer(aLStack192);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack192);
  lib::L2CValue::_L2CValue(aLStack176);
  lib::L2CValue::L2CValue(aLStack176,SpecialLwBomb_main_loop);
