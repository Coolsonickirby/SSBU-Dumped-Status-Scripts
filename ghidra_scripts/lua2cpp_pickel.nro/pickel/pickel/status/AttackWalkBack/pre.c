...
void __thiscall
L2CFighterPickel::status::AttackWalkBack_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  uVar13 = lib::L2CValue::operator__(aLStack216,aLStack120);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_KINETIC_TYPE_MOTION_LOOP);
