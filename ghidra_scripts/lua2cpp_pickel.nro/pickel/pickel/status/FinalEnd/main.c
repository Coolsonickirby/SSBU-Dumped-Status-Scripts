...
void __thiscall
L2CFighterPickel::status::FinalEnd_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PICKEL_FINAL_MODULE_END_INIT);
