...
void __thiscall
L2CFighterPickel::status::SpecialSDrive_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_SPRING
