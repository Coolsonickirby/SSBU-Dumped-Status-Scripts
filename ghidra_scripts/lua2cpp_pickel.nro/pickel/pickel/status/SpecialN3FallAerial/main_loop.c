...
void __thiscall
L2CFighterPickel::status::SpecialN3FallAerial_main_loop
...

{
  ...
  if ((bVar1 & 1U) != 0) goto LAB_7100053ff0;
  FUN_710004d710(this);
...
LAB_7100053e04:
  ...
  FUN_710004e300(aLStack80,this,aLStack144);
  lib::L2CValue::L2CValue(aLStack64,true);
  uVar5 = lib::L2CValue::operator__(aLStack80,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  if ((uVar5 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_STATUS_KIND_FALL_AERIAL);
    FUN_7100054190(aLStack80,this,aLStack160);
    lib::L2CValue::L2CValue(aLStack64,true);
    uVar5 = lib::L2CValue::operator__(aLStack80,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
