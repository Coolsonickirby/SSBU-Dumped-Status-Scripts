...
void __thiscall
L2CFighterPickel::status::SpecialN3FallAerial_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  FUN_7100053a20(this);
  lib::L2CValue::L2CValue(aLStack64,SpecialN3FallAerial_main_loop);
