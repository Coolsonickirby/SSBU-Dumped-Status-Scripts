...
void __thiscall
L2CFighterPickel::status::SpecialHiGliding_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack184,_FIGHTER_KINETIC_TYPE_GLIDE_START);
