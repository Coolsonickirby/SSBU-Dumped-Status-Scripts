...
void __thiscall
L2CFighterPickel::status::SpecialN3Wait_main_loop(L2CFighterPickel *this,L2CValue *return_value)
...
LAB_71000586a0:
  ...
  if ((uVar7 & 1) != 0) goto LAB_71000589bc;
  FUN_710004efa0(aLStack80,this);
  bVar3 = lib::L2CValue::operator_cast_to_bool(aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  if ((bVar3 & 1U) != 0) goto LAB_71000589bc;
