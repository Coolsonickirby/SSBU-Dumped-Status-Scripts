...
void __thiscall
L2CFighterPickel::status::GuardOn_main_loop(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) != 0) goto LAB_71000893c0;
  ...
  if ((uVar4 & 1) == 0) {
LAB_71000893ac:
    lua2cpp::L2CFighterCommon::status_GuardOn_Main(this);
  }
  else {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((bVar1 & 1U) == 0) goto LAB_71000893ac;
