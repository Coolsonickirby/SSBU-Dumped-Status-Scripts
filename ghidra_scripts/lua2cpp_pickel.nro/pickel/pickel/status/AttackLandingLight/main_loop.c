...
void __thiscall
L2CFighterPickel::status::AttackLandingLight_main_loop
...
LAB_7100081d38:
      ...
      if ((uVar5 & 1) != 0) goto LAB_7100081d48;
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_STATUS_KIND_LANDING_LIGHT);
