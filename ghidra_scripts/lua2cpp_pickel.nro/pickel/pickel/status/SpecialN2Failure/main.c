...
void __thiscall
L2CFighterPickel::status::SpecialN2Failure_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12f8f2ad84);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack96,SpecialN2Failure_main_loop);
