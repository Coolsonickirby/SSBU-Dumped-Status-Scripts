...
void __thiscall
L2CFighterPickel::status::SpecialSFailed_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x14bc213647);
  ...
  lib::L2CValue::L2CValue(aLStack208,SpecialSFailed_main_loop);
