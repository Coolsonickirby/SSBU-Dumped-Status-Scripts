...
void __thiscall
L2CFighterPickel::status::FinalReady_exec(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_FINAL_MODULE_READY_EXIT_PRE);
    pFVar6 = (Fighter *)lib::L2CValue::as_pointer(pLVar5);
    iVar2 = lib::L2CValue::as_integer(aLStack80);
    app::FighterSpecializer_Pickel::call_final_module(pFVar6,iVar2);
    lib::L2CValue::_L2CValue(aLStack80);
  }
  pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,4);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_FINAL_MODULE_READY_EXEC);
  pFVar6 = (Fighter *)lib::L2CValue::as_pointer(pLVar5);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Pickel::call_final_module(pFVar6,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  if ((uVar3 & 1) != 0) {
    bVar1 = app::lua_bind::FighterManager__is_prepared_movie_impl(LUA_SCRIPT_LINE_STATUS_SHIFT);
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    if ((uVar3 & 1) != 0) {
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_STATUS_FINAL_FLAG_TO_SCENE01);
      iVar2 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar2);
      lib::L2CValue::_L2CValue(aLStack80);
    }
