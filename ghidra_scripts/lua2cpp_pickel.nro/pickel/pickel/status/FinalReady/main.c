...
void __thiscall
L2CFighterPickel::status::FinalReady_main(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PICKEL_FINAL_MODULE_READY_INIT);
  pFVar8 = (Fighter *)lib::L2CValue::as_pointer(pLVar5);
  iVar3 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Pickel::call_final_module(pFVar8,iVar3);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_PICKEL_INSTANCE_WORK_ID_INT_FINAL_MOVIE_HASH);
  ...
  HVar7 = lib::L2CValue::as_hash(aLStack80);
  app::lua_bind::FighterManager__prepare_movie_impl(LUA_SCRIPT_LINE_STATUS_SHIFT,HVar7);
