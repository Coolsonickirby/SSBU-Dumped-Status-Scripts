...
void __thiscall
L2CFighterPickel::status::SpecialN2_main_loop(L2CFighterPickel *this,L2CValue *return_value)
...
LAB_710006029c:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      if ((uVar3 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack64);
        if ((bVar2 & 1U) != 0) {
          lib::L2CValue::L2CValue(aLStack64,_FIGHTER_PICKEL_STATUS_KIND_SPECIAL_N2_CRAFT);
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710006042c;
      goto LAB_710006029c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
