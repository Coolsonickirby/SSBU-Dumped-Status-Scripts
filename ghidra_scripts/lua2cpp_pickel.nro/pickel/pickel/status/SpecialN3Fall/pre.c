...
void __thiscall
L2CFighterPickel::status::SpecialN3Fall_pre(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  FUN_710004c830(aLStack120,aLStack136);
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    FUN_710004c830(aLStack232,aLStack248);
    ...
    if ((uVar15 & 1) != 0) {
      ...
      FUN_7100055910(aLStack344,aLStack232);
      lib::L2CValue::operator_(aLStack120,aLStack344);
