...
void __thiscall
L2CFighterPickel::status::SpecialN3WalkBack_main_loop(L2CFighterPickel *this,L2CValue *return_value)
...
LAB_71000574d0:
    ...
    if ((uVar5 & 1) != 0) goto LAB_7100057588;
    FUN_710004efa0(aLStack80,this);
    bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) != 0) goto LAB_7100057588;
