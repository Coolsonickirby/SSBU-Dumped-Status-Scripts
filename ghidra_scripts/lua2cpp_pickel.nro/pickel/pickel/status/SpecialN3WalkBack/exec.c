...
void __thiscall
L2CFighterPickel::status::SpecialN3WalkBack_exec(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack224,aLStack64);
  lib::L2CValue::L2CValue(aLStack240,aLStack80);
