...
void __thiscall
L2CFighterPickel::status::AttackJumpAerial_main_loop(L2CFighterPickel *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack144,FIGHTER_STATUS_KIND_JUMP_AERIAL);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      if ((bVar1 & 1U) == 0) {
        ...
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_PICKEL_STATUS_KIND_ATTACK_FALL_AERIAL);
