...
void __thiscall
L2CWeaponPickelStone::status::Lost_main(L2CWeaponPickelStone *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x4404584aa);
  ...
  lib::L2CValue::L2CValue(aLStack80,Lost_main_loop);
