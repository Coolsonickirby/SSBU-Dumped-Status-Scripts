...
void __thiscall
L2CWeaponPickelPlate::status::On_main_loop(L2CWeaponPickelPlate *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,_WEAPON_PICKEL_PLATE_INSTANCE_WORK_ID_FLAG_IGNITION);
    ...
    if ((uVar4 & 1) != 0) goto LAB_710009a92c;
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) == 0) goto LAB_710009a92c;
    lib::L2CValue::L2CValue(aLStack64,_WEAPON_PICKEL_PLATE_STATUS_KIND_OFF);
