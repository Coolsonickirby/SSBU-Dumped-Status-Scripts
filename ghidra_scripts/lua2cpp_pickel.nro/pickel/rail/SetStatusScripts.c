...
void __thiscall L2CWeaponPickelRail::SetStatusScripts(L2CWeaponPickelRail *this)

{
  ...
  iVar1 = _WEAPON_PICKEL_RAIL_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PICKEL_RAIL_STATUS_KIND_NORMAL);
