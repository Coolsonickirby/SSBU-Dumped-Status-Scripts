...
void __thiscall L2CWeaponYounglinkHookshot::SetStatusScripts(L2CWeaponYounglinkHookshot *this)

{
  ...
  iVar1 = _WEAPON_TOONLINK_HOOKSHOT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_TOONLINK_HOOKSHOT_STATUS_KIND_WAIT);
