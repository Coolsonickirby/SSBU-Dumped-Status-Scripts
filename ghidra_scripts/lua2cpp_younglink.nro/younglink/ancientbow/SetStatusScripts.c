...
void __thiscall L2CWeaponYounglinkAncientbow::SetStatusScripts(L2CWeaponYounglinkAncientbow *this)

{
  ...
  iVar1 = _WEAPON_LINK_ANCIENTBOW_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_LINK_ANCIENTBOW_STATUS_KIND_HAVE);
