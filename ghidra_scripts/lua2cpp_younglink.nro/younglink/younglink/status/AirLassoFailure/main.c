...
void __thiscall
L2CFighterYounglink::status::AirLassoFailure_main(L2CFighterYounglink *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710000e960);
  lib::L2CValue::L2CValue(aLStack80,0x9e7d3cd80);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_TOONLINK_HOOKSHOT_STATUS_KIND_REWIND);
