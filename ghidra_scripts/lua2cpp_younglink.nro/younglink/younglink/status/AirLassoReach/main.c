...
void __thiscall
L2CFighterYounglink::status::AirLassoReach_main(L2CFighterYounglink *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_710000e408;
    ...
    if ((bVar2 & 1U) == 0) goto LAB_710000e408;
