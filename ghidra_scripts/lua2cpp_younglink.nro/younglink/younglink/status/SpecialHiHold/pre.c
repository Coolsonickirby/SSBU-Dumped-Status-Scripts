...
void __thiscall
L2CFighterYounglink::status::SpecialHiHold_pre(L2CFighterYounglink *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_LINK_SPECIAL_HI_HOLD_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_LINK_SPECIAL_HI_HOLD_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_LINK_SPECIAL_HI_HOLD_FLOAT);
