...
void __thiscall
L2CFighterYounglink::status::FinalCombo_main_loop(L2CFighterYounglink *this,L2CValue *return_value)
...
LAB_710000f848:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
LAB_710000f954:
        lib::L2CValue::L2CValue(aLStack96,0x27b8857ef6);
        ...
        if ((uVar5 & 1) == 0) goto LAB_710000f9ec;
        iVar7 = 0;
      }
      else {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) != 0) goto LAB_710000f954;
LAB_710000f9ec:
        iVar7 = 1;
      }
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) == 0) goto LAB_710000fa34;
      goto LAB_710000f670;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
