...
void __thiscall
L2CFighterMariod::status::SpecialLw_main_loop(L2CFighterMariod *this,L2CValue *return_value)
...
LAB_71000060f4:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_MARIOD_STATUS_SPECIAL_LW_INT_MTRANS);
      iVar3 = lib::L2CValue::as_integer(aLStack112);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar4 & 1) != 0) goto LAB_71000060f4;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,0);
  }
LAB_71000063c4:
