...
void __thiscall L2CFighterMariod::status::Final_end(L2CFighterMariod *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MARIOD_GENERATE_ARTICLE_HUGECAPSULE);
