...
void __thiscall L2CFighterMariod::status::SpecialS_exec(L2CAgent *this)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_MARIOD_STATUS_SPECIAL_S_FLAG_SPECIAL_FALL);
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack160,_FIGHTER_MARIOD_STATUS_SPECIAL_S_FLAG_HOP);
      iVar2 = lib::L2CValue::as_integer(aLStack160);
      bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar2);
      lib::L2CValue::L2CValue(aLStack144,(bool)(bVar1 & 1));
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      if ((uVar3 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MARIOD_STATUS_SPECIAL_S_FLAG_HOP);
        iVar2 = lib::L2CValue::as_integer(aLStack64);
        ...
        lib::L2CValue::_L2CValue(aLStack64);
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::L2CValue(aLStack160,_FIGHTER_MARIOD_INSTANCE_WORK_ID_FLAG_SPECIAL_S_HOP);
        iVar2 = lib::L2CValue::as_integer(aLStack160);
        bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar2);
        lib::L2CValue::L2CValue(aLStack144,(bool)(bVar1 & 1));
        lib::L2CValue::L2CValue(aLStack64,false);
        ...
        if ((uVar3 & 1) == 0) {
          ...
          lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MARIOD_INSTANCE_WORK_ID_FLAG_SPECIAL_S_HOP);
          iVar2 = lib::L2CValue::as_integer(aLStack64);
          app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar2);
          lib::L2CValue::_L2CValue(aLStack64);
