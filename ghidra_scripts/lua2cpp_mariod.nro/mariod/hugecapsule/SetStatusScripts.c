...
void __thiscall L2CWeaponMariodHugecapsule::SetStatusScripts(L2CWeaponMariodHugecapsule *this)

{
  ...
  iVar1 = _WEAPON_MARIOD_HUGECAPSULE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MARIOD_HUGECAPSULE_STATUS_KIND_REGULAR);
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Regular_init);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MARIOD_HUGECAPSULE_STATUS_KIND_REGULAR);
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Regular_exit);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MARIOD_HUGECAPSULE_STATUS_KIND_REGULAR);
