...
void __thiscall
L2CWeaponMariodDrcapsule::status::Haved_main(L2CWeaponMariodDrcapsule *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x5eed375b6);
  ...
  lib::L2CValue::L2CValue(aLStack80,Haved_main_loop);
