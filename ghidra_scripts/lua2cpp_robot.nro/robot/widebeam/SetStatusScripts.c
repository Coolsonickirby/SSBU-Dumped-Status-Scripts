...
void __thiscall L2CWeaponRobotWidebeam::SetStatusScripts(L2CWeaponRobotWidebeam *this)

{
  ...
  iVar1 = _WEAPON_ROBOT_WIDEBEAM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROBOT_WIDEBEAM_STATUS_KIND_BEAM);
