...
void __thiscall L2CWeaponRobotHugebeam::SetStatusScripts(L2CWeaponRobotHugebeam *this)

{
  ...
  iVar1 = _WEAPON_ROBOT_HUGEBEAM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROBOT_HUGEBEAM_STATUS_KIND_BEAM);
