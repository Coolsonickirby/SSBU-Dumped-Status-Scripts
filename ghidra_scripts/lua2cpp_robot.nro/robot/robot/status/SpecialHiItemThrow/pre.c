...
void __thiscall
L2CFighterRobot::status::SpecialHiItemThrow_pre(L2CFighterRobot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ITEM_THROW_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ITEM_THROW_INT)
  ;
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ITEM_THROW_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_THROW_ITEM |
