...
void __thiscall
L2CFighterRobot::status::SpecialHiItemShootAir_pre(L2CFighterRobot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ITEM_SHOOT_AIR_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ITEM_SHOOT_AIR_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ITEM_SHOOT_AIR_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_POWER_UP_ATTACK_BIT_ITEM_SHOOT);
  lib::L2CValue::L2CValue(aLStack248,0);
