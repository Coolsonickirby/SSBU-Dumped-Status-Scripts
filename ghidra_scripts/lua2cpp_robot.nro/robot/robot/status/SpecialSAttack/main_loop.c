...
void __thiscall
L2CFighterRobot::status::SpecialSAttack_main_loop(L2CFighterRobot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_ROBOT_STATUS_ARMSPIN_WORK_FLOAT_ANG_SPD_Y);
  ...
  if ((uVar5 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ROBOT_STATUS_KIND_SPECIAL_S_END);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_710001cad8;
    }
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack96);
...
LAB_710001cad8:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KINETIC_TYPE_ROBOT_SPECIAL_AIR_S_ATTACK);
      ...
      app::lua_bind::GroundModule__correct_impl(this->moduleAccessor,GVar4);
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KINETIC_TYPE_ROBOT_SPECIAL_S_ATTACK);
      iVar3 = lib::L2CValue::as_integer(aLStack96);
      app::lua_bind::KineticModule__change_kinetic_impl(this->moduleAccessor,iVar3);
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_ROBOT_STATUS_ARMSPIN_FLAG_CONTINUE_MOT);
