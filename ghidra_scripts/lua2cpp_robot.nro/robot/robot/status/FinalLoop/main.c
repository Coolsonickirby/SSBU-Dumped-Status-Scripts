...
void __thiscall
L2CFighterRobot::status::FinalLoop_main(L2CFighterRobot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ROBOT_STATUS_FINAL_WORK_FLAG_HOMINGLASER_LOOP);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    FUN_71000112e0(aLStack112,this,aLStack128);
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
  }
  pLVar3 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x15);
  lib::L2CValue::L2CValue(aLStack96,&DAT_7100011770);
  lib::L2CValue::operator_(pLVar3,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,FinalLoop_main_loop);
