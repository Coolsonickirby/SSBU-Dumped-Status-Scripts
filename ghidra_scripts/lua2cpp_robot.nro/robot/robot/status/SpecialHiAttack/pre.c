...
void __thiscall
L2CFighterRobot::status::SpecialHiAttack_pre(L2CFighterRobot *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ATTACK_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ATTACK_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_ROBOT_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_ATTACK_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack248,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_AIR);
