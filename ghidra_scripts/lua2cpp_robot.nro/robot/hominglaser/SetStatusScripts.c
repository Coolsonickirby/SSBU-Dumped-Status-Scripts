...
void __thiscall L2CWeaponRobotHominglaser::SetStatusScripts(L2CWeaponRobotHominglaser *this)

{
  ...
  iVar1 = _WEAPON_ROBOT_HOMINGLASER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROBOT_HOMINGLASER_STATUS_KIND_FLY);
