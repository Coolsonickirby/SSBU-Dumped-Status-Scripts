...
void __thiscall
L2CWeaponRobotGyroholder::status::Start_main(L2CWeaponRobotGyroholder *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0x9bdc1e36b);
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100021e90);
