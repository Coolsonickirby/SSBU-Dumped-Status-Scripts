...
void __thiscall
L2CWeaponRobotGyroholder::status::End_main(L2CWeaponRobotGyroholder *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0x300fc33b1);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0x770978045);
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100021d90);
