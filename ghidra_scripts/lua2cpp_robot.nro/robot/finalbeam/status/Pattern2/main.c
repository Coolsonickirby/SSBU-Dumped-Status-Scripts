...
void __thiscall
L2CWeaponRobotFinalbeam::status::Pattern2_main(L2CWeaponRobotFinalbeam *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x81076acd6);
  ...
  lib::L2CValue::L2CValue(aLStack80,Pattern2_main_loop);
