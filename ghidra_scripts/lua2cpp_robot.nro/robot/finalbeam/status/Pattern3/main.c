...
void __thiscall
L2CWeaponRobotFinalbeam::status::Pattern3_main(L2CWeaponRobotFinalbeam *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x867719c40);
  ...
  lib::L2CValue::L2CValue(aLStack80,Pattern3_main_loop);
