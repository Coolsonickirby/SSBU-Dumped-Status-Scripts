...
void __thiscall
L2CWeaponRobotFinalbeam::status::Pattern1_main(L2CWeaponRobotFinalbeam *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x8897ffd6c);
  ...
  lib::L2CValue::L2CValue(aLStack80,Pattern1_main_loop);
