...
void __thiscall
L2CFighterDemon::status::AttackSquat4_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0xe84eb2d30);
    ...
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LOG_ATTACK_KIND_ADDITIONS_ATTACK_09);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack96,AttackSquat4_main_loop);
