...
void __thiscall
L2CFighterDemon::status::AttackStand1_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xe7569ca68);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,AttackStand1_main_loop);
