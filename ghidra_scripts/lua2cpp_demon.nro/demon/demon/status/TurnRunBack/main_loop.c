...
void __thiscall
L2CFighterDemon::status::TurnRunBack_main_loop(L2CFighterDemon *this,L2CValue *return_value)
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack160);
        if ((uVar5 & 1) == 0) goto LAB_7100041938;
      }
...
LAB_7100041d14:
          ...
          if ((bVar1 & 1U) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack288);
            lib::L2CValue::_L2CValue(aLStack256);
            if ((uVar5 & 1) != 0) goto LAB_7100041f38;
          }
          else {
            lib::L2CValue::_L2CValue(aLStack256);
LAB_7100041f38:
