...
void __thiscall
L2CFighterDemon::status::AttackStand4_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0xe05033ee7);
    ...
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LOG_ATTACK_KIND_ADDITIONS_ATTACK_04);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack96,AttackStand4_main_loop);
