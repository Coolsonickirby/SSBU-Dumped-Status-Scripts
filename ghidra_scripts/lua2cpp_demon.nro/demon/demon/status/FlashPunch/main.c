...
void __thiscall
L2CFighterDemon::status::FlashPunch_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xbdeb83518);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,FlashPunch_main_loop);
