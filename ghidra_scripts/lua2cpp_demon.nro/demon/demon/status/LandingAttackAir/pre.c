...
void __thiscall
L2CFighterDemon::status::LandingAttackAir_pre(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP);
