...
void __thiscall
L2CFighterDemon::status::WalkBack_main_loop(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack176,&DAT_7100045350);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_7100045160;
