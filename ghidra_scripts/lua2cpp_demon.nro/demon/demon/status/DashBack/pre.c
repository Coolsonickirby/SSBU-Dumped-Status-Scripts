...
void __thiscall L2CFighterDemon::status::DashBack_pre(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::status_pre_DashCommon(this);
  lib::L2CValue::L2CValue(aLStack120,_SITUATION_KIND_GROUND);
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_DASH_BACK);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_ENABLE_ROCKETBELT_EJECT | _FIGHTER_STATUS_ATTR_INTO_DOOR);
