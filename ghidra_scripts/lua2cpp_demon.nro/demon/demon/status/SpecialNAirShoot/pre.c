...
void __thiscall
L2CFighterDemon::status::SpecialNAirShoot_pre(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,FIGHTER_KINETIC_TYPE_UNIQ);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_DEMON_STATUS_WORK_KEEP_FLAG_SPECIAL_N_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_DEMON_STATUS_WORK_KEEP_FLAG_SPECIAL_N_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_DEMON_STATUS_WORK_KEEP_FLAG_SPECIAL_N_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             ...
             FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_ATTACK | _FIGHTER_LOG_MASK_FLAG_SHOOT);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_SCALE_KINETIC_ENERGY);
