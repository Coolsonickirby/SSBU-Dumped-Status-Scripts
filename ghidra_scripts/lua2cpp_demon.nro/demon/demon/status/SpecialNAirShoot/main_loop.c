...
void __thiscall
L2CFighterDemon::status::SpecialNAirShoot_main_loop(L2CFighterDemon *this,L2CValue *return_value)
...
LAB_710002688c:
    ...
    if ((bVar4 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((bVar4 & 1U) == 0) goto LAB_7100026f98;
...
LAB_7100026f88:
    ...
    if ((uVar6 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar6 & 1) == 0) goto LAB_7100026f98;
      goto LAB_710002688c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    pLVar7 = aLStack112;
