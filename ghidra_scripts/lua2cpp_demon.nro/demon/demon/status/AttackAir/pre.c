...
void __thiscall L2CFighterDemon::status::AttackAir_pre(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_INT);
  lib::L2CValue::L2CValue(aLStack248,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_NONE);
