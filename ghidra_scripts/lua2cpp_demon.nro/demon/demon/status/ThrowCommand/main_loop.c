...
void __thiscall
L2CFighterDemon::status::ThrowCommand_main_loop(L2CFighterDemon *this,L2CValue *return_value)
...
LAB_7100027a5c:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      if ((bVar2 & 1U) == 0) goto LAB_7100027bb4;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100027bb4;
      goto LAB_7100027a5c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
