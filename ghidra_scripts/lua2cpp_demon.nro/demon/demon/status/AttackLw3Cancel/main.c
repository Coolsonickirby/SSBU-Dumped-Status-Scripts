...
void __thiscall
L2CFighterDemon::status::AttackLw3Cancel_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x11cca4f779);
  ...
  lib::L2CValue::L2CValue(aLStack80,AttackLw3Cancel_main_loop);
