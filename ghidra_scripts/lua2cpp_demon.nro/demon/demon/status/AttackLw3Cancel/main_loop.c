...
void __thiscall
L2CFighterDemon::status::AttackLw3Cancel_main_loop(L2CFighterDemon *this,L2CValue *return_value)
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar5 & 1) != 0) goto LAB_710002a948;
      }
...
LAB_710002a948:
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_DEMON_STATUS_ATTACK_LW_3_WORK_INT_CANCEL_STATUS);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
