...
void __thiscall
L2CFighterDemon::status::AttackHi4_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_TRANSFORM);
  ...
  if ((uVar3 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::L2CValue(aLStack64,0x14bf53a9f0);
