...
void __thiscall
L2CFighterDemon::status::SpecialNAirStart_main_loop(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar4 & 1) == 0) goto LAB_71000273e0;
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_DEMON_STATUS_KIND_SPECIAL_N_AIR_SHOOT);
    lib::L2CValue::L2CValue(aLStack80,false);
    lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xc0,(L2CValue)0xb0);
  }
  lib::L2CValue::_L2CValue(aLStack80);
