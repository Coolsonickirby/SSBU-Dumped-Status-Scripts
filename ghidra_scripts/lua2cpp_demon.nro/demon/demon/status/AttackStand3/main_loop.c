...
void __thiscall
L2CFighterDemon::status::AttackStand3_main_loop(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_DEMON_STATUS_ATTACK_STAND_3_WORK_INT_COMBO);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar4 & 1) == 0) goto LAB_710002e268;
...
LAB_710002e068:
  ...
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_DEMON_STATUS_ATTACK_STAND_3_FLAG_CHECK_STEP);
  iVar3 = lib::L2CValue::as_integer(aLStack144);
  bVar2 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::L2CValue(aLStack128,(bool)(bVar2 & 1));
  lib::L2CValue::L2CValue(aLStack80,true);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  if ((uVar4 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_DEMON_STATUS_ATTACK_STAND_3_FLAG_INC_STEP);
    iVar3 = lib::L2CValue::as_integer(aLStack144);
    bVar2 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
    lib::L2CValue::L2CValue(aLStack128,(bool)(bVar2 & 1));
    lib::L2CValue::L2CValue(aLStack80,true);
    ...
    if ((uVar4 & 1) != 0) {
      ...
      app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar3);
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEMON_STATUS_ATTACK_STAND_3_WORK_INT_COMBO);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
