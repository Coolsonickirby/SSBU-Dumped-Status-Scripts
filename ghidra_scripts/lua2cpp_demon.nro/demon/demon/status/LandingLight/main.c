...
void __thiscall
L2CFighterDemon::status::LandingLight_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,0x2bb2c89680);
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::L2CValue(aLStack64,0xdf05c072b);
    lib::L2CValue::L2CValue(aLStack112,0x2b8897f0a6);
    uVar4 = lib::L2CValue::as_integer(aLStack64);
