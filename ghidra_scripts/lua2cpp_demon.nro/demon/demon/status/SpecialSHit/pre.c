...
void __thiscall
L2CFighterDemon::status::SpecialSHit_pre(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,FIGHTER_KINETIC_TYPE_AIR_BRAKE);
  lib::L2CValue::L2CValue(aLStack168,GROUND_CORRECT_KIND_KEEP);
  lib::L2CValue::L2CValue(aLStack184,GROUND_CLIFF_CHECK_KIND_ALWAYS);
  lib::L2CValue::L2CValue(aLStack200,true);
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLAG);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_INT);
  lib::L2CValue::L2CValue(aLStack248,FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLOAT);
  ...
  lib::L2CValue::as_integer(aLStack120);
