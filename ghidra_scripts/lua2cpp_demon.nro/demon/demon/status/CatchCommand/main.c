...
void __thiscall
L2CFighterDemon::status::CatchCommand_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xd038ab90b);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,CatchCommand_main_loop);
