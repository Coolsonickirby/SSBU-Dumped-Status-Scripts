...
void __thiscall
L2CFighterDemon::status::SpecialNGroundStart_main(L2CFighterDemon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,SpecialNGroundStart_main_loop);
