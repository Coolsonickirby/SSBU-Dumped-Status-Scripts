...
void __thiscall L2CWeaponDemonDemonp::SetStatusScripts(L2CWeaponDemonDemonp *this)

{
  ...
  iVar1 = _WEAPON_DEMON_DEMONP_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DEMON_DEMONP_STATUS_KIND_FINAL);
