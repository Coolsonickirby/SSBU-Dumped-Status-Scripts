...
void __thiscall L2CWeaponDemonBlasterchest::SetStatusScripts(L2CWeaponDemonBlasterchest *this)

{
  ...
  iVar1 = _WEAPON_DEMON_BLASTERCHEST_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DEMON_BLASTERCHEST_STATUS_KIND_FINAL);
