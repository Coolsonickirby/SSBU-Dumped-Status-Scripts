...
void __thiscall L2CWeaponMarioHugeflame::SetStatusScripts(L2CWeaponMarioHugeflame *this)

{
  ...
  iVar1 = _WEAPON_MARIO_HUGE_FLAME_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MARIO_HUGE_FLAME_STATUS_KIND_REGULAR);
