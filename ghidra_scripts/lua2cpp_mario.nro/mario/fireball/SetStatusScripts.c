...
void __thiscall L2CWeaponMarioFireball::SetStatusScripts(L2CWeaponMarioFireball *this)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MARIO_FIREBALL_STATUS_KIND_REGULAR);
