...
void __thiscall
L2CFighterMario::status::SpecialS_main_loop(L2CFighterMario *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar5 & 1) != 0) goto LAB_71000086dc;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack112);
LAB_71000086dc:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MARIO_STATUS_SPECIAL_S_FLAG_CONTINUE);
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MARIO_STATUS_SPECIAL_S_FLAG_CONTINUE);
...
LAB_7100008ce0:
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        uVar5 = lib::L2CValue::operator__(pLVar6,aLStack96);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) == 0) goto LAB_7100008dec;
...
LAB_7100008c84:
      ...
      if ((uVar5 & 1) != 0) {
        ...
        bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack96);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((bVar2 & 1U) != 0) goto LAB_7100008dec;
      }
      goto LAB_7100008ce0;
    }
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((bVar2 & 1U) == 0) goto LAB_7100008c84;
  }
LAB_7100008dec:
  iVar3 = 0;
LAB_7100008df4:
