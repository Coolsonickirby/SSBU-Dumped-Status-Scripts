...
void __thiscall
L2CWeaponCaptainBluefalcon::status::Scene02_main
          (L2CWeaponCaptainBluefalcon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x71d2a7e89);
  ...
  app::lua_bind::MotionModule__set_frame_impl(this->moduleAccessor,fVar3,true);
  lib::L2CValue::_L2CValue(aLStack80);
