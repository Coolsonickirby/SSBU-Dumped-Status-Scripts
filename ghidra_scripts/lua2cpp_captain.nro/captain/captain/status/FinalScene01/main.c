...
void __thiscall
L2CFighterCaptain::status::FinalScene01_main(L2CFighterCaptain *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIND_CAPTAIN);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
  app::lua_bind::FighterManager__start_finalbg_impl(FIGHTER_STATUS_KIND_ATTACK_AIR,iVar2,1.0);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,false);
  bVar1 = lib::L2CValue::as_bool(aLStack64);
