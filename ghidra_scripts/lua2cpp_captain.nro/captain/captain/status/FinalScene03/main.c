...
void __thiscall
L2CFighterCaptain::status::FinalScene03_main(L2CFighterCaptain *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xe69e491c2);
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_CAPTAIN_BLUEFALCON_STATUS_KIND_SCENE03);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
