...
void __thiscall
L2CFighterCaptain::status::SpecialNTurn_main_loop(L2CFighterCaptain *this,L2CValue *return_value)
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar3 & 1) == 0) {
        ...
        if ((uVar3 & 1) != 0) {
          ...
          uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar3 & 1) != 0) goto LAB_7100014b40;
        }
        pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
        lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        ...
        if ((uVar3 & 1) == 0) {
          ...
          if ((uVar3 & 1) != 0) goto LAB_7100014b48;
        }
        else {
          lib::L2CValue::_L2CValue(aLStack112);
        }
...
LAB_7100014ba0:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100014a40;
  }
  iVar5 = 1;
LAB_7100014cb0:
