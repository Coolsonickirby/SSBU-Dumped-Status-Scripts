...
void __thiscall
L2CFighterCaptain::status::SpecialHiCling_main(L2CFighterCaptain *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x10062e309d);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialHiCling_main_loop);
