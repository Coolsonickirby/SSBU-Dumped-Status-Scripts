...
void __thiscall
L2CFighterCaptain::status::FinalScene02_main(L2CFighterCaptain *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xe1ee3a154);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_CAPTAIN_GENERATE_ARTICLE_BLUEFALCON);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_CAPTAIN_BLUEFALCON_STATUS_KIND_SCENE02);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
