...
void __thiscall L2CFighterMiigunner::SetStatusScripts(L2CFighterMiigunner *this)

{
  ...
  iVar1 = _FIGHTER_MIIGUNNER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100003540);
