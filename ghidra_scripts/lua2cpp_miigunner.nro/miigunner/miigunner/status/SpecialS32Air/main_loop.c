...
void __thiscall
L2CFighterMiigunner::status::SpecialS32Air_main_loop
...
LAB_710002d608:
      ...
      if ((uVar6 & 1) == 0) {
        ...
        uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar6 & 1) == 0) goto LAB_710002d8a0;
        lib::L2CValue::L2CValue(aLStack80,0xc09409a97);
...
LAB_710002d8a0:
        ...
        if ((uVar6 & 1) != 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar6 & 1) == 0) {
            lib::L2CValue::L2CValue(aLStack80,0x10b10aad9d);
            HVar8 = lib::L2CValue::as_hash(aLStack80);
            app::lua_bind::MotionModule__change_motion_inherit_frame_impl
                      (this->moduleAccessor,HVar8,-1.0,1.0,0.0,false,false);
            lib::L2CValue::_L2CValue(aLStack80);
    ...
    if ((uVar6 & 1) == 0) {
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar6 & 1) == 0) goto LAB_710002d608;
...
LAB_710002db2c:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar6 & 1) != 0) goto LAB_710002d5c0;
  }
  iVar5 = 1;
LAB_710002db38:
