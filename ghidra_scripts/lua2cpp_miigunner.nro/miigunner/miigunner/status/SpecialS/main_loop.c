...
void __thiscall
L2CFighterMiigunner::status::SpecialS_main_loop(L2CFighterMiigunner *this,L2CValue *return_value)
...
LAB_710001a0f0:
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) != 0) goto LAB_7100019f6c;
    }
    iVar5 = 1;
  }
