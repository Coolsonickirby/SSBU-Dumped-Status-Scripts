...
void __thiscall
L2CFighterMiigunner::status::SpecialLw1End_main_loop
...

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar4 & 1) != 0) goto LAB_710002aa58;
    }
  ...
  lib::L2CValue::_L2CValue(aLStack128);
LAB_710002aa58:
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MIIGUNNER_REFLECTOR_TRANSITION_TERM_ID_WAIT);
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MIIGUNNER_REFLECTOR_TRANSITION_TERM_ID_FALL);
  iVar3 = lib::L2CValue::as_integer(aLStack128);
  bVar1 = app::lua_bind::WorkModule__is_enable_transition_term_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::L2CValue(aLStack80,(bool)(bVar1 & 1));
  bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
