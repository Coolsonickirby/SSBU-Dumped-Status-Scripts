...
void __thiscall
L2CFighterMiigunner::status::SpecialS31Air_main(L2CFighterMiigunner *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack96,0x102803fc27);
  ...
  lib::L2CValue::_L2CValue(aLStack160);
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::L2CValue(aLStack144,SpecialS31Air_main_loop);
