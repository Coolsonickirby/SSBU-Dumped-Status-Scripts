...
void __thiscall
L2CFighterMiigunner::status::SpecialN1Cancel_main_loop
...

{
  ...
  if ((uVar8 & 1) != 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      if ((uVar8 & 1) == 0) goto LAB_7100032310;
      lib::L2CValue::L2CValue(aLStack80,true);
...
LAB_7100032310:
  ...
  if ((uVar8 & 1) == 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar8 & 1) == 0) goto LAB_7100032724;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack128);
    }
  ...
  if ((uVar8 & 1) != 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar8 & 1) != 0) goto LAB_7100032460;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,0);
    goto LAB_7100032bfc;
  }
...
LAB_7100032724:
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      uVar8 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar8 & 1) == 0) goto LAB_71000328e0;
