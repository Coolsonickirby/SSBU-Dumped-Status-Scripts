...
void __thiscall
L2CFighterMiigunner::status::FinalEnd_main_loop(L2CFighterMiigunner *this,L2CValue *return_value)
...
LAB_7100027510:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      if ((uVar3 & 1) != 0) {
        ...
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar3 & 1) != 0) goto LAB_710002754c;
      }
      pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
      lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      ...
      if ((uVar3 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar3 & 1) != 0) goto LAB_7100027554;
      }
      else {
        lib::L2CValue::_L2CValue(aLStack96);
      }
...
LAB_7100027750:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100027510;
  }
  iVar5 = 1;
LAB_710002775c:
