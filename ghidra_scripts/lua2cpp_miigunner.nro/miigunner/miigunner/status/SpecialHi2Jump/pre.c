...
void __thiscall
L2CFighterMiigunner::status::SpecialHi2Jump_pre(L2CFighterMiigunner *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_MIIGUNNER_SPECIAL_HI2_JUMP);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_CANNONJUMP_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_CANNONJUMP_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_CANNONJUMP_JUMP_FLOAT)
  ;
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_IGNORE_SPEED_LIMIT);
