...
void __thiscall
L2CFighterMiigunner::status::SpecialLw1Loop_pre(L2CFighterMiigunner *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_REFLECTOR_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_REFLECTOR_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_REFLECTOR_FLOAT);
