...
void __thiscall
L2CFighterMiigunner::status::SpecialHi3RushEnd_pre(L2CFighterMiigunner *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_ARM_ROCKET_RUSH_END_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_ARM_ROCKET_RUSH_END_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIGUNNER_ARM_ROCKET_RUSH_END_FLOAT);
