...
void __thiscall
L2CFighterMiigunner::status::SpecialHi3Rush_main_loop
...

{
  ...
  if (((bVar2 & 1U) != 0) ||
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar6 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MIIGUNNER_STATUS_ARM_ROCKET_RUSH_FLAG_AIR);
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::L2CValue(aLStack144,_FIGHTER_MIIGUNNER_STATUS_ARM_ROCKET_RUSH_FLAG_CONTINUE);
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack96);
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MIIGUNNER_STATUS_ARM_ROCKET_RUSH_FLAG_CONTINUE);
        iVar3 = lib::L2CValue::as_integer(aLStack96);
        app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar3);
      }
      else {
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MIIGUNNER_STATUS_KIND_SPECIAL_HI3_RUSH_END);
