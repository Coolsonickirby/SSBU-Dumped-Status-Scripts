...
void __thiscall
L2CFighterMiigunner::status::SpecialLw_main_loop(L2CFighterMiigunner *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MIIGUNNER_STATUS_KIND_SPECIAL_LW1_LOOP);
