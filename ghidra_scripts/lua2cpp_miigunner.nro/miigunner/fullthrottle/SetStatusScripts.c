...
void __thiscall
L2CWeaponMiigunnerFullthrottle::SetStatusScripts(L2CWeaponMiigunnerFullthrottle *this)

{
  ...
  iVar1 = _WEAPON_MIIGUNNER_FULLTHROTTLE_STATUS_KIND_NUM;
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::End_fix_cam);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIIGUNNER_FULLTHROTTLE_STATUS_KIND_CHARGE);
