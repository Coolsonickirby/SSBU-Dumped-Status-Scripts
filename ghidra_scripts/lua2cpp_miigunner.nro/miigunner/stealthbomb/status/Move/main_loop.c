...
void __thiscall
L2CWeaponMiigunnerStealthbomb::status::Move_main_loop
...

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_MIIGUNNER_STEALTHBOMB_STATUS_WORK_FLOAT_LIFE);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) goto LAB_7100045824;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  lib::L2CValue::L2CValue(aLStack64,_WEAPON_MIIGUNNER_STEALTHBOMB_STATUS_KIND_TAME);
