...
void __thiscall
L2CWeaponMiigunnerGunnercharge::status::Shoot_main_loop
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack80,_WEAPON_MIIGUNNER_GUNNERCHARGE_INSTANCE_WORK_ID_FLAG_GROUND_TOUCH);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar6 & 1) == 0) goto LAB_710003ebdc;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
