...
void __thiscall L2CWeaponMiigunnerBottomshoot::SetStatusScripts(L2CWeaponMiigunnerBottomshoot *this)

{
  ...
  iVar1 = _WEAPON_MIIGUNNER_BOTTOMSHOOT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIIGUNNER_BOTTOMSHOOT_STATUS_KIND_SHOOT);
