...
void __thiscall
L2CWeaponMiiswordsmanLightshuriken::SetStatusScripts(L2CWeaponMiiswordsmanLightshuriken *this)

{
  ...
  iVar1 = _WEAPON_MIISWORDSMAN_LIGHTSHURIKEN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIISWORDSMAN_LIGHTSHURIKEN_STATUS_KIND_START);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIISWORDSMAN_LIGHTSHURIKEN_STATUS_KIND_HAVED);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Haved_pre);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIISWORDSMAN_LIGHTSHURIKEN_STATUS_KIND_FLY);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
