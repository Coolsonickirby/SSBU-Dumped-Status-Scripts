...
void __thiscall
L2CWeaponMiiswordsmanTornadoshot::SetStatusScripts(L2CWeaponMiiswordsmanTornadoshot *this)

{
  ...
  iVar1 = _WEAPON_MIISWORDSMAN_TORNADOSHOT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIISWORDSMAN_TORNADOSHOT_STATUS_KIND_FLY);
