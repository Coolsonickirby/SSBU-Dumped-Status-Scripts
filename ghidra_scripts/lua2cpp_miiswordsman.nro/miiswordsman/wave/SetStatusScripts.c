...
void __thiscall L2CWeaponMiiswordsmanWave::SetStatusScripts(L2CWeaponMiiswordsmanWave *this)

{
  ...
  iVar1 = _WEAPON_MIISWORDSMAN_WAVE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MIISWORDSMAN_WAVE_STATUS_KIND_FLY);
