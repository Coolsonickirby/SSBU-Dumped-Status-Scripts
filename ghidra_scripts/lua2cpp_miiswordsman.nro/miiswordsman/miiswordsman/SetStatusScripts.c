...
void __thiscall L2CFighterMiiswordsman::SetStatusScripts(L2CFighterMiiswordsman *this)

{
  ...
  iVar1 = _FIGHTER_MIISWORDSMAN_STATUS_KIND_NUM;
  ...
  pLVar4 = (L2CValue *)lib::L2CValue::operator__(pLVar4,0x3d);
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100002360);
