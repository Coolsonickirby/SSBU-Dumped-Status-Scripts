...
void __thiscall
L2CFighterMiiswordsman::status::SpecialHi1Loop_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_ROKET_UNDER_THRUST_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_ROKET_UNDER_THRUST_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_ROKET_UNDER_THRUST_FLOAT);
