...
void __thiscall
L2CFighterMiiswordsman::status::SpecialS1Attack_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MIISWORDSMAN_STATUS_HENSOKU_SLASH_WORK_FLAG_HIT);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,SpecialS1Attack_main_loop);
