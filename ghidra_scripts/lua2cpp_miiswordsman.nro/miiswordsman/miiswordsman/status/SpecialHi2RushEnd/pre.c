...
void __thiscall
L2CFighterMiiswordsman::status::SpecialHi2RushEnd_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_SDUSH_RUSH_END_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_SDUSH_RUSH_END_INT)
  ;
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_SDUSH_RUSH_END_FLOAT);
