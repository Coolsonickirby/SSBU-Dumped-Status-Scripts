...
void __thiscall
L2CFighterMiiswordsman::status::SpecialHi3Hold_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_SPECIAL_HI3_HOLD_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_SPECIAL_HI3_HOLD_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIISWORDSMAN_SPECIAL_HI3_HOLD_FLOAT);
