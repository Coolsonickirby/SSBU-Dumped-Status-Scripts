...
void __thiscall
L2CFighterMiiswordsman::status::SpecialLw_main(L2CFighterMiiswordsman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MIISWORDSMAN_STATUS_COUNTER_FLAG_CONTINUE_MOT);
