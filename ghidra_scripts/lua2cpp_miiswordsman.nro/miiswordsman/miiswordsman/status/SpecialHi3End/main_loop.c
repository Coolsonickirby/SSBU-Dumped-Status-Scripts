...
void __thiscall
L2CFighterMiiswordsman::status::SpecialHi3End_main_loop
...
LAB_7100033034:
      FUN_710001f2f0(aLStack112,this);
      ...
      if ((bVar1 & 1U) == 0) {
        ...
        if ((uVar5 & 1) != 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack96);
          lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MIISWORDSMAN_STATUS_RSLASH_END_FLAG_FIRST);
          ...
          if ((uVar5 & 1) == 0) {
            lib::L2CValue::L2CValue(aLStack96,0xbed9f1824);
            ...
            lib::L2CValue::_L2CValue(aLStack112);
            lib::L2CValue::_L2CValue(aLStack96);
            lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MIISWORDSMAN_STATUS_RSLASH_END_FLAG_FIRST);
            iVar3 = lib::L2CValue::as_integer(aLStack96);
      ...
      if ((bVar1 & 1U) != 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          app::lua_bind::WorkModule__unable_transition_term_impl(*ppBVar8,iVar3);
          lib::L2CValue::_L2CValue(aLStack96);
          lib::L2CValue::L2CValue(aLStack96,&DAT_7100033920);
...
LAB_7100033668:
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar5 & 1) != 0) goto LAB_7100033034;
      }
    }
    iVar3 = 0;
  }
