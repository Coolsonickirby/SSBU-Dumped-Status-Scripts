...
void __thiscall
L2CWeaponPzenigameWater::status::Die_main(L2CWeaponPzenigameWater *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x33978ffd7);
  ...
  lib::L2CValue::L2CValue(aLStack80,Die_main_loop);
