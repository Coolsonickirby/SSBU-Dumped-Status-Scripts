...
void __thiscall
L2CFighterPzenigame::status::SpecialNCharge_main(L2CFighterPzenigame *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    FUN_710000a520(aLStack80,this,aLStack96);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack64,&DAT_710000a900);
  lib::L2CValue::operator_(this_00,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,true);
  lib::L2CValue::L2CValue(aLStack112,0xe06860a20);
  lib::L2CValue::L2CValue(aLStack128,0x1244d4ffef);
  FUN_7100009c60(this,aLStack64,aLStack112,aLStack128);
  ...
  app::lua_bind::WorkModule__enable_transition_term_group_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::L2CValue(aLStack144,SpecialNCharge_main_loop);
