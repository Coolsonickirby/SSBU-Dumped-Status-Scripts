...
void __thiscall
L2CFighterPzenigame::status::SpecialSOverTurn_main(L2CFighterPzenigame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSOverTurn_main_loop);
