...
void __thiscall
L2CFighterPzenigame::status::Final_main_loop(L2CFighterPzenigame *this,L2CValue *return_value)
...
LAB_7100006cbc:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar2 & 1U) == 0) goto LAB_7100006da4;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100006da4;
      goto LAB_7100006cbc;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
