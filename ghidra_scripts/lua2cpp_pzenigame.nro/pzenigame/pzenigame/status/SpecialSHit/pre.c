...
void __thiscall
L2CFighterPzenigame::status::SpecialSHit_pre(L2CFighterPzenigame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_PZENIGAME_SPECIAL_S_HIT);
