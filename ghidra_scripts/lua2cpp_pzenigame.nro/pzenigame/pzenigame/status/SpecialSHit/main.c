...
void __thiscall
L2CFighterPzenigame::status::SpecialSHit_main(L2CFighterPzenigame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1102fe80cd);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSHit_main_loop);
