...
void __thiscall
L2CFighterPzenigame::status::SpecialLwStandby_pre(L2CFighterPzenigame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT);
