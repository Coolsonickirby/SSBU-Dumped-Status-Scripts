...
void __thiscall
L2CFighterPzenigame::status::SpecialSLoop_pre(L2CFighterPzenigame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_PZENIGAME_STATUS_WORK_KEEP_FLAG_SPECIAL_S);
