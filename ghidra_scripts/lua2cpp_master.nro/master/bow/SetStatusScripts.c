...
void __thiscall L2CWeaponMasterBow::SetStatusScripts(L2CWeaponMasterBow *this)

{
  ...
  iVar1 = _WEAPON_MASTER_BOW_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MASTER_BOW_STATUS_KIND_HAVE);
