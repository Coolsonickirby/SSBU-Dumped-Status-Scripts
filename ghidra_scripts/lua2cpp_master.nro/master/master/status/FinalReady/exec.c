...
void __thiscall
L2CFighterMaster::status::FinalReady_exec(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_FINAL_MODULE_READY_EXIT_PRE);
    pFVar5 = (Fighter *)lib::L2CValue::as_pointer(pLVar4);
    iVar1 = lib::L2CValue::as_integer(aLStack80);
    app::FighterSpecializer_Master::call_final_module(pFVar5,iVar1);
    lib::L2CValue::_L2CValue(aLStack80);
  }
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,4);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_FINAL_MODULE_READY_EXEC);
  pFVar5 = (Fighter *)lib::L2CValue::as_pointer(pLVar4);
  iVar1 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Master::call_final_module(pFVar5,iVar1);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar2 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_STATUS_FINAL_FLAG_TO_SCENE01);
    iVar1 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar1);
    lib::L2CValue::_L2CValue(aLStack80);
  }
