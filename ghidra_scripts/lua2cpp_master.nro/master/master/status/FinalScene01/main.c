...
void __thiscall
L2CFighterMaster::status::FinalScene01_main(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIND_MASTER);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::FighterManager__start_finalbg_impl
            (FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP,iVar2,1.0);
  lib::L2CValue::_L2CValue(aLStack80);
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,4);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_FINAL_MODULE_SCENE_01_INIT);
  pFVar4 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Master::call_final_module(pFVar4,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
