...
void __thiscall
L2CFighterMaster::status::SpecialNJumpCancel_main_loop
          (L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_SPECIAL_N_CANCEL_TYPE_AIR_JUMP_AERIAL);
