...
void __thiscall
L2CFighterMaster::status::SpecialNTurn_main(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_STATUS_SPECIAL_N_FLAG_AFTER_TURN);
