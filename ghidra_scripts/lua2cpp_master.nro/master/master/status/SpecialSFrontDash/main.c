...
void __thiscall
L2CFighterMaster::status::SpecialSFrontDash_main(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack48,0x145bb51d9a);
  lib::L2CValue::L2CValue(aLStack64,0x1829c5f051);
  ...
  lib::L2CValue::L2CValue(aLStack208,SpecialSFrontDash_main_loop);
