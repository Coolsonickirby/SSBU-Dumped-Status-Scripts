...
void __thiscall
L2CFighterMaster::status::SpecialLwLanding1_pre(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_NO_REACTION | _FS_SUCCEEDS_KEEP_EFFECT);
