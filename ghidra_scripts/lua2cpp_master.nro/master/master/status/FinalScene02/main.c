...
void __thiscall
L2CFighterMaster::status::FinalScene02_main(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_FINAL_MODULE_SCENE_02_INIT);
