...
void __thiscall
L2CFighterMaster::status::FinalScene02_end(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_FINAL_MODULE_SCENE_02_EXIT);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MASTER_STATUS_KIND_FINAL_SCENE03);
