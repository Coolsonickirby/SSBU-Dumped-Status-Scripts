...
void __thiscall
L2CFighterMaster::status::SpecialHiWallJump_pre(L2CFighterMaster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_SCALE_KINETIC_ENERGY | FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE |
