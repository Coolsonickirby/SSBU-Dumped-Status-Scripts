...
void __thiscall
L2CWeaponMasterSword::status::Connect_main(L2CWeaponMasterSword *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x135770d03f);
  ...
  lib::L2CValue::L2CValue(aLStack64,Connect_main_loop);
