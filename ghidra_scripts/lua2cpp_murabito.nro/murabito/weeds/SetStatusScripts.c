...
void __thiscall L2CWeaponMurabitoWeeds::SetStatusScripts(L2CWeaponMurabitoWeeds *this)

{
  ...
  iVar1 = _WEAPON_MURABITO_WEEDS_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MURABITO_WEEDS_STATUS_KIND_READY);
