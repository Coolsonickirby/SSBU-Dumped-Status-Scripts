...
void __thiscall
L2CWeaponMurabitoTimmy::status::Appear_main_loop
          (L2CWeaponMurabitoTimmy *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar4 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack64,_WEAPON_MURABITO_TIMMY_STATUS_KIND_CONSTRUCT);
      lib::L2CValue::operator_(aLStack80,aLStack64);
    }
    else {
      lib::L2CValue::L2CValue(aLStack64,_WEAPON_MURABITO_TIMMY_STATUS_KIND_FAILURE);
      lib::L2CValue::operator_(aLStack80,aLStack64);
    }
    lib::L2CValue::_L2CValue(aLStack64);
