...
void __thiscall
L2CWeaponMurabitoBullet::status::Shoot_pre(L2CWeaponMurabitoBullet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_MURABITO_BULLET_SHOOT);
