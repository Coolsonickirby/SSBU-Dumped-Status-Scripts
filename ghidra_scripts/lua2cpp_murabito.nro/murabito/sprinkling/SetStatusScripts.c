...
void __thiscall L2CWeaponMurabitoSprinkling::SetStatusScripts(L2CWeaponMurabitoSprinkling *this)

{
  ...
  iVar1 = _WEAPON_MURABITO_SPRINKLING_WATER_STATUS_KIND_NUM;
