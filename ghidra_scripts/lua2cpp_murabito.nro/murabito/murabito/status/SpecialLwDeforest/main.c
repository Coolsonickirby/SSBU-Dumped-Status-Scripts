...
void __thiscall
L2CFighterMurabito::status::SpecialLwDeforest_main(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0x13d70249e9);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x17a088072f);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SpecialLwDeforest_main_loop);
