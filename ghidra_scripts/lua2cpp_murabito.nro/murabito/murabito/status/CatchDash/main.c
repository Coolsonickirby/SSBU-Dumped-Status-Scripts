...
void __thiscall
L2CFighterMurabito::status::CatchDash_main(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MURABITO_GENERATE_ARTICLE_BUTTERFLYNET);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lua2cpp::L2CFighterCommon::status_CatchDash(this);
  lib::L2CValue::_L2CValue(aLStack64);
