...
void __thiscall
L2CFighterMurabito::status::SpecialLwPlant_main(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x10dbedafe2);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwPlant_main_loop);
