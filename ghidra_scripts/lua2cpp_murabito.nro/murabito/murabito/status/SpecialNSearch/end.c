...
void __thiscall
L2CFighterMurabito::status::SpecialNSearch_end(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MURABITO_STATUS_KIND_SPECIAL_N_POCKET);
