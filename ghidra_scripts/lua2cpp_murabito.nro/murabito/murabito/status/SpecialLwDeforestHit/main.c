...
void __thiscall
L2CFighterMurabito::status::SpecialLwDeforestHit_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0x17e904a2b3);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x1bcf2b27fd);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SpecialLwDeforestHit_main_loop);
