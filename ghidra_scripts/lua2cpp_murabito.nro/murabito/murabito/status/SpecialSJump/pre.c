...
void __thiscall
L2CFighterMurabito::status::SpecialSJump_pre(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_MURABITO_SPECIAL_S_JUMP);
