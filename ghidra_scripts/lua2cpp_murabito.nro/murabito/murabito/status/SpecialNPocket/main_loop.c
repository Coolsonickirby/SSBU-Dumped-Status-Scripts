...
void __thiscall
L2CFighterMurabito::status::SpecialNPocket_main_loop
...

{
  ...
  if ((bVar3 & 1U) != 0) {
    ...
    if ((bVar3 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar3 & 1U) != 0) goto LAB_71000261fc;
...
LAB_7100026350:
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar2 & 1) != 0) goto LAB_7100026368;
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MURABITO_STATUS_SPECIAL_N_FLAG_TAKEOUT_INPUT);
      iVar4 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar4);
      pLVar7 = aLStack80;
    ...
    if ((uVar8 & 1) != 0) {
      ...
      if ((uVar8 & 1) != 0) {
        ...
        if ((uVar8 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack304);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar8 & 1) != 0) goto LAB_7100026bdc;
        }
        lib::L2CValue::L2CValue((L2CValue *)return_value,1);
        goto LAB_7100027010;
      }
...
LAB_7100026bdc:
    ...
    FUN_710001a2d0(aLStack352,this,aLStack368,aLStack384,aLStack400,aLStack416,aLStack432,aLStack448
                   ,aLStack464);
    ...
    if (((bVar3 & 1U) != 0) ||
      ...
      if ((uVar8 & 1) != 0) {
        ...
        pvVar9 = (void *)app::lua_bind::ItemManager__find_active_item_from_id_impl
                                   (FIGHTER_STATUS_AIR_LASSO_HANG_FLAG_NOT_ARM,uVar5);
        if (pvVar9 == (void *)0x0) {
          lib::L2CValue::L2CValue
                    (aLStack80,(L2CValue *)&FIGHTER_STATUS_AIR_LASSO_HANG_WORK_FLOAT_BODY_OFFSET);
        }
        else {
