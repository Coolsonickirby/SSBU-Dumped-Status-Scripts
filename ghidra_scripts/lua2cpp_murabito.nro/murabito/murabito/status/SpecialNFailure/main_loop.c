...
void __thiscall
L2CFighterMurabito::status::SpecialNFailure_main_loop
...
LAB_7100025d30:
    ...
    FUN_710001a2d0(aLStack64,this,aLStack96,aLStack112,aLStack144,aLStack160,aLStack176,aLStack192,
                   aLStack208);
    lib::L2CValue::_L2CValue(aLStack64);
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_7100025d30;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,1);
  }
LAB_7100025f68:
