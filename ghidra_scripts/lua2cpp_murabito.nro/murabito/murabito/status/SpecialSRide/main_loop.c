...
void __thiscall
L2CFighterMurabito::status::SpecialSRide_main_loop(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  if (bVar2) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::L2CValue(aLStack96,_WEAPON_MURABITO_CLAYROCKET_SHOOT_FLY);
