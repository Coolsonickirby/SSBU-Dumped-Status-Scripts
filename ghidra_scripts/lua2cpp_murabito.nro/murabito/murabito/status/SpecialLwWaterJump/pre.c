...
void __thiscall
L2CFighterMurabito::status::SpecialLwWaterJump_pre(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_JUMP);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MURABITO_SPECIAL_LW_WATER_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MURABITO_SPECIAL_LW_WATER_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MURABITO_SPECIAL_LW_WATER_FLOAT)
  ;
  lib::L2CValue::L2CValue(aLStack248,FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_EFFECT);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_LOG_MASK_FLAG_SHOOT | _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP);
