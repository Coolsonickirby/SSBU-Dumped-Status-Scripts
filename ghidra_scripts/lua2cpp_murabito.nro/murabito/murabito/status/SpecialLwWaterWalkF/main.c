...
void __thiscall
L2CFighterMurabito::status::SpecialLwWaterWalkF_main
...

{
  ...
  lua2cpp::L2CFighterCommon::sub_ItemShootWalkF_Common(this,(L2CValue)0xc0);
  ...
  app::lua_bind::WorkModule__unable_transition_term_impl(this->moduleAccessor,iVar1);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialLwWaterWalkF_main_loop);
