...
void __thiscall
L2CFighterMurabito::status::SpecialHiWait_pre(L2CFighterMurabito *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_MURABITO_SPECIAL_HI);
  lib::L2CValue::L2CValue(aLStack152,GROUND_CORRECT_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack168,_GROUND_CLIFF_CHECK_KIND_ALWAYS_BOTH_SIDES);
  lib::L2CValue::L2CValue(aLStack184,false);
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MURABITO_SPECIAL_HI_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MURABITO_SPECIAL_HI_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MURABITO_SPECIAL_HI_FLOAT);
