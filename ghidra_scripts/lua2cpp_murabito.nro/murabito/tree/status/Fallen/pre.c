...
void __thiscall
L2CWeaponMurabitoTree::status::Fallen_pre(L2CWeaponMurabitoTree *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_MURABITO_TREE_FALL);
