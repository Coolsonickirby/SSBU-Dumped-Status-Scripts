...
void __thiscall
L2CWeaponMurabitoSprout::status::Grow_pre(L2CWeaponMurabitoSprout *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_SEARCH | _FS_SUCCEEDS_KEEP_HIT);
