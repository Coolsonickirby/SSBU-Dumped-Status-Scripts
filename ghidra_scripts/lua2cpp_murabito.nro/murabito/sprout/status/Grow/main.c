...
void __thiscall
L2CWeaponMurabitoSprout::status::Grow_main(L2CWeaponMurabitoSprout *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_MURABITO_SPROUT_INSTANCE_WORK_ID_INT_GROW);
  iVar3 = lib::L2CValue::as_integer(aLStack96);
  iVar3 = app::lua_bind::WorkModule__get_int_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::L2CValue(aLStack80,iVar3);
  lib::L2CValue::L2CValue(aLStack112,_WEAPON_MURABITO_SPROUT_STATUS_GROW_WORK_INT_PREV_GROW);
