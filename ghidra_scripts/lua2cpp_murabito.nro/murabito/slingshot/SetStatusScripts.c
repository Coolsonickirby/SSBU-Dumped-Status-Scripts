...
void __thiscall L2CWeaponMurabitoSlingshot::SetStatusScripts(L2CWeaponMurabitoSlingshot *this)

{
  ...
  iVar1 = _WEAPON_MURABITO_SLINGSHOT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MURABITO_SLINGSHOT_STATUS_KIND_SHOOT);
