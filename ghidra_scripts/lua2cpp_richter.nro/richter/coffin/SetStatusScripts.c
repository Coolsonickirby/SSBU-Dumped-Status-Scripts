...
void __thiscall L2CWeaponRichterCoffin::SetStatusScripts(L2CWeaponRichterCoffin *this)

{
  ...
  iVar1 = _WEAPON_SIMON_COFFIN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SIMON_COFFIN_STATUS_KIND_NORMAL);
