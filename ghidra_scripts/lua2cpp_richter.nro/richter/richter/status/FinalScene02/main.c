...
void __thiscall
L2CFighterRichter::status::FinalScene02_main(L2CFighterRichter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0xf077026de);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SIMON_FINAL_MODULE_SCENE_02_INIT);
