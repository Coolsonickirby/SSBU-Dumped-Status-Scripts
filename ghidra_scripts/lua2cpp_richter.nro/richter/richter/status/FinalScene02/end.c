...
void __thiscall
L2CFighterRichter::status::FinalScene02_end(L2CFighterRichter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_SIMON_FINAL_MODULE_SCENE_02_EXIT);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_SIMON_STATUS_KIND_FINAL_SCENE03);
