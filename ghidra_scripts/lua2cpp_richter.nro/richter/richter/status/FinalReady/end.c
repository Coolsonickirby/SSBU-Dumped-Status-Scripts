...
void __thiscall
L2CFighterRichter::status::FinalReady_end(L2CFighterRichter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_SIMON_FINAL_MODULE_READY_EXIT);
