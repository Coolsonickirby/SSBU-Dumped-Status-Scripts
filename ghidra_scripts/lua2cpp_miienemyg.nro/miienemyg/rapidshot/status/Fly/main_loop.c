...
void __thiscall
L2CWeaponMiienemygRapidshot::status::Fly_main_loop
          (L2CWeaponMiienemygRapidshot *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) == 0) goto LAB_7100002be4;
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar6 & 1) == 0) goto LAB_7100002be4;
