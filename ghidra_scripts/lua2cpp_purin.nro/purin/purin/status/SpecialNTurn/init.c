...
void __thiscall
L2CFighterPurin::status::SpecialNTurn_init(L2CFighterPurin *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,5);
    pBVar11 = (BattleObjectModuleAccessor *)lib::L2CValue::as_pointer(pLVar7);
    app::FighterSpecializer_Purin::special_n_remove_effect_flushing(pBVar11);
  }
