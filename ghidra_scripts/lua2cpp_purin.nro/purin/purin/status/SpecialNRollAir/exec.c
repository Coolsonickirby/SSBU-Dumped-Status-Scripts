...
void __thiscall
L2CFighterPurin::status::SpecialNRollAir_exec(L2CFighterPurin *this,L2CValue *return_value)

{
  ...
  FUN_710000f330(aLStack96,auStack256 + 0x10);
  lib::L2CValue::operator_(aLStack224,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue((L2CValue *)(auStack256 + 0x10));
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) == 0) {
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PURIN_STATUS_KIND_SPECIAL_N_TURN);
