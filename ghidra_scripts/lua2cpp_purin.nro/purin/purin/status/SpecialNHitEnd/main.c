...
void __thiscall
L2CFighterPurin::status::SpecialNHitEnd_main(L2CFighterPurin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x15113b0f29);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialNHitEnd_main_loop);
