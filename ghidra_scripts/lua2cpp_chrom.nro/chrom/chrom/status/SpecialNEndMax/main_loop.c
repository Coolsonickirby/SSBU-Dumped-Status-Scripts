...
void __thiscall
L2CFighterChrom::status::SpecialNEndMax_main_loop(L2CFighterChrom *this,L2CValue *return_value)
...
LAB_7100022760:
          ...
          if ((uVar4 & 1) == 0) {
            ...
            uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
            lib::L2CValue::_L2CValue(aLStack80);
            if ((uVar4 & 1) != 0) goto LAB_71000227d0;
          }
        }
        else {
          pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
          ...
          uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar4 & 1) == 0) goto LAB_7100022760;
LAB_71000227d0:
          FUN_7100022010(this);
        }
      }
...
LAB_710002284c:
        ...
        if ((uVar4 & 1) == 0) goto LAB_7100022a58;
        iVar3 = 0;
      }
      else {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar4 & 1) != 0) goto LAB_710002284c;
LAB_7100022a58:
        iVar3 = 1;
      }
      ...
      if ((uVar4 & 1) == 0) {
        ...
        uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar4 & 1) == 0) goto LAB_71000226a0;
    ...
    if ((uVar4 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar4 & 1) == 0) goto LAB_7100022a6c;
      goto LAB_7100022580;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack144);
