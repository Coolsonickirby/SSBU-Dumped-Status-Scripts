...
void __thiscall
L2CFighterChrom::status::SpecialHi_on_change_lr(L2CFighterChrom *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_ROY_STATUS_SPECIAL_HI_WORK_FLOAT_STICK_CONTROL_ANGLE);
