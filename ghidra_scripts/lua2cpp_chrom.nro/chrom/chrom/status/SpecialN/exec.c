...
void __thiscall L2CFighterChrom::status::SpecialN_exec(L2CFighterChrom *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack160,_FIGHTER_ROY_STATUS_SPECIAL_N_WORK_INT_SITUATION_PREV);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack176,0x152d2f40c7);
