...
void __thiscall L2CFighterChrom::status::SpecialN_init(L2CFighterChrom *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack176,_FIGHTER_ROY_STATUS_SPECIAL_N_WORK_INT_SITUATION_PREV);
    iVar1 = lib::L2CValue::as_integer(aLStack80);
