...
void __thiscall
L2CFighterChrom::status::SpecialNEnd3_main_loop(L2CFighterChrom *this,L2CValue *return_value)
...
LAB_71000238b8:
          ...
          if ((uVar7 & 1) == 0) {
            ...
            uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
            lib::L2CValue::_L2CValue(aLStack112);
            if ((uVar7 & 1) != 0) goto LAB_7100023928;
          }
        }
        else {
          pLVar8 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
          ...
          uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar7 & 1) == 0) goto LAB_71000238b8;
LAB_7100023928:
          FUN_7100022c00(this);
        }
      }
...
LAB_71000239a4:
        ...
        if ((uVar7 & 1) == 0) goto LAB_7100023d68;
        iVar5 = 0;
      }
      else {
        lib::L2CValue::L2CValue(aLStack128,0);
        ...
        lib::L2CValue::_L2CValue(aLStack112);
        lib::L2CValue::_L2CValue(aLStack128);
        if ((uVar7 & 1) != 0) goto LAB_71000239a4;
LAB_7100023d68:
        iVar5 = 1;
      }
      lib::L2CValue::L2CValue(aLStack112,iVar5);
      ...
      if ((uVar7 & 1) == 0) {
        ...
        uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar7 & 1) == 0) goto LAB_71000237f8;
    ...
    if ((uVar7 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar7 & 1) == 0) goto LAB_7100023d7c;
      goto LAB_71000236d8;
    }
    lib::L2CValue::_L2CValue(aLStack144);
    lib::L2CValue::_L2CValue(aLStack320);
