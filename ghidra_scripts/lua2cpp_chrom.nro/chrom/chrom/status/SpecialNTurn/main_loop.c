...
void __thiscall
L2CFighterChrom::status::SpecialNTurn_main_loop(L2CFighterChrom *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) goto LAB_7100024a28;
...
LAB_71000249b0:
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_71000249b0;
  }
  FUN_7100023fd0(this);
LAB_7100024a28:
