...
void __thiscall
L2CWeaponTantanSpiral::status::DragonBeam_exec_stop
...

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    app::WeaponSpecializer_TantanSpiralleft::update_dragon_beam_nest_tip_pos(pBVar5);
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,5);
    pBVar5 = (BattleObjectModuleAccessor *)lib::L2CValue::as_pointer(pLVar4);
    app::WeaponSpecializer_TantanSpiralleft::update_dragon_beam_2nd_pos(pBVar5);
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,5);
    pBVar5 = (BattleObjectModuleAccessor *)lib::L2CValue::as_pointer(pLVar4);
    app::WeaponSpecializer_TantanSpiralleft::update_dragon_beam_2nd_end_pos(pBVar5);
    lib::L2CValue::L2CValue
              (aLStack80,
