...
void __thiscall
L2CWeaponTantanSpiral::status::Rewind_pre(L2CWeaponTantanSpiral *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_TANTAN_SPIRALLEFT_STATUS_WORK_KEEP_FLAG_REWIND_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_TANTAN_SPIRALLEFT_STATUS_WORK_KEEP_FLAG_REWIND_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_TANTAN_SPIRALLEFT_STATUS_WORK_KEEP_FLAG_REWIND_FLOAT);
