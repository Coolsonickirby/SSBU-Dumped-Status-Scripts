...
void __thiscall
L2CFighterTantan::status::AttackLandingLight_init(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,FIGHTER_INSTANCE_WORK_ID_FLAG_DISABLE_LANDING_TURN);
  ...
  lib::L2CValue::L2CValue(aLStack96,0x19db58a3e6);
