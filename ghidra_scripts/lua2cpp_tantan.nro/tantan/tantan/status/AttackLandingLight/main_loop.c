...
void __thiscall
L2CFighterTantan::status::AttackLandingLight_main_loop
...

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack160,FIGHTER_INSTANCE_WORK_ID_FLAG_GENESISSET);
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::L2CValue(aLStack80,ITEM_KIND_ASSIST);
...
LAB_710005c0e0:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar6 & 1) != 0) goto LAB_710005c24c;
...
LAB_710005c338:
    ...
    lib::L2CValue::L2CValue(aLStack208,0x19ca73854e);
    lib::L2CValue::L2CValue(aLStack224,0x1f28d9f0cc);
