...
void __thiscall
L2CFighterTantan::status::FallAerial_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack112,FIGHTER_STATUS_WORK_KEEP_FLAG_FALL_INT);
    ...
    lib::L2CValue::L2CValue(aLStack240,_FIGHTER_TANTAN_STATUS_KIND_ATTACK_FALL_AERIAL);
    ...
    lua2cpp::L2CFighterCommon::status_pre_FallAerial_main_param
