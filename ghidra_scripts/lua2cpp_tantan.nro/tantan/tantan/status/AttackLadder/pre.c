...
void __thiscall
L2CFighterTantan::status::AttackLadder_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_STATUS_WORK_ID_KEEP_FLAG_GIMMICK_LADDER_FLAG);
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_STATUS_WORK_ID_KEEP_FLAG_GIMMICK_LADDER_INT);
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_STATUS_WORK_ID_KEEP_FLAG_GIMMICK_LADDER_FLOAT);
  lib::L2CValue::L2CValue(aLStack168,0);
  lib::L2CValue::L2CValue(aLStack184,_FIGHTER_KINETIC_TYPE_LADDER_ATTACK);
  ...
  uVar13 = lib::L2CValue::operator__(aLStack200,aLStack296);
  ...
  if ((uVar13 & 1) != 0) {
    ...
    lib::L2CValue::operator_(aLStack168,aLStack296);
    lib::L2CValue::_L2CValue(aLStack296);
  }
  ...
  lib::L2CValue::L2CValue(aLStack296,_FIGHTER_STATUS_KIND_LADDER);
  uVar13 = lib::L2CValue::operator__(aLStack200,aLStack296);
  lib::L2CValue::_L2CValue(aLStack296);
  lib::L2CValue::_L2CValue(aLStack200);
  ...
  if ((uVar13 & 1) != 0) {
    ...
    FUN_7100070c20(aLStack296,aLStack200);
    lib::L2CValue::operator_(aLStack120,aLStack296);
    lib::L2CValue::operator_(aLStack136,aLStack280);
    lib::L2CValue::operator_(aLStack152,aLStack264);
    lib::L2CValue::operator_(aLStack184,aLStack248);
    lib::L2CValue::operator_(aLStack168,aLStack232);
  ...
  lib::L2CValue::L2CValue(aLStack296,SITUATION_KIND_LADDER);
  lib::L2CValue::L2CValue(aLStack216,GROUND_CORRECT_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack312,GROUND_CLIFF_CHECK_KIND_NONE);
  lib::L2CValue::L2CValue(aLStack328,false);
  SVar6 = lib::L2CValue::as_integer(aLStack296);
  iVar5 = lib::L2CValue::as_integer(aLStack184);
  uVar7 = lib::L2CValue::as_integer(aLStack216);
  GVar8 = lib::L2CValue::as_integer(aLStack312);
  ...
  lib::L2CValue::L2CValue
            (aLStack376,
             _FIGHTER_STATUS_ATTR_CLEAR_MOTION_ENERGY | FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE |
  ...
  uVar13 = lib::L2CValue::as_integer(aLStack360);
