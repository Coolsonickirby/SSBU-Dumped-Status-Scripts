...
void __thiscall
L2CFighterTantan::status::SpecialHiGroundEnd_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_AIR_STOP);
