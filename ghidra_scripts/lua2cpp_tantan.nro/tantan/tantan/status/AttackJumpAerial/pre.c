...
void __thiscall
L2CFighterTantan::status::AttackJumpAerial_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack296,FIGHTER_STATUS_KIND_JUMP_AERIAL);
  uVar13 = lib::L2CValue::operator__(aLStack200,aLStack296);
  lib::L2CValue::_L2CValue(aLStack296);
  lib::L2CValue::_L2CValue(aLStack200);
  ...
  lib::L2CValue::L2CValue(aLStack296,SITUATION_KIND_AIR);
  ...
  lib::L2CValue::L2CValue(aLStack376,FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE);
