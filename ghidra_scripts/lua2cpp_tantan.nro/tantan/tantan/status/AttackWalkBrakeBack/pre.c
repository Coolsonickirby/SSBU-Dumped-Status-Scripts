...
void __thiscall
L2CFighterTantan::status::AttackWalkBrakeBack_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack296,_FIGHTER_STATUS_KIND_WALK_BRAKE);
  uVar13 = lib::L2CValue::operator__(aLStack200,aLStack296);
  lib::L2CValue::_L2CValue(aLStack296);
  lib::L2CValue::_L2CValue(aLStack200);
  ...
  if ((uVar13 & 1) != 0) {
    ...
    FUN_7100070c20(aLStack296,aLStack312);
  ...
  lib::L2CValue::L2CValue(aLStack200,GROUND_CORRECT_KIND_GROUND);
