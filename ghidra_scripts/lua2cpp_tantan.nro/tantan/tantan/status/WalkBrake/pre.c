...
void __thiscall
L2CFighterTantan::status::WalkBrake_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack240,_FIGHTER_TANTAN_STATUS_KIND_ATTACK_WALK_BRAKE);
  ...
  lua2cpp::L2CFighterCommon::status_pre_WalkBrake_param
