...
void __thiscall L2CFighterTantan::status::Fall_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack240,_FIGHTER_TANTAN_STATUS_KIND_ATTACK_FALL);
