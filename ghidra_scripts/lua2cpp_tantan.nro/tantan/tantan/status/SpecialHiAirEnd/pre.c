...
void __thiscall
L2CFighterTantan::status::SpecialHiAirEnd_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_TANTAN_STATUS_WORK_KEEP_FLAG_SPECIAL_AIR_HI_FLAG);
