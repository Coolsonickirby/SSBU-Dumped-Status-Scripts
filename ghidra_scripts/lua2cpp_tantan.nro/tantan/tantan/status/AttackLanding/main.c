...
void __thiscall
L2CFighterTantan::status::AttackLanding_main(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,0x227270baef);
  ...
  lib::L2CValue::L2CValue(aLStack64,AttackLanding_main_loop);
