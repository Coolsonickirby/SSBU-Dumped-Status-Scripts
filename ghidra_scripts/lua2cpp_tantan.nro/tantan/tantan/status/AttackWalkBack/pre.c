...
void __thiscall
L2CFighterTantan::status::AttackWalkBack_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,FIGHTER_KINETIC_TYPE_MOTION_LOOP);
  ...
  lib::L2CValue::L2CValue
            (aLStack280,
             ...
             _FIGHTER_STATUS_ATTR_ENABLE_ROCKETBELT_EJECT | FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE
