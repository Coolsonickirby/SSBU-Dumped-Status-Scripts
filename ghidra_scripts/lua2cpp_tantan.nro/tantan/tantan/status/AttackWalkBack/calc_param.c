...
void __thiscall
L2CFighterTantan::status::AttackWalkBack_calc_param(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,0x17fd0178c0);
  lib::L2CValue::L2CValue(aLStack144,0x19bd05360b);
  lib::L2CValue::L2CValue(aLStack160,0x174e037927);
