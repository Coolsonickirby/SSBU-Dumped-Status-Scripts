...
void __thiscall
L2CFighterTantan::status::AttackFallAerial_main(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack96,0x177a069d96);
      lua2cpp::L2CFighterCommon::status_FallAerialSub_param(this,(L2CValue)0xa0);
    }
    else {
      lib::L2CValue::L2CValue(aLStack96,0x177a069d96);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack160,AttackFallAerial_main_loop);
