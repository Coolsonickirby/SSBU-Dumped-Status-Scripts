...
void __thiscall
L2CFighterTantan::status::AttackFallAerial_main_loop(L2CFighterTantan *this,L2CValue *return_value)
...
LAB_710005d9a0:
    ...
    if ((uVar4 & 1) != 0) goto LAB_710005dbd8;
    FUN_710004c020(this);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack192,0x177a069d96);
      lib::L2CValue::L2CValue(aLStack208,0x1dc27904cf);
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar1 & 1U) == 0) goto LAB_710005d9a0;
