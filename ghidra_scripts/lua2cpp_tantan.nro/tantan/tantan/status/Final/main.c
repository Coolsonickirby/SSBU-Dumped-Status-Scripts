...
void __thiscall L2CFighterTantan::status::Final_main(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_FINAL_MODULE_START_INIT);
  pFVar5 = (Fighter *)lib::L2CValue::as_pointer(pLVar4);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Tantan::call_final_module(pFVar5,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_INSTANCE_WORK_ID_INT_ATTACK_MOTION_KIND);
  lVar7 = lib::L2CValue::as_integer(aLStack224);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  ...
  app::lua_bind::ArticleModule__change_motion_impl(this->moduleAccessor,iVar2,HVar8,false,-1.0);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x71a99f496);
  lib::L2CValue::L2CValue(aLStack240,0xcec1191d4);
  lVar7 = lib::L2CValue::as_integer(aLStack80);
  lVar9 = lib::L2CValue::as_integer(aLStack240);
  app::lua_bind::VisibilityModule__set_status_default_int64_impl(this->moduleAccessor,lVar7,lVar9);
  lib::L2CValue::_L2CValue(aLStack240);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x59a6ef56c);
  lib::L2CValue::L2CValue(aLStack240,0xadd214353);
  lVar7 = lib::L2CValue::as_integer(aLStack80);
  lVar9 = lib::L2CValue::as_integer(aLStack240);
  app::lua_bind::VisibilityModule__set_status_default_int64_impl(this->moduleAccessor,lVar7,lVar9);
  lib::L2CValue::_L2CValue(aLStack240);
