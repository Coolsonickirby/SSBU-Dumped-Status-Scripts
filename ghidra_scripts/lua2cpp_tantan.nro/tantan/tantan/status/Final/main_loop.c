...
void __thiscall
L2CFighterTantan::status::Final_main_loop(L2CFighterTantan *this,L2CValue *return_value)
...
LAB_710003930c:
    bVar1 = app::FighterSpecializer_Tantan::final_module_hit_success();
    lib::L2CValue::L2CValue(aLStack80,(bool)(bVar1 & 1));
    lib::L2CValue::L2CValue(aLStack64,true);
    uVar3 = lib::L2CValue::operator__(aLStack80,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::operator__(pLVar4,aLStack64);
    }
    else {
      lib::L2CValue::L2CValue(aLStack64,_FIGHTER_TANTAN_STATUS_KIND_FINAL_READY);
      lib::L2CValue::L2CValue(aLStack80,false);
      lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xc0,(L2CValue)0xb0);
      lib::L2CValue::_L2CValue(aLStack80);
    }
...
LAB_71000394a8:
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) != 0) goto LAB_710003930c;
    }
    iVar5 = 1;
  }
