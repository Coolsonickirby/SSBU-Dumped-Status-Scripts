...
void __thiscall
L2CFighterTantan::status::CatchDash_main(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::sub_status_CatchDash(this);
  lib::L2CValue::L2CValue(aLStack64,0);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_STATUS_CATCH_DASH_INT_REACH_COUNT);
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_TANTAN_STATUS_CATCH_DASH_INT_REACH_STOP_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,CatchDash_main_loop);
