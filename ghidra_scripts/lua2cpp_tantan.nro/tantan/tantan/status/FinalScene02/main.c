...
void __thiscall
L2CFighterTantan::status::FinalScene02_main(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_FINAL_MODULE_SCENE_02_INIT);
  pFVar4 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Tantan::call_final_module(pFVar4,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_LINK_NO_ARTICLE);
  lib::L2CValue::L2CValue(aLStack96,0x1cb0100a6d);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
