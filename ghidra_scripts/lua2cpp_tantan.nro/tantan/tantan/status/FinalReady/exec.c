...
void __thiscall
L2CFighterTantan::status::FinalReady_exec(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_FINAL_MODULE_READY_EXIT_PRE);
  ...
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,4);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_FINAL_MODULE_READY_EXEC);
  pFVar5 = (Fighter *)lib::L2CValue::as_pointer(pLVar4);
  iVar1 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Tantan::call_final_module(pFVar5,iVar1);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar2 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_STATUS_FINAL_FLAG_TO_SCENE01);
    iVar1 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar1);
    lib::L2CValue::_L2CValue(aLStack80);
  }
