...
void __thiscall
L2CFighterTantan::status::FinalReady_main(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_TANTAN_FINAL_MODULE_READY_INIT);
  pFVar3 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
  app::FighterSpecializer_Tantan::call_final_module(pFVar3,iVar2);
  lib::L2CValue::_L2CValue(aLStack64);
