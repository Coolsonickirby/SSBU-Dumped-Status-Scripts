...
void __thiscall
L2CFighterTantan::status::AttackWalk_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack184,FIGHTER_KINETIC_TYPE_MOTION_LOOP);
  ...
  lib::L2CValue::L2CValue(aLStack296,FIGHTER_STATUS_KIND_WALK);
  uVar13 = lib::L2CValue::operator__(aLStack200,aLStack296);
  lib::L2CValue::_L2CValue(aLStack296);
  lib::L2CValue::_L2CValue(aLStack200);
  ...
  lib::L2CValue::L2CValue
            (aLStack376,
             FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_SCALE_KINETIC_ENERGY |
