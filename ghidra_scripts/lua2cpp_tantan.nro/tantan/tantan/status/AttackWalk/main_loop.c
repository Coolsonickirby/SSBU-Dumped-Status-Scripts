...
void __thiscall
L2CFighterTantan::status::AttackWalk_main_loop(L2CFighterTantan *this,L2CValue *return_value)
...
LAB_7100061f2c:
          ...
          if ((uVar5 & 1) == 0) {
            ...
            if ((uVar5 & 1) == 0) {
              ...
              if ((uVar5 & 1) == 0) {
                ...
                lib::L2CValue::L2CValue(aLStack272,0x15f254fb34);
                ...
                if ((uVar5 & 1) == 0) {
                  ...
                  lib::L2CValue::L2CValue(aLStack336,0x171c51ff07);
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TANTAN_STATUS_KIND_ATTACK_WALK_BRAKE);
          lib::L2CValue::L2CValue(aLStack192,false);
          lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xb0,(L2CValue)0x40);
        }
      }
