...
void __thiscall
L2CFighterTantan::status::FinalScene03_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             ...
             _FIGHTER_STATUS_ATTR_FINAL | _FIGHTER_STATUS_ATTR_HIDE_NAME_CURSOR |
             _FIGHTER_STATUS_ATTR_DISABLE_DISSOLVE_CURSOR);
