...
void __thiscall
L2CFighterTantan::status::SpecialHiGroundJump_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_MOTION_AIR_ANGLE);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_TANTAN_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_TANTAN_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_TANTAN_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_JUMP_FLOAT);
