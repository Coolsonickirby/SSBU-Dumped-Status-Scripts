...
void __thiscall
L2CFighterTantan::status::AttackJump_main_loop(L2CFighterTantan *this,L2CValue *return_value)
...
LAB_710005f254:
    ...
    if ((uVar3 & 1) != 0) goto LAB_710005f3b8;
    FUN_710004c020(this);
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack256,0x17f0bb63e4);
      lib::L2CValue::L2CValue(aLStack272,0x1d48c4fabd);
      ...
      if ((uVar3 & 1) == 0) {
        ...
        lib::L2CValue::L2CValue(aLStack320,0x12e6fa5ece);
        lib::L2CValue::L2CValue(aLStack336,0x18224311f0);
        FUN_710004ebd0(aLStack208,this,aLStack288,aLStack304,aLStack320,aLStack336);
        lib::L2CValue::L2CValue(aLStack80,true);
        uVar3 = lib::L2CValue::operator__(aLStack208,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack208);
        ...
        if ((uVar3 & 1) == 0) {
          ...
          lib::L2CValue::L2CValue(aLStack384,0x176b2a21f2);
          lib::L2CValue::L2CValue(aLStack400,0x1dd355b8ab);
          FUN_710004ebd0(aLStack208,this,aLStack352,aLStack368,aLStack384,aLStack400);
          lib::L2CValue::L2CValue(aLStack80,true);
          uVar3 = lib::L2CValue::operator__(aLStack208,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::_L2CValue(aLStack208);
          ...
          if ((uVar3 & 1) == 0) {
            ...
            lib::L2CValue::L2CValue(aLStack416,aLStack192);
            lib::L2CValue::L2CValue(aLStack432,0x12e1979ad7);
            lib::L2CValue::L2CValue(aLStack448,0x18252ed5e9);
            FUN_710004ebd0(aLStack80,this,aLStack208,aLStack416,aLStack432,aLStack448);
            lib::L2CValue::_L2CValue(aLStack80);
    ...
    bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar1 & 1U) == 0) goto LAB_710005f254;
