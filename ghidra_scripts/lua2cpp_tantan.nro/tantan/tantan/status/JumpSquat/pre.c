...
void __thiscall
L2CFighterTantan::status::JumpSquat_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack240,_FIGHTER_TANTAN_STATUS_KIND_ATTACK_JUMP_SQUAT);
