...
void __thiscall
L2CFighterTantan::status::AttackSquatRv_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack280,
             FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_ENABLE_ROCKETBELT_EJECT
