...
void __thiscall
L2CFighterTantan::status::Catch_main_loop(L2CFighterTantan *this,L2CValue *return_value)
...
LAB_71000422e0:
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack112,0x1bf1293c92);
...
LAB_71000421a4:
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_71000421a4;
      goto LAB_7100042424;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
