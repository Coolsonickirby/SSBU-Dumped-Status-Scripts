...
void __thiscall L2CFighterTantan::status::Catch_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_CATCH);
