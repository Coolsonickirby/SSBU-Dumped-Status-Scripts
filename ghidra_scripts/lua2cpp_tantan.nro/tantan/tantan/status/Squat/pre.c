...
void __thiscall L2CFighterTantan::status::Squat_pre(L2CFighterTantan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack240,_FIGHTER_TANTAN_STATUS_KIND_ATTACK_SQUAT);
  ...
  lua2cpp::L2CFighterCommon::status_pre_Squat_param
