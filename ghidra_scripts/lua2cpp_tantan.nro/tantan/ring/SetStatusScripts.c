...
void __thiscall L2CWeaponTantanRing::SetStatusScripts(L2CWeaponTantanRing *this)

{
  ...
  iVar1 = _WEAPON_TANTAN_RING_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_TANTAN_RING_STATUS_KIND_FLY);
