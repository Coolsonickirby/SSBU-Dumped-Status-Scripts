...
void __thiscall
L2CWeaponTantanPunch2::status::DragonBeamEnd_pre(L2CWeaponTantanPunch2 *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_TANTAN_PUNCH1_BEAM_STATUS_WORK_KEEP_FLAG_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_TANTAN_PUNCH1_BEAM_STATUS_WORK_KEEP_FLAG_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_TANTAN_PUNCH1_BEAM_STATUS_WORK_KEEP_FLAG_FLOAT);
