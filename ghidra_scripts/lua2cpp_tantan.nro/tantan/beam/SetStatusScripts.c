...
void __thiscall L2CWeaponTantanBeam::SetStatusScripts(L2CWeaponTantanBeam *this)

{
  ...
  iVar1 = _WEAPON_TANTAN_BEAM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_TANTAN_BEAM_STATUS_KIND_SHOOT);
