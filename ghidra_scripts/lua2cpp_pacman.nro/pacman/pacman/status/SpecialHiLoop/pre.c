...
void __thiscall
L2CFighterPacman::status::SpecialHiLoop_pre(L2CFighterPacman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_PACMAN_STATUS_WORK_KEEP_SPECIAL_HI_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_PACMAN_STATUS_WORK_KEEP_SPECIAL_HI_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_PACMAN_STATUS_WORK_KEEP_SPECIAL_HI_FLOAT);
