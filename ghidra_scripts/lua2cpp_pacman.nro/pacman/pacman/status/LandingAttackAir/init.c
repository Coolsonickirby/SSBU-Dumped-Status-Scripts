...
void __thiscall
L2CFighterPacman::status::LandingAttackAir_init(L2CFighterPacman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  if ((uVar4 & 1) == 0) goto LAB_710001a8f4;
...
LAB_710001a590:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
    if ((uVar4 & 1) == 0) goto LAB_710001a590;
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_INSTANCE_WORK_ID_FLAG_IGNORE_2ND_MOTION);
    iVar2 = lib::L2CValue::as_integer(aLStack64);
    app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar2);
    lib::L2CValue::_L2CValue(aLStack64);
