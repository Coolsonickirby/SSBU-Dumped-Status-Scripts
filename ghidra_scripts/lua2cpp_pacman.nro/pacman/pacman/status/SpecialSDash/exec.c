...
void __thiscall
L2CFighterPacman::status::SpecialSDash_exec(L2CFighterPacman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PACMAN_STATUS_SPECIAL_S_WORK_FLOAT_ROT);
