...
void __thiscall
L2CFighterPacman::status::SpecialSChange_main(L2CFighterPacman *this,L2CValue *return_value)

{
  ...
  app::lua_bind::KineticModule__unable_energy_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x10e348e450);
  lib::L2CValue::L2CValue(aLStack96,0.0);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialSChange_main_loop);
