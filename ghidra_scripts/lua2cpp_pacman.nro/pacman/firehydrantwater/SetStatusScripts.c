...
void __thiscall
L2CWeaponPacmanFirehydrantwater::SetStatusScripts(L2CWeaponPacmanFirehydrantwater *this)

{
  ...
  iVar1 = _WEAPON_PACMAN_FIREHYDRANT_WATER_STATUS_KIND_TERM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PACMAN_FIREHYDRANT_WATER_STATUS_KIND_SHOOT);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PACMAN_FIREHYDRANT_WATER_STATUS_KIND_HIT);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PACMAN_FIREHYDRANT_WATER_STATUS_KIND_REMOVE);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
