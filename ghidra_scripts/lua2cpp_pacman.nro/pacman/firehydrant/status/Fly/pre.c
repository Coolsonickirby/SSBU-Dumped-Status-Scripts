...
void __thiscall
L2CWeaponPacmanFirehydrant::status::Fly_pre(L2CWeaponPacmanFirehydrant *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_PACMAN_FIREHYDRANT_DAMAGE);
