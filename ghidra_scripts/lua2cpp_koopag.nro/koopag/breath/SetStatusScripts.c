...
void __thiscall L2CWeaponKoopagBreath::SetStatusScripts(L2CWeaponKoopagBreath *this)

{
  ...
  iVar1 = _WEAPON_KOOPA_BREATH_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KOOPA_BREATH_STATUS_KIND_MOVE);
