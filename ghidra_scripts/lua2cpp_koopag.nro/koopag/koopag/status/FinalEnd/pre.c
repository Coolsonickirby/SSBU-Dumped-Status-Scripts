...
void __thiscall
L2CFighterKoopag::status::FinalEnd_pre(L2CFighterKoopag *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_FINAL);
