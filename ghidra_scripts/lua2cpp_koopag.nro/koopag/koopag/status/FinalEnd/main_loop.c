...
void __thiscall
L2CFighterKoopag::status::FinalEnd_main_loop(L2CFighterKoopag *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71000128c0;
    }
    iVar5 = 1;
    goto LAB_7100012ac0;
  }
...
LAB_7100012ab0:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100012a78;
      lib::L2CValue::_L2CValue(aLStack96);
LAB_7100012b1c:
      lib::L2CValue::L2CValue(aLStack80,false);
      FUN_7100012320(this,aLStack80);
      goto LAB_7100012a70;
    }
LAB_7100012a78:
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_7100012ab0;
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100012b1c;
  }
  else {
