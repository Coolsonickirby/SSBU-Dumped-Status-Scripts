...
void __thiscall
L2CFighterKoopag::status::SpecialLwA_main(L2CFighterKoopag *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KOOPA_STATUS_SPECIAL_LW_FLAG_FROM_GR);
