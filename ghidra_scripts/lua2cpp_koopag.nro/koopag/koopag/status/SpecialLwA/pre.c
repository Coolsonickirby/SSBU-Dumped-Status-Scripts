...
void __thiscall
L2CFighterKoopag::status::SpecialLwA_pre(L2CFighterKoopag *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack120,
             ...
             FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_ATTACK | _FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON
            );
  lib::L2CValue::operator_(aLStack136,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KOOPA_STATUS_SPECIAL_LW_FLAG_FROM_GR);
  ...
  lib::L2CValue::L2CValue(aLStack120,_SITUATION_KIND_NONE);
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLOAT);
  lib::L2CValue::L2CValue(aLStack264,_FS_SUCCEEDS_KEEP_ATTACK);
