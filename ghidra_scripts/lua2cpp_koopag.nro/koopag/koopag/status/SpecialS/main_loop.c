...
void __thiscall
L2CFighterKoopag::status::SpecialS_main_loop(L2CFighterKoopag *this,L2CValue *return_value)
...
LAB_7100016330:
    ...
    uVar3 = lib::L2CValue::operator__(aLStack96,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_710001649c;
...
LAB_710001650c:
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_71000164a4;
    }
    else {
      pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710001650c;
      lib::L2CValue::_L2CValue(aLStack96);
    }
    lib::L2CValue::L2CValue(aLStack80,false);
    FUN_7100015ea0(this,aLStack80);
    pLVar4 = aLStack80;
LAB_71000164a0:
...
LAB_710001649c:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100016330;
  }
LAB_71000164a4:
  iVar5 = 0;
LAB_71000164f0:
