...
void __thiscall
L2CFighterKoopag::status::SpecialHiA_pre(L2CFighterKoopag *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_KOOPA_STATUS_KIND_SPECIAL_HI_G);
  ...
  lib::L2CValue::L2CValue(aLStack264,_FS_SUCCEEDS_KEEP_SOUND);
