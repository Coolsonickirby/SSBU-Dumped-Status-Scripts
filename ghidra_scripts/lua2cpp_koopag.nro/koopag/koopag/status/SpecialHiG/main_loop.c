...
void __thiscall
L2CFighterKoopag::status::SpecialHiG_main_loop(L2CFighterKoopag *this,L2CValue *return_value)
...
LAB_7100015cd8:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100015cd8;
...
LAB_7100015d88:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100015bc0;
  }
  iVar5 = 1;
LAB_7100015da0:
