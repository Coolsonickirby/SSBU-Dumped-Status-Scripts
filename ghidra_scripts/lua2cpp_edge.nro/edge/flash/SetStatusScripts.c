...
void __thiscall L2CWeaponEdgeFlash::SetStatusScripts(L2CWeaponEdgeFlash *this)

{
  ...
  iVar1 = _WEAPON_EDGE_FLASH_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_EDGE_FLASH_STATUS_KIND_ATTACK);
