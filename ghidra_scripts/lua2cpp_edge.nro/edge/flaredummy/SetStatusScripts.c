...
void __thiscall L2CWeaponEdgeFlaredummy::SetStatusScripts(L2CWeaponEdgeFlaredummy *this)

{
  ...
  iVar1 = _WEAPON_EDGE_FLAREDUMMY_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_EDGE_FLAREDUMMY_STATUS_KIND_FLY);
