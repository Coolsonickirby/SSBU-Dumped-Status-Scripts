...
void __thiscall
L2CFighterEdge::status::SpecialSShoot_pre(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_SPECIAL_S_FLAG);
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_SPECIAL_S_INT);
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_SPECIAL_S_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack280,_FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_S);
