...
void __thiscall
L2CFighterEdge::status::AttackAirFWallJump_pre(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_FLOAT);
  lib::L2CValue::L2CValue(aLStack264,FS_SUCCEEDS_KEEP_VISIBILITY);
  SVar5 = lib::L2CValue::as_integer(aLStack136);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_ATTACK_AIR_F);
