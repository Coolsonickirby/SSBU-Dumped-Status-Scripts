...
void __thiscall
L2CFighterEdge::status::AttackAirFWall_pre(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_ATTACK | FS_SUCCEEDS_KEEP_VISIBILITY);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_ATTACK_AIR_F |
