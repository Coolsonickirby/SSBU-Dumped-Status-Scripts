...
void __thiscall
L2CFighterEdge::status::SpecialLwHit_main(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack48,0xeb28cfd52);
  lib::L2CValue::L2CValue(aLStack64,0x12f0de089d);
  ...
  lib::L2CValue::L2CValue(aLStack160,SpecialLwHit_main_loop);
