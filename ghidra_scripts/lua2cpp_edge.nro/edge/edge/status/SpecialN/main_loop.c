...
void __thiscall
L2CFighterEdge::status::SpecialN_main_loop(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,CONTROL_PAD_BUTTON_GUARD._4_4_);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack144);
    if ((uVar5 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_EDGE_STATUS_KIND_SPECIAL_N_SHOOT);
...
LAB_710001d0e0:
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack96);
        lib::L2CValue::_L2CValue(aLStack144);
        if ((uVar5 & 1) == 0) goto LAB_710001d5d8;
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack96);
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_EDGE_STATUS_KIND_SPECIAL_N_JUMP_CANCEL);
        lib::L2CValue::L2CValue(aLStack144,true);
...
LAB_710001d544:
        ...
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_EDGE_STATUS_KIND_SPECIAL_N_CANCEL);
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack256);
        if ((uVar5 & 1) == 0) goto LAB_710001d0e0;
