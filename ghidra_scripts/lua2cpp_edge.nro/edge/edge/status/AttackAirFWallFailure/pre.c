...
void __thiscall
L2CFighterEdge::status::AttackAirFWallFailure_pre(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_FALL);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_EDGE_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_ATTACK_AIR_F);
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE);
