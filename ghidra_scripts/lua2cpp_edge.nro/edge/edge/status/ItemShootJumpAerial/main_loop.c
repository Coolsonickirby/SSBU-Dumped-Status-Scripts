...
void __thiscall
L2CFighterEdge::status::ItemShootJumpAerial_main_loop(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  FUN_7100002770(aLStack80,this);
  lib::L2CValue::_L2CValue(aLStack80);
  lua2cpp::L2CFighterCommon::status_ItemShootJumpAerial_Main_New(this);
  lib::L2CValue::_L2CValue(aLStack96);
