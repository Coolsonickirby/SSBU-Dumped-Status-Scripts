...
void __thiscall
L2CFighterEdge::status::SpecialHiChargedRush_pre(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_AIR_BRAKE);
