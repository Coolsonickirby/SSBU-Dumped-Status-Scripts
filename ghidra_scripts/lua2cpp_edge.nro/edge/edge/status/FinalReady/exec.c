...
void __thiscall L2CFighterEdge::status::FinalReady_exec(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_EDGE_FINAL_MODULE_READY_EXIT_PRE);
  ...
  pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,4);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_EDGE_FINAL_MODULE_READY_EXEC);
  pFVar6 = (Fighter *)lib::L2CValue::as_pointer(pLVar5);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Edge::call_final_module(pFVar6,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
