...
void __thiscall
L2CFighterEdge::status::LandingAttackAir_pre(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,lVar13);
  ...
  lib::L2CValue::L2CValue(aLStack168,FIGHTER_KINETIC_TYPE_MOTION);
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_LANDING_ATTACK_AIR_FLAG);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_LANDING_ATTACK_AIR_INT);
  lib::L2CValue::L2CValue(aLStack264,_FIGHTER_STATUS_WORK_KEEP_FLAG_LANDING_ATTACK_AIR_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_ATTR_INTO_DOOR);
  lib::L2CValue::L2CValue(aLStack264,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_AIR);
