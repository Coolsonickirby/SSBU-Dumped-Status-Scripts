...
void __thiscall
L2CFighterEdge::status::AttackAirFWallEnd_main(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1532f1cc35);
  ...
  lib::L2CValue::L2CValue(aLStack80,AttackAirFWallEnd_main_loop);
