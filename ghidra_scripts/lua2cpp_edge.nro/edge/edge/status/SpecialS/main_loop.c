...
void __thiscall
L2CFighterEdge::status::SpecialS_main_loop(L2CFighterEdge *this,L2CValue *return_value)
...
LAB_710001ad1c:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack64,_FIGHTER_EDGE_STATUS_KIND_SPECIAL_S_CHARGE);
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) != 0) goto LAB_710001ad1c;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,0);
  }
  return;
