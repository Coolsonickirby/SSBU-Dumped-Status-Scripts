...
void __thiscall L2CFighterEdge::status::SpecialHi_exec(L2CFighterEdge *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack96,CONTROL_PAD_BUTTON_GUARD._4_4_);
    ...
    if ((bVar2 & 1U) == 0) goto LAB_7100003800;
