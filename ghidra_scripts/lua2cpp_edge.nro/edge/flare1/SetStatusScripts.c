...
void __thiscall L2CWeaponEdgeFlare1::SetStatusScripts(L2CWeaponEdgeFlare1 *this)

{
  ...
  iVar1 = _WEAPON_EDGE_FLARE1_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_EDGE_FLARE1_STATUS_KIND_FLY);
