...
void __thiscall
L2CWeaponCloudWave::status::Hit_main_loop(L2CWeaponCloudWave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_INSTANCE_WORK_ID_INT_CUSTOMIZE_NO);
