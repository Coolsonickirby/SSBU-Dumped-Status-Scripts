...
void __thiscall L2CWeaponCloudWave::SetStatusScripts(L2CWeaponCloudWave *this)

{
  ...
  iVar1 = _WEAPON_CLOUD_WAVE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_CLOUD_WAVE_STATUS_KIND_REGULAR);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_CLOUD_WAVE_STATUS_KIND_HIT);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
