...
void __thiscall
L2CFighterCloud::status::Final2Dash_check_atk(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_CLOUD_STATUS_FINAL_FLAG_ATTACK_HIT);
