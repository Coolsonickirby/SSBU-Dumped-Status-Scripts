...
void __thiscall L2CFighterCloud::status::SpecialLw_pre(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_LIMIT_BREAK);
