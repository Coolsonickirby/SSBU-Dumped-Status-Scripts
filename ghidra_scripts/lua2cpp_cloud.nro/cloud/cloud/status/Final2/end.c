...
void __thiscall L2CFighterCloud::status::Final2_end(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_CLOUD_STATUS_KIND_FINAL2_DASH);
