...
void __thiscall
L2CFighterCloud::status::Final2Hit_main(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  FUN_7100014870(this,aLStack168);
  ...
  app::lua_bind::WorkModule__set_float_impl(this->moduleAccessor,fVar12,iVar2);
  lib::L2CValue::_L2CValue(aLStack440);
  lib::L2CValue::L2CValue(aLStack440,Final2Hit_main_loop);
