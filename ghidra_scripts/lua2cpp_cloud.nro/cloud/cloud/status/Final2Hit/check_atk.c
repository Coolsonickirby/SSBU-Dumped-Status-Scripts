...
void __thiscall
L2CFighterCloud::status::Final2Hit_check_atk(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) != 0) {
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_CLOUD_STATUS_FINAL_WORK_INT_ATTACK_HIT_NUM);
      iVar1 = lib::L2CValue::as_integer(aLStack80);
      iVar1 = app::lua_bind::WorkModule__get_int_impl(this->moduleAccessor,iVar1);
      lib::L2CValue::L2CValue(aLStack96,iVar1);
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_CLOUD_FINAL_TARGET_NUM);
      ...
      if ((uVar5 & 1) != 0) {
        ...
        if ((uVar5 & 1) != 0) {
          ...
          lib::L2CValue::L2CValue
                    (aLStack80,_FIGHTER_CLOUD_STATUS_FINAL_WORK_INT_ATTACK_HIT_OBJECT_ID);
