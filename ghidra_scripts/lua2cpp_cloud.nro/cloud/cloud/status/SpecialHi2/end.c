...
void __thiscall
L2CFighterCloud::status::SpecialHi2_end(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_CLOUD_STATUS_KIND_SPECIAL_HI2_FALL);
