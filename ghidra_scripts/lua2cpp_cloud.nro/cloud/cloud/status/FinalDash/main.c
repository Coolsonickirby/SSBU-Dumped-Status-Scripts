...
void __thiscall
L2CFighterCloud::status::FinalDash_main(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    FUN_7100017c70(aLStack144,this,aLStack160);
    lib::L2CValue::_L2CValue(aLStack144);
    lib::L2CValue::_L2CValue(aLStack160);
  }
  this_00 = &this->globalTable;
  pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x15);
  lib::L2CValue::L2CValue(aLStack96,&DAT_7100017eb0);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) == 0) goto LAB_710000fd48;
