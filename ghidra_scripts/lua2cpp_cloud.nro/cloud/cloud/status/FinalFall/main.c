...
void __thiscall
L2CFighterCloud::status::FinalFall_main(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa3872494d);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_7100005b10(this);
  lib::L2CValue::L2CValue(aLStack80,FinalFall_main_loop);
