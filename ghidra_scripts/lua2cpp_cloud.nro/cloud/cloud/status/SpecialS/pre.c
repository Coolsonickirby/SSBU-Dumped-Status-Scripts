...
void __thiscall L2CFighterCloud::status::SpecialS_pre(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_LIMIT_BREAK_SPECIAL);
  ...
  if ((uVar13 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_STATUS_ATTR_START_TURN);
    lib::L2CValue::operator_(aLStack136,aLStack120);
  }
  else {
    lib::L2CValue::L2CValue
              (aLStack120,FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_START_TURN)
    ;
    lib::L2CValue::operator_(aLStack136,aLStack120);
  }
  lib::L2CValue::_L2CValue(aLStack120);
