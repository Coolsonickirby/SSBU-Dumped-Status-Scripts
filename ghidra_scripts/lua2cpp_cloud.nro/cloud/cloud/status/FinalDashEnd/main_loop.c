...
void __thiscall
L2CFighterCloud::status::FinalDashEnd_main_loop(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) == 0) goto LAB_7100017b8c;
  }
...
LAB_7100017b80:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100017ae4;
      lib::L2CValue::_L2CValue(aLStack96);
LAB_7100017b64:
      lib::L2CValue::L2CValue(aLStack80,false);
      FUN_71000174f0(this,aLStack80);
      pLVar4 = aLStack80;
      goto LAB_7100017b80;
    }
LAB_7100017ae4:
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_7100017b1c;
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100017b64;
  }
  FUN_71000168c0(this);
LAB_7100017b8c:
