...
void __thiscall
L2CFighterCloud::status::SpecialLwEnd_pre(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_CLOUD_STATUS_SPECIAL_LW_END_WORK_KEEP_FLAG);
