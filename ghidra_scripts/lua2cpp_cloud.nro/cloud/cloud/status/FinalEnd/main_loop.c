...
void __thiscall
L2CFighterCloud::status::FinalEnd_main_loop(L2CFighterCloud *this,L2CValue *return_value)
...
LAB_7100016714:
        ...
        if ((uVar3 & 1) == 0) {
          ...
          uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar3 & 1) != 0) goto LAB_7100016784;
        }
      }
      else {
        pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
        ...
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar3 & 1) == 0) goto LAB_7100016714;
LAB_7100016784:
        FUN_7100013ba0(this);
      }
      FUN_71000168c0(this);
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_71000167e8;
      goto LAB_7100016600;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
