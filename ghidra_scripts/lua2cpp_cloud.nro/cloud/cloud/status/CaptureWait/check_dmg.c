...
void __thiscall
L2CFighterCloud::status::CaptureWait_check_dmg(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::FighterStatusUniqProcessCapture_check_damage(this,(L2CValue)0xc0);
  lib::L2CValue::_L2CValue(aLStack64);
