...
void __thiscall
L2CFighterCloud::status::Final2DashEnd_main(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,Final2DashEnd_main_loop);
