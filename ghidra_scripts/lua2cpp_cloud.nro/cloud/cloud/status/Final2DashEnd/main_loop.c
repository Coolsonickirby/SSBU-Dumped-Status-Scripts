...
void __thiscall
L2CFighterCloud::status::Final2DashEnd_main_loop(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) == 0) goto LAB_710001576c;
  }
...
LAB_7100015760:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71000156c4;
      lib::L2CValue::_L2CValue(aLStack96);
LAB_7100015744:
      lib::L2CValue::L2CValue(aLStack80,false);
      FUN_71000150d0(this,aLStack80);
      pLVar4 = aLStack80;
      goto LAB_7100015760;
    }
LAB_71000156c4:
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_71000156fc;
    pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100015744;
  }
  FUN_71000143e0(this);
LAB_710001576c:
