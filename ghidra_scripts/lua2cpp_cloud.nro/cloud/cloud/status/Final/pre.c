...
void __thiscall L2CFighterCloud::status::Final_pre(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_INSTANCE_WORK_ID_INT_COLOR);
  ...
  if ((uVar13 & 1) == 0) {
    lua2cpp::L2CFighterCommon::sub_status_pre_FinalCommon(this);
    lib::L2CValue::L2CValue(aLStack120,SITUATION_KIND_NONE);
    lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_RESET_NORMAL);
    ...
    lib::L2CValue::L2CValue
              (aLStack232,
               FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_INHERIT_CURSOR |
               _FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT | _FIGHTER_STATUS_ATTR_FINAL);
    lib::L2CValue::L2CValue(aLStack248,_FIGHTER_POWER_UP_ATTACK_BIT_FINAL);
    lib::L2CValue::L2CValue(aLStack264,0);
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_CLOUD_STATUS_KIND_FINAL2);
    iVar5 = lib::L2CValue::as_integer(aLStack120);
