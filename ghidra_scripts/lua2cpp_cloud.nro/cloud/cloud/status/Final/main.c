...
void __thiscall L2CFighterCloud::status::Final_main(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack112,0x2192feda50);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack112,0x16ca1c5441);
  HVar4 = lib::L2CValue::as_hash(aLStack112);
  app::lua_bind::EffectModule__req_common_impl(this->moduleAccessor,HVar4,0.0);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack112,0x10b18945b6);
  lib::L2CValue::L2CValue(aLStack128,_EFFECT_SUB_ATTRIBUTE_STATIONAL);
  HVar4 = lib::L2CValue::as_hash(aLStack112);
  ...
  FUN_7100018360(this,aLStack112);
  lib::L2CValue::_L2CValue(aLStack112);
