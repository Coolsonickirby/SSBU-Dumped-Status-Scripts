...
void __thiscall
L2CFighterCloud::status::Final2Move_init(L2CFighterCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack240,0xeb6991b4a);
  ...
  iVar1 = app::lua_bind::WorkModule__get_param_int_impl(this->moduleAccessor,uVar2,(ulong)pLVar4);
  ...
  if ((uVar2 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue((L2CValue *)&local_50);
    if ((uVar2 & 1) == 0) goto LAB_7100007f24;
    lib::L2CValue::L2CValue((L2CValue *)&local_50,360.0);
