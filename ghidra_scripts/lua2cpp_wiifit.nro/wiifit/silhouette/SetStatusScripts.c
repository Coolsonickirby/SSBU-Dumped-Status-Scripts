...
void __thiscall L2CWeaponWiifitSilhouette::SetStatusScripts(L2CWeaponWiifitSilhouette *this)

{
  ...
  iVar1 = _WEAPON_WIIFIT_SILHOUETTE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_WIIFIT_SILHOUETTE_STATUS_KIND_REGULAR);
