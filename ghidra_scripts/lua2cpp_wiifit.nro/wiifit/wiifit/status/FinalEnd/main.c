...
void __thiscall
L2CFighterWiifit::status::FinalEnd_main(L2CFighterWiifit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  if ((uVar4 & 1) != 0) {
    FUN_710000bb30(aLStack112,this);
    lib::L2CValue::_L2CValue(aLStack112);
  }
  pLVar3 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x14);
  lib::L2CValue::L2CValue(aLStack96,&LAB_710000bdc0);
