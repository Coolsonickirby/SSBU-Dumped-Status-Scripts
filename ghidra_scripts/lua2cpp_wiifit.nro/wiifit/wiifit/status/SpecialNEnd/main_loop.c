...
void __thiscall
L2CFighterWiifit::status::SpecialNEnd_main_loop(L2CFighterWiifit *this,L2CValue *return_value)
...
LAB_71000174f0:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) != 0) goto LAB_7100017538;
        goto LAB_71000177e0;
      }
      pLVar6 = aLStack96;
LAB_71000177dc:
...
LAB_71000177e0:
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar5 & 1) == 0) goto LAB_71000178f8;
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_71000174f0;
    }
  }
LAB_71000178f8:
  iVar4 = 0;
