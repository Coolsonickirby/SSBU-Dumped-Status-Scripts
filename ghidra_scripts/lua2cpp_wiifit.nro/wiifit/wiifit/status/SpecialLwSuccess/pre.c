...
void __thiscall
L2CFighterWiifit::status::SpecialLwSuccess_pre(L2CFighterWiifit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_LW);
