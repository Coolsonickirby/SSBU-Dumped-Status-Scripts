...
void __thiscall
L2CFighterWiifit::status::SpecialHiEnd_end(L2CFighterWiifit *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    uVar3 = lib::L2CValue::operator__(pLVar2,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_7100006288;
    ...
    lib::L2CValue::L2CValue(aLStack144,0x1af1e8afb5);
...
LAB_7100006288:
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack96,0x25d84df015);
