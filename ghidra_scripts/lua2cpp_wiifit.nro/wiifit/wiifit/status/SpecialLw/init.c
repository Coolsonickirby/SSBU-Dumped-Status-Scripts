...
void __thiscall
L2CFighterWiifit::status::SpecialLw_init(L2CFighterWiifit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_WIIFIT_INSTANCE_WORK_ID_FLAG_FUKUSHIKI_LANDING);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,0x1b3c277b51);
