...
void __thiscall L2CWeaponWiifitSilhouettel::SetStatusScripts(L2CWeaponWiifitSilhouettel *this)

{
  ...
  iVar1 = _WEAPON_WIIFIT_SILHOUETTEL_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_WIIFIT_SILHOUETTEL_STATUS_KIND_REGULAR);
