...
void __thiscall
L2CWeaponPalutenaExplosiveflame::status::Miss_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x462100ade);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  if ((uVar3 & 1) != 0) {
    FUN_710001a0b0(aLStack96,this);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x14);
  lib::L2CValue::L2CValue(aLStack80,&LAB_710001a220);
  lib::L2CValue::operator_(this_00,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Miss_main_loop);
