...
void __thiscall
L2CWeaponPalutenaReflectionboard::status::Break_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0xf26d015b4);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  if ((uVar3 & 1) != 0) {
    FUN_710001b5d0(aLStack112,this);
    lib::L2CValue::_L2CValue(aLStack112);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x14);
  lib::L2CValue::L2CValue(aLStack80,&LAB_710001b740);
