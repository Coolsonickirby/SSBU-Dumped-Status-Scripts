...
void __thiscall
L2CWeaponPalutenaReflectionboard::SetStatusScripts(L2CWeaponPalutenaReflectionboard *this)

{
  ...
  iVar1 = _WEAPON_PALUTENA_REFLECTIONBOARD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PALUTENA_REFLECTIONBOARD_STATUS_KIND_SHOOT);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PALUTENA_REFLECTIONBOARD_STATUS_KIND_BREAK);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Shoot_fix_cam);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PALUTENA_REFLECTIONBOARD_STATUS_KIND_SHOOT);
