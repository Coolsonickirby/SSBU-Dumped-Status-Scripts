...
void __thiscall L2CWeaponPalutenaBeam::SetStatusScripts(L2CWeaponPalutenaBeam *this)

{
  ...
  iVar1 = _WEAPON_PALUTENA_BEAM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PALUTENA_BEAM_STATUS_KIND_BEAM);
