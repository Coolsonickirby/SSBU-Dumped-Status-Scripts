...
void __thiscall
L2CFighterPalutena::status::SpecialHi_pre(L2CFighterPalutena *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             ...
             _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP | FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON);
