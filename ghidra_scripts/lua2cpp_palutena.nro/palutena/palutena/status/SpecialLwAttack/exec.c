...
void __thiscall
L2CFighterPalutena::status::SpecialLwAttack_exec(L2CFighterPalutena *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack224,_FIGHTER_PALUTENA_STATUS_SPECIAL_LW_WORK_INT_SITUATION_PREV);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        lib::L2CValue::L2CValue
                  (aLStack224,_FIGHTER_PALUTENA_STATUS_SPECIAL_LW_WORK_INT_SITUATION_PREV);
        iVar1 = lib::L2CValue::as_integer(aLStack96);
