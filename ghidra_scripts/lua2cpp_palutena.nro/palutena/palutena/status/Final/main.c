...
void __thiscall
L2CFighterPalutena::status::Final_main(L2CFighterPalutena *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PALUTENA_STATUS_FINAL_FLAG_IS_AIR_SITUATION);
