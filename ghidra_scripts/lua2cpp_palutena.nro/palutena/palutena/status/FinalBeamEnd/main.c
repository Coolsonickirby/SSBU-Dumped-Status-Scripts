...
void __thiscall
L2CFighterPalutena::status::FinalBeamEnd_main(L2CFighterPalutena *this,L2CValue *return_value)

{
  ...
  app::lua_bind::WorkModule__set_flag_impl(this->moduleAccessor,(bool)(bVar1 & 1),iVar5);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  ...
  app::lua_bind::KineticModule__unable_energy_impl(this->moduleAccessor,iVar5);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,FinalBeamEnd_main_loop);
