...
void __thiscall
L2CWeaponPalutenaAutoaimbullet::SetStatusScripts(L2CWeaponPalutenaAutoaimbullet *this)

{
  ...
  iVar1 = _WEAPON_PALUTENA_AUTOAIMBULLET_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PALUTENA_AUTOAIMBULLET_STATUS_KIND_SHOT);
