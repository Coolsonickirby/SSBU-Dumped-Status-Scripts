...
void __thiscall L2CFighterIke::status::FinalAttack_exec(L2CFighterIke *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_IKE_STATUS_FINAL_FLAG_FALL_START);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,0x172b35e107);
