...
void __thiscall L2CFighterIke::status::SpecialN_exec(L2CFighterIke *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack160,_FIGHTER_IKE_STATUS_SPECIAL_N_WORK_INT_SITUATION_PREV);
