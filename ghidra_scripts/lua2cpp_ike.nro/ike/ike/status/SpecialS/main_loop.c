...
void __thiscall
L2CFighterIke::status::SpecialS_main_loop(L2CFighterIke *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_IKE_STATUS_SPECIAL_S_FLAG_CHARGE);
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        if ((uVar4 & 1) != 0) {
          ...
          uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar4 & 1) != 0) goto LAB_710001d19c;
        }
        pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
        lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
        uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
        ...
        if ((uVar4 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::_L2CValue(aLStack96);
          if ((uVar4 & 1) != 0) goto LAB_710001d1a4;
        }
        else {
          lib::L2CValue::_L2CValue(aLStack96);
        }
...
LAB_710001d1a4:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((bVar2 & 1U) == 0) goto LAB_710001d0fc;
