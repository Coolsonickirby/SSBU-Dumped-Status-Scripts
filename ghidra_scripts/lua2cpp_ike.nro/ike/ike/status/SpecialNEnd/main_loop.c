...
void __thiscall
L2CFighterIke::status::SpecialNEnd_main_loop(L2CFighterIke *this,L2CValue *return_value)
...
LAB_710001f278:
          ...
          if ((uVar7 & 1) == 0) {
            ...
            uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
            lib::L2CValue::_L2CValue(aLStack112);
            if ((uVar7 & 1) != 0) goto LAB_710001f2e8;
          }
        }
        else {
          pLVar8 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
          ...
          uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar7 & 1) == 0) goto LAB_710001f278;
LAB_710001f2e8:
          FUN_710001eb20(this);
        }
      }
...
LAB_710001f364:
        ...
        if ((uVar7 & 1) == 0) goto LAB_710001f750;
        iVar5 = 0;
      }
      else {
        lib::L2CValue::L2CValue(aLStack128,0);
        ...
        lib::L2CValue::_L2CValue(aLStack112);
        lib::L2CValue::_L2CValue(aLStack128);
        if ((uVar7 & 1) != 0) goto LAB_710001f364;
LAB_710001f750:
        iVar5 = 1;
      }
      lib::L2CValue::L2CValue(aLStack112,iVar5);
      ...
      if ((uVar7 & 1) == 0) {
        ...
        uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar7 & 1) == 0) goto LAB_710001f1b8;
    ...
    if ((uVar7 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar7 & 1) == 0) goto LAB_710001f764;
      goto LAB_710001f098;
    }
    lib::L2CValue::_L2CValue(aLStack144);
    lib::L2CValue::_L2CValue(aLStack336);
