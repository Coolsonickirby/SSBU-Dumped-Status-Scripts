...
void __thiscall L2CWeaponIkeSword::status::Had_main(L2CWeaponIkeSword *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x38fbcbc2d);
  ...
  lib::L2CValue::L2CValue(aLStack80,Had_main_loop);
