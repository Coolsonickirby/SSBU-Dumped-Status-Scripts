...
void __thiscall
L2CWeaponToonlinkBowarrow::status::Stick_pre(L2CWeaponToonlinkBowarrow *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE | _FS_SUCCEEDS_KEEP_ATTACK);
