...
void __thiscall
L2CFighterPikachu::status::FinalAttack2_main(L2CFighterPikachu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xeb2a9d859);
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_710001c160);
  ...
  app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,FinalAttack2_main_loop);
