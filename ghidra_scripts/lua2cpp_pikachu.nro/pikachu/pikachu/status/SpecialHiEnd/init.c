...
void __thiscall
L2CFighterPikachu::status::SpecialHiEnd_init(L2CFighterPikachu *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,_ENERGY_STOP_RESET_TYPE_AIR_X_NORMAL_MAX);
  ...
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_PIKACHU_STATUS_WORK_ID_INT_QUICK_ATTACK_COUNT);
  iVar1 = lib::L2CValue::as_integer(aLStack96);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar1,iVar2);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0);
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_PIKACHU_STATUS_WORK_ID_INT_QUICK_ATTACK_PHASE);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
