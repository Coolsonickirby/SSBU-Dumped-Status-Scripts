...
void __thiscall
L2CFighterPikachu::status::SpecialSHold_main(L2CFighterPikachu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0xeb9ce1b65);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0x12fb9ceeaa);
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack64,_FIGHTER_PIKACHU_STATUS_WORK_ID_INT_SKULL_BASH_HOLD_COUNT);
      iVar3 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_71000238e0);
