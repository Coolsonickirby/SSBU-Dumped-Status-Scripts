...
void __thiscall
L2CFighterPikachu::status::FinalAttackFinish_end(L2CFighterPikachu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_50,_FIGHTER_PIKACHU_STATUS_KIND_FINAL_RETURN);
