...
void __thiscall
L2CFighterPikachu::status::FinalAttackFinish_main(L2CFighterPikachu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x13c8228d19);
  ...
  app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,FinalAttackFinish_main_loop);
