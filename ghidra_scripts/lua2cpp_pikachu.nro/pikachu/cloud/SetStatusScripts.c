...
void __thiscall L2CWeaponPikachuCloud::SetStatusScripts(L2CWeaponPikachuCloud *this)

{
  ...
  iVar1 = _WEAPON_PIKACHU_CLOUD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIKACHU_CLOUD_STATUS_KIND_REGULAR);
