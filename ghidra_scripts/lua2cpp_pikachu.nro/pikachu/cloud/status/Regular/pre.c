...
void __thiscall
L2CWeaponPikachuCloud::status::Regular_pre(L2CWeaponPikachuCloud *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_WEAPON_PIKACHU_CLOUD_INSTANCE_WORK_ID_FLAG_SELF_REMOVE);
