...
void __thiscall
L2CWeaponPikachuSpecialupdummy::status::Fly_main_loop
          (L2CWeaponPikachuSpecialupdummy *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    local_50._0_4_ = (float)lib::L2CValue::as_number(aLStack208);
    local_50._4_4_ = (float)lib::L2CValue::as_number(aLStack224);
    ...
    app::lua_bind::ModelModule__joint_global_rotation_impl
              (pBVar9,HVar8,(Vector3f *)&local_50,(bool)(bVar2 & 1));
    lib::L2CValue::L2CValue(aLStack176,(float)local_50);
