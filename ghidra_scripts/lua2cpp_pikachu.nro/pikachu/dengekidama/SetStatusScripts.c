...
void __thiscall L2CWeaponPikachuDengekidama::SetStatusScripts(L2CWeaponPikachuDengekidama *this)

{
  ...
  iVar1 = _WEAPON_PIKACHU_DENGEKIDAMA_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIKACHU_DENGEKIDAMA_STATUS_KIND_REGULAR);
