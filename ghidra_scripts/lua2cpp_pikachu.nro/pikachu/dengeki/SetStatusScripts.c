...
void __thiscall L2CWeaponPikachuDengeki::SetStatusScripts(L2CWeaponPikachuDengeki *this)

{
  ...
  iVar1 = _WEAPON_PIKACHU_DENGEKI_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIKACHU_DENGEKI_STATUS_KIND_REGULAR);
