...
void __thiscall L2CWeaponPikachuKaminari::SetStatusScripts(L2CWeaponPikachuKaminari *this)

{
  ...
  iVar1 = _WEAPON_PIKACHU_KAMINARI_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIKACHU_KAMINARI_STATUS_KIND_REGULAR);
