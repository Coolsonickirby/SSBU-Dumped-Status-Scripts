...
void __thiscall L2CWeaponInklingSplash::SetStatusScripts(L2CWeaponInklingSplash *this)

{
  ...
  iVar1 = _WEAPON_INKLING_SPLASH_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_INKLING_SPLASH_STATUS_KIND_NORMAL);
