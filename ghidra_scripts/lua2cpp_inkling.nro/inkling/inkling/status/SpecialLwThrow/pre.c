...
void __thiscall
L2CFighterInkling::status::SpecialLwThrow_pre(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_INKLING_GENERATE_ARTICLE_SPLASHBOMB);
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue
              (aLStack120,
               FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_ATTACK |
               _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_LW | _FIGHTER_LOG_MASK_FLAG_SHOOT);
