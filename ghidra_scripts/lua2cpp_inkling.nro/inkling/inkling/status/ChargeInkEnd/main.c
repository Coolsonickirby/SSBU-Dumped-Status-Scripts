...
void __thiscall
L2CFighterInkling::status::ChargeInkEnd_main(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x16c7221ca4);
  ...
  lib::L2CValue::L2CValue(aLStack80,ChargeInkEnd_main_loop);
