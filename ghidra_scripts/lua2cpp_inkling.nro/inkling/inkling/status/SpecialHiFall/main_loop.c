...
void __thiscall
L2CFighterInkling::status::SpecialHiFall_main_loop(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  uVar1 = lib::L2CValue::operator_(aLStack80,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  if ((uVar1 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack112,0x1086bc4a93);
    lib::L2CValue::L2CValue(aLStack128,0x134301441c);
