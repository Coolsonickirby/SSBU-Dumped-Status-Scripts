...
void __thiscall
L2CFighterInkling::status::SpecialN_main_loop(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  FUN_710002c750(this,aLStack80,aLStack96,aLStack112);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar5 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack64,_FIGHTER_INKLING_STATUS_KIND_SPECIAL_N_SHOOT);
