...
void __thiscall
L2CFighterInkling::status::SpecialSRunTurn_main(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0x126e8369f0);
  ...
  lib::L2CValue::L2CValue(aLStack112,0x8bcde4a63);
  lib::L2CValue::L2CValue(aLStack128,0x8bcde4a63);
  ...
  lib::L2CValue::L2CValue(aLStack176,_WEAPON_INKLING_ROLLER_STATUS_KIND_RUN_TURN);
  ...
  FUN_710001f4f0(this);
  lib::L2CValue::L2CValue(aLStack160,SpecialSRunTurn_main_loop);
