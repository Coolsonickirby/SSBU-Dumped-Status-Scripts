...
void __thiscall
L2CFighterInkling::status::SpecialNShoot_main_loop(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  FUN_710002c750(this,aLStack128,aLStack144,aLStack160);
  ...
  if ((uVar5 & 1) == 0) goto LAB_710002e0bc;
