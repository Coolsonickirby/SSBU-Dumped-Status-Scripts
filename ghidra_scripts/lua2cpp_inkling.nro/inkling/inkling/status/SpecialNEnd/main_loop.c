...
void __thiscall
L2CFighterInkling::status::SpecialNEnd_main_loop(L2CFighterInkling *this,L2CValue *return_value)
...
LAB_710002cc60:
    ...
    FUN_710002c750(this,aLStack96,aLStack112,aLStack144);
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) == 0) goto LAB_710002cdec;
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710002cdec;
