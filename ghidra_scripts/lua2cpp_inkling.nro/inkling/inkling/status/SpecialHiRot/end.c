...
void __thiscall
L2CFighterInkling::status::SpecialHiRot_end(L2CFighterInkling *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_INKLING_SQUID_STATUS_KIND_NONE);
