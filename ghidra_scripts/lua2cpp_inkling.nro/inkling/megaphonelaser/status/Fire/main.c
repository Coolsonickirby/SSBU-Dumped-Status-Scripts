...
void __thiscall
L2CWeaponInklingMegaphonelaser::status::Fire_main
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack80,_WEAPON_INKLING_MEGAPHONELASER_INSTANCE_WORK_ID_FLAG_CHANGE_DEGREE);
  ...
  lib::L2CValue::L2CValue
            (aLStack96,_WEAPON_INKLING_MEGAPHONELASER_INSTANCE_WORK_ID_FLOAT_SHOOT_DEGREE);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Fire_main_loop);
