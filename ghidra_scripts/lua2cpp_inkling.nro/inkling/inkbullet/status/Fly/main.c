...
void __thiscall
L2CWeaponInklingInkbullet::status::Fly_main(L2CWeaponInklingInkbullet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100036f80);
  lib::L2CValue::operator_(this_00,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100037030);
