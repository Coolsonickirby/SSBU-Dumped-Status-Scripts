...
void __thiscall
L2CFighterDiddy::status::SpecialSDamageFall_pre(L2CFighterDiddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_DAMAGE_FALL_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_DAMAGE_FALL_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_DAMAGE_FALL_FLOAT);
