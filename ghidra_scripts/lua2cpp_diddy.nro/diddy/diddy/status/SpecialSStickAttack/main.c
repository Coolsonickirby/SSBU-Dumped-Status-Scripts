...
void __thiscall
L2CFighterDiddy::status::SpecialSStickAttack_main(L2CFighterDiddy *this,L2CValue *return_value)

{
  ...
  FUN_71000256d0();
  lib::L2CValue::L2CValue(aLStack80,0x1672cea9f8);
  ...
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack80,SpecialSStickAttack_main_loop);
