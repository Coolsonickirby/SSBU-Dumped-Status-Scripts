...
void __thiscall
L2CFighterDiddy::status::SpecialSFlipLanding_main(L2CFighterDiddy *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSFlipLanding_main_loop);
