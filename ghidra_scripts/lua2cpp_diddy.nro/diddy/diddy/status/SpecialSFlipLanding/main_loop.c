...
void __thiscall
L2CFighterDiddy::status::SpecialSFlipLanding_main_loop(L2CFighterDiddy *this,L2CValue *return_value)
...
LAB_7100024de8:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((bVar1 & 1U) == 0) goto LAB_7100024ed0;
...
LAB_7100024ecc:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_7100024de8;
  }
LAB_7100024ed0:
  iVar5 = 0;
LAB_7100024ed8:
