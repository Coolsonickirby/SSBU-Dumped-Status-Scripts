...
void __thiscall
L2CFighterDiddy::status::SpecialSKickLanding_main_loop(L2CFighterDiddy *this,L2CValue *return_value)
...
LAB_7100026738:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((bVar1 & 1U) == 0) goto LAB_7100026820;
...
LAB_710002681c:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_7100026738;
  }
LAB_7100026820:
  iVar5 = 0;
LAB_7100026828:
