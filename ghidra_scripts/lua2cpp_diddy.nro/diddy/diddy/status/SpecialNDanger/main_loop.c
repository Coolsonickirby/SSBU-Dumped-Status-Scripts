...
void __thiscall
L2CFighterDiddy::status::SpecialNDanger_main_loop(L2CFighterDiddy *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) != 0) {
      ...
      uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) != 0) goto LAB_7100028604;
    }
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar4 & 1) != 0) goto LAB_710002860c;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack112);
    }
...
LAB_710002860c:
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DIDDY_STATUS_KIND_SPECIAL_N_BLOW);
