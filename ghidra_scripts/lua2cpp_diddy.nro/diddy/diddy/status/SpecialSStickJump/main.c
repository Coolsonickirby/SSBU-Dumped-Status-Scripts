...
void __thiscall
L2CFighterDiddy::status::SpecialSStickJump_main(L2CFighterDiddy *this,L2CValue *return_value)

{
  ...
  FUN_71000256d0();
  lib::L2CValue::L2CValue(aLStack80,0x1480cd2da3);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSStickJump_main_loop);
