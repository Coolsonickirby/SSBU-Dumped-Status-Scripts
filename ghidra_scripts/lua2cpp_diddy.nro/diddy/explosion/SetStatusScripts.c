...
void __thiscall L2CWeaponDiddyExplosion::SetStatusScripts(L2CWeaponDiddyExplosion *this)

{
  ...
  iVar1 = _WEAPON_DIDDY_EXPLOSION_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DIDDY_EXPLOSION_STATUS_KIND_FLY);
