...
void __thiscall
L2CWeaponDiddyBarreljet::status::Explosion_pre(L2CWeaponDiddyBarreljet *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_DIDDY_BARRELJET_STOP);
