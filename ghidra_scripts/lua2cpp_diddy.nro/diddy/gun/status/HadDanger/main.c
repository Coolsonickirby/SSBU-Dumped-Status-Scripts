...
void __thiscall
L2CWeaponDiddyGun::status::HadDanger_main(L2CWeaponDiddyGun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xaec494fdc);
  ...
  lib::L2CValue::L2CValue(aLStack80,HadDanger_main_loop);
