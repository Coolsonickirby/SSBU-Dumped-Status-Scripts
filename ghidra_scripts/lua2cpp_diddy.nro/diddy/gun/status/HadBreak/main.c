...
void __thiscall
L2CWeaponDiddyGun::status::HadBreak_main(L2CWeaponDiddyGun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x9558ce224);
  ...
  lib::L2CValue::L2CValue(aLStack80,HadBreak_main_loop);
