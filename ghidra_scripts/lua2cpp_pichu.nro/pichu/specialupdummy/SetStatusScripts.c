...
void __thiscall L2CWeaponPichuSpecialupdummy::SetStatusScripts(L2CWeaponPichuSpecialupdummy *this)

{
  ...
  iVar1 = _WEAPON_PIKACHU_SPECIALUPDUMMY_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PIKACHU_SPECIALUPDUMMY_STATUS_KIND_FLY);
