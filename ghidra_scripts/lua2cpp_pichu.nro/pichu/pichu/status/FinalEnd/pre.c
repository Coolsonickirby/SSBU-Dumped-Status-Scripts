...
void __thiscall L2CFighterPichu::status::FinalEnd_pre(L2CFighterPichu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_INHERIT_CAMERA_RANGE | _FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT
