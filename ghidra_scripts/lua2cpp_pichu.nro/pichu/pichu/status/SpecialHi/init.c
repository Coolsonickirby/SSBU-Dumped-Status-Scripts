...
void __thiscall
L2CFighterPichu::status::SpecialHi_init(L2CFighterPichu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x12e6bbfce1);
  uVar3 = lib::L2CValue::as_integer(aLStack80);
  uVar4 = lib::L2CValue::as_integer(aLStack96);
  iVar1 = app::lua_bind::WorkModule__get_param_int_impl(this->moduleAccessor,uVar3,uVar4);
  lib::L2CValue::L2CValue(aLStack64,iVar1);
  lib::L2CValue::L2CValue
            (aLStack112,_FIGHTER_PIKACHU_STATUS_WORK_ID_INT_QUICK_ATTACK_FALL_STOP_COUNTER);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::L2CValue
            (aLStack80,_FIGHTER_PIKACHU_STATUS_WORK_ID_INT_QUICK_ATTACK_GUIDE_EFFECT_HANDLE);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
