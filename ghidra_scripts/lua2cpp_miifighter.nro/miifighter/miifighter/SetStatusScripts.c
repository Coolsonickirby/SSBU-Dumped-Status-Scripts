...
void __thiscall L2CFighterMiifighter::SetStatusScripts(L2CFighterMiifighter *this)

{
  ...
  iVar1 = _FIGHTER_MIIFIGHTER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_7100002a50);
