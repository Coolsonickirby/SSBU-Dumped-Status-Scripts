...
void __thiscall
L2CFighterMiifighter::status::SpecialN2Finish_pre(L2CFighterMiifighter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_N | _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP);
