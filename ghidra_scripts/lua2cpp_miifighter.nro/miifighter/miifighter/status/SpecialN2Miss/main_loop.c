...
void __thiscall
L2CFighterMiifighter::status::SpecialN2Miss_main_loop
...

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_7100040c60;
    }
    iVar4 = 1;
    goto LAB_7100040f7c;
  }
...
LAB_7100040c60:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_7100040e44;
      lib::L2CValue::L2CValue(aLStack80,0xf2e4c9f2d);
...
LAB_7100040e44:
      ...
      if ((uVar5 & 1) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar5 & 1) == 0) {
          lib::L2CValue::L2CValue(aLStack80,0x1325d512f9);
          HVar7 = lib::L2CValue::as_hash(aLStack80);
          app::lua_bind::MotionModule__change_motion_inherit_frame_impl
                    (this->moduleAccessor,HVar7,-1.0,1.0,0.0,false,false);
          lib::L2CValue::_L2CValue(aLStack80);
