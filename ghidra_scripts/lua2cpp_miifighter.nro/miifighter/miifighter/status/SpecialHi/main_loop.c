...
void __thiscall
L2CFighterMiifighter::status::SpecialHi_main_loop(L2CFighterMiifighter *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
      ...
      if ((bVar1 & 1U) != 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::L2CValue
                    (aLStack80,_FIGHTER_MIIFIGHTER_INSTANCE_WORK_ID_FLAG_MTRANS_SMPL_GROUND);
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MIIFIGHTER_STATUS_KIND_SPECIAL_HI1_2);
