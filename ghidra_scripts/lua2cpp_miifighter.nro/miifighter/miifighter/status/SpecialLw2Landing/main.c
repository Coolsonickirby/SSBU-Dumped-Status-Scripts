...
void __thiscall
L2CFighterMiifighter::status::SpecialLw2Landing_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1310cee00f);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLw2Landing_main_loop);
