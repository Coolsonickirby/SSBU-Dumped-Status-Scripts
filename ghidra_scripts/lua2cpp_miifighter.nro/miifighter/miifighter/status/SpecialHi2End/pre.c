...
void __thiscall
L2CFighterMiifighter::status::SpecialHi2End_pre(L2CFighterMiifighter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,_FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_ATTACK | _FS_SUCCEEDS_KEEP_RUMBLE)
  ;
