...
void __thiscall
L2CFighterMiifighter::status::SpecialLw2AutoAttack_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x1b1b2c11ab);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack112,SpecialLw2AutoAttack_main_loop);
