...
void __thiscall
L2CFighterMiifighter::status::SpecialLw1Air_pre(L2CFighterMiifighter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_MIIFIGHTER_STATUS_WORK_ID_KUIUCHI_HEAD_FLAG_FROM_GR);
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLAG);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_INT);
  lib::L2CValue::L2CValue(aLStack264,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLOAT);
