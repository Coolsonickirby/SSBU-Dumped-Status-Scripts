...
void __thiscall
L2CFighterMiifighter::status::SpecialHi13_pre(L2CFighterMiifighter *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack168,_GROUND_CLIFF_CHECK_KIND_ON_DROP);
  lib::L2CValue::L2CValue(aLStack184,true);
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIFIGHTER_TENCHI_KICK_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIFIGHTER_TENCHI_KICK_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_MIIFIGHTER_TENCHI_KICK_FLOAT);
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_ATTACK);
