...
void __thiscall L2CFighterTrail::status::AttackAir_pre(L2CFighterTrail *this,L2CValue *return_value)

{
  ...
  if ((uVar13 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_TRAIL_STATUS_KIND_ATTACK_AIR_F);
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_TRAIL_STATUS_KIND_ATTACK_AIR_N);
    iVar5 = lib::L2CValue::as_integer(aLStack120);
    app::lua_bind::StatusModule__set_status_kind_interrupt_impl(this->moduleAccessor,iVar5);
  }
  lib::L2CValue::_L2CValue(aLStack120);
