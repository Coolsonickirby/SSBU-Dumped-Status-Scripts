...
void __thiscall
L2CFighterTrail::status::AttackAirN_main_loop(L2CFighterTrail *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) goto LAB_7100014400;
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,0x1659c343fd);
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack160,_FIGHTER_TRAIL_STATUS_ATTACK_AIR_N_FLAG_CONNECT_COMBO);
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::L2CValue(aLStack192,_FIGHTER_TRAIL_STATUS_ATTACK_AIR_N_FLAG_ENABLE_COMBO);
      ...
      if ((uVar5 & 1) == 0) goto LAB_71000143c4;
      lib::L2CValue::L2CValue(aLStack64,true);
      FUN_7100013fe0(this,aLStack64);
      lVar1 = -0x30;
    }
