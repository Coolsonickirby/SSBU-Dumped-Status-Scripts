...
void __thiscall
L2CFighterTrail::status::SpecialN1End_main_loop(L2CFighterTrail *this,L2CValue *return_value)
...
LAB_7100011afc:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      FUN_71000118e0(this,aLStack160);
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar4 & 1U) == 0) goto LAB_7100011cac;
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_7100011cac;
      goto LAB_7100011afc;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
