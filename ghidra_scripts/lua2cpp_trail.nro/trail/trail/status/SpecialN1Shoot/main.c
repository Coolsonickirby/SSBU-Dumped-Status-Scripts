...
void __thiscall
L2CFighterTrail::status::SpecialN1Shoot_main(L2CFighterTrail *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,SpecialN1Shoot_main_loop);
