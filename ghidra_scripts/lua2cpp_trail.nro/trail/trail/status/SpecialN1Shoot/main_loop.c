...
void __thiscall
L2CFighterTrail::status::SpecialN1Shoot_main_loop(L2CFighterTrail *this,L2CValue *return_value)
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        FUN_7100011db0(this,aLStack176);
      ...
      FUN_7100010fb0(this,aLStack192,aLStack208);
      ...
      if ((bVar3 & 1U) != 0) {
        ...
        if ((bVar3 & 1U) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::_L2CValue(aLStack224);
          if ((uVar6 & 1) == 0) goto LAB_7100012748;
...
LAB_7100012748:
      ...
      if ((bVar3 & 1U) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack224);
        if ((bVar3 & 1U) == 0) {
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TRAIL_STATUS_KIND_SPECIAL_N1_END);
  ...
  if ((uVar6 & 1) == 0) {
    ...
    FUN_7100011db0(this,aLStack160);
    lib::L2CValue::_L2CValue(aLStack160);
  }
  bVar2 = app::lua_bind::MotionModule__is_end_impl(this->moduleAccessor);
