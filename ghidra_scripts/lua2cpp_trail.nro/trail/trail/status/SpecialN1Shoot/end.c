...
void __thiscall
L2CFighterTrail::status::SpecialN1Shoot_end(L2CFighterTrail *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_TRAIL_STATUS_KIND_SPECIAL_N1_END);
