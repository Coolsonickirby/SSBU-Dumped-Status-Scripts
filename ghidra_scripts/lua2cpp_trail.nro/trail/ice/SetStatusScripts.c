...
void __thiscall L2CWeaponTrailIce::SetStatusScripts(L2CWeaponTrailIce *this)

{
  ...
  iVar1 = _WEAPON_TRAIL_ICE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_TRAIL_ICE_STATUS_KIND_FLY);
