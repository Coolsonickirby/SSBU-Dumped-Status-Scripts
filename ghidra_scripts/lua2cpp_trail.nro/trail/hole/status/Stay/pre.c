...
void __thiscall
L2CWeaponTrailHole::status::Stay_pre(L2CWeaponTrailHole *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_TRAIL_HOLE_STATUS_WORK_KEEP_FLAG_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_TRAIL_HOLE_STATUS_WORK_KEEP_FLAG_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_TRAIL_HOLE_STATUS_WORK_KEEP_FLAG_FLOAT);
