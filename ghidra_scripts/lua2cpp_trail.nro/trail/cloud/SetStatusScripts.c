...
void __thiscall L2CWeaponTrailCloud::SetStatusScripts(L2CWeaponTrailCloud *this)

{
  ...
  iVar1 = _WEAPON_TRAIL_CLOUD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_TRAIL_CLOUD_STATUS_KIND_START);
