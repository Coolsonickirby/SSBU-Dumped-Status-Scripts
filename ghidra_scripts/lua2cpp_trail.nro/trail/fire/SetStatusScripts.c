...
void __thiscall L2CWeaponTrailFire::SetStatusScripts(L2CWeaponTrailFire *this)

{
  ...
  iVar1 = _WEAPON_TRAIL_FIRE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_TRAIL_FIRE_STATUS_KIND_FLY);
