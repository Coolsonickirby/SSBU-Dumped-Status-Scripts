...
void __thiscall L2CWeaponRockmanRockmandash::SetStatusScripts(L2CWeaponRockmanRockmandash *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_ROCKMANDASH_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_ROCKMANDASH_STATUS_KIND_SCENE01);
