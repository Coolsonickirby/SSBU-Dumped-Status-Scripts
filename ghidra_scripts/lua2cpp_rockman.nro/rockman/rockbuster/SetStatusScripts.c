...
void __thiscall L2CWeaponRockmanRockbuster::SetStatusScripts(L2CWeaponRockmanRockbuster *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_ROCKBUSTER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_ROCKBUSTER_STATUS_KIND_REGULAR);
