...
void __thiscall
L2CWeaponRockmanRockbuster::status::Regular_init
          (L2CWeaponRockmanRockbuster *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1013897305);
  ...
  lib::L2CValue::L2CValue(aLStack128,0x1013897305);
