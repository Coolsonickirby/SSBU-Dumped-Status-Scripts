...
void __thiscall L2CWeaponRockmanRockmanx::SetStatusScripts(L2CWeaponRockmanRockmanx *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_ROCKMANX_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_ROCKMANX_STATUS_KIND_SCENE01);
