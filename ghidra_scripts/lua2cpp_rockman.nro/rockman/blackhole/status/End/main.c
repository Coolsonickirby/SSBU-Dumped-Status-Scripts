...
void __thiscall
L2CWeaponRockmanBlackhole::status::End_main(L2CWeaponRockmanBlackhole *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1e);
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_71000026b0);
