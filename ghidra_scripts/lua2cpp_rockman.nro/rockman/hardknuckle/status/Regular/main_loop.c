...
void __thiscall
L2CWeaponRockmanHardknuckle::status::Regular_main_loop
...

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) goto LAB_7100027768;
    lib::L2CValue::L2CValue(aLStack64,_WEAPON_ROCKMAN_HARDKNUCKLE_STATUS_KIND_STICK);
