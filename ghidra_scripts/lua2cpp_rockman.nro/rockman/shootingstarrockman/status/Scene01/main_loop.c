...
void __thiscall
L2CWeaponRockmanShootingstarrockman::status::Scene01_main_loop
          (L2CWeaponRockmanShootingstarrockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack96,_WEAPON_ROCKMAN_SHOOTINGSTARROCKMAN_INSTANCE_WORK_ID_FLAG_VISIBILITY_CHANGE);
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue
                (aLStack64,
                 _WEAPON_ROCKMAN_SHOOTINGSTARROCKMAN_INSTANCE_WORK_ID_FLAG_VISIBILITY_CHANGE);
