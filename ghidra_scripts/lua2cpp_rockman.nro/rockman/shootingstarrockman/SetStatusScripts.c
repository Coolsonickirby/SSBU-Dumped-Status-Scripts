...
void __thiscall
L2CWeaponRockmanShootingstarrockman::SetStatusScripts(L2CWeaponRockmanShootingstarrockman *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_SHOOTINGSTARROCKMAN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_SHOOTINGSTARROCKMAN_STATUS_KIND_SCENE01);
