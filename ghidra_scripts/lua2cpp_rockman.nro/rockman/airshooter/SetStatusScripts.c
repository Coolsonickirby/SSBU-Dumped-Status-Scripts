...
void __thiscall L2CWeaponRockmanAirshooter::SetStatusScripts(L2CWeaponRockmanAirshooter *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_AIRSHOOTER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_AIRSHOOTER_STATUS_KIND_REGULAR);
