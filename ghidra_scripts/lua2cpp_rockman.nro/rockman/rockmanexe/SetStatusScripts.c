...
void __thiscall L2CWeaponRockmanRockmanexe::SetStatusScripts(L2CWeaponRockmanRockmanexe *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_ROCKMANEXE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_ROCKMANEXE_STATUS_KIND_SCENE01);
