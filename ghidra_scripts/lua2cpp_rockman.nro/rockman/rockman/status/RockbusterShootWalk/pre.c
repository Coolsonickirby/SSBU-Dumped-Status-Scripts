...
void __thiscall
L2CFighterRockman::status::RockbusterShootWalk_pre(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,FIGHTER_STATUS_KIND_WALK);
  ...
  if ((uVar13 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack120);
    lib::L2CValue::L2CValue(aLStack120,FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT);
  ...
  iVar9 = lib::L2CValue::as_integer(aLStack152);
  ...
  lib::L2CValue::L2CValue(aLStack280,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_3);
