...
void __thiscall
L2CFighterRockman::status::SpecialHiJump_pre(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_ROCKMAN_SPECIAL_HI_JUMP);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROCKMAN_SPECIAL_HI_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROCKMAN_SPECIAL_HI_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROCKMAN_SPECIAL_HI_JUMP_FLOAT);
