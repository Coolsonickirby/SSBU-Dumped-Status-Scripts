...
void __thiscall
L2CFighterRockman::status::RockbusterShootJump_pre(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_ATTR_SCALE_KINETIC_ENERGY | _FIGHTER_STATUS_ATTR_INTO_DOOR);
