...
void __thiscall
L2CFighterRockman::status::AttackAir_main(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack112,_FIGHTER_ROCKMAN_INSTANCE_WORK_ID_INT_ROCKBUSTER_COUNT_MINI_JUMP_ATTACK);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    uVar3 = lib::L2CValue::operator__(aLStack80,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar3 & 1) != 0) goto LAB_710000b1c4;
  }
  else {
LAB_710000b1c4:
  ...
  lib::L2CValue::L2CValue(aLStack96,&LAB_7100018670);
