...
void __thiscall
L2CFighterRockman::status::FinalScene01_main(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,FIGHTER_KIND_ROCKMAN);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::FighterManager__start_finalbg_impl(FIGHTER_STATUS_KIND_AIR_LASSO_HANG,iVar2,1.0);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xe87eaf0ee);
