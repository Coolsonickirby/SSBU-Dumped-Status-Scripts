...
void __thiscall
L2CFighterRockman::status::RockbusterShootLanding_main_loop
...

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack208,0xd07d69a9b);
      ...
      uVar3 = lib::L2CValue::operator_(aLStack192,aLStack80);
