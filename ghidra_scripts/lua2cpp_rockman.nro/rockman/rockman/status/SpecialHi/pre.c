...
void __thiscall
L2CFighterRockman::status::SpecialHi_pre(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_ROCKMAN_SPECIAL_HI_COMP);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROCKMAN_SPECIAL_HI_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROCKMAN_SPECIAL_HI_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROCKMAN_SPECIAL_HI_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_WARP | _FIGHTER_STATUS_ATTR_START_TURN
            );
