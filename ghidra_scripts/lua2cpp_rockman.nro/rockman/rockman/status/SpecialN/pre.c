...
void __thiscall
L2CFighterRockman::status::SpecialN_pre(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT);
