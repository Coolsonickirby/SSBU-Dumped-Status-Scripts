...
void __thiscall
L2CFighterRockman::status::AttackHi4Start_end(L2CFighterRockman *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) != 0) {
    ...
    if ((uVar2 & 1) == 0) {
      ...
      if ((uVar2 & 1) != 0) goto LAB_71000090cc;
  ...
  lib::L2CValue::_L2CValue(aLStack96);
LAB_71000090cc:
  lua2cpp::L2CFighterCommon::status_end_AttackHi4Start(this);
  lib::L2CValue::_L2CValue(aLStack96);
