...
void __thiscall L2CWeaponRockmanChargeshot::SetStatusScripts(L2CWeaponRockmanChargeshot *this)

{
  ...
  iVar1 = _WEAPON_ROCKMAN_CHARGESHOT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROCKMAN_CHARGESHOT_STATUS_KIND_REGULAR);
