...
void __thiscall L2CFighterRoy::status::SpecialLwHit_exec(L2CFighterRoy *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue
              ((L2CValue *)auStack128,_FIGHTER_ROY_STATUS_SPECIAL_LW_WORK_INT_SITUATION_PREV);
