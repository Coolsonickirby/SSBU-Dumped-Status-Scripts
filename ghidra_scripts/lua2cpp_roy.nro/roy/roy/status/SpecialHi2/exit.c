...
void __thiscall L2CFighterRoy::status::SpecialHi4_exit(L2CFighterRoy *this,L2CValue *return_value)
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        if ((uVar4 & 1) != 0) {
          ...
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ROY_INSTANCE_WORK_ID_INT_SPECIAL_HI_CLIFF_NUM);
