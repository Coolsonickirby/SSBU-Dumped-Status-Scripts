...
void __thiscall L2CWeaponBraveSleep::SetStatusScripts(L2CWeaponBraveSleep *this)

{
  ...
  iVar1 = _WEAPON_BRAVE_SLEEP_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_BRAVE_SLEEP_STATUS_KIND_START);
