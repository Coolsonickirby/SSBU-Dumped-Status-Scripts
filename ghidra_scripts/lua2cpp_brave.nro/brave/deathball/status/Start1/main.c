...
void __thiscall
L2CWeaponBraveDeathball::status::Start1_main(L2CWeaponBraveDeathball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa74807323);
  ...
  lib::L2CValue::L2CValue(aLStack80,Start1_main_loop);
