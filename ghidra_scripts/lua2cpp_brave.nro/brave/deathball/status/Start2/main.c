...
void __thiscall
L2CWeaponBraveDeathball::status::Start2_main(L2CWeaponBraveDeathball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xaed892299);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Start2_main_loop);
