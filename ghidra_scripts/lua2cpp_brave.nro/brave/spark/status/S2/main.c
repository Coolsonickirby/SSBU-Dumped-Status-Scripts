...
void __thiscall
L2CWeaponBraveSpark::status::S2_main(L2CWeaponBraveSpark *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0xb251c6810);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,S32_main_loop);
