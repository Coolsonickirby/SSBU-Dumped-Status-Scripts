...
void __thiscall
L2CWeaponBraveFlash::status::Hit2_exec(L2CWeaponBraveFlash *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,0xc190ff958);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0xb17c1f83e);
  lib::L2CValue::L2CValue(aLStack144,0xc00e23406);
  uVar3 = lib::L2CValue::as_integer(aLStack64);
