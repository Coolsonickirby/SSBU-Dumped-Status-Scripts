...
void __thiscall
L2CWeaponBraveFlash::status::Hit1_main(L2CWeaponBraveFlash *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xab91842c4);
  ...
  lib::L2CValue::L2CValue(aLStack112,0xc8006a8e2);
  ...
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,Hit1_main_loop);
