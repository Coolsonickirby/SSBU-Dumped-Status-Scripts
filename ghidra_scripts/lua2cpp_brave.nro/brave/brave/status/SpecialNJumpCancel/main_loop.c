...
void __thiscall
L2CFighterBrave::status::SpecialNJumpCancel_main_loop(L2CFighterBrave *this,L2CValue *return_value)
...
LAB_710002e3c0:
      ...
      if ((uVar4 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar4 & 1) != 0) goto LAB_710002e3c0;
      }
      lib::L2CValue::L2CValue((L2CValue *)return_value,0);
    }
  }
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar4 & 1) != 0) goto LAB_710002e2e0;
