...
void __thiscall
L2CFighterBrave::status::SpecialSAttack1_main_loop(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack224,0x15f9ab874a);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack272);
      lib::L2CValue::_L2CValue(aLStack240);
      if ((uVar4 & 1) != 0) goto LAB_710002a980;
    }
