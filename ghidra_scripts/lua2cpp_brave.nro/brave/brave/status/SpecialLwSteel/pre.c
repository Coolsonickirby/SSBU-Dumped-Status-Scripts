...
void __thiscall
L2CFighterBrave::status::SpecialLwSteel_pre(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_BRAVE_SPECIAL_LW_COMMAND10_STEEL);
  ...
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLAG);
  lib::L2CValue::L2CValue(aLStack264,FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_INT);
  lib::L2CValue::L2CValue(aLStack280,_FIGHTER_STATUS_WORK_KEEP_FLAG_ALL_FLOAT);
  lib::L2CValue::L2CValue(aLStack296,_FS_SUCCEEDS_KEEP_HIT);
  ...
  lib::L2CValue::L2CValue
            (aLStack248,
             _FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_SPRING | _FIGHTER_STATUS_ATTR_KEEP_2NDARY |
             _FIGHTER_STATUS_ATTR_DISABLE_SWIM);
