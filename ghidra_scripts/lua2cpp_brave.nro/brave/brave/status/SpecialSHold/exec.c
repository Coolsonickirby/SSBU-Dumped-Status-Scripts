...
void __thiscall
L2CFighterBrave::status::SpecialSHold_exec(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_BRAVE_STATUS_SPECIAL_S_WORK_INT_HOLD_FRAME);
  ...
  if ((uVar2 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,0x14d29f9c6e);
