...
void __thiscall
L2CFighterBrave::status::SpecialLwFlyingStart_pre(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_BRAVE_SPECIAL_LW_COMMAND16_FLYING);
