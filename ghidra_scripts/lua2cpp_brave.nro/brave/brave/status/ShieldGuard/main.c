...
void __thiscall
L2CFighterBrave::status::ShieldGuard_main(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_BRAVE_STATUS_KIND_SHIELD_GUARD);
    ...
    if ((uVar4 & 1) != 0) {
      ...
      if ((uVar4 & 1) == 0) goto LAB_710000b90c;
      goto LAB_710000b830;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    this_00 = aLStack96;
