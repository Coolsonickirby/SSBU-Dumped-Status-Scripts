...
void __thiscall L2CFighterBrave::status::FinalEnd_main(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_FINAL_MODULE_END_INIT);
