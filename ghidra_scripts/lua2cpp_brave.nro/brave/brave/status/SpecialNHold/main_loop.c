...
void __thiscall
L2CFighterBrave::status::SpecialNHold_main_loop(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((bVar1 & 1U) != 0) goto LAB_710002f208;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack240);
LAB_710002f208:
  ...
  lib::L2CValue::_L2CValue(aLStack240);
  if ((bVar1 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_STATUS_KIND_SPECIAL_N_SHOOT);
...
LAB_710002f5f8:
      ...
      if ((uVar6 & 1) == 0) {
        ...
        if ((uVar6 & 1) != 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack256);
          lib::L2CValue::_L2CValue(aLStack96);
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_STATUS_KIND_SPECIAL_N_JUMP_CANCEL);
...
LAB_710002fa4c:
        ...
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar6 & 1) != 0) {
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_STATUS_KIND_SPECIAL_N_CANCEL);
...
LAB_710002fadc:
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack256);
        lib::L2CValue::_L2CValue(aLStack272);
        if ((uVar6 & 1) == 0) goto LAB_710002f5f8;
    ...
    lib::L2CValue::L2CValue(aLStack256,0x168698de34);
    iVar3 = lib::L2CValue::as_integer(aLStack96);
