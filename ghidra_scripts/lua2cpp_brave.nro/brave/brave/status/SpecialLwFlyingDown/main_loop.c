...
void __thiscall
L2CFighterBrave::status::SpecialLwFlyingDown_main_loop(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_BRAVE_STATUS_SPECIAL_LW_FLYING_FLAG_ARRIVED);
