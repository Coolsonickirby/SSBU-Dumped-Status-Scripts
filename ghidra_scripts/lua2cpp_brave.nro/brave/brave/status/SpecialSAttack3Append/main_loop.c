...
void __thiscall
L2CFighterBrave::status::SpecialSAttack3Append_main_loop
...

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0xbcabfd1fd);
  lib::L2CValue::L2CValue(aLStack112,0xf3d2dd4ca);
  ...
  lib::L2CValue::L2CValue(aLStack224,0x1574a38abf);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack272);
      lib::L2CValue::_L2CValue(aLStack240);
      if ((uVar4 & 1) != 0) goto LAB_71000287f0;
    }
