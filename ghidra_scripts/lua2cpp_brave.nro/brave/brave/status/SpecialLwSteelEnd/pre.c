...
void __thiscall
L2CFighterBrave::status::SpecialLwSteelEnd_pre(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_BRAVE_SPECIAL_LW_COMMAND10_STEEL);
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_BRAVE_SPECIAL_LW_VARIOUS_KIND_NONE);
  FUN_71000398f0(aLStack136,aLStack152,aLStack168);
