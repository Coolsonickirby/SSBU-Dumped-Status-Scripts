...
void __thiscall
L2CFighterBrave::status::FinalScene01_main(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_STATUS_FINAL_FLOAT_SCALE_BASE);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KIND_BRAVE);
  ...
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  fVar8 = (float)lib::L2CValue::as_number(aLStack112);
  app::lua_bind::FighterManager__start_finalbg_impl(LUA_SCRIPT_LINE_SYSTEM_POST,iVar2,fVar8);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::_L2CValue(aLStack96);
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,4);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_FINAL_MODULE_SCENE_01_INIT_PRE);
  pFVar7 = (Fighter *)lib::L2CValue::as_pointer(pLVar6);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_Brave::call_final_module(pFVar7,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  iVar2 = app::lua_bind::SlowModule__whole_mag_impl(this->moduleAccessor);
  lib::L2CValue::L2CValue(aLStack112,iVar2);
  fVar8 = (float)app::lua_bind::BattleObjectSlow__rate_request_impl(LUA_SCRIPT_LINE_STATUS_SYSTEM);
  lib::L2CValue::L2CValue(aLStack128,fVar8);
  ...
  if ((uVar4 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack96,1.0);
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_BRAVE_STATUS_FINAL_FLOAT_MOTION_CAMERA_RATE);
    fVar8 = (float)lib::L2CValue::as_number(aLStack96);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_STATUS_FINAL_FLOAT_MOTION_CAMERA_RATE);
  ...
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,4);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_BRAVE_FINAL_MODULE_SCENE_01_INIT);
  pFVar7 = (Fighter *)lib::L2CValue::as_pointer(pLVar6);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_Brave::call_final_module(pFVar7,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  fVar8 = (float)lib::L2CValue::as_number(aLStack128);
  app::lua_bind::FighterManager__start_movie_impl(LUA_SCRIPT_LINE_SYSTEM_POST,fVar8);
