...
void __thiscall
L2CFighterBrave::status::FinalScene01_end(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_BRAVE_FINAL_MODULE_SCENE_01_EXIT);
  pFVar2 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
  app::FighterSpecializer_Brave::call_final_module(pFVar2,iVar1);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_BRAVE_STATUS_FINAL_FLOAT_SCALE_BASE);
