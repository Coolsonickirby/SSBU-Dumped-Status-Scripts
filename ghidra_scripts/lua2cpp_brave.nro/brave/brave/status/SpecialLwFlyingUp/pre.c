...
void __thiscall
L2CFighterBrave::status::SpecialLwFlyingUp_pre(L2CFighterBrave *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_SCALING);
