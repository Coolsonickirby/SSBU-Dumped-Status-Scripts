...
void __thiscall
L2CWeaponBraveFireball::status::BurstM_main(L2CWeaponBraveFireball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x77dea3eef);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,BurstM_main_loop);
