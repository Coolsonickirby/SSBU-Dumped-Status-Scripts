...
void __thiscall
L2CWeaponBraveFireball::status::BurstL_main(L2CWeaponBraveFireball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0xdb3e2b87c);
  ...
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,0x70aed0e79);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,BurstL_main_loop);
