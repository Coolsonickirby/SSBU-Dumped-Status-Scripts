...
void __thiscall
L2CWeaponBraveFireball::status::FlyM_main(L2CWeaponBraveFireball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0x604a786d4);
  ...
  lib::L2CValue::L2CValue(aLStack160,0x9a9de2c6a);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack128,FlyM_main_loop);
