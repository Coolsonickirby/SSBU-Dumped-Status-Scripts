...
void __thiscall
L2CWeaponBraveFireball::status::FlyL_main_loop(L2CWeaponBraveFireball *this,L2CValue *return_value)
...
LAB_7100040c7c:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) == 0) goto LAB_7100040e50;
...
LAB_7100040e50:
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) == 0) goto LAB_7100040f1c;
      lib::L2CValue::L2CValue(aLStack80,5);
      uVar4 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::EffectModule__detach_all_impl(this->moduleAccessor,uVar4);
      lib::L2CValue::_L2CValue(aLStack80);
...
LAB_7100040f0c:
    ...
    lib::L2CValue::L2CValue(aLStack144,_WEAPON_BRAVE_FIREBALL_INSTANCE_WORK_ID_FLAG_ATTACK);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar5 & 1) == 0) goto LAB_7100040c7c;
    lib::L2CValue::L2CValue(aLStack80,5);
    uVar4 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::EffectModule__detach_all_impl(this->moduleAccessor,uVar4);
    lib::L2CValue::_L2CValue(aLStack80);
