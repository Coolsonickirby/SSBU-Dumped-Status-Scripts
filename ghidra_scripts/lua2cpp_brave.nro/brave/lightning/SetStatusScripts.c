...
void __thiscall L2CWeaponBraveLightning::SetStatusScripts(L2CWeaponBraveLightning *this)

{
  ...
  iVar1 = _WEAPON_BRAVE_LIGHTNING_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_BRAVE_LIGHTNING_STATUS_KIND_REGULAR);
