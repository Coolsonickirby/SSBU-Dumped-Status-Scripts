...
void __thiscall
L2CWeaponBraveTornado::status::FlyM_main_loop(L2CWeaponBraveTornado *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack80,0xd93d110d1);
    lib::L2CValue::L2CValue(aLStack96,0x13ee7f4c81);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) {
      lib::L2CValue::L2CValue(aLStack96,0xd93d110d1);
      lib::L2CValue::L2CValue(aLStack112,0x9a81c465d);
