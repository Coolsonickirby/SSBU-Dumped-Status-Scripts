...
void __thiscall
L2CWeaponPikminDolfin::status::Fly_pre(L2CWeaponPikminDolfin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_PIKMIN_DOLFIN_FINAL_FLY);
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_DOLFIN_FINAL_FLY_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_DOLFIN_FINAL_FLY_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_DOLFIN_FINAL_FLY_FLOAT);
