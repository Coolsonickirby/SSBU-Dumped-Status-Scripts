...
void __thiscall
L2CWeaponPikminDolfin::status::Attack_pre(L2CWeaponPikminDolfin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_DOLFIN_FINAL_ATTACK_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_DOLFIN_FINAL_ATTACK_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_DOLFIN_FINAL_ATTACK_FLOAT)
  ;
