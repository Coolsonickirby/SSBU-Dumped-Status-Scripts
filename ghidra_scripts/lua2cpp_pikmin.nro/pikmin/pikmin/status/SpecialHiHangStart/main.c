...
void __thiscall
L2CWeaponPikminPikmin::status::SpecialHiHangStart_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x10c1409600);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialHiHangStart_main_loop);
