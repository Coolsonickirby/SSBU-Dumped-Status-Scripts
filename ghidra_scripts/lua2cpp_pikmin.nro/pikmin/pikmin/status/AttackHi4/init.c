...
void __thiscall
L2CFighterPikmin::status::AttackHi4_init(L2CFighterPikmin *this,L2CValue *return_value)

{
  ...
  if ((uVar7 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) != 0) {
      app::FighterPikminLinkEventWeaponPikminSetPowerMulStatus::new_l2c_table();
      fVar8 = (float)app::lua_bind::AttackModule__power_mul_status_impl(this->moduleAccessor);
      lib::L2CValue::L2CValue(aLStack80,fVar8);
      pLVar5 = (L2CValue *)lib::L2CValue::operator__(aLStack160,0x110625cbb6);
      lib::L2CValue::operator_(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      pLVar5 = (L2CValue *)lib::L2CValue::operator__(aLStack160,0x105a79305b);
      lib::L2CValue::L2CValue(aLStack80,0x3c50caa7a8);
      lib::L2CValue::operator_(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,3);
      this_00 = (L2CValue *)lib::L2CValue::operator__(aLStack160,0xaa79e68a2);
      lib::L2CValue::operator_(this_00,pLVar5);
