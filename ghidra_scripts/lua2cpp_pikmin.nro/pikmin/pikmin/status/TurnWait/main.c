...
void __thiscall
L2CWeaponPikminPikmin::status::TurnWait_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x48d917a55);
  ...
  lib::L2CValue::L2CValue(aLStack80,TurnWait_main_loop);
