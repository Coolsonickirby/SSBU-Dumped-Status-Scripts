...
void __thiscall
L2CWeaponPikminPikmin::status::CatchCutSub_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xdc9e2449e);
  ...
  lib::L2CValue::L2CValue(aLStack80,CatchCutSub_main_loop);
