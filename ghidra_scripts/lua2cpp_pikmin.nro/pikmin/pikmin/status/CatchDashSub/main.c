...
void __thiscall
L2CWeaponPikminPikmin::status::CatchDashSub_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xe1a7abeb6);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,CatchDashSub_main_loop);
