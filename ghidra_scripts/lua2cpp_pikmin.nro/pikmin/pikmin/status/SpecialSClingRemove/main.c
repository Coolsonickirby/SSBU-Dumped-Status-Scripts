...
void __thiscall
L2CWeaponPikminPikmin::status::SpecialSClingRemove_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xb7cfad464);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSClingRemove_main_loop);
