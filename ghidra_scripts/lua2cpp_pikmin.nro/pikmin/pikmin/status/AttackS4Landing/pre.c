...
void __thiscall
L2CWeaponPikminPikmin::status::AttackS4Landing_pre
...

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_PIKMIN_PIKMIN_GROUND_STOP);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_ATTACK_S4_LANDING_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_ATTACK_S4_LANDING_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_ATTACK_S4_LANDING_FLOAT);
