...
void __thiscall
L2CWeaponPikminPikmin::status::CatchFailureReturn_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x149c5adf1d);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,CatchFailureReturn_main_loop);
