...
void __thiscall
L2CWeaponPikminPikmin::status::AirFollow_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x4a7b30616);
  ...
  lib::L2CValue::L2CValue(aLStack80,AirFollow_main_loop);
