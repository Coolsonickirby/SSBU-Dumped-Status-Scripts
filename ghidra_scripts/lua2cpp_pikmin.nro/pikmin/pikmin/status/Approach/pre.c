...
void __thiscall
L2CWeaponPikminPikmin::status::Approach_pre(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_PIKMIN_PIKMIN_APPROACH);
