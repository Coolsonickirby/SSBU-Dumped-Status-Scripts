...
void __thiscall
L2CFighterPikmin::status::FinalEnd_pre(L2CFighterPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_PIKMIN_FINAL_END);
