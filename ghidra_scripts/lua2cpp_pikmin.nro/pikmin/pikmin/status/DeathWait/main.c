...
void __thiscall
L2CWeaponPikminPikmin::status::DeathWait_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  fVar5 = (float)app::sv_math::randf(HVar4,1.0);
  ...
  lib::L2CValue::L2CValue(aLStack80,DeathWait_main_loop);
