...
void __thiscall
L2CWeaponPikminPikmin::status::SpecialLwRespond_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xd10f05f4b);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwRespond_main_loop);
