...
void __thiscall L2CFighterPikmin::status::Catch_pre(L2CFighterPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_CATCH);
