...
void __thiscall
L2CWeaponPikminPikmin::status::DrownDead_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xb5b4d78a6);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,DrownDead_main_loop);
