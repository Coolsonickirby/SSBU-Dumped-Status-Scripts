...
void __thiscall
L2CWeaponPikminPikmin::status::PullOutStart_pre(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_PULL_OUT_START_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_PULL_OUT_START_INT)
  ;
  lib::L2CValue::L2CValue
            (aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_PULL_OUT_START_FLOAT);
