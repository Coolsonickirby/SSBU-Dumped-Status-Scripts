...
void __thiscall
L2CWeaponPikminPikmin::status::AttackHi4Landing_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1295ad0abf);
  ...
  lib::L2CValue::L2CValue(aLStack80,AttackHi4Landing_main_loop);
