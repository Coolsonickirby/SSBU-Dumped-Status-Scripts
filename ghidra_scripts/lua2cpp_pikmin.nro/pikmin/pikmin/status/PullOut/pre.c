...
void __thiscall
L2CWeaponPikminPikmin::status::PullOut_pre(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_PIKMIN_PIKMIN_PULL_OUT);
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_PULL_OUT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_PULL_OUT_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_PULL_OUT_FLOAT);
