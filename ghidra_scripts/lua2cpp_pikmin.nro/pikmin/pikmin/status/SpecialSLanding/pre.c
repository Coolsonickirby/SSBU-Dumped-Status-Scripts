...
void __thiscall
L2CWeaponPikminPikmin::status::SpecialSLanding_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_SPECIAL_S_LANDING_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_SPECIAL_S_LANDING_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_PIKMIN_PIKMIN_SPECIAL_S_LANDING_FLOAT);
