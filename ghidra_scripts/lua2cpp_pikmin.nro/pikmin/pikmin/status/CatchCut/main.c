...
void __thiscall
L2CWeaponPikminPikmin::status::CatchCut_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x97c7ceeb1);
  ...
  lib::L2CValue::L2CValue(aLStack80,CatchCut_main_loop);
