...
void __thiscall
L2CFighterPikmin::status::SpecialLw_pre(L2CFighterPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack120,
             ...
             _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_NONE | FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON);
