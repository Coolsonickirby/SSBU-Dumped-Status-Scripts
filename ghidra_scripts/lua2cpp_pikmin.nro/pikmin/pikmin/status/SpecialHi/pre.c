...
void __thiscall
L2CFighterPikmin::status::SpecialHi_pre(L2CFighterPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack120,_FIGHTER_STATUS_ATTR_INTO_DOOR | _FIGHTER_STATUS_ATTR_START_TURN);
  lib::L2CValue::operator_(aLStack136,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack120,SITUATION_KIND_NONE);
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_PIKMIN_SPECIAL_HI);
