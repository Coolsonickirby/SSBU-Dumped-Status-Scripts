...
void __thiscall
L2CWeaponPikminPikmin::status::SpinLanding_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xc91204215);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpinLanding_main_loop);
