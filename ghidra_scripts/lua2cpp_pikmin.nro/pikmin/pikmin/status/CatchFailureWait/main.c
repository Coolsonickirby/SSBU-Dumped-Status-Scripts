...
void __thiscall
L2CWeaponPikminPikmin::status::CatchFailureWait_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12b778fc8b);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,CatchFailureWait_main_loop);
