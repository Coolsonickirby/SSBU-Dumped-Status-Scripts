...
void __thiscall
L2CWeaponPikminPikmin::status::Wait_main(L2CWeaponPikminPikmin *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack144,0xc0e62f73f);
  ...
  lib::L2CValue::L2CValue(aLStack64,_WEAPON_PIKMIN_PIKMIN_STATUS_WAIT_WORK_INT_NO_SLEEP_FRAME);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    FUN_710004fc20(aLStack96,this,aLStack112);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack64,&DAT_710004fd50);
