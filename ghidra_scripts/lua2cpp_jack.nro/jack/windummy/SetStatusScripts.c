...
void __thiscall L2CWeaponJackWindummy::SetStatusScripts(L2CWeaponJackWindummy *this)

{
  ...
  iVar1 = _WEAPON_JACK_WINDUMMY_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_JACK_WINDUMMY_STATUS_KIND_WIN);
