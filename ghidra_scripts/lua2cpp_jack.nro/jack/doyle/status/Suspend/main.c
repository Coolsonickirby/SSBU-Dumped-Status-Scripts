...
void __thiscall
L2CWeaponJackDoyle::status::Suspend_main(L2CWeaponJackDoyle *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xb4813477d);
  ...
  lib::L2CValue::L2CValue(aLStack80,Suspend_main_loop);
