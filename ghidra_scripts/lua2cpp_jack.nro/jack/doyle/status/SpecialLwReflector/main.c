...
void __thiscall
L2CWeaponJackDoyle::status::SpecialLwReflector_main(L2CWeaponJackDoyle *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwReflector_main_loop);
