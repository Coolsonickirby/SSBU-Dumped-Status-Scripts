...
void __thiscall
L2CFighterJack::status::AirLassoFailure_main(L2CFighterJack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710001af20);
  lib::L2CValue::L2CValue(aLStack80,0x9e7d3cd80);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_JACK_WIREROPE_STATUS_KIND_REWIND);
