...
void __thiscall L2CFighterJack::status::Dispatch_main(L2CFighterJack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x88612665a);
  ...
  app::lua_bind::VisibilityModule__set_material_anim_priority_impl
            (this->moduleAccessor,HVar2,(bool)(bVar1 & 1));
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Dispatch_main_loop);
