...
void __thiscall L2CFighterJack::status::FinalEnd_end(L2CFighterJack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_JACK_FINAL_MODULE_END_EXIT);
  pFVar4 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Jack::call_final_module(pFVar4,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_JACK_GENERATE_ARTICLE_BACKGROUND);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
