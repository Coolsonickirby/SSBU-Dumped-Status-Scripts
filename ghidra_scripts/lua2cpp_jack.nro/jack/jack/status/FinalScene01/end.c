...
void __thiscall
L2CFighterJack::status::FinalScene01_end(L2CFighterJack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_JACK_FINAL_MODULE_SCENE_01_EXIT);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_JACK_STATUS_KIND_FINAL_SCENE02);
  uVar5 = lib::L2CValue::operator__(pLVar3,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar5 & 1) == 0) {
    app::lua_bind::FighterManager__exit_finalbg_impl
