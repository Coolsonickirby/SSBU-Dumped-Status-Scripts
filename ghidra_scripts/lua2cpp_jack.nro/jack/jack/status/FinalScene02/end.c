...
void __thiscall
L2CFighterJack::status::FinalScene02_end(L2CFighterJack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_JACK_FINAL_MODULE_SCENE_02_EXIT);
  pFVar2 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
  app::FighterSpecializer_Jack::call_final_module(pFVar2,iVar1);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_JACK_STATUS_FINAL_FLOAT_SCALE_BASE);
