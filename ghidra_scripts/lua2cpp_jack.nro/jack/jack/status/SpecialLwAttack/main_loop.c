...
void __thiscall
L2CFighterJack::status::SpecialLwAttack_main_loop(L2CFighterJack *this,L2CValue *return_value)
...
LAB_710001fb60:
    ...
    if ((uVar2 & 1) == 0) {
      ...
      uVar2 = lib::L2CValue::operator__(aLStack96,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar2 & 1) == 0) goto LAB_710001fce4;
...
LAB_710001fd18:
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar2 & 1) == 0) goto LAB_710001fe0c;
      }
      else {
        pLVar3 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
