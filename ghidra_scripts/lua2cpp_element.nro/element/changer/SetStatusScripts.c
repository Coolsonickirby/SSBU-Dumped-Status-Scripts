...
void __thiscall L2CWeaponElementChanger::SetStatusScripts(L2CWeaponElementChanger *this)

{
  ...
  iVar1 = _WEAPON_ELEMENT_CHANGER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ELEMENT_CHANGER_STATUS_KIND_WAIT);
