...
void __thiscall
L2CWeaponElementChanger::status::Wait_pre(L2CWeaponElementChanger *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_GROUND_CORRECT_KIND_GROUND);
