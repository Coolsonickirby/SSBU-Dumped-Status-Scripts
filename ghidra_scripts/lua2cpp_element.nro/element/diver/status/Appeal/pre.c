...
void __thiscall
L2CWeaponElementDiver::status::Appeal_pre(L2CWeaponElementDiver *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_GROUND_CORRECT_KIND_GROUND_CLIFF_STOP);
