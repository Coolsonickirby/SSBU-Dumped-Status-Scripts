...
void __thiscall
L2CFighterShulk::status::SpecialSJump_pre(L2CFighterShulk *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,
             _FS_SUCCEEDS_KEEP_EFFECT | _FS_SUCCEEDS_KEEP_ATTACK | FS_SUCCEEDS_KEEP_VISIBILITY |
             _FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_NO_REACTION);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_KEEP_MOTION_RATE);
