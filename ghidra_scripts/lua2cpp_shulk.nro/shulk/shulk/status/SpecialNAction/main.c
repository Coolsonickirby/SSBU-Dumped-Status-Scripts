...
void __thiscall
L2CFighterShulk::status::SpecialNAction_main(L2CFighterShulk *this,L2CValue *return_value)
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        if ((uVar4 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack160);
          lib::L2CValue::_L2CValue(aLStack176);
          if ((uVar4 & 1) == 0) goto LAB_7100017574;
          pLVar3 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
          lib::L2CValue::L2CValue(aLStack112,_SITUATION_KIND_GROUND);
          uVar4 = lib::L2CValue::operator__(pLVar3,aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
...
LAB_7100017574:
  ...
  lib::L2CValue::_L2CValue(aLStack176);
  lib::L2CValue::_L2CValue(aLStack160);
  lib::L2CValue::L2CValue(aLStack272,&DAT_7100017b50);
