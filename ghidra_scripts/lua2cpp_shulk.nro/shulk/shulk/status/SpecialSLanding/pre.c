...
void __thiscall
L2CFighterShulk::status::SpecialSLanding_pre(L2CFighterShulk *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_EFFECT | _FS_SUCCEEDS_KEEP_ATTACK);
