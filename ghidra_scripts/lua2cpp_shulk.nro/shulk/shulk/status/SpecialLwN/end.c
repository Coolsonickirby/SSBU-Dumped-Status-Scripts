...
void __thiscall
L2CFighterShulk::status::SpecialLwN_end(L2CFighterShulk *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_SHULK_STATUS_KIND_SPECIAL_LW_ATTACK);
  uVar5 = lib::L2CValue::operator__(this_00,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  if ((uVar5 & 1) != 0) goto LAB_710000d260;
