...
void __thiscall
L2CFighterShulk::status::SpecialHiAdd_end(L2CFighterShulk *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0x15b879adc2);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack64,&LAB_7100013de0);
