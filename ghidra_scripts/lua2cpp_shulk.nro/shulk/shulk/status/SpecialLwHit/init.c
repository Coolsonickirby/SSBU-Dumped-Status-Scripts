...
void __thiscall
L2CFighterShulk::status::SpecialLwAttack_init(L2CFighterShulk *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack160);
  if ((uVar6 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_SHULK_STATUS_KIND_SPECIAL_LW_HIT);
    uVar6 = lib::L2CValue::operator__(aLStack208,aLStack160);
    lib::L2CValue::_L2CValue(aLStack160);
    if ((uVar6 & 1) == 0) goto LAB_7100002df0;
    lib::L2CValue::L2CValue
              (aLStack160,_FIGHTER_SHULK_INSTANCE_WORK_ID_FLOAT_SPECIAL_LW_ATTACK_POWER);
    ...
    lib::L2CValue::L2CValue(aLStack288,_FIGHTER_SHULK_STATUS_SPECIAL_LW_FLAG_IS_ATTACK_ENEMY);
