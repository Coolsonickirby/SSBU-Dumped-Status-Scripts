...
void __thiscall
L2CFighterShulk::status::SpecialLw_main(L2CFighterShulk *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_SHULK_STATUS_SPECIAL_LW_FLAG_CONTINUE_MOT);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,-1.0);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SHULK_STATUS_SPECIAL_LW_WORK_FLOAT_COUNTER_START_FRAME)
  ;
