...
void __thiscall L2CWeaponDededeStarmissile::SetStatusScripts(L2CWeaponDededeStarmissile *this)

{
  ...
  iVar1 = _WEAPON_DEDEDE_STARMISSILE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DEDEDE_STARMISSILE_STATUS_KIND_FLY);
