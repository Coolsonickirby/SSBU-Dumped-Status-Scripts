...
void __thiscall
L2CWeaponDededeGordo::status::DeadWater_pre(L2CWeaponDededeGordo *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_DEDEDE_GORDO_WATER_DEAD);
