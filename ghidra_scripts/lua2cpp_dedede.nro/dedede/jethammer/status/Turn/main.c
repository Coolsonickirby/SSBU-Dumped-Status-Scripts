...
void __thiscall
L2CWeaponDededeJethammer::status::Turn_main(L2CWeaponDededeJethammer *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x420201547);
  ...
  lib::L2CValue::L2CValue(aLStack80,Turn_main_loop);
