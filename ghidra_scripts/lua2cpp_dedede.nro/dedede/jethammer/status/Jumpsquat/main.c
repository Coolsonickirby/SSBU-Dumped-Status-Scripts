...
void __thiscall
L2CWeaponDededeJethammer::status::Jumpsquat_main
          (L2CWeaponDededeJethammer *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x5d267ef83);
  ...
  lib::L2CValue::L2CValue(aLStack80,Jumpsquat_main_loop);
