...
void __thiscall L2CWeaponDededeStar::SetStatusScripts(L2CWeaponDededeStar *this)

{
  ...
  iVar1 = _WEAPON_DEDEDE_STAR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DEDEDE_STAR_STATUS_KIND_FLY);
