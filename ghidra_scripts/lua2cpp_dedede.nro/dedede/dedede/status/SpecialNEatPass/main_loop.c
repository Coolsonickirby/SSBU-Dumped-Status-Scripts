...
void __thiscall
L2CFighterDedede::status::SpecialNEatPass_main_loop(L2CFighterDedede *this,L2CValue *return_value)
...
LAB_710002e5d0:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_710002e728;
    ...
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_710002e5d0;
