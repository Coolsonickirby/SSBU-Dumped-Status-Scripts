...
void __thiscall
L2CFighterDedede::status::SpecialNEatWaitPass_main_loop
...
LAB_710002e8a0:
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEDEDE_STATUS_KIND_SPECIAL_N_EAT_WAIT_FALL);
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_710002e9f8;
    ...
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_710002e8a0;
