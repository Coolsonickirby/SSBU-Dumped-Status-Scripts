...
void __thiscall
L2CFighterDedede::status::SpecialNEatWaitPass_main(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  app::lua_bind::WorkModule__unable_transition_term_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x12a6bf5418);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  FUN_710002de70(this);
  lib::L2CValue::L2CValue(aLStack144,SpecialNEatWaitPass_main_loop);
