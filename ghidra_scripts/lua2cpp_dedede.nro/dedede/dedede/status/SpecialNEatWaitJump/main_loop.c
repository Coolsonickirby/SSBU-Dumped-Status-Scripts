...
void __thiscall
L2CFighterDedede::status::SpecialNEatWaitJump_main_loop
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) == 0) goto LAB_71000302c0;
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEDEDE_STATUS_KIND_SPECIAL_N_EAT_TURN_AIR);
