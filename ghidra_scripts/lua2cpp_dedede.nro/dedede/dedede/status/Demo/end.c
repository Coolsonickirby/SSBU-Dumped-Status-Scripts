...
void __thiscall L2CFighterDedede::status::Demo_end(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DEDEDE_GENERATE_ARTICLE_JETHAMMER);
