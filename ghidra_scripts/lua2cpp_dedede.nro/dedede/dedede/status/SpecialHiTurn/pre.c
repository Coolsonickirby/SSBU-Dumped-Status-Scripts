...
void __thiscall
L2CFighterDedede::status::SpecialHiTurn_pre(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_DEDEDE_SPECIAL_HI_TURN);
