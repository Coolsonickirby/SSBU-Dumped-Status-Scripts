...
void __thiscall
L2CFighterDedede::status::SpecialNSwallowWait_main(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0x16526015a2);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0x1aa4d5f792);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_710002d750(this);
  lib::L2CValue::L2CValue(aLStack64,SpecialNSwallowWait_main_loop);
