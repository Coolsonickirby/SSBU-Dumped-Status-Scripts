...
void __thiscall
L2CFighterDedede::status::SpecialHiFailure_main(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1205eb0268);
  ...
  FUN_71000263c0(this);
  lib::L2CValue::L2CValue(aLStack80,SpecialHiFailure_main_loop);
