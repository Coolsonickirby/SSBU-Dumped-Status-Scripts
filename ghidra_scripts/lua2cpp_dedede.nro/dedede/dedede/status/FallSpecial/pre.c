...
void __thiscall
L2CFighterDedede::status::FallSpecial_pre(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  if (bVar1) {
    ...
    lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_DEDEDE_SPECIAL_HI_FALL);
