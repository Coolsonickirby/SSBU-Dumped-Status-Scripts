...
void __thiscall
L2CFighterDedede::status::SpecialNEatTurnAir_main(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_710002de70(this);
  lib::L2CValue::L2CValue(aLStack80,SpecialNEatTurnAir_main_loop);
