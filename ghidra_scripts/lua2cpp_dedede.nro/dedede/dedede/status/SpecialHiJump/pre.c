...
void __thiscall
L2CFighterDedede::status::SpecialHiJump_pre(L2CFighterDedede *this,L2CValue *return_value)

{
  ...
  if ((uVar13 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_DEDEDE_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_START_AIR);
