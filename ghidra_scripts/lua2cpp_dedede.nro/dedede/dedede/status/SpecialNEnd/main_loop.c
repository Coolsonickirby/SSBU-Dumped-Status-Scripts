...
void __thiscall
L2CFighterDedede::status::SpecialNEnd_main_loop(L2CFighterDedede *this,L2CValue *return_value)
...
LAB_7100031064:
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar3 & 1) == 0) goto LAB_7100031064;
...
LAB_71000310f8:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100031170;
      goto LAB_7100030fcc;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
