...
void __thiscall
L2CFighterDedede::status::SpecialLwPass_main_loop(L2CFighterDedede *this,L2CValue *return_value)
...
LAB_7100023100:
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DEDEDE_STATUS_JET_HAMMER_TRANSITION_TERM_ID_GROUND);
    iVar3 = lib::L2CValue::as_integer(aLStack96);
    ...
    if ((bVar2 & 1U) == 0) {
LAB_710002326c:
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DEDEDE_STATUS_JET_HAMMER_TRANSITION_TERM_ID_AIR);
      iVar3 = lib::L2CValue::as_integer(aLStack96);
      bVar1 = app::lua_bind::WorkModule__is_enable_transition_term_impl(this->moduleAccessor,iVar3);
      lib::L2CValue::L2CValue(aLStack80,(bool)(bVar1 & 1));
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) == 0) goto LAB_71000233c4;
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEDEDE_STATUS_JET_HAMMER_TRANSITION_TERM_ID_GROUND)
      ;
      iVar3 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__enable_transition_term_impl(this->moduleAccessor,iVar3);
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEDEDE_STATUS_JET_HAMMER_TRANSITION_TERM_ID_AIR);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__enable_transition_term_impl(this->moduleAccessor,iVar3);
    }
    else {
      ...
      uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) == 0) goto LAB_710002326c;
...
LAB_71000233c0:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) goto LAB_7100023100;
  }
LAB_71000233c4:
  iVar3 = 0;
LAB_71000233cc:
