...
void __thiscall
L2CFighterDedede::status::SpecialNEatWait_main_loop(L2CFighterDedede *this,L2CValue *return_value)
...
LAB_71000306f0:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    FUN_710002f940(aLStack80,this);
    bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) != 0) goto LAB_7100030700;
...
LAB_7100030a2c:
      ...
      if ((uVar5 & 1) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar5 & 1) != 0) {
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEDEDE_STATUS_KIND_SPECIAL_N_EAT_WALK);
...
LAB_7100030700:
    ...
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_7100030a2c;
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DEDEDE_STATUS_KIND_SPECIAL_N_EAT_TURN);
    lib::L2CValue::L2CValue(aLStack112,true);
    lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xb0,(L2CValue)0x90);
LAB_7100030b2c:
    pLVar4 = aLStack112;
