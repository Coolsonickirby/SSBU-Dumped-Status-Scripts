...
void __thiscall
L2CFighterGaogaen::status::FinalScene03_main(L2CFighterGaogaen *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_GAOGAEN_STATUS_WORK_ID_FLOAT_FINAL_TRANS_MOVE_START_Y);
  fVar4 = (float)lib::L2CValue::as_number(aLStack96);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
