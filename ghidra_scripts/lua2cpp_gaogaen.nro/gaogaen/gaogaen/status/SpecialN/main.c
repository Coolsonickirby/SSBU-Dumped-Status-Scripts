...
void __thiscall
L2CFighterGaogaen::status::SpecialN_main(L2CFighterGaogaen *this,L2CValue *return_value)

{
  ...
  FUN_7100023ef0(this,aLStack112);
  lib::L2CValue::_L2CValue(aLStack112);
  ...
  if ((uVar5 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack144,false);
    FUN_71000253c0(aLStack128,this,aLStack144);
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
  }
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack96,&DAT_7100025e00);
