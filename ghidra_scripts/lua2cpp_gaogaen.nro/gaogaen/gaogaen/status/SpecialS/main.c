...
void __thiscall
L2CFighterGaogaen::status::SpecialS_main(L2CFighterGaogaen *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack112,_FIGHTER_GAOGAEN_INSTANCE_WORK_ID_INT_BATTLE_OBJECT_ID_SWING_THROWN_FIGHTER)
  ;
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_GAOGAEN_INSTANCE_WORK_ID_FLAG_INVALID_SPECIAL_AIR_S);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  ...
  FUN_710001d4b0(this,aLStack112);
  lib::L2CValue::_L2CValue(aLStack112);
  ...
  if ((uVar7 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack144,false);
    FUN_7100023730(aLStack128,this,aLStack144);
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
  }
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack96,&DAT_7100023970);
  lib::L2CValue::operator_(pLVar6,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_GAOGAEN_CLIFF_HANG_DATA_SPECIAL_S);
