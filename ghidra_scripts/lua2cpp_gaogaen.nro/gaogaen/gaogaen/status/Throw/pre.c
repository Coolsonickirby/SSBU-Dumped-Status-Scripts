...
void __thiscall L2CFighterGaogaen::status::Throw_pre(L2CFighterGaogaen *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_THROW_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_THROW_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_THROW_FLOAT);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_LOG_MASK_FLAG_THROW | _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP);
  lib::L2CValue::L2CValue
            (aLStack232,
             _FIGHTER_STATUS_ATTR_HIDE_NAME_CURSOR | FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_POWER_UP_ATTACK_BIT_THROW);
  lib::L2CValue::L2CValue(aLStack264,0);
