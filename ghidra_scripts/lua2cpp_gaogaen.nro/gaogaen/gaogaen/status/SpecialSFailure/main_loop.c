...
void __thiscall
L2CFighterGaogaen::status::SpecialSFailure_main_loop(L2CFighterGaogaen *this,L2CValue *return_value)
...
LAB_7100020bcc:
      ...
      if ((bVar1 & 1U) == 0) {
        ...
        if ((uVar4 & 1) == 0) {
          ...
          uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar4 & 1) == 0) goto LAB_7100020d84;
...
LAB_7100020d84:
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar4 & 1) != 0) goto LAB_7100020bcc;
    }
  }
  iVar7 = 1;
LAB_7100020ed4:
