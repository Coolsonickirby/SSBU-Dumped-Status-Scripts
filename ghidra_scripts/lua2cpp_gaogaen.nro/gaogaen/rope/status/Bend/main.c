...
void __thiscall
L2CWeaponGaogaenRope::status::Bend_main(L2CWeaponGaogaenRope *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x44fd60a37);
  ...
  lib::L2CValue::L2CValue(aLStack80,Bend_main_loop);
