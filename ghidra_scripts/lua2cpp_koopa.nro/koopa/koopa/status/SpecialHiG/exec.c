...
void __thiscall
L2CFighterKoopa::status::SpecialHiG_exec(L2CFighterKoopa *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_KOOPA_STATUS_SPECIAL_HI_FLAG1);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack160,_FIGHTER_KOOPA_STATUS_SPECIAL_HI_FLAG1SET);
