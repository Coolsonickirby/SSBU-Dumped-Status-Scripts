...
void __thiscall L2CFighterKoopa::status::SpecialLw_pre(L2CFighterKoopa *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KOOPA_STATUS_KIND_SPECIAL_LW_G);
    iVar1 = lib::L2CValue::as_integer(aLStack64);
    app::lua_bind::StatusModule__set_status_kind_interrupt_impl(this->moduleAccessor,iVar1);
  }
  lib::L2CValue::_L2CValue(aLStack64);
