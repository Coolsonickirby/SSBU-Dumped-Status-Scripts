...
void __thiscall
L2CWeaponSzerosuitParalyzer::status::Shoot_main_loop
...

{
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    uVar5 = lib::L2CValue::operator_(aLStack64,pLVar6);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((bVar1 & 1U) != 0) {
        lib::L2CValue::L2CValue(aLStack64,_WEAPON_SZEROSUIT_PARALYZER_BULLET_STATUS_KIND_END);
