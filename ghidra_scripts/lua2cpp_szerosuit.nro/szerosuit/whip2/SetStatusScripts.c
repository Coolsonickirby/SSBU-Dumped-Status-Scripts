...
void __thiscall L2CWeaponSzerosuitWhip2::SetStatusScripts(L2CWeaponSzerosuitWhip2 *this)

{
  ...
  iVar1 = _WEAPON_SZEROSUIT_WHIP2_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SZEROSUIT_WHIP2_STATUS_KIND_WAIT);
