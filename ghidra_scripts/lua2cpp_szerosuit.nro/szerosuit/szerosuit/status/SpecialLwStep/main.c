...
void __thiscall
L2CFighterSzerosuit::status::SpecialLwStep_main(L2CFighterSzerosuit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x13cc766ced);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwStep_main_loop);
