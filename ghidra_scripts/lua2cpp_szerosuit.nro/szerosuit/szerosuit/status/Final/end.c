...
void __thiscall
L2CFighterSzerosuit::status::Final_end(L2CFighterSzerosuit *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    pLVar3 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0xb);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_SZEROSUIT_STATUS_KIND_FINAL_LOCK_ON);
    uVar4 = lib::L2CValue::operator__(pLVar3,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) == 0) {
