...
void __thiscall
L2CFighterSzerosuit::status::SpecialLwKickLanding_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1754fde924);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwKickLanding_main_loop);
