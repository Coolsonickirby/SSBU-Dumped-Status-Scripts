...
void __thiscall
L2CFighterSzerosuit::status::AirLassoFailure_main(L2CFighterSzerosuit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710000b6d0);
  lib::L2CValue::L2CValue(aLStack80,0x9e7d3cd80);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_SZEROSUIT_WHIP2_STATUS_KIND_REWIND);
