...
void __thiscall
L2CFighterSzerosuit::status::SpecialNLanding_main(L2CFighterSzerosuit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialNLanding_main_loop);
