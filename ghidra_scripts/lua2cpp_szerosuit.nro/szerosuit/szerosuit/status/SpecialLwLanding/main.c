...
void __thiscall
L2CFighterSzerosuit::status::SpecialLwLanding_main(L2CFighterSzerosuit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwLanding_main_loop);
