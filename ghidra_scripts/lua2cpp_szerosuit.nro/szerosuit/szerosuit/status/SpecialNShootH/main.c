...
void __thiscall
L2CFighterSzerosuit::status::SpecialNShootH_main(L2CFighterSzerosuit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,0xc1902f2de);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialNShootH_main_loop);
