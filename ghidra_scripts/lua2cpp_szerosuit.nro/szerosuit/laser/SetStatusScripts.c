...
void __thiscall L2CWeaponSzerosuitLaser::SetStatusScripts(L2CWeaponSzerosuitLaser *this)

{
  ...
  iVar1 = _WEAPON_SZEROSUIT_LASER_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SZEROSUIT_LASER_STATUS_KIND_SHOOT);
