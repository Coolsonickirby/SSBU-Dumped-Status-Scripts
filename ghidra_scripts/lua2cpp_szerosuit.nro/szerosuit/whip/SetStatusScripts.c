...
void __thiscall L2CWeaponSzerosuitWhip::SetStatusScripts(L2CWeaponSzerosuitWhip *this)

{
  ...
  iVar1 = _WEAPON_SZEROSUIT_WHIP_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SZEROSUIT_WHIP_STATUS_KIND_WAIT);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SZEROSUIT_WHIP_STATUS_KIND_PULL);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
