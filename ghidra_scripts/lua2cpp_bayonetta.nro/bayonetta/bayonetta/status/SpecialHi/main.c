...
void __thiscall
L2CFighterBayonetta::status::SpecialHi_main(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue
              (aLStack112,_FIGHTER_BAYONETTA_STATUS_WORK_ID_SPECIAL_HI_FLAG_SITUATION_KEEP);
