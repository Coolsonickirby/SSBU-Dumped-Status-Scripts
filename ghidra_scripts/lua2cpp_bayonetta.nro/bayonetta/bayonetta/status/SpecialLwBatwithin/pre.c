...
void __thiscall
L2CFighterBayonetta::status::SpecialLwBatwithin_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_BATWITHIN_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_BATWITHIN_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_BATWITHIN_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_BAYONETTA_BATWITHIN_STATUS_ATTR);
