...
void __thiscall
L2CFighterBayonetta::status::Final_main(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_EFFECT_SCREEN_NO_FINAL_BG);
  iVar3 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::EffectModule__reset_screen_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_EFFECT_SCREEN_NO_FINAL_FLASH);
  iVar3 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::EffectModule__reset_screen_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::_L2CValue(aLStack80);
