...
void __thiscall
L2CFighterBayonetta::status::FinalEndAfter_main_loop
...

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_7100023270;
    }
    iVar4 = 1;
    goto LAB_71000235dc;
  }
...
LAB_71000232ec:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) goto LAB_710002335c;
    }
  }
  else {
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    ...
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_71000232ec;
LAB_710002335c:
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue
                (aLStack112,_FIGHTER_BAYONETTA_STATUS_WORK_ID_FINAL_INT_AIR_MOTION_KIND);
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue
                (aLStack112,_FIGHTER_BAYONETTA_STATUS_WORK_ID_FINAL_INT_GROUND_MOTION_KIND);
      iVar4 = lib::L2CValue::as_integer(aLStack112);
      lVar7 = app::lua_bind::WorkModule__get_int64_impl(this->moduleAccessor,iVar4);
      lib::L2CValue::L2CValue(aLStack80,lVar7);
      HVar8 = lib::L2CValue::as_hash(aLStack80);
