...
void __thiscall
L2CFighterBayonetta::status::SpecialHiJump_pre(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_BAYONETTA_SPECIAL_HI_JUMP);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_SPECIAL_HI_FLOAT);
  lib::L2CValue::L2CValue
            (aLStack248,
             _FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_ATTACK | FS_SUCCEEDS_KEEP_VISIBILITY |
             _FS_SUCCEEDS_KEEP_EFFECT);
  ...
  lib::L2CValue::_L2CValue(aLStack136);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_BAYONETTA_INSTANCE_WORK_ID_FLAG_SHOOTING_KEEP);
