...
void __thiscall
L2CFighterBayonetta::status::SpecialSHoldEnd_main(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSHoldEnd_main_loop);
