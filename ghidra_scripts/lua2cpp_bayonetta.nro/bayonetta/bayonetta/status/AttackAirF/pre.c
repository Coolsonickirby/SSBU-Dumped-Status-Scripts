...
void __thiscall
L2CFighterBayonetta::status::AttackAirF_pre(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_BAYONETTA_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_F_FLOAT);
