...
void __thiscall
L2CFighterBayonetta::status::SpecialAirSDHit_pre(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_BAYONETTA_SPECIAL_AIR_S_D_HIT);
