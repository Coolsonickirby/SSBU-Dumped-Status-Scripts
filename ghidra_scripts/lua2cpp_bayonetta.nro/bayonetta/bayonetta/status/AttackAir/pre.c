...
void __thiscall
L2CFighterBayonetta::status::AttackAir_pre(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  iVar6 = app::lua_bind::ControlModule__get_attack_air_kind_impl(this->moduleAccessor);
  ...
  if (bVar1) {
    ...
    lib::L2CValue::L2CValue(aLStack200,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_FLAG);
    lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_INT);
    lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_AIR_FLOAT);
    ...
    lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_NONE);
    lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_CLEAR_MOTION_ENERGY);
    lib::L2CValue::L2CValue(aLStack232,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_AIR);
    lib::L2CValue::L2CValue(aLStack248,0);
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_BAYONETTA_STATUS_KIND_ATTACK_AIR_F);
