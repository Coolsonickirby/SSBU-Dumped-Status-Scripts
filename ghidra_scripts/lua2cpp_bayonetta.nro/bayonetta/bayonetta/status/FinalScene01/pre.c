...
void __thiscall
L2CFighterBayonetta::status::FinalScene01_pre(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_FINAL | _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP
             | _FIGHTER_LOG_MASK_FLAG_NO_FINAL);
  lib::L2CValue::L2CValue
            (aLStack216,
  ...
  lib::L2CValue::_L2CValue(aLStack136);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack136,0x2512c932cf);
  lib::L2CValue::L2CValue
            (aLStack152,
             _FIGHTER_SPECIFIC_STATUS_METAL | _FIGHTER_SPECIFIC_STATUS_SCALE |
             _FIGHTER_SPECIFIC_STATUS_CURRY | _FIGHTER_SPECIFIC_STATUS_FLOWER |
             _FIGHTER_SPECIFIC_STATUS_HEAD_MUSHROOM);
