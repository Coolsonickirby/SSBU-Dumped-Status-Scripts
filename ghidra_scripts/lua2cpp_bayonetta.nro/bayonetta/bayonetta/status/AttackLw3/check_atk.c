...
void __thiscall
L2CFighterBayonetta::status::AttackLw3_check_atk(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lua2cpp::L2CFighterCommon::FighterStatusUniqProcessAttackLw3_check_attack
