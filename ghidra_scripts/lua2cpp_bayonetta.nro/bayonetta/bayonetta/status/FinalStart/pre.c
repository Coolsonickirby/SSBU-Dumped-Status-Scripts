...
void __thiscall
L2CFighterBayonetta::status::FinalStart_pre(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_RUMBLE);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_LOG_MASK_FLAG_NO_FINAL | _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_FINAL);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_ATTR_FINAL | FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT);
