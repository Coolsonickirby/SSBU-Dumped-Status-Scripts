...
void __thiscall
L2CFighterBayonetta::status::SpecialS_main(L2CFighterBayonetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KINETIC_TYPE_BAYONETTA_SPECIAL_S);
