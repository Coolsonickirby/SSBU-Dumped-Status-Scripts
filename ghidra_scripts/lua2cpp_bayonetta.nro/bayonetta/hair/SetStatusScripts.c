...
void __thiscall L2CWeaponBayonettaHair::SetStatusScripts(L2CWeaponBayonettaHair *this)

{
  ...
  iVar1 = _WEAPON_BAYONETTA_HAIR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_BAYONETTA_HAIR_STATUS_KIND_FINAL_VISUAL_SCENE01);
