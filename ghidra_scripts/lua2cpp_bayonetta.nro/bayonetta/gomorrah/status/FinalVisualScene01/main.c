...
void __thiscall
L2CWeaponBayonettaGomorrah::status::FinalVisualScene01_main
          (L2CWeaponBayonettaGomorrah *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,FinalVisualScene01_main_loop);
