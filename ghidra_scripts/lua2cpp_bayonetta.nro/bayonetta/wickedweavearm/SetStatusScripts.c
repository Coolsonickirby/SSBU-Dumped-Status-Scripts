...
void __thiscall
L2CWeaponBayonettaWickedweavearm::SetStatusScripts(L2CWeaponBayonettaWickedweavearm *this)

{
  ...
  iVar1 = _WEAPON_BAYONETTA_WICKEDWEAVEARM_STATUS_KIND_NUM;
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::AttackS4_end);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_BAYONETTA_WICKEDWEAVEARM_STATUS_KIND_ATTACK_HI4);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::AttackHi4_pre);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_BAYONETTA_WICKEDWEAVEARM_STATUS_KIND_ATTACK_HI4);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_STATUS_MAIN);
