...
void __thiscall L2CWeaponKenShinryuken::SetStatusScripts(L2CWeaponKenShinryuken *this)

{
  ...
  iVar1 = _WEAPON_KEN_SHINRYUKEN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KEN_SHINRYUKEN_STATUS_KIND_FINAL);
