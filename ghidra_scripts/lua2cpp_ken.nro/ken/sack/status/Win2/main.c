...
void __thiscall L2CWeaponKenSack::status::Win2_main(L2CWeaponKenSack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x4a303a03f);
  ...
  lib::L2CValue::L2CValue(aLStack80,Win2_main_loop);
