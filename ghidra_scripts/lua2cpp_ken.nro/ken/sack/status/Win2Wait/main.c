...
void __thiscall
L2CWeaponKenSack::status::Win2Wait_main(L2CWeaponKenSack *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x9c9bd94df);
  ...
  lib::L2CValue::L2CValue(aLStack80,Win2Wait_main_loop);
