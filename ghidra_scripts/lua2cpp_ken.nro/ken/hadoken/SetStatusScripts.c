...
void __thiscall L2CWeaponKenHadoken::SetStatusScripts(L2CWeaponKenHadoken *this)

{
  ...
  iVar1 = _WEAPON_RYU_HADOKEN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_RYU_HADOKEN_STATUS_KIND_MOVE);
