...
void __thiscall L2CFighterKen::status::AttackDash_main(L2CFighterKen *this,L2CValue *return_value)

{
  ...
  FUN_7100020f10(aLStack96,this,aLStack112);
  ...
  lib::L2CValue::L2CValue(aLStack96,&DAT_7100020fe0);
