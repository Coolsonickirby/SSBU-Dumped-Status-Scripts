...
void __thiscall L2CFighterKen::status::AttackNear_pre(L2CFighterKen *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,FIGHTER_KINETIC_TYPE_MOTION);
  lib::L2CValue::L2CValue(aLStack152,_GROUND_CORRECT_KIND_GROUND_CLIFF_STOP_ATTACK);
  lib::L2CValue::L2CValue(aLStack168,GROUND_CLIFF_CHECK_KIND_NONE);
  lib::L2CValue::L2CValue(aLStack184,true);
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_NEAR_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_NEAR_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ATTACK_NEAR_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP);
  lib::L2CValue::L2CValue(aLStack216,0);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_3);
  lib::L2CValue::L2CValue(aLStack248,0);
