...
void __thiscall
L2CFighterKen::status::DashBack_main_loop(L2CFighterKen *this,L2CValue *return_value)
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((bVar1 & 1) != 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack208);
        lib::L2CValue::_L2CValue(aLStack192);
        if ((uVar6 & 1) == 0) goto LAB_71000270b4;
      }
      else {
        lib::L2CValue::_L2CValue(aLStack160);
        lib::L2CValue::_L2CValue(aLStack208);
...
LAB_7100027bf4:
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack208);
      lib::L2CValue::_L2CValue(aLStack160);
      if ((uVar6 & 1) == 0) goto LAB_7100028010;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack160);
    }
