...
void __thiscall
L2CFighterKen::status::WalkBack_main_loop(L2CFighterKen *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack176,&DAT_7100029450);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_7100029260;
