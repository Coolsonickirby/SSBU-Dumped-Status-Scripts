...
void __thiscall L2CFighterKen::status::Final2_init(L2CFighterKen *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          if ((uVar5 & 1) != 0) {
            ...
            FUN_710000fa20(this,aLStack488);
        ...
        FUN_710000fa20(this,aLStack472);
        pLVar7 = aLStack472;
      }
      else {
      ...
      FUN_710000fa20(this,aLStack360);
      pLVar7 = aLStack360;
    }
  }
  else {
    ...
    FUN_710000fa20(this,aLStack328);
