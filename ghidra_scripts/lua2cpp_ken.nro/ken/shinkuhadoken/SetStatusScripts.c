...
void __thiscall L2CWeaponKenShinkuhadoken::SetStatusScripts(L2CWeaponKenShinkuhadoken *this)

{
  ...
  iVar1 = _WEAPON_RYU_SHINKUHADOKEN_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_RYU_SHINKUHADOKEN_STATUS_KIND_MOVE);
