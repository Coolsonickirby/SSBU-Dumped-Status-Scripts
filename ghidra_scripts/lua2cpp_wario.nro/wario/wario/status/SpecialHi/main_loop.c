...
void __thiscall
L2CFighterWario::status::SpecialHi_main_loop(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_WARIO_STATUS_KIND_SPECIAL_HI_JUMP);
