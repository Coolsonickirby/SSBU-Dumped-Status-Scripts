...
void __thiscall
L2CFighterWario::status::SpecialNBomb_main_loop(L2CFighterWario *this,L2CValue *return_value)
...
LAB_71000144d4:
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar3 & 1) == 0) goto LAB_71000144d4;
...
LAB_7100014568:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71000145a8;
      goto LAB_710001443c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
