...
void __thiscall
L2CFighterWario::status::SpecialSEscapeStart_main(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_WARIO_LINK_NO_BIKE);
  lib::L2CValue::L2CValue(aLStack96,0x1f9a545917);
