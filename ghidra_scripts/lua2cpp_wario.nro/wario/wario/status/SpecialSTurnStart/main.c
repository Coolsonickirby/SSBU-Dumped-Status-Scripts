...
void __thiscall
L2CFighterWario::status::SpecialSTurnStart_main(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x14cf68081d);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSTurnStart_main_loop);
