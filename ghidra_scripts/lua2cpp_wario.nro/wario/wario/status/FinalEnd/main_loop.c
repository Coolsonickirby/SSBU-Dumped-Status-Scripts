...
void __thiscall
L2CFighterWario::status::FinalEnd_main_loop(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_71000065f0;
    }
    iVar5 = 1;
    goto LAB_7100006ab0;
  }
...
LAB_71000066b0:
      ...
      if ((uVar6 & 1) == 0) {
        ...
        uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar6 & 1) != 0) goto LAB_7100006720;
      }
    }
    else {
      pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar1,0x16);
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar6 & 1) == 0) goto LAB_71000066b0;
LAB_7100006720:
      pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar1,0x16);
      lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
  ...
  if ((uVar6 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar6 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack80,_GROUND_CORRECT_KIND_AIR_PASSABLE_OFF);
      GVar4 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::GroundModule__correct_impl(this->moduleAccessor,GVar4);
    }
    else {
  ...
  if ((bVar3 & 1U) == 0) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_WARIO_FINAL_MODULE_END_EXEC);
      pFVar9 = (Fighter *)lib::L2CValue::as_pointer(pLVar7);
      iVar5 = lib::L2CValue::as_integer(aLStack80);
      app::FighterSpecializer_Wario::call_final_module(pFVar9,iVar5);
      goto LAB_7100006aa0;
    }
  }
  else {
