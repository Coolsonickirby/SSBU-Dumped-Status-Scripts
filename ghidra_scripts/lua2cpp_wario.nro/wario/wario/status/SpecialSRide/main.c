...
void __thiscall
L2CFighterWario::status::SpecialSRide_main(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_WARIO_GENERATE_ARTICLE_WARIOBIKE);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_WARIO_WARIOBIKE_STATUS_KIND_SPECIAL_S_RIDE);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_7100011c80(this);
  lib::L2CValue::L2CValue(aLStack64,SpecialSRide_main_loop);
