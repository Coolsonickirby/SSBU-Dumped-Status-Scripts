...
void __thiscall
L2CFighterWario::status::FinalScene_main(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x12035b61d5);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIND_WARIO);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_WARIO_FINAL_MODULE_SCENE_01_INIT);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,FinalScene_main_loop);
