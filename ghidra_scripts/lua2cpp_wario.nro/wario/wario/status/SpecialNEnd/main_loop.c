...
void __thiscall
L2CFighterWario::status::SpecialNEnd_main_loop(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) != 0) goto LAB_7100015eec;
    }
    iVar5 = 1;
    goto LAB_7100016060;
  }
...
LAB_7100015f84:
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar3 & 1) == 0) goto LAB_7100015f84;
