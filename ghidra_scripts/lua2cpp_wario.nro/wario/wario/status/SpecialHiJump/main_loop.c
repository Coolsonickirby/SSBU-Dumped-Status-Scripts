...
void __thiscall
L2CFighterWario::status::SpecialHiJump_main_loop(L2CFighterWario *this,L2CValue *return_value)
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((uVar3 & 1) != 0) {
      ...
      if ((uVar3 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack128);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar3 & 1) != 0) goto LAB_710000ef20;
      }
      iVar5 = 1;
      goto LAB_710000f0ec;
    }
...
LAB_710000f088:
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar3 & 1) != 0) goto LAB_710000f088;
LAB_710000f0d0:
        iVar5 = 1;
      }
