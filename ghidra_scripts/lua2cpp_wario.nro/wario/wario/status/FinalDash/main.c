...
void __thiscall
L2CFighterWario::status::FinalDash_main(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_WARIO_STATUS_FINAL_WORK_INT_DASH_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  ...
  iVar2 = app::lua_bind::WorkModule__get_param_int_impl(this->moduleAccessor,uVar5,uVar6);
  lib::L2CValue::L2CValue(aLStack96,iVar2);
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_WARIO_STATUS_FINAL_WORK_INT_DASH_CLIFF_CHECK_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  iVar3 = lib::L2CValue::as_integer(aLStack176);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar2,iVar3);
  lib::L2CValue::_L2CValue(aLStack176);
