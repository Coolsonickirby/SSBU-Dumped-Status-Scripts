...
void __thiscall L2CFighterWario::status::FinalDash_pre(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,
             FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_ATTACK |
             _FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE);
