...
void __thiscall
L2CFighterWario::status::SpecialSEscape_main_loop(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_7100010350;
    }
    iVar5 = 1;
    goto LAB_71000105c4;
  }
...
LAB_71000103f8:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) != 0) {
      bVar1 = app::lua_bind::AreaModule__is_water_impl(this->moduleAccessor);
      lib::L2CValue::L2CValue(aLStack96,(bool)(bVar1 & 1));
      lib::L2CValue::L2CValue(aLStack80,true);
      uVar3 = lib::L2CValue::operator__(aLStack96,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
...
LAB_710001052c:
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_7100010574;
      iVar5 = 0;
    }
    else {
      lib::L2CValue::L2CValue(aLStack96,0);
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_710001052c;
LAB_7100010574:
      iVar5 = 1;
    }
    ...
    lib::L2CValue::L2CValue(aLStack80,13.0);
    uVar3 = lib::L2CValue::operator_(aLStack80,pLVar4);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_71000103f8;
