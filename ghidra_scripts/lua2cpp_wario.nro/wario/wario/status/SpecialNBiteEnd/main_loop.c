...
void __thiscall
L2CFighterWario::status::SpecialNBiteEnd_main_loop(L2CFighterWario *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71000151c0;
    }
    iVar5 = 1;
    goto LAB_7100015404;
  }
...
LAB_71000153a0:
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_71000153e8;
      iVar5 = 0;
    }
    else {
      lib::L2CValue::L2CValue(aLStack96,0);
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71000153a0;
LAB_71000153e8:
      iVar5 = 1;
    }
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_7100015258;
