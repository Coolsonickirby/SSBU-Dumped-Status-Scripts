...
void __thiscall
L2CWeaponDuckhuntFinalenemy::status::DamageSlow_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xbbceae797);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        uVar5 = lib::L2CValue::operator__(aLStack80,aLStack96);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar5 & 1) == 0) goto LAB_7100029188;
...
LAB_7100029188:
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,DamageSlow_main_loop);
