...
void __thiscall L2CWeaponDuckhuntReticle::SetStatusScripts(L2CWeaponDuckhuntReticle *this)

{
  ...
  iVar1 = _WEAPON_DUCKHUNT_RETICLE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DUCKHUNT_RETICLE_STATUS_KIND_MOVE);
