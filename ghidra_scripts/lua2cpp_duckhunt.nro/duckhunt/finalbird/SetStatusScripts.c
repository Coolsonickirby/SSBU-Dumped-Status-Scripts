...
void __thiscall L2CWeaponDuckhuntFinalbird::SetStatusScripts(L2CWeaponDuckhuntFinalbird *this)

{
  ...
  iVar1 = _WEAPON_DUCKHUNT_FINALBIRD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DUCKHUNT_FINALBIRD_STATUS_KIND_FLY);
