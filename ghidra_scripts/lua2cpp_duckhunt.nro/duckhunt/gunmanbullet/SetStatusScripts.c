...
void __thiscall L2CWeaponDuckhuntGunmanbullet::SetStatusScripts(L2CWeaponDuckhuntGunmanbullet *this)

{
  ...
  iVar1 = _WEAPON_DUCKHUNT_GUNMANBULLET_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DUCKHUNT_GUNMANBULLET_STATUS_KIND_MOVE);
