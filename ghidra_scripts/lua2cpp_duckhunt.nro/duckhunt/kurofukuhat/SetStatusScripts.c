...
void __thiscall L2CWeaponDuckhuntKurofukuhat::SetStatusScripts(L2CWeaponDuckhuntKurofukuhat *this)

{
  ...
  iVar1 = _WEAPON_DUCKHUNT_KUROFUKUHAT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DUCKHUNT_KUROFUKUHAT_STATUS_KIND_MOVE);
