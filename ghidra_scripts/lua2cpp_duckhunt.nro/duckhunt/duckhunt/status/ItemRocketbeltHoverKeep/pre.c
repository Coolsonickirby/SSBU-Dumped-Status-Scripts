...
void __thiscall
L2CFighterDuckhunt::status::ItemRocketbeltHoverKeep_pre
          (L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_INTO_DOOR | _FIGHTER_STATUS_ATTR_ENABLE_ROCKETBELT_EJECT);
