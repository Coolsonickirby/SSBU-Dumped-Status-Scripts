...
void __thiscall
L2CFighterDuckhunt::status::SpecialS_main_loop(L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) != 0) goto LAB_71000121b0;
...
LAB_71000121b0:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) == 0) goto LAB_71000121b0;
  }
  ...
  if ((bVar1 & 1U) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_710001259c;
