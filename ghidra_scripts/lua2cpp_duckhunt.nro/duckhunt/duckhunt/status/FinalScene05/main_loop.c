...
void __thiscall
L2CFighterDuckhunt::status::FinalScene05_main_loop(L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x103cbd7127);
  ...
  if ((uVar2 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0x330b2445ea);
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_DUCKHUNT_STATUS_KIND_FINAL_END);
