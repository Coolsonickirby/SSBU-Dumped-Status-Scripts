...
void __thiscall
L2CFighterDuckhunt::status::SpecialLw_init(L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack144,0x11b3d4c151);
  ...
  lib::L2CValue::L2CValue(aLStack160,0x11c4d3f1c7);
  ...
  if ((uVar2 & 1) != 0) {
    ...
    lib::L2CValue::L2CValue(aLStack176,0x15e8084353);
