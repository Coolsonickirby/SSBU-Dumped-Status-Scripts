...
void __thiscall
L2CFighterDuckhunt::status::SpecialLw_pre(L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_DUCKHUNT_GENERATE_ARTICLE_GUNMAN);
  ...
  if ((bVar2 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_DUCKHUNT_INSTANCE_WORK_ID_FLAG_GUNMAN_OK);
