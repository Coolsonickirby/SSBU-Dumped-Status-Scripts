...
void __thiscall
L2CFighterDuckhunt::status::FinalScene04_main_loop(L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x109aca7a93);
  ...
  if ((uVar2 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_DUCKHUNT_STATUS_KIND_FINAL_SCENE05);
