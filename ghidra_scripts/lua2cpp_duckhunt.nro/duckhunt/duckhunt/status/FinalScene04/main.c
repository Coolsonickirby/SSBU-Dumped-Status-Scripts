...
void __thiscall
L2CFighterDuckhunt::status::FinalScene04_main(L2CFighterDuckhunt *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DUCKHUNT_GENERATE_ARTICLE_FINALGUNMAN);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_DUCKHUNT_FINALGUNMAN_STATUS_KIND_SCENE04);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xef7800461);
