...
void __thiscall L2CWeaponDuckhuntFinalduck::SetStatusScripts(L2CWeaponDuckhuntFinalduck *this)

{
  ...
  iVar1 = _WEAPON_DUCKHUNT_FINALDUCK_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_DUCKHUNT_FINALDUCK_STATUS_KIND_START);
