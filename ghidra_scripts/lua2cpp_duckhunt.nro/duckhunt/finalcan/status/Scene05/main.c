...
void __thiscall
L2CWeaponDuckhuntFinalcan::status::Scene05_main
          (L2CWeaponDuckhuntFinalcan *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa50f50de5);
  ...
  lib::L2CValue::L2CValue(aLStack80,Scene05_main_loop);
