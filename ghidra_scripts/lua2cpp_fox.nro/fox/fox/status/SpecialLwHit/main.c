...
void __thiscall L2CFighterFox::status::SpecialLwHit_main(L2CFighterFox *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_FOX_REFLECTOR_STATUS_WORK_ID_FLAG_HIT_TO_RESTART);
