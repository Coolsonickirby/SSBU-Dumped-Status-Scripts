...
void __thiscall L2CFighterFox::status::SpecialLwLoop_pre(L2CFighterFox *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_FOX_REFLECTOR_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_FOX_REFLECTOR_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_FOX_REFLECTOR_FLOAT);
