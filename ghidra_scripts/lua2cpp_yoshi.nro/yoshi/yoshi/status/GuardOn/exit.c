...
void __thiscall L2CFighterYoshi::status::GuardOn_exit(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::sub_ftStatusUniqProcessGuardOn_exitStatus_common(this);
