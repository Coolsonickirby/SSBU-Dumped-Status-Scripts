...
void __thiscall L2CFighterYoshi::status::FinalEnd_main(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_VISUAL_SCENE_MODULE_END_INIT);
  pFVar6 = (Fighter *)lib::L2CValue::as_pointer(pLVar3);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_Yoshi::call_final_module(pFVar6,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
