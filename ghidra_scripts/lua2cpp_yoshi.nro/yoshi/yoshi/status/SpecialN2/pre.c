...
void __thiscall L2CFighterYoshi::status::SpecialN2_pre(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_DISABLE_CURRY_FACE);
