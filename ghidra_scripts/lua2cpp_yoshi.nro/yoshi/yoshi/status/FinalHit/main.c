...
void __thiscall L2CFighterYoshi::status::FinalHit_main(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_YOSHI_STATUS_FINAL_WORK_INT_DASH_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_YOSHI_STATUS_FINAL_WORK_FLOAT_START_X);
  ...
  lib::L2CValue::operator_(aLStack112,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_YOSHI_STATUS_FINAL_WORK_FLOAT_START_Y);
  fVar6 = (float)lib::L2CValue::as_number(aLStack96);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::WorkModule__set_float_impl(this->moduleAccessor,fVar6,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
