...
void __thiscall
L2CFighterYoshi::status::FinalScene01_main(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_YOSHI_STATUS_FINAL_WORK_INT_CHANGE_MOTION_TARGET);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_YOSHI_STATUS_FINAL_WORK_FLOAT_CHANGE_SCALE_TARGET);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIND_YOSHI);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_YOSHI_GENERATE_ARTICLE_YOSHIMOB);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_VISUAL_SCENE_MODULE_SCENE_01_INIT);
  pFVar7 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Yoshi::call_final_module(pFVar7,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
