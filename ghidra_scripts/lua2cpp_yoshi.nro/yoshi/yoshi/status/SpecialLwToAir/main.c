...
void __thiscall
L2CFighterYoshi::status::SpecialLwToAir_main(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  app::lua_bind::MotionModule__set_frame_impl(this->moduleAccessor,fVar6,true);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_YOSHI_STATUS_SPECIAL_LW_WORK_INT_COUNT);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    FUN_710001e980(aLStack96,this,aLStack112);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack80,&DAT_710001eb20);
  lib::L2CValue::operator_(this_00,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialLwToAir_main_loop);
