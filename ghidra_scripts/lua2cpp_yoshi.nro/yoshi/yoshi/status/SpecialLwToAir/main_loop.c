...
void __thiscall
L2CFighterYoshi::status::SpecialLwToAir_main_loop(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((uVar4 & 1) != 0) goto LAB_710001eccc;
...
LAB_710001ee64:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
    if ((uVar4 & 1) == 0) goto LAB_710001ee64;
