...
void __thiscall L2CFighterYoshi::status::SpecialLw_pre(L2CFighterYoshi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_INSTANCE_WORK_ID_INT_CUSTOMIZE_SPECIAL_LW_NO);
  iVar5 = lib::L2CValue::as_integer(aLStack168);
  iVar5 = app::lua_bind::WorkModule__get_int_impl(this->moduleAccessor,iVar5);
  lib::L2CValue::L2CValue(aLStack120,iVar5);
  ...
  uVar13 = lib::L2CValue::operator__(aLStack120,aLStack136);
  lib::L2CValue::_L2CValue(aLStack120);
  if ((uVar13 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack120,0);
    uVar13 = lib::L2CValue::operator__(aLStack120,aLStack136);
    lib::L2CValue::_L2CValue(aLStack120);
    if ((uVar13 & 1) == 0) goto LAB_710000f978;
  }
  lib::L2CValue::L2CValue
            (aLStack120,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_LW |
...
LAB_710000f978:
  ...
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_KINETIC_TYPE_MOTION_AIR_ANGLE);
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_ATTR_START_TURN);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_LW);
