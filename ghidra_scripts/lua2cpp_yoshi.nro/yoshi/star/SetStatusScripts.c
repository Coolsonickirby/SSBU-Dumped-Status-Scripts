...
void __thiscall L2CWeaponYoshiStar::SetStatusScripts(L2CWeaponYoshiStar *this)

{
  ...
  iVar1 = _WEAPON_YOSHI_STAR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_YOSHI_STAR_STATUS_KIND_MOVE);
