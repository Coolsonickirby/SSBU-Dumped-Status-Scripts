...
void __thiscall
L2CFighterDonkey::status::SuperLiftJump_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xf7bf84149);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SuperLiftJump_main_loop);
