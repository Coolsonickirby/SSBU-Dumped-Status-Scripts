...
void __thiscall
L2CFighterDonkey::status::SpecialNAttack_main_loop(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar6 & 1) != 0) goto LAB_710000ee60;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack112);
LAB_710000ee60:
...
LAB_710000f88c:
    ...
    if ((uVar6 & 1) == 0) {
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) == 0) goto LAB_710000f88c;
...
LAB_710000f87c:
    ...
    lib::L2CValue::_L2CValue(aLStack160);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((uVar6 & 1) != 0) goto LAB_710000f764;
  }
  iVar4 = 1;
LAB_710000f894:
