...
void __thiscall
L2CFighterDonkey::status::ShoulderFall_pre(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE);
