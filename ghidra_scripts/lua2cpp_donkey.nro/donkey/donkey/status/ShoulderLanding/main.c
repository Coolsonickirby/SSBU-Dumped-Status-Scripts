...
void __thiscall
L2CFighterDonkey::status::ShoulderLanding_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1030ae21c7);
  ...
  lib::L2CValue::L2CValue(aLStack80,ShoulderLanding_main_loop);
