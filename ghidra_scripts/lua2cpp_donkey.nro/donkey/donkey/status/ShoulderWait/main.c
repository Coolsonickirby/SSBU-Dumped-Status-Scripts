...
void __thiscall
L2CFighterDonkey::status::ShoulderWait_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0xd62237786);
  ...
  lib::L2CValue::L2CValue(aLStack80,ShoulderWait_main_loop);
