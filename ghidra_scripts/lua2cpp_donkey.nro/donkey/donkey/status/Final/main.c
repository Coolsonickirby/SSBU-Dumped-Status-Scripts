...
void __thiscall L2CFighterDonkey::status::Final_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_DONKEY_STATUS_FINAL_WORK_INT_MOTION_KIND_GROUND);
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_DONKEY_STATUS_FINAL_WORK_INT_MOTION_KIND_AIR);
  lVar3 = lib::L2CValue::as_integer(aLStack96);
  iVar2 = lib::L2CValue::as_integer(aLStack112);
  app::lua_bind::WorkModule__set_int64_impl(this->moduleAccessor,lVar3,iVar2);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DONKEY_STATUS_FINAL_FLAG_MOT_CHANGE);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DONKEY_STATUS_FINAL_FLAG_TO_ATTACK);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  FUN_710000d0d0(this);
