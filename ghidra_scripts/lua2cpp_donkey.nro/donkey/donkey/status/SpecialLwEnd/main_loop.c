...
void __thiscall
L2CFighterDonkey::status::SpecialLwEnd_main_loop(L2CFighterDonkey *this,L2CValue *return_value)
...
LAB_7100011d6c:
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_7100011d6c;
...
LAB_7100011df8:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_7100011cd0;
  }
  iVar5 = 1;
LAB_7100011e10:
