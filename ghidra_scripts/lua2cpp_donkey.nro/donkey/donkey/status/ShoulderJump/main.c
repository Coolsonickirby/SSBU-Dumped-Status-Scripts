...
void __thiscall
L2CFighterDonkey::status::ShoulderJump_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xdb87ef275);
  ...
  lib::L2CValue::L2CValue(aLStack80,ShoulderJump_main_loop);
