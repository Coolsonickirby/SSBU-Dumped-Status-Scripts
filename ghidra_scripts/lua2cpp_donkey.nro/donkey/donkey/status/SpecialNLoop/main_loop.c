...
void __thiscall
L2CFighterDonkey::status::SpecialNLoop_main_loop(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar6 & 1) != 0) goto LAB_7100010e64;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar11,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if ((uVar6 & 1) != 0) goto LAB_7100010e6c;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack128);
    }
...
LAB_7100010e6c:
    ...
    FUN_710000e9f0(this,aLStack128,aLStack144);
