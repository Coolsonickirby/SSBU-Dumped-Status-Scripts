...
void __thiscall
L2CFighterDonkey::status::SpecialNCancel_main_loop(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  if ((uVar8 & 1) != 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      if ((uVar8 & 1) == 0) goto LAB_7100010098;
      lib::L2CValue::L2CValue(aLStack80,true);
...
LAB_7100010098:
  ...
  if ((uVar8 & 1) == 0) {
    ...
    if ((uVar8 & 1) != 0) {
      ...
      uVar8 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar8 & 1) != 0) goto LAB_71000100d4;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar8 = lib::L2CValue::operator__(pLVar7,aLStack80);
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar8 & 1) != 0) goto LAB_71000100dc;
  }
  else {
LAB_71000100d4:
    lib::L2CValue::_L2CValue(aLStack96);
...
LAB_7100010260:
  ...
  if ((uVar8 & 1) != 0) {
    ...
    if ((uVar8 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack176);
      lib::L2CValue::_L2CValue(aLStack144);
      if ((uVar8 & 1) != 0) goto LAB_710001045c;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,1);
    goto LAB_7100010670;
  }
