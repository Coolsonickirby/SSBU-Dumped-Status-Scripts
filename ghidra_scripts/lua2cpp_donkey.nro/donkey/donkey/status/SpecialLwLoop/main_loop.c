...
void __thiscall
L2CFighterDonkey::status::SpecialLwLoop_main_loop(L2CFighterDonkey *this,L2CValue *return_value)
...
LAB_71000122c4:
    ...
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_71000121e4;
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DONKEY_STATUS_SPECIAL_LW_FLAG_LOOP);
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_DONKEY_STATUS_KIND_SPECIAL_LW_LOOP);
