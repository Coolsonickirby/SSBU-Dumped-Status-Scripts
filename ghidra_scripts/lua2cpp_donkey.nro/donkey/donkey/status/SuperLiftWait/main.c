...
void __thiscall
L2CFighterDonkey::status::SuperLiftWait_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xfa1a5c4ba);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SuperLiftWait_main_loop);
