...
void __thiscall
L2CFighterDonkey::status::SuperLiftLanding_main(L2CFighterDonkey *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12d6ece69e);
  ...
  lib::L2CValue::L2CValue(aLStack80,SuperLiftLanding_main_loop);
