...
void __thiscall
L2CFighterLuigi::status::SpecialHiDrop_main_loop(L2CFighterLuigi *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) != 0) goto LAB_710000c378;
...
LAB_710000c2f8:
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar4 & 1) == 0) goto LAB_710000c2f8;
    ...
    if ((uVar4 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) == 0) goto LAB_710000c378;
      goto LAB_710000c23c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
