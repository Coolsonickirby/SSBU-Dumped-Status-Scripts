...
void __thiscall L2CFighterLuigi::status::CatchWait_end(L2CFighterLuigi *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_7100006178;
      ...
      if ((uVar5 & 1) == 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          if ((uVar5 & 1) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack80);
            pLVar4 = aLStack128;
            if ((uVar5 & 1) == 0) goto LAB_7100006174;
          }
        }
      }
    }
