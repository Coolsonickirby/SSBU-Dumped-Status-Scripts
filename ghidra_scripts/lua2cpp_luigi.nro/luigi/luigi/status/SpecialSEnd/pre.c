...
void __thiscall
L2CFighterLuigi::status::SpecialSEnd_pre(L2CFighterLuigi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_S_END_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_S_END_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SPECIAL_S_END_FLOAT);
