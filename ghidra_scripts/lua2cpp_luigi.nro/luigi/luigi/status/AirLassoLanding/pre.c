...
void __thiscall
L2CFighterLuigi::status::AirLassoLanding_pre(L2CFighterLuigi *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_LUIGI_STATUS_WORK_KEEP_FLAG_AIR_LASSO_LANDING_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_LUIGI_STATUS_WORK_KEEP_FLAG_AIR_LASSO_LANDING_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_LUIGI_STATUS_WORK_KEEP_FLAG_AIR_LASSO_LANDING_FLOAT);
