...
void __thiscall L2CWeaponLuigiFireball::SetStatusScripts(L2CWeaponLuigiFireball *this)

{
  ...
  iVar1 = _WEAPON_LUIGI_FIREBALL_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_LUIGI_FIREBALL_STATUS_KIND_START);
