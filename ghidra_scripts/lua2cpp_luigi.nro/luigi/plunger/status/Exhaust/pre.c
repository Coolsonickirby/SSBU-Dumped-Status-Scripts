...
void __thiscall
L2CWeaponLuigiPlunger::status::Exhaust_pre(L2CWeaponLuigiPlunger *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_LUIGI_PLUNGER_STATUS_WORK_KEEP_FLAG_EXHAUST_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_LUIGI_PLUNGER_STATUS_WORK_KEEP_FLAG_EXHAUST_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_LUIGI_PLUNGER_STATUS_WORK_KEEP_FLAG_EXHAUST_FLOAT);
