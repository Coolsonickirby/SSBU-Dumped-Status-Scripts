...
void __thiscall
L2CFighterSonic::status::SpecialSEnd_main(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0x1387328d57);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x17f0b8c391);
