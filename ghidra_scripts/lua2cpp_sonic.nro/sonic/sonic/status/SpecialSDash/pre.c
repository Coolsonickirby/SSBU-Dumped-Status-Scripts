...
void __thiscall
L2CFighterSonic::status::SpecialSDash_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_DASH_FLAG);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_DASH_INT);
  lib::L2CValue::L2CValue(aLStack264,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_DASH_FLOAT);
