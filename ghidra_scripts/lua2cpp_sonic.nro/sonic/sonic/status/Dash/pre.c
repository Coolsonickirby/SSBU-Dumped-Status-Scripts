...
void __thiscall L2CFighterSonic::status::Dash_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_SONIC_DASH);
