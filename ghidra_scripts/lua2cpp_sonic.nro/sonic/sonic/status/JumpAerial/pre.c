...
void __thiscall
L2CFighterSonic::status::JumpAerial_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  if (!bVar1) {
    ...
    lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_SONIC_SPECIAL_S_JUMP_AERIAL);
