...
void __thiscall
L2CFighterSonic::status::SpecialSHoldJump_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_HOLD_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_HOLD_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_HOLD_JUMP_FLOAT)
  ;
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_EFFECT);
