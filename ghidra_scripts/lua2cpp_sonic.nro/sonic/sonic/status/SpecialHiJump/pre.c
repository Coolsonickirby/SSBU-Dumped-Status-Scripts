...
void __thiscall
L2CFighterSonic::status::SpecialHiJump_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,SITUATION_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_SONIC_SPECIAL_HI_JUMP);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_HI_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_HI_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_HI_JUMP_FLOAT);
