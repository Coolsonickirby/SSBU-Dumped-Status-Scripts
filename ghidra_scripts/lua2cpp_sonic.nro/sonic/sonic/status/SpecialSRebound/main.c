...
void __thiscall
L2CFighterSonic::status::SpecialSRebound_main(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x118d286418);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSRebound_main_loop);
