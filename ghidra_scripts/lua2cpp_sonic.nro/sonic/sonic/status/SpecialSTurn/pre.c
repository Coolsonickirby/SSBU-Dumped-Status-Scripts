...
void __thiscall
L2CFighterSonic::status::SpecialSTurn_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack184,GROUND_CORRECT_KIND_GROUND_CLIFF_STOP);
  lib::L2CValue::L2CValue(aLStack200,GROUND_CLIFF_CHECK_KIND_NONE);
  lib::L2CValue::L2CValue(aLStack216,true);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_TURN_FLAG);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_TURN_INT);
  lib::L2CValue::L2CValue(aLStack264,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_TURN_FLOAT);
  ...
  uVar13 = lib::L2CValue::as_integer(aLStack152);
