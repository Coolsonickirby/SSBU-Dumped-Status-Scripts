...
void __thiscall L2CFighterSonic::status::SpinJump_pre(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_S);
  lib::L2CValue::operator_(aLStack136,aLStack120);
  lib::L2CValue::_L2CValue(aLStack120);
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_SONIC_STATUS_SPECIAL_S_DASH_FLAG_SPECIAL_LW_HOLD);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::operator_(aLStack152,aLStack120);
    lib::L2CValue::_L2CValue(aLStack120);
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_LW);
    lib::L2CValue::operator_(aLStack136,aLStack120);
    lib::L2CValue::_L2CValue(aLStack120);
  }
  lib::L2CValue::L2CValue(aLStack120,SITUATION_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack168,_FIGHTER_KINETIC_TYPE_SONIC_SPIN_JUMP);
  lib::L2CValue::L2CValue(aLStack184,GROUND_CORRECT_KIND_AIR);
  lib::L2CValue::L2CValue(aLStack200,_GROUND_CLIFF_CHECK_KIND_ON_DROP);
  lib::L2CValue::L2CValue(aLStack216,true);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_SPIN_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_SPIN_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack264,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_S_SPIN_JUMP_FLOAT)
  ;
  ...
  uVar14 = lib::L2CValue::as_integer(aLStack152);
