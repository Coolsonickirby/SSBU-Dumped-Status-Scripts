...
void __thiscall
L2CFighterSonic::status::SpecialNHomingStart_main_loop(L2CFighterSonic *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SONIC_STATUS_KIND_SPECIAL_N_FAIL);
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SONIC_STATUS_KIND_SPECIAL_N_HOMING);
    lib::L2CValue::L2CValue(aLStack112,_FIGHTER_SONIC_INSTANCE_WORK_INT_SPECIAL_N_STATUS_KIND_NEXT);
    iVar3 = lib::L2CValue::as_integer(aLStack96);
    iVar4 = lib::L2CValue::as_integer(aLStack112);
    app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar3,iVar4);
