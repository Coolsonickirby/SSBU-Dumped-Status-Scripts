...
void __thiscall L2CWeaponElightSpreadbullet::SetStatusScripts(L2CWeaponElightSpreadbullet *this)

{
  ...
  iVar1 = _WEAPON_ELIGHT_SPREADBULLET_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ELIGHT_SPREADBULLET_STATUS_KIND_FLY);
