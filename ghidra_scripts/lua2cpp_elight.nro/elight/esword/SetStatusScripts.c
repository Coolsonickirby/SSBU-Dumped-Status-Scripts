...
void __thiscall L2CWeaponElightEsword::SetStatusScripts(L2CWeaponElightEsword *this)

{
  ...
  iVar1 = _WEAPON_ELIGHT_ESWORD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ELIGHT_ESWORD_STATUS_KIND_HAVE);
