...
void __thiscall
L2CFighterElight::status::SpecialLwStandby_pre(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_SITUATION_KIND_OUTFIELD);
  ...
  lib::L2CValue::L2CValue(aLStack216,FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT);
