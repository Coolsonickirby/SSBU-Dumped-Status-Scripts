...
void __thiscall
L2CFighterElight::status::FinalScene03_end(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_ELIGHT_FINAL_MODULE_SCENE_03_EXIT);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_ELIGHT_STATUS_KIND_FINAL_SCENE04);
