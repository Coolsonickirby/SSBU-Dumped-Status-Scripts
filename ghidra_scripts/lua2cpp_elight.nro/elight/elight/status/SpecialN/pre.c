...
void __thiscall
L2CFighterElight::status::SpecialN_pre(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_N | FIGHTER_TREADED_KIND_NO_REAC._4_4_ |
