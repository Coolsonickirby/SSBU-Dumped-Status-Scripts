...
void __thiscall
L2CFighterElight::status::SpecialNEnd_main_loop(L2CFighterElight *this,L2CValue *return_value)
...
LAB_7100013d50:
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        uVar6 = lib::L2CValue::operator__
                          (aLStack400,(L2CValue *)&FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT);
        if ((uVar6 & 1) == 0) {
          ...
          if (iVar3 <= iVar4) {
            ...
            do {
              ...
              lib::L2CValue::_L2CValue((L2CValue *)&local_90);
              uVar6 = lib::L2CValue::operator__
                                (aLStack416,(L2CValue *)&FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT);
              if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,(L2CValue *)&local_90);
      lib::L2CValue::_L2CValue((L2CValue *)&local_90);
      if ((uVar6 & 1) == 0) goto LAB_7100013d50;
    ...
    if ((uVar6 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      if ((uVar6 & 1) == 0) goto LAB_7100013d40;
      goto LAB_7100013c10;
    }
    lib::L2CValue::_L2CValue(aLStack176);
    lib::L2CValue::_L2CValue(aLStack192);
