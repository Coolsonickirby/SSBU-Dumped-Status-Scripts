...
void __thiscall L2CFighterElight::status::Final_pre(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,(int)FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT);
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT._4_4_);
  ...
  lib::L2CValue::L2CValue(aLStack136,(int)FIGHTER_TREADED_KIND_NO_REAC);
  lib::L2CValue::L2CValue(aLStack152,false);
  lib::L2CValue::L2CValue(aLStack168,false);
  lib::L2CValue::L2CValue(aLStack184,false);
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_FINAL | FIGHTER_TREADED_KIND_NO_REAC._4_4_ |
             FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON);
  lib::L2CValue::L2CValue
            (aLStack216,
             FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT |
             FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_AIR_LASSO._4_4_ | _FIGHTER_STATUS_ATTR_FINAL);
