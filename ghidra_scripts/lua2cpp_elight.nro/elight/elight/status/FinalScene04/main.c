...
void __thiscall
L2CFighterElight::status::FinalScene04_main(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0x115061e1b0);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ELIGHT_FINAL_MODULE_SCENE_04_INIT);
  pFVar4 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_ELight::call_final_module(pFVar4,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,FinalScene04_main_loop);
