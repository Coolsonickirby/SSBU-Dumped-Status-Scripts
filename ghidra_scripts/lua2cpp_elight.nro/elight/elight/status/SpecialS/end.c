...
void __thiscall
L2CFighterElight::status::SpecialS_end(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_ELIGHT_STATUS_KIND_SPECIAL_S_FORWARD);
