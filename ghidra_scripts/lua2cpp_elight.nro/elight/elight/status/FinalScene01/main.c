...
void __thiscall
L2CFighterElight::status::FinalScene01_main(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ELIGHT_GENERATE_ARTICLE_DIVER);
  lib::L2CValue::L2CValue(aLStack112,0x11200b153f);
  ...
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  fVar8 = (float)lib::L2CValue::as_number(aLStack112);
  app::lua_bind::FighterManager__start_finalbg_impl(FIGHTER_TREADED_KIND_NO_REAC,iVar2,fVar8);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::_L2CValue(aLStack96);
  ...
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_ELight::call_final_module(pFVar7,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
