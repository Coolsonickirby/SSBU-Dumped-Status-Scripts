...
void __thiscall
L2CFighterElight::status::SpecialLw_pre(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_SLOW |
             _FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_SPRING |
             _FIGHTER_STATUS_ATTR_DISABLE_INTERRUPT_STOP);
