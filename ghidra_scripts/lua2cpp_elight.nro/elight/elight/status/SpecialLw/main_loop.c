...
void __thiscall
L2CFighterElight::status::SpecialLw_main_loop(L2CFighterElight *this,L2CValue *return_value)
...
LAB_710001a608:
      ...
      if ((uVar3 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar3 & 1) == 0) goto LAB_710001a6a0;
        goto LAB_710001a680;
      }
    }
    else {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710001a608;
      lib::L2CValue::_L2CValue(aLStack96);
LAB_710001a680:
      lib::L2CValue::L2CValue(aLStack96,false);
      FUN_7100019e20(this,aLStack96);
    }
    lib::L2CValue::_L2CValue(aLStack96);
  }
LAB_710001a6a0:
