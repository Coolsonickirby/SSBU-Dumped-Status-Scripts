...
void __thiscall
L2CFighterElight::status::SpecialHi_pre(L2CFighterElight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_MOTION_CLIFF_MOVE);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_HI | FIGHTER_TREADED_KIND_NO_REAC._4_4_ |
