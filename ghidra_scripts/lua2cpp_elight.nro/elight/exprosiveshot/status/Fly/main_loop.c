...
void __thiscall
L2CWeaponElightExprosiveshot::status::Fly_main_loop
...

{
  ...
  app::lua_bind::WorkModule__set_float_impl(this->moduleAccessor,fVar6,iVar3);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::L2CValue(aLStack160,_WEAPON_ELIGHT_EXPROSIVESHOT_INSTANCE_WORK_ID_FLAG_ATTACK);
  ...
  if ((uVar4 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack128,_WEAPON_ELIGHT_EXPROSIVESHOT_STATUS_KIND_BURST);
  ...
  lib::L2CValue::L2CValue(aLStack144,_WEAPON_ELIGHT_EXPROSIVESHOT_INSTANCE_WORK_ID_FLAG_HIT_WALL);
  iVar3 = lib::L2CValue::as_integer(aLStack144);
  bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack144);
      if ((uVar4 & 1) == 0) goto LAB_710001d7ac;
      lib::L2CValue::L2CValue
                (aLStack128,_WEAPON_ELIGHT_EXPROSIVESHOT_INSTANCE_WORK_ID_FLAG_HIT_WALL);
      iVar3 = lib::L2CValue::as_integer(aLStack128);
