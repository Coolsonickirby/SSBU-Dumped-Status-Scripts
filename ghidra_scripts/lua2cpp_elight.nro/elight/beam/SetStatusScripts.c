...
void __thiscall L2CWeaponElightBeam::SetStatusScripts(L2CWeaponElightBeam *this)

{
  ...
  iVar1 = _WEAPON_ELIGHT_BEAM_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ELIGHT_BEAM_STATUS_KIND_FINAL_ATTACK);
