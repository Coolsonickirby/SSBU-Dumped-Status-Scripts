...
void __thiscall L2CWeaponElightMeteor::SetStatusScripts(L2CWeaponElightMeteor *this)

{
  ...
  iVar1 = _WEAPON_ELIGHT_METEOR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ELIGHT_METEOR_STATUS_KIND_FINAL_ATTACK);
