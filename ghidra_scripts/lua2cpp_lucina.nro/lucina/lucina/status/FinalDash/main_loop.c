...
void __thiscall
L2CFighterLucina::status::FinalDash_main_loop(L2CFighterLucina *this,L2CValue *return_value)
...
LAB_7100015800:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar2 & 1U) == 0) {
        lib::L2CValue::L2CValue(aLStack112,_FIGHTER_MARTH_STATUS_FINAL_WORK_INT_DASH_COUNT);
        ...
        if ((uVar4 & 1) == 0) {
          ...
          if ((uVar4 & 1) == 0) {
            ...
            if ((uVar4 & 1) != 0) {
              ...
              uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
              lib::L2CValue::_L2CValue(aLStack80);
              if ((uVar4 & 1) != 0) goto LAB_7100015a1c;
            }
            pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
            lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
            uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
            lib::L2CValue::_L2CValue(aLStack80);
            if ((uVar4 & 1) != 0) goto LAB_7100015910;
            pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
            lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
            uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
            lib::L2CValue::_L2CValue(aLStack80);
            lib::L2CValue::_L2CValue(aLStack96);
            if ((uVar4 & 1) == 0) goto LAB_71000159bc;
          }
          else {
LAB_7100015a1c:
            lib::L2CValue::_L2CValue(aLStack96);
