...
void __thiscall
L2CFighterLucina::status::SpecialNEndMax_main_loop(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack192);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) != 0) goto LAB_7100018174;
    }
    iVar3 = 1;
    goto LAB_71000188d8;
  }
...
LAB_7100018174:
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_71000181b0;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) != 0) goto LAB_71000187bc;
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar5 & 1) != 0) goto LAB_71000181b8;
  }
  else {
LAB_71000181b0:
    lib::L2CValue::_L2CValue(aLStack112);
