...
void __thiscall
L2CFighterLucina::status::FinalDashEnd_main(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0xe2b8caefd);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0x1200557d50);
