...
void __thiscall
L2CFighterLucina::status::SpecialS3_main_loop(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    if ((uVar2 & 1) != 0) {
      ...
      uVar2 = lib::L2CValue::operator__(pLVar3,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar2 & 1) != 0) goto LAB_710001770c;
    }
    pLVar3 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar2 = lib::L2CValue::operator__(pLVar3,aLStack80);
    ...
    if ((uVar2 & 1) == 0) {
      ...
      if ((uVar2 & 1) != 0) goto LAB_7100017714;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack96);
    }
...
LAB_7100017900:
    ...
    if ((uVar2 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar2 & 1) == 0) goto LAB_7100017934;
      goto LAB_7100017900;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
