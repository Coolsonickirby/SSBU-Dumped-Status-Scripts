...
void __thiscall
L2CFighterLucina::status::SpecialHi_main(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    FUN_710001b600(aLStack112,this);
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
  }
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack96,&DAT_710001b840);
