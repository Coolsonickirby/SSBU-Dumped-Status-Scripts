...
void __thiscall L2CFighterLucina::status::Final_main(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MARTH_STATUS_FINAL_WORK_INT_MOTION_KIND);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MARTH_STATUS_FINAL_WORK_INT_MOTION_KIND_AIR);
  lVar3 = lib::L2CValue::as_integer(aLStack80);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::lua_bind::WorkModule__set_int64_impl(this->moduleAccessor,lVar3,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
