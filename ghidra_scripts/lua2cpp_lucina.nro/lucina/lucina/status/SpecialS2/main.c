...
void __thiscall
L2CFighterLucina::status::SpecialS2_main(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_MARTH_STATUS_KIND_SPECIAL_S3);
