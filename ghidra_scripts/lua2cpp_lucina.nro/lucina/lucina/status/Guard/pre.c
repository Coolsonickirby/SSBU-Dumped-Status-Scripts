...
void __thiscall L2CFighterLucina::status::Guard_pre(L2CFighterLucina *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_GUARD_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_GUARD_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_GUARD_FLOAT);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_DISABLE_SHIELD_RECOVERY);
