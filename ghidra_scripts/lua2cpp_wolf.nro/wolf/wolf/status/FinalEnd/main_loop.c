...
void __thiscall
L2CFighterWolf::status::FinalEnd_main_loop(L2CFighterWolf *this,L2CValue *return_value)
...
LAB_710000740c:
      ...
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_FOX_STATUS_WORK_ID_FLAG_FINAL_END_EXIT_FINISH);
      iVar3 = lib::L2CValue::as_integer(aLStack128);
      bVar1 = app::lua_bind::WorkModule__is_flag_impl(*ppBVar9,iVar3);
      lib::L2CValue::L2CValue(aLStack112,(bool)(bVar1 & 1));
      lib::L2CValue::L2CValue(aLStack96,false);
