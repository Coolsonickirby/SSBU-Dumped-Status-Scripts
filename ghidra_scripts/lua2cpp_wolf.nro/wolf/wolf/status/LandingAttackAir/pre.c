...
void __thiscall
L2CFighterWolf::status::LandingAttackAir_pre(L2CFighterWolf *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_FOX_STATUS_WORK_KEEP_FLAG_LANDING_ATTACK_AIR_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_FOX_STATUS_WORK_KEEP_FLAG_LANDING_ATTACK_AIR_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_FOX_STATUS_WORK_KEEP_FLAG_LANDING_ATTACK_AIR_FLOAT);
