...
void __thiscall L2CFighterWolf::status::SpecialHi_pre(L2CFighterWolf *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_MOTION_CLIFF_MOVE);
