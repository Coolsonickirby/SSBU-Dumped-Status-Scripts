...
void __thiscall L2CFighterWolf::status::FinalReady_end(L2CFighterWolf *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_FOX_GENERATE_ARTICLE_ARWING);
    iVar1 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::ArticleModule__remove_exist_impl(this->moduleAccessor,iVar1,0);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_WOLF_GENERATE_ARTICLE_WOLFEN);
    iVar1 = lib::L2CValue::as_integer(aLStack80);
    app::lua_bind::ArticleModule__remove_exist_impl(this->moduleAccessor,iVar1,0);
    lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_FOX_GENERATE_ARTICLE_RETICLE);
