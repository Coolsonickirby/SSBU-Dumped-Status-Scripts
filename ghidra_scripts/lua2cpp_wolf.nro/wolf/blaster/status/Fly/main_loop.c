...
void __thiscall
L2CWeaponWolfBlaster::status::Fly_main_loop(L2CWeaponWolfBlaster *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) goto LAB_71000016cc;
    lib::L2CValue::L2CValue(aLStack64,_WEAPON_FOX_BLASTER_BULLET_STATUS_KIND_STAY);
