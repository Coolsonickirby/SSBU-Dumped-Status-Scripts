...
void __thiscall L2CFighterRyu::status::Final_pre(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,0x20e3e3c94b);
  ...
  if (bVar1) {
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_RYU_STATUS_KIND_FINAL2);
