...
void __thiscall L2CFighterRyu::status::TurnRunBack_main(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    FUN_71000255d0(aLStack112,this,aLStack128);
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
  }
  pLVar4 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack64,&DAT_71000257d0);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) goto LAB_7100017e58;
