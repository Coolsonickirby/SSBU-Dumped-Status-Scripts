...
void __thiscall L2CFighterRyu::status::SpecialSLoop_pre(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_S);
    lib::L2CValue::operator_(aLStack136,aLStack120);
    lib::L2CValue::_L2CValue(aLStack120);
    lib::L2CValue::operator_(aLStack136,aLStack152);
  }
  else {
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_SPECIAL_S_COMMAND);
    lib::L2CValue::operator_(aLStack136,aLStack120);
    lib::L2CValue::_L2CValue(aLStack120);
    lib::L2CValue::operator_(aLStack136,aLStack152);
  }
