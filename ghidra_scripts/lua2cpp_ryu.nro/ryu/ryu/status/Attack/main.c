...
void __thiscall L2CFighterRyu::status::Attack_main(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar4 & 1) != 0) {
    FUN_71000252e0(aLStack80,this);
    lib::L2CValue::_L2CValue(aLStack80);
  }
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x13);
  lib::L2CValue::L2CValue(aLStack64,&LAB_71000255c0);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    FUN_710001d270(aLStack96,this,aLStack112);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
  }
  pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack64,&DAT_710001de60);
  lib::L2CValue::operator_(pLVar6,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
