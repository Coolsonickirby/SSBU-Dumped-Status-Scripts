...
void __thiscall
L2CFighterRyu::status::AttackNear_main_loop(L2CFighterRyu *this,L2CValue *return_value)
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        if ((bVar2 & 1U) != 0) goto LAB_710001e318;
      }
    }
...
LAB_710001e318:
  ...
  if ((uVar5 & 1) == 0) {
    ...
    uVar5 = lib::L2CValue::operator__(aLStack112,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) != 0) goto LAB_710001e3d4;
...
LAB_710001e638:
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        lib::L2CValue::L2CValue(aLStack96,(bool)(bVar1 & 1));
        bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack96);
        if ((bVar2 & 1U) == 0) goto LAB_710001e638;
...
LAB_710001ea44:
    ...
    if ((uVar5 & 1) != 0) {
      ...
      FUN_7100020030(aLStack128,this,aLStack448);
