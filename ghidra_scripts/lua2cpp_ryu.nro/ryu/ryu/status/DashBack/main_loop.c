...
void __thiscall
L2CFighterRyu::status::DashBack_main_loop(L2CFighterRyu *this,L2CValue *return_value)
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((bVar1 & 1) != 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack208);
        lib::L2CValue::_L2CValue(aLStack192);
        if ((uVar6 & 1) == 0) goto LAB_7100027074;
      }
      else {
        lib::L2CValue::_L2CValue(aLStack160);
        lib::L2CValue::_L2CValue(aLStack208);
...
LAB_7100027bb4:
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack208);
      lib::L2CValue::_L2CValue(aLStack160);
      if ((uVar6 & 1) == 0) goto LAB_7100027fd0;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack160);
    }
