...
void __thiscall L2CFighterRyu::status::Final2_fix_cam(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) == 0) goto LAB_71000089cc;
  }
  else {
    lib::L2CValue::_L2CValue((L2CValue *)&local_90);
  }
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        FUN_7100009a90(&local_80,this,&local_90,auStack368);
