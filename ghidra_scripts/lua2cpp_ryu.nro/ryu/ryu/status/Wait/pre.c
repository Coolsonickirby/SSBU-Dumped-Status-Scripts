...
void __thiscall L2CFighterRyu::status::Wait_pre(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      FUN_7100007270(aLStack96,aLStack160);
      ...
      if ((uVar3 & 1) != 0) {
        ...
        if ((uVar3 & 1) == 0) {
          ...
          uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar3 & 1) != 0) goto LAB_710002b740;
        }
        else {
LAB_710002b740:
...
LAB_710002b86c:
            ...
            lib::L2CValue::_L2CValue(aLStack80);
            lib::L2CValue::_L2CValue(aLStack96);
            if ((uVar3 & 1) == 0) goto LAB_710002b86c;
          ...
          if ((uVar3 & 1) == 0) goto LAB_710002b8e4;
        }
