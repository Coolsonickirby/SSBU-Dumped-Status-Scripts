...
void __thiscall
L2CFighterRyu::status::AttackLw3_main_loop(L2CFighterRyu *this,L2CValue *return_value)
...
LAB_710002241c:
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack128);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((bVar2 & 1U) != 0) goto LAB_7100022e0c;
      }
    }
    bVar1 = app::lua_bind::CancelModule__is_enable_cancel_impl(*ppBVar10);
    lib::L2CValue::L2CValue(aLStack112,(bool)(bVar1 & 1));
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) == 0) goto LAB_7100022e0c;
    }
...
LAB_7100022794:
      ...
      if ((uVar5 & 1) != 0) {
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack128);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar5 & 1) == 0) goto LAB_7100022b10;
        }
        else {
          lib::L2CValue::_L2CValue(aLStack112);
        }
...
LAB_7100022d80:
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((bVar2 & 1U) == 0) goto LAB_7100022794;
      ...
      lib::L2CValue::L2CValue(aLStack96,(bool)(bVar1 & 1));
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack96);
      if ((bVar2 & 1U) == 0) goto LAB_7100022784;
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) == 0) goto LAB_7100022794;
...
LAB_7100022328:
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((bVar2 & 1U) == 0) goto LAB_7100022328;
