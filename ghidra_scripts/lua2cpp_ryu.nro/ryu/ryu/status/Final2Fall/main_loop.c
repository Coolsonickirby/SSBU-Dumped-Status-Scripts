...
void __thiscall
L2CFighterRyu::status::Final2Fall_main_loop(L2CFighterRyu *this,L2CValue *return_value)
...
LAB_710003e2cc:
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar4 & 1) == 0) {
        lib::L2CValue::L2CValue(aLStack96,_FIGHTER_RYU_STATUS_WORK_ID_FINAL_INT_COUNTER);
      ...
      if ((uVar4 & 1) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar4 & 1) == 0) goto LAB_710003e410;
        goto LAB_710003e2cc;
      }
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
