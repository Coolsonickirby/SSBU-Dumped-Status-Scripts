...
void __thiscall L2CFighterRyu::status::SpecialHiJump_pre(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_RYU_SPECIAL_HI_JUMP);
