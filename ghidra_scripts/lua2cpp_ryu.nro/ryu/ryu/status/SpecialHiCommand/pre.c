...
void __thiscall
L2CFighterRyu::status::SpecialHiCommand_pre(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_RYU_STATUS_KIND_SPECIAL_HI_COMMAND);
