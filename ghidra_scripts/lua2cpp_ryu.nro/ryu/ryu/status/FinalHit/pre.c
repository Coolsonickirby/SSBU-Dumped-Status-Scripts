...
void __thiscall L2CFighterRyu::status::FinalHit_pre(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_ATTACK);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             ...
             _FIGHTER_STATUS_ATTR_FINAL | _FIGHTER_STATUS_ATTR_SCALE_KINETIC_ENERGY);
