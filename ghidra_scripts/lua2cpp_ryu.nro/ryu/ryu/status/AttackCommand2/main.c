...
void __thiscall
L2CFighterRyu::status::AttackCommand2_main(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xfa572ab9d);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LOG_ATTACK_KIND_ATTACK_COMMAND2);
