...
void __thiscall
L2CFighterRyu::status::Final2Landing_main_loop(L2CFighterRyu *this,L2CValue *return_value)
...
LAB_710003df4c:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      if ((bVar2 & 1U) == 0) goto LAB_710003e034;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710003e034;
      goto LAB_710003df4c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
