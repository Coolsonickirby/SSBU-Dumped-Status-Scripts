...
void __thiscall
L2CFighterRyu::status::SpecialLwStepB_main_loop(L2CFighterRyu *this,L2CValue *return_value)
...
LAB_7100044d94:
        ...
        if ((bVar1 & 1U) != 0) {
          ...
          if ((uVar3 & 1) == 0) {
            ...
            uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
            lib::L2CValue::_L2CValue(aLStack80);
            if ((uVar3 & 1) == 0) goto LAB_7100044f4c;
        ...
        uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar3 & 1) == 0) goto LAB_7100044d94;
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_STATUS_KIND_FALL);
        lib::L2CValue::L2CValue(aLStack96,false);
        lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xb0,(L2CValue)0xa0);
LAB_7100044f3c:
...
LAB_7100044f4c:
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_7100044cec;
    }
  }
  iVar5 = 1;
LAB_7100044f54:
