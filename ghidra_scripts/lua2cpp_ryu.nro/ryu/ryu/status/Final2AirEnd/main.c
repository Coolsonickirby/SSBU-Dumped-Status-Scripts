...
void __thiscall L2CFighterRyu::status::Final2AirEnd_main(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xed61a29fb);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,Final2AirEnd_main_loop);
