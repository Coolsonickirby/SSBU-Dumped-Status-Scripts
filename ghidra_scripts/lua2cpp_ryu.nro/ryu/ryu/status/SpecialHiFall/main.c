...
void __thiscall
L2CFighterRyu::status::SpecialHiFall_main(L2CFighterRyu *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RYU_STATUS_WORK_ID_SPECIAL_HI_INT_COUNTER);
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_71000490c0);
