...
void __thiscall
L2CWeaponSnakeC4::status::EstablishGround_main(L2CWeaponSnakeC4 *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1022f1b2cd);
  ...
  lib::L2CValue::L2CValue(aLStack80,EstablishGround_main_loop);
