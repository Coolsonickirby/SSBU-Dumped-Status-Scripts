...
void __thiscall
L2CWeaponSnakeC4::status::EstablishWall_main(L2CWeaponSnakeC4 *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xe79d949a6);
  ...
  lib::L2CValue::L2CValue(aLStack80,EstablishWall_main_loop);
