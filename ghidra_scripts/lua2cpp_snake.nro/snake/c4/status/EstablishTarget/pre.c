...
void __thiscall
L2CWeaponSnakeC4::status::EstablishTarget_pre(L2CWeaponSnakeC4 *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_SNAKE_C4_ESTABLISH_TARGET_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_SNAKE_C4_ESTABLISH_TARGET_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_SNAKE_C4_ESTABLISH_TARGET_FLOAT);
