...
void __thiscall
L2CWeaponSnakeC4::status::EstablishTarget_main(L2CWeaponSnakeC4 *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x10c3611e59);
  ...
  lib::L2CValue::L2CValue(aLStack80,EstablishTarget_main_loop);
