...
void __thiscall
L2CWeaponSnakeC4::status::StickTarget_main(L2CWeaponSnakeC4 *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xc81578d2d);
  ...
  lib::L2CValue::L2CValue(aLStack80,StickTarget_main_loop);
