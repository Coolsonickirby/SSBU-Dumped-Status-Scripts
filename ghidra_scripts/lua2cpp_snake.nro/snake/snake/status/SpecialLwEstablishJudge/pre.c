...
void __thiscall
L2CFighterSnake::status::SpecialLwEstablishJudge_pre(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SNAKE_SPECIAL_LW_ESTABLISH_JUDGE_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SNAKE_SPECIAL_LW_ESTABLISH_JUDGE_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SNAKE_SPECIAL_LW_ESTABLISH_JUDGE_FLOAT);
