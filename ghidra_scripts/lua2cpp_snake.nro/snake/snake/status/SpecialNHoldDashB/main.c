...
void __thiscall
L2CFighterSnake::status::SpecialNHoldDashB_main(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  lua2cpp::L2CFighterCommon::sub_ItemShootDashB_Common(this);
  ...
  lib::L2CValue::operator_(pLVar2,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SpecialNHoldDashB_main_loop);
