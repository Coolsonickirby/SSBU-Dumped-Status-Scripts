...
void __thiscall
L2CFighterSnake::status::AppealEnd_main(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xaab6b85db);
  ...
  lib::L2CValue::L2CValue(aLStack80,AppealEnd_main_loop);
