...
void __thiscall
L2CFighterSnake::status::SpecialLwProduce_pre(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_STATUS_ATTR_START_TURN);
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_SNAKE_STATUS_SPECIAL_LW_FLAG_SQUAT);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SNAKE_SPECIAL_LW_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SNAKE_SPECIAL_LW_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_SNAKE_SPECIAL_LW_FLOAT);
  ...
  uVar8 = lib::L2CValue::as_integer(aLStack136);
