...
void __thiscall
L2CFighterSnake::status::SpecialNHoldWalkB_main_loop(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    lua2cpp::L2CFighterCommon::sub_ItemShootWalkB_Common_Main(this);
    bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar1 & 1U) == 0) {
