...
void __thiscall
L2CFighterSnake::status::SpecialLwDrop_main(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1521dd0a91);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialLwDrop_main_loop);
