...
void __thiscall
L2CFighterSnake::status::SpecialNHoldJumpAerial_pre(L2CFighterSnake *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_JUMP_AERIAL);
