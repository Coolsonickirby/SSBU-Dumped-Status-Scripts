...
void __thiscall
L2CWeaponSnakeCypher::status::Attach_main(L2CWeaponSnakeCypher *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x6dec97c81);
  ...
  lib::L2CValue::L2CValue(aLStack80,Attach_main_loop);
