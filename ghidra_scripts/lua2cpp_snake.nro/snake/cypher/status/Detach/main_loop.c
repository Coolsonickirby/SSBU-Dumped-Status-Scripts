...
void __thiscall
L2CWeaponSnakeCypher::status::Detach_main_loop(L2CWeaponSnakeCypher *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_SNAKE_CYPHER_INSTANCE_WORK_ID_INT_LIFE_COUNT);
