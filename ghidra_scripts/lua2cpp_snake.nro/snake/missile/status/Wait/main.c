...
void __thiscall
L2CWeaponSnakeMissile::status::Wait_main(L2CWeaponSnakeMissile *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_SNAKE_MISSILE_INSTANCE_WORK_ID_INT_DELAY_FRAME);
  iVar3 = lib::L2CValue::as_integer(aLStack80);
  iVar3 = app::lua_bind::WorkModule__get_int_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::L2CValue(aLStack64,iVar3);
  lib::L2CValue::L2CValue(aLStack96,_WEAPON_SNAKE_MISSILE_STATUS_WAIT_WORK_INT_FRAME);
  ...
  lib::L2CValue::L2CValue(aLStack64,0xd0ec2be8d);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack64,_WEAPON_SNAKE_MISSILE_STATUS_WAIT_WORK_INT_FRAME);
      iVar3 = lib::L2CValue::as_integer(aLStack64);
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710002f8d0);
