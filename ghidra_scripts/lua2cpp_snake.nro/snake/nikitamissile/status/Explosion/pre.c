...
void __thiscall
L2CWeaponSnakeNikitamissile::status::Explosion_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_SNAKE_NIKITA_MISSILE_EXPLOSION_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_SNAKE_NIKITA_MISSILE_EXPLOSION_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_SNAKE_NIKITA_MISSILE_EXPLOSION_FLOAT);
