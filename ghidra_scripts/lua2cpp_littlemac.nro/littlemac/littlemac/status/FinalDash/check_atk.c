...
void __thiscall
L2CFighterLittlemac::status::FinalDash_check_atk(L2CFighterLittlemac *this,L2CValue *return_value)

{
  ...
  pLVar4 = (L2CValue *)lib::L2CValue::operator__(aLStack176,0x10860c2250);
  lib::L2CValue::L2CValue(aLStack80,_BATTLE_OBJECT_CATEGORY_FIGHTER);
  uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar5 & 1) != 0) {
    pLVar4 = (L2CValue *)lib::L2CValue::operator__(aLStack176,0x5d6e20d24);
    lib::L2CValue::L2CValue(aLStack80,COLLISION_KIND_HIT);
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) != 0) {
      pLVar4 = (L2CValue *)lib::L2CValue::operator__(aLStack176,0xa854977fe);
      ...
      pLVar4 = (L2CValue *)lib::L2CValue::operator__(aLStack176,0x3a4b90435);
      this_00 = (L2CValue *)lib::L2CValue::operator__(aLStack176,0x6c2b55593);
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LITTLEMAC_STATUS_FINAL_FLAG_ATTACK_HIT);
