...
void __thiscall
L2CFighterLittlemac::status::SpecialLwHit_main(L2CFighterLittlemac *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LITTLEMAC_STATUS_SPECIAL_LW_FLAG_CONTINUE_MOT);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack160,0x1dbcedb55f);
      ...
      lib::L2CValue::L2CValue(aLStack144,0x1018dfb2f4);
      lib::L2CValue::L2CValue(aLStack160,0x194fc58654);
      uVar4 = lib::L2CValue::as_integer(aLStack144);
      uVar6 = lib::L2CValue::as_integer(aLStack160);
      fVar7 = (float)app::lua_bind::WorkModule__get_param_float_impl
                               (this->moduleAccessor,uVar4,uVar6);
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack80,0x12f0de089d);
      lib::L2CValue::L2CValue(aLStack112,0.0);
