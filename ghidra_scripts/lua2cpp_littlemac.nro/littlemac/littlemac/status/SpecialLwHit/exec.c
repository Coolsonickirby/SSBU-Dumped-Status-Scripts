...
void __thiscall
L2CFighterLittlemac::status::SpecialLwHit_exec(L2CFighterLittlemac *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack176,_FIGHTER_LITTLEMAC_STATUS_KIND_SPECIAL_LW_HIT);
    ...
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_LITTLEMAC_STATUS_SPECIAL_LW_WORK_INT_SITUATION_PREV)
    ;
    ...
    lib::L2CValue::_L2CValue(aLStack176);
    if ((uVar3 & 1) != 0) goto LAB_7100003914;
