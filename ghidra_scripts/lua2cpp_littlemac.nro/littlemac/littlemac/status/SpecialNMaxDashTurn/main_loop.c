...
void __thiscall
L2CFighterLittlemac::status::SpecialNMaxDashTurn_main_loop
...
LAB_7100022f00:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar5 & 1) == 0) goto LAB_71000230fc;
...
LAB_71000230fc:
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LITTLEMAC_STATUS_KIND_SPECIAL_N_MAX_DASH_END);
...
LAB_71000230ec:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) != 0) goto LAB_7100022f00;
  }
  iVar3 = 1;
LAB_71000231d8:
