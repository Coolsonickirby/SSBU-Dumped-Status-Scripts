...
void __thiscall
L2CFighterLittlemac::status::FinalHit_end(L2CFighterLittlemac *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_LITTLEMAC_STATUS_KIND_FINAL_ATTACK);
