...
void __thiscall L2CFighterLittlemac::SetStatusScripts(L2CFighterLittlemac *this)

{
  ...
  iVar1 = _FIGHTER_LITTLEMAC_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100000b00);
  lib::L2CValue::operator_(pLVar3,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LITTLEMAC_STATUS_KIND_SPECIAL_LW_HIT);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_INIT_STATUS);
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::SpecialLwHit_init);
  lib::L2CValue::_L2CValue(aLStack96);
