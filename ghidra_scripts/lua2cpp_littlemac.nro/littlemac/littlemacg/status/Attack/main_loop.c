...
void __thiscall
L2CWeaponLittlemacLittlemacg::status::Attack_main_loop
...

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) goto LAB_71000282d4;
    uVar4 = lib::L2CValue::as_integer(aLStack96);
...
LAB_71000282d4:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue((L2CValue *)&local_50,_WEAPON_LITTLEMAC_LITTLEMACG_STATUS_KIND_END);
