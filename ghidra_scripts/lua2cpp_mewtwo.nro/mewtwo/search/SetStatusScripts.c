...
void __thiscall L2CWeaponMewtwoSearch::SetStatusScripts(L2CWeaponMewtwoSearch *this)

{
  ...
  iVar1 = _WEAPON_MEWTWO_SEARCH_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MEWTWO_SEARCH_STATUS_KIND_MOVE);
