...
void __thiscall L2CWeaponMewtwoBindball::SetStatusScripts(L2CWeaponMewtwoBindball *this)

{
  ...
  iVar1 = _WEAPON_MEWTWO_BINDBALL_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_MEWTWO_BINDBALL_STATUS_KIND_SHOOT);
