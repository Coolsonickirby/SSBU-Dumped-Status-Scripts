...
void __thiscall
L2CFighterMewtwo::status::SpecialHi2_pre(L2CFighterMewtwo *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_DISABLE_DISSOLVE_CURSOR | _FIGHTER_STATUS_ATTR_HIDE_NAME_CURSOR);
