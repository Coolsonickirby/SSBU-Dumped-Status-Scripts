...
void __thiscall
L2CFighterMewtwo::status::SpecialHi_main_loop(L2CFighterMewtwo *this,L2CValue *return_value)
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        lib::L2CValue::L2CValue
                  (aLStack112,_FIGHTER_MEWTWO_STATUS_SPECIAL_HI_WORK_INT_MOVE_WAIT_FRAME);
      ...
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MEWTWO_STATUS_SPECIAL_HI_WORK_INT_MOVE_WAIT_FRAME);
