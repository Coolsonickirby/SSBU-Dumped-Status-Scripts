...
void __thiscall
L2CFighterMewtwo::status::SpecialSThrow_pre(L2CFighterMewtwo *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,
             FS_SUCCEEDS_KEEP_SOUND | _FS_SUCCEEDS_KEEP_EFFECT | _FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE |
             _FS_SUCCEEDS_KEEP_SHIELD);
