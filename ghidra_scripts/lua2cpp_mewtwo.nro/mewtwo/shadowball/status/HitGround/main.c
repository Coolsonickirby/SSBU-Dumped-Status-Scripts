...
void __thiscall
L2CWeaponMewtwoShadowball::status::HitGround_main
...

{
  ...
  app::WeaponSpecializer_MewtwoShadowball::set_effect_scale(pBVar2,(bool)(bVar1 & 1));
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xa3ac03ff2);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,HitGround_main_loop);
