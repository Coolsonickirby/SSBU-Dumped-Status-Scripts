...
void __thiscall L2CWeaponRosettaMeteor::SetStatusScripts(L2CWeaponRosettaMeteor *this)

{
  ...
  iVar1 = _WEAPON_ROSETTA_METEOR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROSETTA_METEOR_STATUS_KIND_SHOOT);
