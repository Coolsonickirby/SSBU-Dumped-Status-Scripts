...
void __thiscall
L2CWeaponRosettaTico::status::AttackDash_main_loop
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        if ((uVar4 & 1) != 0) {
          ...
          uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar4 & 1) != 0) goto LAB_710003d898;
        }
        pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
        lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
        uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar4 & 1) != 0) goto LAB_710003dae8;
        pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
        lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
        uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar4 & 1) != 0) goto LAB_710003d8a0;
      }
      else {
LAB_710003d898:
        lib::L2CValue::_L2CValue(aLStack112);
LAB_710003d8a0:
        ...
        if ((bVar1 & 1U) == 0) {
          ...
          lib::L2CValue::L2CValue
                    (aLStack112,_WEAPON_KINETIC_TYPE_ROSETTA_TICO_MOTION_TRANS_FREE_ATTACK);
          lib::L2CValue::L2CValue(aLStack128,true);
          FUN_710003bc90(this,aLStack112,aLStack128);
        }
