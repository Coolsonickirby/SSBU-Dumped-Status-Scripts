...
void __thiscall
L2CWeaponRosettaTico::status::SpecialHiEnd_pre(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_ROSETTA_TICO_SPECIAL_HI_END);
