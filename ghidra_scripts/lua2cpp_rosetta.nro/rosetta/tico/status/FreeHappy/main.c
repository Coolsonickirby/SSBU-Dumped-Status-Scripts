...
void __thiscall
L2CWeaponRosettaTico::status::FreeHappy_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa25b4f479);
  ...
  lib::L2CValue::L2CValue(aLStack80,FreeHappy_main_loop);
