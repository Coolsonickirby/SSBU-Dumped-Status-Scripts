...
void __thiscall
L2CWeaponRosettaTico::status::FollowGuard_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xcbaf6f976);
  ...
  lib::L2CValue::L2CValue(aLStack80,FollowGuard_main_loop);
