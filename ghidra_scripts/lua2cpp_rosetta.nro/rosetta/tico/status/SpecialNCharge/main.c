...
void __thiscall
L2CWeaponRosettaTico::status::SpecialNCharge_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack128,_WEAPON_ROSETTA_TICO_STATUS_SPECIAL_N_COMMON_WORK_FLOAT_CHARGE_MOTION_RATE);
