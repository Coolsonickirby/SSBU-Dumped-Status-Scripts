...
void __thiscall
L2CWeaponRosettaTico::status::FollowTurn_pre(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_FOLLOW_TURN_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_FOLLOW_TURN_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_FOLLOW_TURN_FLOAT);
