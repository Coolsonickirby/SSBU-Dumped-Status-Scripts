...
void __thiscall
L2CWeaponRosettaTico::status::FreeWorry_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa166935f5);
  ...
  lib::L2CValue::L2CValue(aLStack80,FreeWorry_main_loop);
