...
void __thiscall
L2CWeaponRosettaTico::status::FreeGuard_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa344b647c);
  ...
  lib::L2CValue::L2CValue(aLStack80,FreeGuard_main_loop);
