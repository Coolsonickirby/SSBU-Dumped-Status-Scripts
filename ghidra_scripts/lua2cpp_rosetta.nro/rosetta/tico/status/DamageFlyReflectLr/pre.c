...
void __thiscall
L2CWeaponRosettaTico::status::DamageFlyReflectLr_pre
...

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_ROSETTA_TICO_DAMAGE_FLY_REFLECT_LR);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_DAMAGE_FLY_REFLECT_FLAG);
  lib::L2CValue::L2CValue
            (aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_DAMAGE_FLY_REFLECT_INT);
  lib::L2CValue::L2CValue
            (aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_DAMAGE_FLY_REFLECT_FLOAT);
