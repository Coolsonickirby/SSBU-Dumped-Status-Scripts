...
void __thiscall
L2CWeaponRosettaTico::status::FreeBrake_pre(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_ROSETTA_TICO_BRAKE);
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_FREE_BRAKE_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_FREE_BRAKE_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_STATUS_WORK_KEEP_FLAG_ROSETTA_TICO_FREE_BRAKE_FLOAT);
