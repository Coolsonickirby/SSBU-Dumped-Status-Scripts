...
void __thiscall
L2CWeaponRosettaTico::status::Down_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xa5bb41db1);
  ...
  lib::L2CValue::L2CValue(aLStack80,Down_main_loop);
