...
void __thiscall
L2CWeaponRosettaTico::status::Dragoon_end(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack48);
  lib::L2CValue::L2CValue(aLStack48,_WEAPON_ROSETTA_TICO_INSTANCE_WORK_ID_FLAG_NO_DEAD);
