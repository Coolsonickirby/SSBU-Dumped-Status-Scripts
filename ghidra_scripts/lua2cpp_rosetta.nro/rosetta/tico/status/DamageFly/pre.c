...
void __thiscall
L2CWeaponRosettaTico::status::DamageFly_pre(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_ROSETTA_TICO_DAMAGE_FLY);
