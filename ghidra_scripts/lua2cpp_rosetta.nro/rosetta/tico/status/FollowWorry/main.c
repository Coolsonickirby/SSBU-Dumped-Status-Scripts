...
void __thiscall
L2CWeaponRosettaTico::status::FollowWorry_main(L2CWeaponRosettaTico *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xc98d4a8ff);
  ...
  lib::L2CValue::L2CValue(aLStack80,FollowWorry_main_loop);
