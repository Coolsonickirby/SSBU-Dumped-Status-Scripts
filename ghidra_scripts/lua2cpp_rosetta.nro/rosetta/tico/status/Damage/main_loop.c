...
void __thiscall
L2CWeaponRosettaTico::status::Damage_main_loop(L2CWeaponRosettaTico *this,L2CValue *return_value)
...
LAB_710003aa18:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar4 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack64,_WEAPON_ROSETTA_TICO_STATUS_KIND_DAMAGE_FALL);
...
LAB_710003aaf4:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((bVar2 & 1U) == 0) goto LAB_710003aa18;
    ...
    uVar4 = lib::L2CValue::operator__(pLVar5,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar4 & 1) == 0) goto LAB_710003aa18;
    FUN_710002c5a0(this);
  }
  iVar3 = 1;
LAB_710003ab0c:
