...
void __thiscall
L2CFighterRosetta::status::SpecialHiJump_pre(L2CFighterRosetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROSETTA_SPECIAL_HI_JUMP_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROSETTA_SPECIAL_HI_JUMP_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROSETTA_SPECIAL_HI_JUMP_FLOAT);
