...
void __thiscall
L2CFighterRosetta::status::SpecialHi_pre(L2CFighterRosetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON | _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_NONE);
