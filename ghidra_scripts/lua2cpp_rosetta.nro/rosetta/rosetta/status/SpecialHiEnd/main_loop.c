...
void __thiscall
L2CFighterRosetta::status::SpecialHiEnd_main_loop(L2CFighterRosetta *this,L2CValue *return_value)
      ...
      if ((bVar1 & 1U) == 0) {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          if ((uVar6 & 1) != 0) {
            ...
            uVar6 = lib::L2CValue::operator__(pLVar5,aLStack80);
            lib::L2CValue::_L2CValue(aLStack80);
            if ((uVar6 & 1) != 0) goto LAB_7100009d40;
          }
          pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
          lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
          uVar6 = lib::L2CValue::operator__(pLVar5,aLStack80);
          ...
          if ((uVar6 & 1) != 0) goto LAB_7100009d48;
        }
        else {
LAB_7100009d40:
          lib::L2CValue::_L2CValue(aLStack96);
...
LAB_7100009e78:
      ...
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_ROSETTA_STATUS_SPECIAL_HI_END_FLAG_NO_LANDING);
      ...
      if ((bVar1 & 1U) == 0) goto LAB_7100009c7c;
