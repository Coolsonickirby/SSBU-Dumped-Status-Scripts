...
void __thiscall
L2CFighterRosetta::status::SpecialHiEnd_pre(L2CFighterRosetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_ROSETTA_SPECIAL_HI_END);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROSETTA_SPECIAL_HI_END_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROSETTA_SPECIAL_HI_END_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_ROSETTA_SPECIAL_HI_END_FLOAT);
