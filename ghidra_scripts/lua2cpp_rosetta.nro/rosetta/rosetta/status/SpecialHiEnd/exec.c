...
void __thiscall
L2CFighterRosetta::status::SpecialHiEnd_exec_stop(L2CFighterRosetta *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            ((L2CValue *)&local_40,_FIGHTER_ROSETTA_STATUS_SPECIAL_HI_COMMON_FLOAT_ANGLE);
