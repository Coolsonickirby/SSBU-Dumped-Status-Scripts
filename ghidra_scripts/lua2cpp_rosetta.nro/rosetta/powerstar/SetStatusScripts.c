...
void __thiscall L2CWeaponRosettaPowerstar::SetStatusScripts(L2CWeaponRosettaPowerstar *this)

{
  ...
  iVar1 = _WEAPON_ROSETTA_POWERSTAR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROSETTA_POWERSTAR_STATUS_KIND_START);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_ROSETTA_POWERSTAR_STATUS_KIND_LOOP);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
