...
void __thiscall
L2CFighterRidley::status::SpecialHiChargeHi_main(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack48,0x184830fa65);
  lib::L2CValue::L2CValue(aLStack64,0xffee13228);
