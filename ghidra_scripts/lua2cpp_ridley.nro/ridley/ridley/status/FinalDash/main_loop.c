...
void __thiscall
L2CFighterRidley::status::FinalDash_main_loop(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack96,0xfde1e60c8);
  ...
  bVar1 = app::FighterSpecializer_Ridley::final_module_hit_success();
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  if ((uVar6 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_RIDLEY_STATUS_KIND_FINAL_READY);
  ...
  lib::L2CValue::L2CValue(aLStack144,0xa641abc98);
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  lib::L2CValue::_L2CValue(aLStack96);
  uVar6 = lib::L2CValue::operator_(aLStack128,aLStack112);
  if ((uVar6 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_RIDLEY_STATUS_KIND_FINAL_DASH_END);
  ...
  lib::L2CValue::L2CValue(aLStack96,0xb54dafbfb);
  lib::L2CValue::L2CValue(aLStack160,0x182dc8c467);
  uVar6 = lib::L2CValue::as_integer(aLStack96);
...
LAB_71000170d0:
    ...
    bVar1 = app::FighterUtil::check_final_dash_ground(pBVar9);
    ...
    uVar6 = lib::L2CValue::operator__(pLVar8,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar6 & 1) == 0) goto LAB_71000170d0;
