...
void __thiscall
L2CFighterRidley::status::FinalScene01_main(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIND_RIDLEY);
  ...
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  fVar7 = (float)lib::L2CValue::as_number(aLStack96);
  app::lua_bind::FighterManager__start_finalbg_impl(LUA_SCRIPT_LINE_STATUS_SYSTEM,iVar2,fVar7);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack128);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack80);
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,4);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_FINAL_MODULE_SCENE_01_INIT);
  pFVar6 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Ridley::call_final_module(pFVar6,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
