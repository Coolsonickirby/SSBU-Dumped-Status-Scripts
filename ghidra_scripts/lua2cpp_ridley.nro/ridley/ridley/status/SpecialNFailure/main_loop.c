...
void __thiscall
L2CFighterRidley::status::SpecialNFailure_main_loop(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  FUN_71000234e0(this,aLStack144,aLStack160,aLStack176);
...
LAB_71000238f0:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    if ((bVar2 & 1U) == 0) goto LAB_71000239d0;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack192);
      if ((uVar3 & 1) == 0) goto LAB_71000239d0;
      goto LAB_71000238f0;
    }
    lib::L2CValue::_L2CValue(aLStack208);
    lib::L2CValue::_L2CValue(aLStack224);
