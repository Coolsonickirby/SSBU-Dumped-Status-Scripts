...
void __thiscall
L2CFighterRidley::status::SpecialNShoot_main(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_N_CHARGE);
  ...
  if ((uVar6 & 1) != 0) {
    ...
    FUN_7100023b10(aLStack208,this,aLStack224);
    lib::L2CValue::_L2CValue(aLStack208);
    lib::L2CValue::_L2CValue(aLStack224);
  }
  pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100023c30);
  lib::L2CValue::operator_(pLVar5,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SpecialNShoot_main_loop);
