...
void __thiscall
L2CFighterRidley::status::SpecialNShoot_main_loop(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  FUN_71000230f0(this,aLStack128,aLStack144,aLStack160,aLStack176);
  ...
  FUN_71000234e0(this,aLStack192,aLStack208,aLStack224);
...
LAB_71000243c4:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack320);
      lib::L2CValue::_L2CValue(aLStack288);
      if ((uVar5 & 1) != 0) goto LAB_71000243c4;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,0);
  }
  lib::L2CValue::_L2CValue(aLStack272);
