...
void __thiscall
L2CFighterRidley::status::SpecialNCharge_end(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_N_SHOOT);
