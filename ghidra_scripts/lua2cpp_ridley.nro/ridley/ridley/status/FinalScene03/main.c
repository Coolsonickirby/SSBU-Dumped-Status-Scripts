...
void __thiscall
L2CFighterRidley::status::FinalScene03_main(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_FINAL_MODULE_SCENE_03_INIT);
