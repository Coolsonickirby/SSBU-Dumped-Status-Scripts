...
void __thiscall
L2CFighterRidley::status::FinalEnd_main_loop(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_7100015ed0;
    }
    iVar4 = 1;
    goto LAB_7100016394;
  }
...
LAB_7100016080:
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_7100016080;
      lib::L2CValue::L2CValue(aLStack80,GROUND_CORRECT_KIND_GROUND_CLIFF_STOP);
      GVar3 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::GroundModule__correct_impl(this->moduleAccessor,GVar3);
      lib::L2CValue::_L2CValue(aLStack80);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) != 0) {
        ...
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_FINAL_MODULE_END_EXEC);
        pFVar8 = (Fighter *)lib::L2CValue::as_pointer(pLVar6);
        iVar4 = lib::L2CValue::as_integer(aLStack80);
        app::FighterSpecializer_Ridley::call_final_module(pFVar8,iVar4);
        goto LAB_7100016384;
      }
    }
  }
