...
void __thiscall
L2CFighterRidley::status::FinalScene04_main(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xfee1383eb);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_FINAL_MODULE_SCENE_04_INIT);
