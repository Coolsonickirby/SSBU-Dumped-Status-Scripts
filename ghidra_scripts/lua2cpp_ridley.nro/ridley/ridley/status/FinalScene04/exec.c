...
void __thiscall
L2CFighterRidley::status::FinalScene04_exec(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_STATUS_FINAL_WORK_INT_ADD_DAMAGE_COUNT);
  ...
  if ((uVar3 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_STATUS_FINAL_WORK_FLOAT_ADD_DAMAGE);
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_FINAL_MODULE_SCENE_04_EXEC_STATUS);
      pFVar6 = (Fighter *)lib::L2CValue::as_pointer(pLVar5);
      iVar1 = lib::L2CValue::as_integer(aLStack80);
      app::FighterSpecializer_Ridley::call_final_module(pFVar6,iVar1);
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_STATUS_FINAL_WORK_INT_ADD_DAMAGE_COUNT);
      iVar1 = lib::L2CValue::as_integer(aLStack80);
