...
void __thiscall
L2CFighterRidley::status::FinalScene05_main(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0xf9914b37d);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_RIDLEY_FINAL_MODULE_SCENE_05_INIT);
  pFVar4 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack80);
  app::FighterSpecializer_Ridley::call_final_module(pFVar4,iVar2);
  lib::L2CValue::_L2CValue(aLStack80);
