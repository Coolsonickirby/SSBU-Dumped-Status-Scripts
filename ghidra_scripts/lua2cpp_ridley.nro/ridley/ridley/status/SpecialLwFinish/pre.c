...
void __thiscall
L2CFighterRidley::status::SpecialLwFinish_pre(L2CFighterRidley *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_ATTR_INHERIT_CAMERA_RANGE);
