...
void __thiscall
L2CWeaponKirbyRosettaticomissile::status::SpecialNShoot_pre
...

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_KIRBY_ROSETTATICOMISSILE_SPECIAL_N_SHOOT);
