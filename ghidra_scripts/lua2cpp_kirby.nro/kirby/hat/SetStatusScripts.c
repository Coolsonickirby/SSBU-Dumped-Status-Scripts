...
void __thiscall L2CWeaponKirbyHat::SetStatusScripts(L2CWeaponKirbyHat *this)

{
  ...
  iVar1 = _WEAPON_KIRBY_HAT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KIRBY_HAT_STATUS_KIND_REGULAR);
