...
void __thiscall L2CWeaponKirbyUltraswordhat::SetStatusScripts(L2CWeaponKirbyUltraswordhat *this)

{
  ...
  iVar1 = _WEAPON_KIRBY_ULTRASWORDHAT_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KIRBY_ULTRASWORDHAT_STATUS_KIND_REGULAR);
