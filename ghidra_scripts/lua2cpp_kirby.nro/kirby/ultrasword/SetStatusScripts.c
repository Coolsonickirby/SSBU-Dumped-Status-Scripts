...
void __thiscall L2CWeaponKirbyUltrasword::SetStatusScripts(L2CWeaponKirbyUltrasword *this)

{
  ...
  iVar1 = _WEAPON_KIRBY_ULTRASWORD_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KIRBY_ULTRASWORD_STATUS_KIND_REGULAR);
