...
void __thiscall L2CWeaponKirbyWindummy::SetStatusScripts(L2CWeaponKirbyWindummy *this)

{
  ...
  iVar1 = _WEAPON_KIRBY_WINDUMMY_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_KIRBY_WINDUMMY_STATUS_KIND_WIN);
