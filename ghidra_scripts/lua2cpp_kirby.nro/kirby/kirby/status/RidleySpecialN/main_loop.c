...
void __thiscall
L2CFighterKirby::status::RidleySpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KIRBY_STATUS_KIND_RIDLEY_SPECIAL_N_SHOOT);
      lib::L2CValue::L2CValue(aLStack192,false);
      lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0x50,(L2CValue)0x40);
    }
    else {
      lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KIRBY_STATUS_KIND_RIDLEY_SPECIAL_N_CHARGE);
      lib::L2CValue::L2CValue(aLStack192,false);
      lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0x50,(L2CValue)0x40);
    }
    lib::L2CValue::_L2CValue(aLStack192);
