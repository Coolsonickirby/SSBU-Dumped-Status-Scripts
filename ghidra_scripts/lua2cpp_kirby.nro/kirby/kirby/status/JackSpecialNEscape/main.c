...
void __thiscall
L2CFighterKirby::status::JackSpecialNEscape_main(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100157f44:
  ...
  if ((uVar6 & 1) != 0) {
    ...
    FUN_7100159370(aLStack480,this,aLStack496);
    lib::L2CValue::_L2CValue(aLStack480);
    lib::L2CValue::_L2CValue(aLStack496);
  }
  pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x15);
  lib::L2CValue::L2CValue(aLStack112,&DAT_71001597a0);
  lib::L2CValue::operator_(pLVar5,aLStack112);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::L2CValue(aLStack512,&DAT_7100159800);
