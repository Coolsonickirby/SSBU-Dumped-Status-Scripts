...
void __thiscall
L2CFighterKirby::status::DededeSpecialNEatWaitFall_main_loop
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        if ((uVar4 & 1) != 0) {
          lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_DEDEDE_SPECIAL_N_SPIT);
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_DEDEDE_SPECIAL_N_EAT_LANDING);
    lib::L2CValue::L2CValue(aLStack80,false);
    lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xc0,(L2CValue)0xb0);
LAB_71001dfc24:
    lib::L2CValue::_L2CValue(aLStack80);
