...
void __thiscall
L2CFighterKirby::status::GamewatchSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack176);
      lib::L2CValue::_L2CValue(aLStack144);
      if ((uVar6 & 1) != 0) goto LAB_71001f681c;
    }
...
LAB_71001f681c:
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_71001f6920;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
    uVar6 = lib::L2CValue::operator__(pLVar7,aLStack96);
