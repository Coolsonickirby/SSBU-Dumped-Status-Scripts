...
void __thiscall
L2CFighterKirby::status::PacmanSpecialNJumpCancel_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,PacmanSpecialNJumpCancel_main_loop);
