...
void __thiscall
L2CFighterKirby::status::WarioSpecialNBomb_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0xe99437e30);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x12db118bff);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_71001ee6f0(this);
  lib::L2CValue::L2CValue(aLStack64,WarioSpecialNBomb_main_loop);
