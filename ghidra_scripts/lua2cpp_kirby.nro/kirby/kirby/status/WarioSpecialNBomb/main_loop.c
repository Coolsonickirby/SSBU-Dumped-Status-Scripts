...
void __thiscall
L2CFighterKirby::status::WarioSpecialNBomb_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001ef744:
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar3 & 1) == 0) goto LAB_71001ef744;
...
LAB_71001ef7d8:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71001ef818;
      goto LAB_71001ef6ac;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
