...
void __thiscall
L2CFighterKirby::status::SpecialNEatLanding_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x1580331cf7);
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,_CAMERA_QUAKE_KIND_SMALL);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::lua_bind::CameraModule__req_quake_impl(this->moduleAccessor,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
  FUN_710022feb0(this);
  lib::L2CValue::L2CValue(aLStack96,SpecialNEatLanding_main_loop);
