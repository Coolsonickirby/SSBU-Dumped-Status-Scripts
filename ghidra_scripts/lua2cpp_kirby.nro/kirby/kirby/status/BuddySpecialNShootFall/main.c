...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootFall_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_BUDDY_SPECIAL_N_SHOOT_START);
  uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar5 & 1) != 0) {
  ...
  lib::L2CValue::L2CValue(aLStack80,BuddySpecialNShootFall_main_loop);
