...
void __thiscall
L2CFighterKirby::status::DaisySpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_71002043f0(this,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack80,DaisySpecialN_main_loop);
