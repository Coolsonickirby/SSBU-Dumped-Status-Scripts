...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNHoldJumpAerial_main
...

{
  ...
  lua2cpp::L2CFighterCommon::sub_ItemShootJumpAerial_Common(this);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SnakeSpecialNHoldJumpAerial_main_loop);
