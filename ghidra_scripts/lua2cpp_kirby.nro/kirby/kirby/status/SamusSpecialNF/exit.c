...
void __thiscall
L2CFighterKirby::status::SamusdSpecialNF_exit(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_SAMUS_GENERATE_ARTICLE_CSHOT);
  iVar1 = lib::L2CValue::as_integer(aLStack96);
