...
void __thiscall
L2CFighterKirby::status::JackSpecialNJump_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) == 0) goto LAB_7100156f98;
...
LAB_7100156f98:
    ...
    if ((uVar5 & 1) == 0) goto LAB_71001570e8;
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar2 & 1U) != 0) goto LAB_7100157084;
