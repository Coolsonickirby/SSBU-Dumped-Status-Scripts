...
void __thiscall
L2CFighterKirby::status::TrailSpecialN3_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0xe0547016d);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_TRAIL_INSTANCE_WORK_ID_FLAG_SPECIAL_N3_HOP);
  ...
  lib::L2CValue::L2CValue(aLStack288,_FIGHTER_TRAIL_STATUS_SPECIAL_N3_INT_THUNDER_NUM);
  ...
  lib::L2CValue::L2CValue(aLStack320,_FIGHTER_LOG_ATTACK_KIND_ADDITIONS_ATTACK_04);
  lib::L2CAgent::clear_lua_stack((L2CAgent *)this);
  ...
  lib::L2CValue::_L2CValue(aLStack288);
  lib::L2CValue::L2CValue(aLStack288,TrailSpecialN3_main_loop);
