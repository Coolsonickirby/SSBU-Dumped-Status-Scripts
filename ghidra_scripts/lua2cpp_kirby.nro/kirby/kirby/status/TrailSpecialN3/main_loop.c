...
void __thiscall
L2CFighterKirby::status::TrailSpecialN3_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100112480:
    ...
    if ((bVar4 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack256,_FIGHTER_TRAIL_STATUS_SPECIAL_N3_FLAG_SHOOTED);
      lib::L2CValue::L2CValue(aLStack272,_FIGHTER_TRAIL_INSTANCE_WORK_ID_FLAG_SPECIAL_N3_HOP);
      FUN_7100112810(this,aLStack256,aLStack272);
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) == 0) goto LAB_71001126bc;
      goto LAB_7100112480;
    }
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
