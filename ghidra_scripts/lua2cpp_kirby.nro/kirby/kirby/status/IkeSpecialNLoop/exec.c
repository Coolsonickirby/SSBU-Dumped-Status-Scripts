...
void __thiscall
L2CFighterKirby::status::IkeSpecialNLoop_exec(L2CFighterKirby *this,L2CValue *return_value)
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        FUN_71001925b0(aLStack80,this,aLStack176,aLStack192,aLStack208,aLStack224,aLStack240,
