...
void __thiscall
L2CFighterKirby::status::DiddySpecialNCharge_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) != 0) {
      ...
      uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) != 0) goto LAB_71001e3e94;
    }
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar4 & 1) != 0) goto LAB_71001e3e9c;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack112);
    }
...
LAB_71001e3e9c:
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_DIDDY_SPECIAL_N_DANGER);
      lib::L2CValue::L2CValue(aLStack112,false);
      lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0xb0,(L2CValue)0x90);
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack80);
