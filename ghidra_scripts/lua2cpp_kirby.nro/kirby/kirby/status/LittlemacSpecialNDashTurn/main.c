...
void __thiscall
L2CFighterKirby::status::LittlemacSpecialNDashTurn_main
...

{
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0x1702fbe934);
    ...
    lib::L2CValue::L2CValue(aLStack80,0x137571a7f2);
    lib::L2CValue::L2CValue(aLStack96,0.0);
    lib::L2CValue::L2CValue(aLStack112,1.0);
    lib::L2CValue::L2CValue(aLStack128,false);
    HVar4 = lib::L2CValue::as_hash(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,LittlemacSpecialNDashTurn_main_loop);
