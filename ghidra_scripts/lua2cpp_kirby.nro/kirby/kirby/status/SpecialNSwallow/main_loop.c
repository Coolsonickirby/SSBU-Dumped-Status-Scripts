...
void __thiscall
L2CFighterKirby::status::SpecialNSwallow_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71002339e8:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_71002339e8;
...
LAB_7100233a9c:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_710023394c;
  }
  iVar5 = 1;
LAB_7100233ac4:
