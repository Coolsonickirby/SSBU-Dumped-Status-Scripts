...
void __thiscall
L2CFighterKirby::status::WarioSpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0xebd3c8483);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x12ff6e714c);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_71001efac0(this);
  lib::L2CValue::L2CValue(aLStack64,WarioSpecialN_main_loop);
