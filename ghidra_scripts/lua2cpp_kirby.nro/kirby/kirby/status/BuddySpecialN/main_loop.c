...
void __thiscall
L2CFighterKirby::status::BuddySpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710014f280:
      ...
      FUN_71001467f0(aLStack80,this,aLStack112);
      bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
...
LAB_710014f984:
          ...
          if ((uVar6 & 1) != 0) {
            ...
            iVar3 = lib::L2CValue::as_integer(aLStack144);
            bVar2 = app::lua_bind::ControlModule__check_button_on_impl(*ppBVar11,iVar3);
            lib::L2CValue::L2CValue(aLStack80,(bool)(bVar2 & 1));
            bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack80);
            lib::L2CValue::_L2CValue(aLStack80);
            lib::L2CValue::_L2CValue(aLStack144);
            if ((bVar1 & 1U) == 0) {
              ...
              uVar6 = lib::L2CValue::as_integer(aLStack160);
              uVar8 = lib::L2CValue::as_integer(aLStack176);
              iVar3 = app::lua_bind::WorkModule__get_param_int_impl(*ppBVar11,uVar6,uVar8);
              lib::L2CValue::L2CValue(aLStack144,iVar3);
              lib::L2CValue::_L2CValue(aLStack176);
              lib::L2CValue::_L2CValue(aLStack160);
              ...
              if ((uVar6 & 1) != 0) {
                lib::L2CValue::L2CValue
                          (aLStack160,_FIGHTER_KIRBY_STATUS_KIND_BUDDY_SPECIAL_N_SHOOT_START);
        ...
        if ((uVar6 & 1) == 0) {
          ...
          if ((uVar6 & 1) != 0) {
            ...
            lib::L2CValue::L2CValue(aLStack80,true);
            pFVar10 = (Fighter *)lib::L2CValue::as_pointer(pLVar7);
            bVar2 = lib::L2CValue::as_bool(aLStack80);
            app::FighterSpecializer_Buddy::update_special_n_partner_motion
                      (pFVar10,(bool)(bVar2 & 1));
            goto LAB_710014fb78;
          }
        }
        else {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          uVar6 = lib::L2CValue::operator__(pLVar7,aLStack80);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar6 & 1) == 0) goto LAB_710014f64c;
...
LAB_710014fb78:
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_710014f280;
    }
  }
  iVar3 = 1;
LAB_710014fb88:
