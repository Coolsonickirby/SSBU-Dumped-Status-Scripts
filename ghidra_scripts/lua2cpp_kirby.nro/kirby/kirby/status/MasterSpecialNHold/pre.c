...
void __thiscall
L2CFighterKirby::status::MasterSpecialNHold_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,FS_SUCCEEDS_KEEP_SOUND | _FS_SUCCEEDS_KEEP_EFFECT);
