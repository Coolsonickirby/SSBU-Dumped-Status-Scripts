...
void __thiscall
L2CFighterKirby::status::WarioSpecialNBiteStart_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x14f9f3f9b8);
  ...
  lib::L2CValue::L2CValue(aLStack80,0x188b831473);
  ...
  lib::L2CValue::L2CValue(aLStack80,WarioSpecialNBiteStart_main_loop);
