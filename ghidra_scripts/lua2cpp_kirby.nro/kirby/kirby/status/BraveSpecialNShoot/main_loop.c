...
void __thiscall
L2CFighterKirby::status::BraveSpecialNShoot_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_7100150090(this,aLStack224);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack272);
      lib::L2CValue::_L2CValue(aLStack240);
      if ((uVar5 & 1) != 0) goto LAB_7100152014;
    }
