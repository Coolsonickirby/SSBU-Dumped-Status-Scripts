...
void __thiscall
L2CFighterKirby::status::BraveSpecialNShoot_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_710014fe60(aLStack152,this);
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_BRAVE_SPECIAL_N_L);
