...
void __thiscall
L2CFighterKirby::status::SpecialSJump_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71002271cc:
    ...
    if ((uVar4 & 1) == 0) {
      ...
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((bVar2 & 1U) == 0) goto LAB_7100227344;
...
LAB_7100227340:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) != 0) goto LAB_71002271cc;
  }
LAB_7100227344:
  iVar3 = 0;
LAB_710022734c:
