...
void __thiscall
L2CFighterKirby::status::LittlemacSpecialNDash_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0x12c0702fe8);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_71001a8a20(this);
  lib::L2CValue::L2CValue(aLStack80,LittlemacSpecialNDash_main_loop);
