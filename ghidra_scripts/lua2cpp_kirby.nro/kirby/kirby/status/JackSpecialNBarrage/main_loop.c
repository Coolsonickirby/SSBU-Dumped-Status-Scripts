...
void __thiscall
L2CFighterKirby::status::JackSpecialNBarrage_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100155e4c:
  ...
  if ((uVar8 & 1) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack200);
    if ((uVar8 & 1) != 0) {
      lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KIRBY_STATUS_KIND_JACK_SPECIAL_N_BARRAGE_END);
