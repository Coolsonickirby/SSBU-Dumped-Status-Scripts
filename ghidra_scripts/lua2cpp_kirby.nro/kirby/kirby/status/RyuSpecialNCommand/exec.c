...
void __thiscall
L2CFighterKirby::status::KenSpecialN2Command_exec(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) goto LAB_71000bdf20;
...
LAB_71000bddcc:
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar4 & 1) == 0) goto LAB_71000bddcc;
