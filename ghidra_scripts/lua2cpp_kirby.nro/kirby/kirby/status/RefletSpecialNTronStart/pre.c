...
void __thiscall
L2CFighterKirby::status::RefletSpecialNTronStart_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_REFLET_MAGIC_KIND_THUNDER);
