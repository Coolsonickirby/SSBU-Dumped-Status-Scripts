...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNEarClose_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xfb61278a8);
  ...
  lib::L2CValue::L2CValue(aLStack80,SnakeSpecialNEarClose_main_loop);
