...
void __thiscall
L2CFighterKirby::status::KroolSpecialNLoop_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) goto LAB_710016ba7c;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar1,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) != 0) goto LAB_710016bb7c;
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar1,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((uVar5 & 1) != 0) goto LAB_710016ba84;
  }
  else {
LAB_710016ba7c:
    lib::L2CValue::_L2CValue(aLStack128);
LAB_710016ba84:
    ...
    FUN_710016a3c0(this,aLStack128,aLStack144);
...
LAB_710016bb7c:
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar3 & 1U) == 0) goto LAB_710016be38;
...
LAB_710016be38:
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar7,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) goto LAB_710016be74;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar1,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar5 & 1) != 0) goto LAB_710016bf74;
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)pLVar1,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack176);
    if ((uVar5 & 1) != 0) goto LAB_710016be7c;
  }
  else {
LAB_710016be74:
    lib::L2CValue::_L2CValue(aLStack176);
LAB_710016be7c:
    ...
    FUN_710016a3c0(this,aLStack176,aLStack192);
    lib::L2CValue::_L2CValue(aLStack192);
LAB_710016bf74:
    lib::L2CValue::_L2CValue(aLStack176);
  }
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((bVar3 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack208);
      if ((uVar5 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_KROOL_SPECIAL_N_END);
