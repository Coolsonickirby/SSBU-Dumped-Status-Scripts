...
void __thiscall
L2CFighterKirby::status::MasterSpecialNJumpCancel_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_MASTER_STATUS_WORK_KEEP_FLAG_SPECIAL_N_CANCEL_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_MASTER_STATUS_WORK_KEEP_FLAG_SPECIAL_N_CANCEL_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_MASTER_STATUS_WORK_KEEP_FLAG_SPECIAL_N_CANCEL_FLOAT);
