...
void __thiscall
L2CFighterKirby::status::MasterSpecialNJumpCancel_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,MasterSpecialNJumpCancel_main_loop);
