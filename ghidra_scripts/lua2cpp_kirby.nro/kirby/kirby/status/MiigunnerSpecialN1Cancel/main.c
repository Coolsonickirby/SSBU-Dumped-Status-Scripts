...
void __thiscall
L2CFighterKirby::status::MiigunnerSpecialN1Cancel_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    uVar6 = lib::L2CValue::operator__(aLStack96,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar6 & 1) != 0) goto LAB_71000524c8;
  }
  else {
LAB_71000524c8:
...
LAB_7100052584:
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,MiigunnerSpecialN1Cancel_main_loop);
