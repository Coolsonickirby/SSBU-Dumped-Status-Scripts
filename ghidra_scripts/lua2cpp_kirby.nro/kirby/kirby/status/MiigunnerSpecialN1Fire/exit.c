...
void __thiscall
L2CFighterKirby::status::MiigunnerSpecialN1Fire_exit(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_MIIGUNNER_INSTANCE_WORK_ID_INT_GUNNER_CHARGE_COUNT);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_MIIGUNNER_INSTANCE_WORK_ID_INT_EFH_CHARGE_MAX);
    iVar1 = lib::L2CValue::as_integer(aLStack112);
