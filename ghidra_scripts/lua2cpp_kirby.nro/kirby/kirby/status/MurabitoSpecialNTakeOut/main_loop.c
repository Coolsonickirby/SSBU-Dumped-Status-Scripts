...
void __thiscall
L2CFighterKirby::status::MurabitoSpecialNTakeOut_main_loop
...

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) == 0) goto LAB_71001a2174;
...
LAB_71001a2398:
    ...
    if ((uVar4 & 1) != 0) {
      ...
      FUN_71001a1a50(this,aLStack64,aLStack144);
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack64);
    }
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack176);
      lib::L2CValue::_L2CValue(aLStack144);
      if ((uVar4 & 1) != 0) goto LAB_71001a2398;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,1);
  }
LAB_71001a2530:
