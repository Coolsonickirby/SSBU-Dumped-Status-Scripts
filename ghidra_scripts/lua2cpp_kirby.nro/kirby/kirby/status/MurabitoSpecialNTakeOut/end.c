...
void __thiscall
L2CFighterKirby::status::MurabitoSpecialNTakeOut_end(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MURABITO_STATUS_SPECIAL_N_FLAG_END_SCALE);
