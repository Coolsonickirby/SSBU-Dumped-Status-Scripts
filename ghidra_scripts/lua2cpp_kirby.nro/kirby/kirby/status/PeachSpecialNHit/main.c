...
void __thiscall
L2CFighterKirby::status::DaisySpecialNHit_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_7100203670(this,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack96,DaisySpecialNHit_main_loop);
