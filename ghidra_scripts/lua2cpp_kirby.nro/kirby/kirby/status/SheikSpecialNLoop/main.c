...
void __thiscall
L2CFighterKirby::status::SheikSpecialNLoop_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FT_SHEIK_STATUS_SPECIAL_N_WORK_INT_CANCEL_STATUS);
  iVar2 = lib::L2CValue::as_integer(aLStack64);
  ...
  if ((uVar5 & 1) != 0) {
    ...
    FUN_71001fba80(aLStack80,this,aLStack96);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack64,&DAT_71001fbd50);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SheikSpecialNLoop_main_loop);
