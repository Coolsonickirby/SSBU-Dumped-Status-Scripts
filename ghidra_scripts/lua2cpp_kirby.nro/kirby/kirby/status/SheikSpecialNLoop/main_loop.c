...
void __thiscall
L2CFighterKirby::status::SheikSpecialNLoop_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001fc37c:
        ...
        if ((uVar8 & 1) != 0) {
          ...
          lua2cpp::L2CFighterCommon::sub_check_fly_in_charging_for_cancel_status
                    (this,(L2CValue)0x80);
          bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
          lib::L2CValue::_L2CValue(aLStack128);
          if ((bVar2 & 1U) != 0) goto LAB_71001fc618;
        }
        bVar2 = false;
      }
      else {
          ...
          if ((bVar2 & 1U) == 0) {
            ...
            if ((bVar2 & 1U) == 0) {
              ...
              if ((bVar2 & 1U) == 0) {
                ...
                lib::L2CValue::_L2CValue(aLStack128);
                lib::L2CValue::_L2CValue(aLStack144);
                if ((uVar8 & 1) == 0) goto LAB_71001fc37c;
                goto LAB_71001fc618;
              }
...
LAB_71001fcde8:
          ...
          if ((bVar2 & 1U) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack144);
            lib::L2CValue::_L2CValue(aLStack160);
            if ((uVar8 & 1) == 0) goto LAB_71001fceac;
            lib::L2CValue::L2CValue
                      (aLStack112,_FIGHTER_SHEIK_INSTANCE_WORK_ID_FLAG_MTRANS_WAIT_GROUND);
            iVar3 = lib::L2CValue::as_integer(aLStack112);
            app::lua_bind::WorkModule__off_flag_impl(*ppBVar12,iVar3);
...
LAB_71001fceac:
        ...
        lib::L2CValue::L2CValue(aLStack256,_FIGHTER_KIRBY_STATUS_KIND_SHEIK_SPECIAL_N_CANCEL);
        ...
        lib::L2CValue::L2CValue(aLStack224,_FIGHTER_KIRBY_STATUS_KIND_SHEIK_SPECIAL_N_CANCEL);
  ...
  lib::L2CValue::L2CValue(aLStack176,_FIGHTER_KIRBY_STATUS_KIND_SHEIK_SPECIAL_N_SHOOT);
