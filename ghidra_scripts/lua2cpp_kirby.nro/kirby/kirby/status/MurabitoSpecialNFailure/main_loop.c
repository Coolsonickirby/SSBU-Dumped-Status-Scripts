...
void __thiscall
L2CFighterKirby::status::MurabitoSpecialNFailure_main_loop
...
LAB_71001a2d00:
    ...
    FUN_71001a27c0(aLStack64,this,aLStack96,aLStack112,aLStack144,aLStack160,aLStack176,aLStack192,
                   aLStack208);
    lib::L2CValue::_L2CValue(aLStack64);
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71001a2d00;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,1);
  }
LAB_71001a2f38:
