...
void __thiscall
L2CFighterKirby::status::DonkeySpecialN_end(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_DONKEY_SPECIAL_N_LOOP);
