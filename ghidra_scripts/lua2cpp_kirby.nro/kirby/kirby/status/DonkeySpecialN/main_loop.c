...
void __thiscall
L2CFighterKirby::status::DonkeySpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) goto LAB_710021d0dc;
    }
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
    ...
    if ((uVar5 & 1) != 0) goto LAB_710021d0e4;
  }
  else {
LAB_710021d0dc:
    lib::L2CValue::_L2CValue(aLStack96);
LAB_710021d0e4:
    ...
    FUN_7100219ea0(this,aLStack80,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    pLVar6 = aLStack80;
LAB_710021d1e4:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KIRBY_STATUS_KIND_DONKEY_SPECIAL_N_ATTACK);
      lib::L2CValue::L2CValue(aLStack128,false);
      lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0x90,(L2CValue)0x80);
    }
    else {
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KIRBY_STATUS_KIND_DONKEY_SPECIAL_N_LOOP);
      lib::L2CValue::L2CValue(aLStack128,false);
      lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0x90,(L2CValue)0x80);
    }
    lib::L2CValue::_L2CValue(aLStack128);
