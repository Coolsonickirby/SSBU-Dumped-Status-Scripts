...
void __thiscall
L2CFighterKirby::status::KoopaSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100200c88:
      ...
      if ((uVar6 & 1) != 0) goto LAB_7100200afc;
    }
    iVar3 = 1;
    goto LAB_7100202250;
  }
...
LAB_7100200afc:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((bVar1 & 1) != 0) goto LAB_7100200d40;
    bVar2 = false;
  }
  else {
LAB_7100200d30:
...
LAB_7100201c48:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
    if ((bVar1 & 1) != 0) goto LAB_7100201d80;
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack112);
        lib::L2CValue::_L2CValue(aLStack128);
        if ((uVar6 & 1) != 0) goto LAB_7100201d80;
      }
    }
    bVar2 = false;
  }
    ...
    uVar6 = lib::L2CValue::operator__(pLVar7,aLStack112);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar6 & 1) == 0) goto LAB_7100201c48;
LAB_7100201ccc:
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
LAB_7100201d80:
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack112);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((bVar2 & 1U) == 0) goto LAB_7100202248;
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KOOPA_STATUS_BREATH_STEP_LOOP);
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_KOOPA_STATUS_BREATH_WORK_INT_STEP);
      iVar3 = lib::L2CValue::as_integer(aLStack112);
      iVar5 = lib::L2CValue::as_integer(aLStack128);
