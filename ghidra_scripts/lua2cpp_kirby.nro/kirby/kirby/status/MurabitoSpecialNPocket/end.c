...
void __thiscall
L2CFighterKirby::status::MurabitoSpecialNPocket_end(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar6 & 1) != 0) goto LAB_71000aa76c;
...
LAB_71000aa760:
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_MURABITO_SPECIAL_N_TAKE_OUT);
