...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNHoldDashF_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_SHOOT_DASH);
