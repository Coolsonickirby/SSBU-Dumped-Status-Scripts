...
void __thiscall
L2CFighterKirby::status::DededeSpecialNEatJump1_main_loop
...

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_DEDEDE_SPECIAL_N_EAT_JUMP2);
    ...
    if ((uVar5 & 1) == 0) goto LAB_71001defb0;
