...
void __thiscall
L2CFighterKirby::status::DededeSpecialNEatFall_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_71001ddb90(this);
  lib::L2CValue::L2CValue(aLStack80,DededeSpecialNEatFall_main_loop);
