...
void __thiscall
L2CFighterKirby::status::KamuiSpecialNHold_end(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_KAMUI_SPECIAL_N_SHOOT);
