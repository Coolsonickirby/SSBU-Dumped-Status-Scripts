...
void __thiscall
L2CFighterKirby::status::GekkougaSpecialNMaxStart_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x1320d64295);
  ...
  lib::L2CValue::L2CValue(aLStack80,0x17575c0c53);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_7100192820(this);
  lib::L2CValue::L2CValue(aLStack80,GekkougaSpecialNMaxStart_main_loop);
