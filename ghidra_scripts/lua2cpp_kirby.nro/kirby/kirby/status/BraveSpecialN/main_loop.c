...
void __thiscall
L2CFighterKirby::status::BraveSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack224);
      if ((bVar1 & 1U) == 0) goto LAB_7100154ca0;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack224);
    }
...
LAB_7100154ca0:
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_BRAVE_SPECIAL_N_HOLD);
