...
void __thiscall
L2CFighterKirby::status::SzerosuitSpecialN_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack200,FIGHTER_LOG_MASK_FLAG_ACTION_TRIGGER_ON | _FIGHTER_LOG_MASK_FLAG_SHOOT);
