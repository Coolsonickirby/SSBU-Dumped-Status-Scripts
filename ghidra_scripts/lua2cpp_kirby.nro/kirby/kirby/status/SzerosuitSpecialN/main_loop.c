...
void __thiscall
L2CFighterKirby::status::SzerosuitSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001e6344:
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_SZEROSUIT_SPECIAL_N_SHOOT_H);
