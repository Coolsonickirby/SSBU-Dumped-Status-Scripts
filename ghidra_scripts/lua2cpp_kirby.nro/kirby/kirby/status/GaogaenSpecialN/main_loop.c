...
void __thiscall
L2CFighterKirby::status::GaogaenSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar4 & 1) != 0) goto LAB_7100167d10;
    }
    iVar7 = 1;
    goto LAB_7100168008;
  }
