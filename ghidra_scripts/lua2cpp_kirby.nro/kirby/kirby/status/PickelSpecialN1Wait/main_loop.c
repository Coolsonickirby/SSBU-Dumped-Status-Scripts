...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1Wait_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) != 0) goto LAB_7100138c78;
...
LAB_7100138ec8:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((uVar5 & 1) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar5 & 1) != 0) {
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_PICKEL_SPECIAL_N1_WALK_BACK);
