...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1Wait_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_710012d860(aLStack96,aLStack112);
  ...
  FUN_710012db40(this);
  FUN_7100134da0(this);
  lib::L2CValue::L2CValue(aLStack96,PickelSpecialN1Wait_main_loop);
