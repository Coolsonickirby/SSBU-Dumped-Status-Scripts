...
void __thiscall
L2CFighterKirby::status::MewtwoSpecialNShoot_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_710018a830(this);
  lib::L2CValue::L2CValue(aLStack64,MewtwoSpecialNShoot_main_loop);
