...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootWalkB_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,BuddySpecialNShootWalkB_main_loop);
