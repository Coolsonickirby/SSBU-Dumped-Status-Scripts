...
void __thiscall
L2CFighterKirby::status::EflameSpecialNHold_end(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_EFLAME_SPECIAL_N_ATTACK);
