...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootWalkF_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,BuddySpecialNShootWalkF_main_loop);
