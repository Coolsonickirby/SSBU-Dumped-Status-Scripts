...
void __thiscall
L2CFighterKirby::status::DededeSpecialNEatJump2_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,0x132d71672c);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_71001ddb90(this);
  lib::L2CValue::L2CValue(aLStack80,DededeSpecialNEatJump2_main_loop);
