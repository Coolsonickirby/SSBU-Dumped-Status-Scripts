...
void __thiscall
L2CFighterKirby::status::PackunSpecialNEnd_end(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_PACKUN_GENERATE_ARTICLE_SPIKEBALL);
