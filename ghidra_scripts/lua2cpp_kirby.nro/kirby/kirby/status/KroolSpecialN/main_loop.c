...
void __thiscall
L2CFighterKirby::status::KroolSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) != 0) {
      ...
      uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) != 0) goto LAB_710016d72c;
    }
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) != 0) goto LAB_710016d82c;
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) goto LAB_710016d734;
  }
  else {
LAB_710016d72c:
    lib::L2CValue::_L2CValue(aLStack96);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar4 & 1) != 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack160);
        lib::L2CValue::_L2CValue(aLStack128);
        if ((uVar4 & 1) != 0) goto LAB_710016d968;
      }
      iVar3 = 1;
      goto LAB_710016df04;
    }
...
LAB_710016d968:
  ...
  if ((uVar4 & 1) == 0) {
    ...
    bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) == 0) goto LAB_710016dc14;
    lib::L2CValue::L2CValue(aLStack80,false);
...
LAB_710016dda8:
    ...
    if ((bVar2 & 1U) != 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        uVar4 = lib::L2CValue::operator__(pLVar6,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar4 & 1) == 0) goto LAB_710016def4;
...
LAB_710016def4:
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        if ((bVar2 & 1U) != 0) {
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_KROOL_SPECIAL_N_SUCTION);
