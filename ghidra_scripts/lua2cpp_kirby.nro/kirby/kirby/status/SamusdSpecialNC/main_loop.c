...
void __thiscall
L2CFighterKirby::status::SamusdSpecialNC_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar6 & 1) == 0) goto LAB_71002121ec;
      lib::L2CValue::L2CValue(aLStack80,true);
...
LAB_71002124c0:
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar6 & 1) == 0) goto LAB_71002125e4;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack128);
    }
...
LAB_71002125e4:
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack80,&DAT_7100212980);
...
LAB_71002126fc:
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar6 & 1) != 0) goto LAB_71002126fc;
    }
