...
void __thiscall
L2CFighterKirby::status::LucarioSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001d6474:
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        pLVar5 = aLStack96;
        if ((uVar4 & 1) != 0) goto LAB_71001d64b0;
        pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
        lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
        uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((uVar4 & 1) == 0) goto LAB_71001d64b4;
      }
      else {
        pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
        ...
        uVar4 = lib::L2CValue::operator__(pLVar5,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar4 & 1) == 0) goto LAB_71001d6474;
        lib::L2CValue::_L2CValue(aLStack96);
      }
      FUN_71001d5e10(this);
      goto LAB_71001d64b4;
    ...
    if ((bVar2 & 1U) == 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        lib::L2CValue::_L2CValue(aLStack96);
        if ((bVar2 & 1U) == 0) goto LAB_71001d63b0;
