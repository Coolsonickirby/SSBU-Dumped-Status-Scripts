...
void __thiscall
L2CFighterKirby::status::KroolSpecialNSwallow_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_71001680f0(this);
  lib::L2CValue::L2CValue(aLStack64,KroolSpecialNSwallow_main_loop);
