...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootEnd_main_loop
...

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      uVar6 = lib::L2CValue::operator__(aLStack96,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar6 & 1) != 0) goto LAB_710014470c;
...
LAB_710014470c:
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar6 & 1) != 0) goto LAB_7100144a70;
    }
...
LAB_7100144a70:
  ...
  if ((uVar6 & 1) == 0) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      app::FighterSpecializer_Buddy::update_special_n_partner_motion(pFVar9,(bool)(bVar1 & 1));
      goto LAB_7100144d98;
    }
  }
  else {
