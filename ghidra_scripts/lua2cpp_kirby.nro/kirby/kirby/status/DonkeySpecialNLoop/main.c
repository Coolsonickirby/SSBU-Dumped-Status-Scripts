...
void __thiscall
L2CFighterKirby::status::DonkeySpecialNLoop_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_DONKEY_STATUS_SPECIAL_N_FLAG_MOT_CHANGE);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    FUN_710021bff0(aLStack128,this,aLStack144);
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack80,&DAT_710021c240);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,DonkeySpecialNLoop_main_loop);
