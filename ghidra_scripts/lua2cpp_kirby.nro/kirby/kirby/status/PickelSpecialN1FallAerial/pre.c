...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1FallAerial_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    uVar15 = lib::L2CValue::as_integer(aLStack376);
    uVar8 = lib::L2CValue::as_integer(aLStack392);
    uVar13 = lib::L2CValue::as_integer(aLStack408);
