...
void __thiscall
L2CFighterKirby::status::LucasSpecialNFire_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar4 & 1) != 0) goto LAB_7100185068;
    }
...
LAB_7100185068:
  ...
  if ((uVar4 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((bVar2 & 1U) != 0) goto LAB_71001852d4;
  }
  else {
LAB_71001852d4:
