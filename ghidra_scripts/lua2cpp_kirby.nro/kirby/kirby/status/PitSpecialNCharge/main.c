...
void __thiscall L2CFighterKirby::status::PitbSpecialNCharge_main(L2CFighterCommon *this)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_71001e87d0);
  lib::L2CValue::operator_(this_00,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,PitbSpecialNCharge_main_loop);
