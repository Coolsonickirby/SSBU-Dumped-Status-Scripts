...
void __thiscall
L2CFighterKirby::status::MasterSpecialNMaxShoot_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack128,MasterSpecialNMaxShoot_main_loop);
