...
void __thiscall
L2CFighterKirby::status::PitbSpecialNCharge_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack128);
    if ((uVar5 & 1) != 0) goto LAB_71001e88f4;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack128);
LAB_71001e88f4:
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack144);
        lib::L2CValue::_L2CValue(aLStack128);
        if ((uVar5 & 1) == 0) goto LAB_71001e9220;
        lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KIRBY_STATUS_KIND_PIT_SPECIAL_N_DIR);
        ...
        if ((uVar5 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack128);
          if ((uVar5 & 1) == 0) goto LAB_71001e9220;
          lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KIRBY_STATUS_KIND_PIT_SPECIAL_N_TURN);
          lib::L2CValue::L2CValue(aLStack128,true);
          lua2cpp::L2CFighterBase::change_status(this,(L2CValue)0x90,(L2CValue)0x80);
        }
        else {
      ...
      app::lua_bind::WorkModule__on_flag_impl(*ppBVar10,iVar3);
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KIRBY_STATUS_KIND_PIT_SPECIAL_N_SHOOT);
