...
void __thiscall
L2CFighterKirby::status::EdgeSpecialNShoot_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_STATUS_ATTR_KEEP_MOTION_RATE);
