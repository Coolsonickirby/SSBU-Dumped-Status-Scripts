...
void __thiscall
L2CFighterKirby::status::DemonSpecialNAirStart_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  VVar2 = lib::L2CValue::as_integer(aLStack80);
  app::lua_bind::VisibilityModule__set_visibility_mode_impl(this->moduleAccessor,VVar2);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,DemonSpecialNAirStart_main_loop);
