...
void __thiscall
L2CFighterKirby::status::SzerosuitSpecialNLanding_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,SzerosuitSpecialNLanding_main_loop);
