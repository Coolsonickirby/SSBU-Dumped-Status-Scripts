...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1Walk_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack64,&LAB_710012c480);
  ...
  FUN_710012db40(this);
  FUN_7100134da0(this);
  lib::L2CValue::L2CValue(aLStack64,PickelSpecialN1Walk_main_loop);
