...
void __thiscall
L2CFighterKirby::status::FallAerial_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) != 0) {
      ...
      if ((bVar2 & 1U) == 0) {
        ...
        FUN_7100222850(aLStack176,this);
        lib::L2CValue::L2CValue(aLStack256,true);
  ...
  lua2cpp::L2CFighterCommon::status_pre_FallAerial(this);
  return;
}
