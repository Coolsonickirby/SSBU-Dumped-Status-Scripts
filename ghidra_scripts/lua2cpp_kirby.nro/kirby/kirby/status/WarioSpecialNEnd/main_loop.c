...
void __thiscall
L2CFighterKirby::status::WarioSpecialNEnd_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) != 0) goto LAB_71001f115c;
    }
    iVar5 = 1;
    goto LAB_71001f12d0;
  }
...
LAB_71001f11f4:
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    if ((uVar3 & 1) == 0) goto LAB_71001f11f4;
