...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootAir_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_FIGHTER_KIRBY_STATUS_KIND_BUDDY_SPECIAL_N_SHOOT_JUMP_SQUAT);
  ...
  if ((uVar15 & 1) == 0) {
    ...
    uVar15 = lib::L2CValue::operator__(pLVar14,aLStack120);
    lib::L2CValue::_L2CValue(aLStack120);
    if ((uVar15 & 1) == 0) goto LAB_71000ee978;
    ...
    if ((bVar2 & 1U) == 0) goto LAB_71000ee978;
...
LAB_71000ee978:
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_BUDDY_STATUS_WORK_KEEP_FLAG_SPECIAL_N_SHOOT_AIR_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_BUDDY_STATUS_WORK_KEEP_FLAG_SPECIAL_N_SHOOT_AIR_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_BUDDY_STATUS_WORK_KEEP_FLAG_SPECIAL_N_SHOOT_AIR_FLOAT)
  ;
  lib::L2CValue::L2CValue(aLStack248,FS_SUCCEEDS_KEEP_SLOPE | FS_SUCCEEDS_KEEP_VISIBILITY);
  ...
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_N);
