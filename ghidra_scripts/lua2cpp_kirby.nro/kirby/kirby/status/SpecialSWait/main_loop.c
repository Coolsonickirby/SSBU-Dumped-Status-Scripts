...
void __thiscall
L2CFighterKirby::status::SpecialSWait_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100229180:
    ...
    if ((bVar4 & 1U) == 0) {
      ...
      if ((uVar6 & 1) == 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack112);
        lib::L2CValue::_L2CValue(aLStack144);
        if ((uVar6 & 1) == 0) goto LAB_7100229298;
        lib::L2CValue::L2CValue(aLStack112,_FIGHTER_KIRBY_STATUS_KIND_SPECIAL_S_WALK);
...
LAB_7100229294:
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_7100229180;
    }
LAB_7100229298:
    iVar5 = 0;
  }
