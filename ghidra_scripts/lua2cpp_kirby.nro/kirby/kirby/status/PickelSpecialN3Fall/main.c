...
void __thiscall
L2CFighterKirby::status::PickelSpecialN3Fall_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_7100127aa0(this);
  FUN_7100120960(this);
  lib::L2CValue::L2CValue(aLStack96,PickelSpecialN3Fall_main_loop);
