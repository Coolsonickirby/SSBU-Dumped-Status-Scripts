...
void __thiscall
L2CFighterKirby::status::PickelSpecialN3Fall_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_7100120720(aLStack120,aLStack136);
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    FUN_7100120720(aLStack232,aLStack248);
    ...
    if ((uVar15 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack344);
      lib::L2CValue::L2CValue(aLStack344,_FIGHTER_PICKEL_STATUS_WORK_KEEP_FLAG_SPECIAL_N3_FLAG);
      lib::L2CValue::operator_(aLStack120,aLStack344);
      lib::L2CValue::_L2CValue(aLStack344);
      lib::L2CValue::L2CValue(aLStack344,_FIGHTER_PICKEL_STATUS_WORK_KEEP_FLAG_SPECIAL_N3_INT);
      lib::L2CValue::operator_(aLStack152,aLStack344);
      lib::L2CValue::_L2CValue(aLStack344);
      lib::L2CValue::L2CValue(aLStack344,_FIGHTER_PICKEL_STATUS_WORK_KEEP_FLAG_SPECIAL_N3_FLOAT);
    ...
    if ((uVar15 & 1) != 0) {
      ...
      FUN_710012a0f0(aLStack344,aLStack232);
      lib::L2CValue::operator_(aLStack120,aLStack344);
