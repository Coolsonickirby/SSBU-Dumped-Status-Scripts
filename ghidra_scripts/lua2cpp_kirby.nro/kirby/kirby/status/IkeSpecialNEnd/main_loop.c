...
void __thiscall
L2CFighterKirby::status::IkeSpecialNEnd_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001d8608:
          ...
          if ((uVar7 & 1) == 0) {
            ...
            uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
            lib::L2CValue::_L2CValue(aLStack112);
            if ((uVar7 & 1) != 0) goto LAB_71001d8678;
          }
        }
        else {
          pLVar8 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x16);
          ...
          uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar7 & 1) == 0) goto LAB_71001d8608;
LAB_71001d8678:
          FUN_71001d7eb0(this);
        }
      }
...
LAB_71001d86f4:
        ...
        lib::L2CValue::L2CValue(aLStack224,0x1ab49df8af);
        ...
        lib::L2CValue::L2CValue(aLStack272,_FIGHTER_IKE_STATUS_SPECIAL_N_WORK_FLOAT_CHARGE_COUNT);
        ...
        lib::L2CValue::L2CValue(aLStack304,0x1a807f5f7a);
        ...
        if ((uVar7 & 1) == 0) goto LAB_71001d8ae0;
        iVar5 = 0;
      }
      else {
        lib::L2CValue::L2CValue(aLStack128,0);
        ...
        lib::L2CValue::_L2CValue(aLStack112);
        lib::L2CValue::_L2CValue(aLStack128);
        if ((uVar7 & 1) != 0) goto LAB_71001d86f4;
LAB_71001d8ae0:
        iVar5 = 1;
      }
      lib::L2CValue::L2CValue(aLStack112,iVar5);
      ...
      if ((uVar7 & 1) == 0) {
        ...
        uVar7 = lib::L2CValue::operator__(pLVar8,aLStack112);
        lib::L2CValue::_L2CValue(aLStack112);
        if ((uVar7 & 1) == 0) goto LAB_71001d8548;
    ...
    if ((uVar7 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar7 & 1) == 0) goto LAB_71001d8af4;
      goto LAB_71001d8428;
    }
    lib::L2CValue::_L2CValue(aLStack144);
    lib::L2CValue::_L2CValue(aLStack336);
