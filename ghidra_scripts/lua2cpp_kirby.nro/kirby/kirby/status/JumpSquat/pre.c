...
void __thiscall L2CFighterKirby::status::JumpSquat_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    uVar3 = lib::L2CValue::operator__(aLStack336,aLStack256);
    lib::L2CValue::_L2CValue(aLStack256);
    if ((uVar3 & 1) != 0) {
      ...
      FUN_7100222a10(aLStack176,this);
      lib::L2CValue::L2CValue(aLStack256,true);
      ...
      lua2cpp::L2CFighterCommon::status_pre_JumpSquat_param
  ...
  lua2cpp::L2CFighterCommon::status_pre_JumpSquat(this);
  return;
}
