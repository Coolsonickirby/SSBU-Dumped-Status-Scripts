...
void __thiscall
L2CFighterKirby::status::SpecialHi4_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710022b3c4:
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_710022b3c4;
...
LAB_710022b450:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar3 & 1) != 0) goto LAB_710022b320;
  }
  iVar5 = 1;
LAB_710022b468:
