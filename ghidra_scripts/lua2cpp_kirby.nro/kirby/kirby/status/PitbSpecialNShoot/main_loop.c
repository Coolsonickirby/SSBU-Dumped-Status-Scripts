...
void __thiscall
L2CFighterKirby::status::PitbSpecialNShoot_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar5 & 1) != 0) goto LAB_71001e67c0;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack112);
LAB_71001e67c0:
...
LAB_71001e70dc:
    ...
    bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((bVar2 & 1U) == 0) goto LAB_71001e7224;
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) == 0) goto LAB_71001e7224;
      goto LAB_71001e70dc;
    }
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
