...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootJump_main_loop
...

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((bVar1 & 1U) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_BUDDY_SPECIAL_N_SHOOT_END);
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      if ((bVar1 & 1U) == 0) {
        ...
        bVar1 = lib::L2CValue::operator_cast_to_bool(aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((bVar1 & 1U) == 0) goto LAB_710014ad70;
