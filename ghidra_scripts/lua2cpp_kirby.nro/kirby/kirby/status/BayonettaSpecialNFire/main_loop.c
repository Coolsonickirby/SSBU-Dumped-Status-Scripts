...
void __thiscall
L2CFighterKirby::status::BayonettaSpecialNFire_main_loop
...

{
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) != 0) goto LAB_710017c794;
    }
    iVar3 = 1;
    goto LAB_710017ce50;
  }
...
LAB_710017c794:
  ...
  if ((uVar5 & 1) == 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_710017c7d0;
    }
    pLVar7 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack96,_SITUATION_KIND_GROUND);
    uVar5 = lib::L2CValue::operator__(pLVar7,aLStack96);
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) != 0) goto LAB_710017c7d8;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack112);
    }
...
LAB_710017c7d8:
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    if ((uVar5 & 1) == 0) {
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KIRBY_STATUS_KIND_BAYONETTA_SPECIAL_N_END);
