...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNHoldJump_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SnakeSpecialNHoldJump_main_loop);
