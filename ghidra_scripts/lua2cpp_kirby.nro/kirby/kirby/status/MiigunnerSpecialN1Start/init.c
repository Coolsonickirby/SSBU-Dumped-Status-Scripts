...
void __thiscall
L2CFighterKirby::status::MiigunnerSpecialN1Start_init(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_MIIGUNNER_INSTANCE_WORK_ID_FLAG_ST_INIT);
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MIIGUNNER_STATUS_GUNNER_CHARGE_WORK_INT_COUNT);
