...
void __thiscall
L2CFighterKirby::status::GekkougaSpecialNMaxShot_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,GekkougaSpecialNMaxShot_main_loop);
