...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootLanding_main
...

{
  ...
  FUN_7100145610();
  lib::L2CValue::L2CValue(aLStack80,0x17f1e94083);
  ...
  lib::L2CValue::L2CValue(aLStack80,BuddySpecialNShootLanding_main_loop);
