...
void __thiscall
L2CFighterKirby::status::DededeSpecialNEatPass_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack144);
  FUN_71001ddb90(this);
  lib::L2CValue::L2CValue(aLStack144,DededeSpecialNEatPass_main_loop);
