...
void __thiscall
L2CFighterKirby::status::SpecialSLanding_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71002264bc:
    ...
    if ((uVar4 & 1) == 0) {
      ...
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((bVar2 & 1U) == 0) goto LAB_71002267ec;
...
LAB_71002267e8:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) goto LAB_7100226440;
  }
LAB_71002267ec:
  iVar3 = 0;
LAB_71002267f4:
