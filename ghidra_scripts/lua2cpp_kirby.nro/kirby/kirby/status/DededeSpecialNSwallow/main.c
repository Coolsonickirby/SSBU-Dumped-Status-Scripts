...
void __thiscall
L2CFighterKirby::status::DededeSpecialNSwallow_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_71001dd470(this);
  lib::L2CValue::L2CValue(aLStack64,DededeSpecialNSwallow_main_loop);
