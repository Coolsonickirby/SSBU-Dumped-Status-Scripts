...
void __thiscall
L2CFighterKirby::status::WarioSpecialNBiteEnd_main_loop
...

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71001f0430;
    }
    iVar5 = 1;
    goto LAB_71001f0674;
  }
...
LAB_71001f0610:
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) == 0) goto LAB_71001f0658;
      iVar5 = 0;
    }
    else {
      lib::L2CValue::L2CValue(aLStack96,0);
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar3 & 1) != 0) goto LAB_71001f0610;
LAB_71001f0658:
      iVar5 = 1;
    }
    ...
    uVar3 = lib::L2CValue::operator__(pLVar4,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_71001f04c8;
