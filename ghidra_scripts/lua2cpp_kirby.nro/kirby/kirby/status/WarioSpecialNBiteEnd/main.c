...
void __thiscall
L2CFighterKirby::status::WarioSpecialNBiteEnd_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x12447d1aef);
  ...
  lib::L2CValue::L2CValue(aLStack80,0x16c9034aee);
  ...
  lib::L2CValue::L2CValue(aLStack80,WarioSpecialNBiteEnd_main_loop);
