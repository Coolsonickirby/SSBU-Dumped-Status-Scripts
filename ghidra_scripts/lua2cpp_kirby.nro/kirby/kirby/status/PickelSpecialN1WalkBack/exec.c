...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1WalkBack_exec(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0xee2ec2860);
  ...
  lib::L2CValue::L2CValue(aLStack64,0xef53a098c);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,0xea1225bca);
  ...
  lib::L2CValue::L2CValue(aLStack160,0x9eeaf3544);
  ...
  lib::L2CValue::L2CValue(aLStack272,0xed6982b48);
  uVar1 = lib::L2CValue::as_integer(aLStack256);
  uVar2 = lib::L2CValue::as_integer(aLStack272);
  fVar3 = (float)app::lua_bind::WorkModule__get_param_float_impl(this->moduleAccessor,uVar1,uVar2);
  lib::L2CValue::L2CValue(aLStack240,fVar3);
  ...
  lua2cpp::L2CFighterCommon::sub_walk_uniq_process_main_common_param
            (this,(L2CValue)0xc0,(L2CValue)0x50,(L2CValue)0x40,(L2CValue)0x30,(L2CValue)0x20,
             (L2CValue)0xe0,(L2CValue)0xd0);
