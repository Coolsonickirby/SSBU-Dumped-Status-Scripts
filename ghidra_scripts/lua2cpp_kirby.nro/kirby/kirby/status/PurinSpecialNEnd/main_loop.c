...
void __thiscall
L2CFighterKirby::status::PurinSpecialNEnd_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar1 & 1U) != 0) goto LAB_71001c0fa0;
...
LAB_71001c0c50:
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar5 & 1) != 0) goto LAB_71001c08b0;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack112);
LAB_71001c08b0:
...
LAB_71001c0e90:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) == 0) goto LAB_71001c0fa0;
