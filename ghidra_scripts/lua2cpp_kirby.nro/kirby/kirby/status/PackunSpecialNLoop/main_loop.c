...
void __thiscall
L2CFighterKirby::status::PackunSpecialNLoop_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100160308:
        ...
        uVar7 = lib::L2CValue::operator__(aLStack96,aLStack80);
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar7 & 1) == 0) goto LAB_710016039c;
        pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x1a);
        lib::L2CValue::L2CValue(aLStack80,0.0);
        ...
        lib::L2CValue::_L2CValue(aLStack80);
        if ((uVar7 & 1) == 0) goto LAB_7100160308;
        lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PACKUN_STATUS_SPECIAL_N_FLAG_SHOOT_FRONT);
        iVar3 = lib::L2CValue::as_integer(aLStack80);
        app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar3);
      }
...
LAB_710016039c:
    ...
    if ((uVar7 & 1) == 0) {
      ...
      uVar7 = lib::L2CValue::operator__(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar7 & 1) == 0) goto LAB_7100160174;
