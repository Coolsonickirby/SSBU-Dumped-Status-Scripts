...
void __thiscall
L2CFighterKirby::status::MetaknightSpecialNSpin_main_loop
...

{
  ...
  if ((uVar3 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_KIRBY_STATUS_KIND_METAKNIGHT_SPECIAL_N_END);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar3 = lib::L2CValue::operator__(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71001ee02c;
