...
void __thiscall
L2CFighterKirby::status::JackSpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KIRBY_STATUS_KIND_JACK_SPECIAL_N_ESCAPE);
  ...
  lib::L2CValue::L2CValue(aLStack96,&DAT_710015c460);
  lib::L2CValue::operator_(pLVar7,aLStack96);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,JackSpecialN_main_loop);
