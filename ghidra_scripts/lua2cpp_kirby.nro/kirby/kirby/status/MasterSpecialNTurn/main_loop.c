...
void __thiscall
L2CFighterKirby::status::MasterSpecialNTurn_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710014068c:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_710014055c;
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_MASTER_SPECIAL_N_HOLD);
