...
void __thiscall
L2CFighterKirby::status::YounglinkSpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar4 & 1) == 0) goto LAB_71000582b8;
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_LINK_STATUS_BOW_FLAG_DOUBLE);
      iVar2 = lib::L2CValue::as_integer(aLStack80);
...
LAB_71000582b8:
  lib::L2CValue::L2CValue(aLStack80,YounglinkSpecialN_main_loop);
