...
void __thiscall
L2CFighterKirby::status::SonicSpecialNFail_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_SONIC_SPECIAL_N_FAIL);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_N_FAIL_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_N_FAIL_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SONIC_SPECIAL_N_FAIL_FLOAT);
