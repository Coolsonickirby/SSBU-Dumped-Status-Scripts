...
void __thiscall
L2CFighterKirby::status::PickelSpecialN3Wait_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_710012b840(this);
  FUN_7100120960(this);
  lib::L2CValue::L2CValue(aLStack96,PickelSpecialN3Wait_main_loop);
