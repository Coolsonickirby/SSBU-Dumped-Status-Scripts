...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNHoldJumpSquat_main
...

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&LAB_7100175180);
  lib::L2CValue::operator_(this_00,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SnakeSpecialNHoldJumpSquat_main_loop);
