...
void __thiscall
L2CFighterKirby::status::DonkeySpecialNCancel_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack48);
  lib::L2CValue::L2CValue(aLStack48,DonkeySpecialNCancel_main_loop);
