...
void __thiscall
L2CFighterKirby::status::TantanSpecialNEnd_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_TANTAN_KIRBY_STATUS_WORK_KEEP_FLAG_SPECIAL_N_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_TANTAN_KIRBY_STATUS_WORK_KEEP_FLAG_SPECIAL_N_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_TANTAN_KIRBY_STATUS_WORK_KEEP_FLAG_SPECIAL_N_FLOAT);
