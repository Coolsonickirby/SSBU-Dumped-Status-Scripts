...
void __thiscall
L2CFighterKirby::status::BraveSpecialNJumpCancel_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack80,0x155da4a197);
    lib::L2CValue::L2CValue(aLStack96,0.0);
    lib::L2CValue::L2CValue(aLStack112,1.0);
    lib::L2CValue::L2CValue(aLStack128,false);
    HVar3 = lib::L2CValue::as_hash(aLStack80);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,BraveSpecialNJumpCancel_main_loop);
