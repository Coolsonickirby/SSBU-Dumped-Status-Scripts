...
void __thiscall
L2CFighterKirby::status::BraveSpecialNCancel_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if ((uVar6 & 1) == 0) goto LAB_71001534e0;
      lib::L2CValue::L2CValue(aLStack80,true);
...
LAB_71001535d8:
      ...
      uVar6 = lib::L2CValue::operator__(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar6 & 1) == 0) goto LAB_71001535d8;
      lib::L2CValue::L2CValue(aLStack80,-1);
      lib::L2CValue::L2CValue(aLStack240,_FIGHTER_BRAVE_STATUS_SPECIAL_N_HOLD_INT_NEXT_STATUS);
      iVar3 = lib::L2CValue::as_integer(aLStack80);
      iVar4 = lib::L2CValue::as_integer(aLStack240);
...
LAB_7100153688:
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack288);
      lib::L2CValue::_L2CValue(aLStack256);
      if ((uVar6 & 1) != 0) goto LAB_7100153894;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,0);
    goto LAB_71001539f4;
  }
