...
void __thiscall
L2CFighterKirby::status::EdgeSpecialN_exec(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  bVar1 = (uVar3 & 1) != 0;
  if (bVar1) {
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_EDGE_SPECIAL_N_SHOOT);
