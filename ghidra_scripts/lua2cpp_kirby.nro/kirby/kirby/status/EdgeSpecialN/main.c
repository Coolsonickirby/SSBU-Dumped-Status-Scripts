...
void __thiscall
L2CFighterKirby::status::EdgeSpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_7100114cf0(this,aLStack192);
  ...
  lib::L2CValue::_L2CValue(aLStack208);
  lib::L2CValue::L2CValue(aLStack208,EdgeSpecialN_main_loop);
