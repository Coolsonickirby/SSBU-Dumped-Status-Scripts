...
void __thiscall
L2CFighterKirby::status::PfushigisouSpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,PfushigisouSpecialN_main_loop);
