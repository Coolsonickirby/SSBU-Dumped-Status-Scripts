...
void __thiscall
L2CFighterKirby::status::PacmanSpecialNShoot_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_7100191834:
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_7100191834;
      FUN_710018dd50(this);
...
LAB_71001918e8:
    ...
    if ((uVar5 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) != 0) goto LAB_7100191770;
    }
    lib::L2CValue::L2CValue(aLStack80,_PACMAN_SPECIAL_N_RANK_MIN);
