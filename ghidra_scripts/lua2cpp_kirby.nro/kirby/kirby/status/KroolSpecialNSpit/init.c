...
void __thiscall
L2CFighterKirby::status::KroolSpecialNSpit_init(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_STATUS_THROW_WORK_INT_TARGET_OBJECT);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_STATUS_THROW_WORK_INT_TARGET_HIT_GROUP);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
