...
void __thiscall
L2CFighterKirby::status::SpecialNEatJump1_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack96,0x13b4783696);
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  FUN_710022feb0(this);
  lib::L2CValue::L2CValue(aLStack96,SpecialNEatJump1_main_loop);
