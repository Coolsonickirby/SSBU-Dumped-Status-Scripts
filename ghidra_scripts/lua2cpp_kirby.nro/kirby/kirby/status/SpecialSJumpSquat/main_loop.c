...
void __thiscall
L2CFighterKirby::status::SpecialSJumpSquat_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710022751c:
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_HAMMER_TRANSITION_TERM_ID_SQUAT);
...
LAB_71002275d8:
      ...
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((bVar2 & 1U) == 0) goto LAB_7100227654;
      ...
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar4 & 1) == 0) goto LAB_71002275d8;
    ...
    if ((uVar4 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) == 0) goto LAB_7100227654;
      goto LAB_710022751c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
