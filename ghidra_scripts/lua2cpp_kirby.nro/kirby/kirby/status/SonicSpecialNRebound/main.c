...
void __thiscall
L2CFighterKirby::status::SonicSpecialNRebound_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    uStack296 = _LUA_SCRIPT_STATUS_FUNC_STATUS_END;
    local_130 = LUA_SCRIPT_STATUS_FUNC_FIX_CAMERA;
    local_b0 = local_130;
    uStack168 = uStack296;
    local_a0 = local_130;
    uStack152 = uStack296;
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_90,SonicSpecialNRebound_main_loop);
