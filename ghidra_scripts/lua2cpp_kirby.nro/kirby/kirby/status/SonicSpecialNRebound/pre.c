...
void __thiscall
L2CFighterKirby::status::SonicSpecialNRebound_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_SONIC_SPECIAL_N_REBOUND);
