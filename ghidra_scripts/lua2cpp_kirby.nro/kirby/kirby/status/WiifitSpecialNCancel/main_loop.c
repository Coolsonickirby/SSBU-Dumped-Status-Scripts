...
void __thiscall
L2CFighterKirby::status::WiifitSpecialNCancel_main_loop
...

{
  ...
  if ((uVar7 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar7 & 1) != 0) goto LAB_71001afe7c;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack96);
LAB_71001afe7c:
...
LAB_71001b019c:
  ...
  if ((uVar7 & 1) != 0) {
    ...
    if ((uVar7 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar7 & 1) == 0) goto LAB_71001b03f0;
      lib::L2CValue::L2CValue(aLStack80,true);
...
LAB_71001b03f0:
  ...
  if ((uVar7 & 1) == 0) {
    ...
    if ((bVar3 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar7 & 1) == 0) goto LAB_71001b0508;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack128);
    }
...
LAB_71001b0a1c:
    ...
    if ((uVar7 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack160);
      lib::L2CValue::_L2CValue(aLStack128);
      if ((uVar7 & 1) != 0) goto LAB_71001b0a1c;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,1);
  }
LAB_71001b0a50:
