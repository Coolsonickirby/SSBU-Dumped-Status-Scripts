...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1Jump_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_710012d860(aLStack200,aLStack216);
  ...
  if ((uVar14 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack200,iVar5);
    uVar14 = lib::L2CValue::operator__(aLStack200,aLStack184);
    if ((uVar14 & 1) == 0) {
      pLVar13 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,10);
      lib::L2CValue::L2CValue(aLStack312,_FIGHTER_KIRBY_STATUS_KIND_PICKEL_SPECIAL_N3_JUMP);
      uVar14 = lib::L2CValue::operator__(pLVar13,aLStack312);
      lib::L2CValue::_L2CValue(aLStack312);
      lib::L2CValue::_L2CValue(aLStack200);
      if ((uVar14 & 1) == 0) goto LAB_71000f9e48;
    }
    else {
      lib::L2CValue::_L2CValue(aLStack200);
    }
    ...
    FUN_7100137470(aLStack312,aLStack200);
    lib::L2CValue::operator_(aLStack120,aLStack312);
