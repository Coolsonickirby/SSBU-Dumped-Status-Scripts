...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNHoldAir_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,&DAT_7100173be0);
  lib::L2CValue::operator_(this_00,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SnakeSpecialNHoldAir_main_loop);
