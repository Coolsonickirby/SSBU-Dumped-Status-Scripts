...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNThrow_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710017345c:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_710017334c;
  }
  iVar5 = 1;
LAB_7100173468:
