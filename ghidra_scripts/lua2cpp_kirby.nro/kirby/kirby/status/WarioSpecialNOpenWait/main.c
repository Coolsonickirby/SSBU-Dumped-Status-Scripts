...
void __thiscall
L2CFighterKirby::status::WarioSpecialNOpenWait_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  if ((uVar4 & 1) != 0) {
    FUN_71001f13a0(aLStack96,this);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x14);
  lib::L2CValue::L2CValue(aLStack80,&LAB_71001f1460);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  FUN_71001efac0(this);
  lib::L2CValue::L2CValue(aLStack80,WarioSpecialNOpenWait_main_loop);
