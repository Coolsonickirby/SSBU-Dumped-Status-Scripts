...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1JumpAerial_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack312,_FIGHTER_STATUS_KIND_FLY);
  ...
  uVar14 = lib::L2CValue::operator__(aLStack312,aLStack200);
  lib::L2CValue::_L2CValue(aLStack312);
  lib::L2CValue::_L2CValue(aLStack232);
  if ((uVar14 & 1) != 0) {
    lib::L2CValue::L2CValue(aLStack232,aLStack168);
    FUN_7100137470(aLStack312,aLStack232);
    lib::L2CValue::operator_(aLStack120,aLStack312);
  ...
  uVar14 = lib::L2CValue::as_integer(aLStack392);
  ...
  app::lua_bind::FighterStatusModuleImpl__set_fighter_status_data_impl
            (this->moduleAccessor,(bool)(bVar1 & 1),iVar5,(bool)(bVar2 & 1),(bool)(bVar3 & 1),
             (bool)(bVar4 & 1),uVar14,uVar7,uVar12,in_stack_fffffffffffffe34);
