...
void __thiscall
L2CFighterKirby::status::MurabitoSpecialNSearch_main_loop
...

{
  ...
  FUN_71001a27c0(aLStack96,this,aLStack208,aLStack224,aLStack240,aLStack256,aLStack272,aLStack288,
                 aLStack304);
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack320);
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KIRBY_MURABITO_AREA_KIND_SEARCH_ITEM);
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if ((bVar2 & 1U) != 0) {
        ...
        lib::L2CValue::_L2CValue(aLStack336);
        if ((uVar6 & 1) == 0) {
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KIRBY_STATUS_KIND_MURABITO_SPECIAL_N_POCKET);
          lib::L2CValue::operator_(aLStack160,aLStack96);
        }
        else {
          lib::L2CValue::L2CValue(aLStack96,_FIGHTER_KIRBY_STATUS_KIND_MURABITO_SPECIAL_N_FAILURE);
          lib::L2CValue::operator_(aLStack160,aLStack96);
        }
        lib::L2CValue::_L2CValue(aLStack96);
      ...
      lib::L2CValue::_L2CValue(aLStack320);
      if ((uVar6 & 1) != 0) {
        lib::L2CValue::L2CValue(aLStack384,_FIGHTER_KIRBY_STATUS_KIND_MURABITO_SPECIAL_N_FAILURE);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      if ((uVar6 & 1) != 0) {
        ...
        FUN_71001654a0(aLStack464,this,aLStack96,aLStack320,aLStack336,aLStack352,aLStack128,
