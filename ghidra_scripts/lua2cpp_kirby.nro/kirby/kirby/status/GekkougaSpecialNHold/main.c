...
void __thiscall
L2CFighterKirby::status::GekkougaSpecialNHold_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,GekkougaSpecialNHold_main_loop);
