...
void __thiscall
L2CFighterKirby::status::GekkougaSpecialNHold_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_GEKKOUGA_STATUS_WORK_KEEP_RELEASE_HOLD_BUTTON_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_GEKKOUGA_STATUS_WORK_KEEP_RELEASE_HOLD_BUTTON_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_GEKKOUGA_STATUS_WORK_KEEP_RELEASE_HOLD_BUTTON_FLOAT);
