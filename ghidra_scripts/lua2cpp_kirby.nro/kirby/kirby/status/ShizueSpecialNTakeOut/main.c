...
void __thiscall
L2CFighterKirby::status::ShizueSpecialNTakeOut_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    uVar4 = lib::L2CValue::operator__(aLStack96,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) == 0) goto LAB_71000dd640;
...
LAB_71000dd640:
  ...
  FUN_7100161720(this,aLStack160,aLStack176);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::_L2CValue(aLStack240);
  lib::L2CValue::L2CValue(aLStack80,ShizueSpecialNTakeOut_main_loop);
