...
void __thiscall
L2CFighterKirby::status::PlizardonSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack448);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar6 & 1) != 0) goto LAB_71001cdf14;
    }
...
LAB_71001ce254:
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) == 0) goto LAB_71001ce254;
      lib::L2CValue::L2CValue(aLStack96,true);
      lib::L2CValue::operator_(aLStack256,aLStack96);
LAB_71001ce2dc:
      lib::L2CValue::_L2CValue(aLStack96);
  ...
  if ((bVar3 & 1U) == 0) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      uVar6 = lib::L2CValue::operator__(pLVar7,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar6 & 1) != 0) goto LAB_71001ce3bc;
LAB_71001ce75c:
...
LAB_71001ce758:
      ...
      bVar3 = lib::L2CValue::operator_cast_to_bool(aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar3 & 1U) == 0) goto LAB_71001ce75c;
      lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PLIZARDON_STATUS_BREATH_STEP_LOOP);
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_PLIZARDON_STATUS_BREATH_WORK_INT_STEP);
      iVar4 = lib::L2CValue::as_integer(aLStack96);
      iVar5 = lib::L2CValue::as_integer(aLStack128);
...
LAB_71001ce768:
    ...
    if ((bVar3 & 1U) != 0) goto LAB_71001ce788;
  }
  else {
LAB_71001ce788:
    FUN_71001ccf00(this);
