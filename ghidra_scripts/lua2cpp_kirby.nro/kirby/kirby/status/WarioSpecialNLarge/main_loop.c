...
void __thiscall
L2CFighterKirby::status::WarioSpecialNLarge_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001ef404:
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar3 & 1) == 0) goto LAB_71001ef404;
...
LAB_71001ef498:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71001ef4d8;
      goto LAB_71001ef36c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
