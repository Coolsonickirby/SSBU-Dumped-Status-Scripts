...
void __thiscall
L2CFighterKirby::status::WarioSpecialNLarge_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0xffc78d0d2);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x13f7e15d06);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_71001ee6f0(this);
  lib::L2CValue::L2CValue(aLStack64,WarioSpecialNLarge_main_loop);
