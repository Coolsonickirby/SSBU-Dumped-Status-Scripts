...
void __thiscall
L2CFighterKirby::status::PickelSpecialN3JumpAerial_main_loop
...
LAB_710012aa6c:
  ...
  if ((uVar5 & 1) == 0) {
    ...
    FUN_7100128210(aLStack96,this,aLStack176);
    lib::L2CValue::L2CValue(aLStack64,true);
    uVar5 = lib::L2CValue::operator__(aLStack96,aLStack64);
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack96);
        ...
        if ((uVar5 & 1) == 0) {
          ...
          if ((bVar1 & 1U) == 0) {
            ...
            lib::L2CValue::L2CValue
                      (aLStack64,_FIGHTER_KIRBY_STATUS_KIND_PICKEL_SPECIAL_N3_FALL_AERIAL);
