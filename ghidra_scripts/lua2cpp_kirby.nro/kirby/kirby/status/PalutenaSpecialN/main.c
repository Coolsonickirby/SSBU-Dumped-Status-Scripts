...
void __thiscall
L2CFighterKirby::status::PalutenaSpecialN_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar6 & 1) == 0) {
    ...
    uVar6 = lib::L2CValue::operator__(pLVar5,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar6 & 1) == 0) goto LAB_71000ac47c;
  ...
  lib::L2CValue::_L2CValue(aLStack96);
LAB_71000ac47c:
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_PALUTENA_STATUS_SPECIAL_N_FLAG_HAS_TARGET_ARTICLE);
  iVar3 = lib::L2CValue::as_integer(aLStack96);
  app::lua_bind::WorkModule__off_flag_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,BATTLE_OBJECT_CATEGORY_INVALID);
  lib::L2CValue::L2CValue(aLStack112,_FIGHTER_PALUTENA_STATUS_SPECIAL_N_WORK_INT_TARGET_CATEGORY);
  iVar3 = lib::L2CValue::as_integer(aLStack96);
  iVar4 = lib::L2CValue::as_integer(aLStack112);
  app::lua_bind::WorkModule__set_int_impl(this->moduleAccessor,iVar3,iVar4);
  lib::L2CValue::_L2CValue(aLStack112);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::L2CValue(aLStack96,PalutenaSpecialN_main_loop);
