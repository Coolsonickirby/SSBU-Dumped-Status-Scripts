...
void __thiscall
L2CFighterKirby::status::TrailSpecialN1_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack144,_FIGHTER_KIRBY_STATUS_KIND_TRAIL_SPECIAL_N1_SHOOT);
