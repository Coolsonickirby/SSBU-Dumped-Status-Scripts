...
void __thiscall
L2CFighterKirby::status::PurinSpecialNTurn_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar7 & 1) == 0) {
    ...
    if ((uVar7 & 1) != 0) {
      ...
      uVar7 = lib::L2CValue::operator__(pLVar8,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar7 & 1) != 0) goto LAB_71001c11b0;
    }
    pLVar8 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)this_00,0x17);
    lib::L2CValue::L2CValue(aLStack80,_SITUATION_KIND_GROUND);
    uVar7 = lib::L2CValue::operator__(pLVar8,aLStack80);
    ...
    if ((uVar7 & 1) != 0) goto LAB_71001c11b8;
  }
  else {
LAB_71001c11b0:
    lib::L2CValue::_L2CValue(aLStack96);
...
LAB_71001c13e4:
  ...
  if ((uVar7 & 1) != 0) {
    ...
    if ((uVar7 & 1) != 0) {
      ...
      app::FighterSpecializer_Kirby::purin_req_effect_dash_smoke(pBVar10);
  ...
  uVar7 = lib::L2CValue::operator__(aLStack96,aLStack80);
  lib::L2CValue::_L2CValue(aLStack80);
  if ((uVar7 & 1) == 0) goto LAB_71001c1e9c;
