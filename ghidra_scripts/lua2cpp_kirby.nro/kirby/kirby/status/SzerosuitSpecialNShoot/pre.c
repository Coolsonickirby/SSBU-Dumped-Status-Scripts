...
void __thiscall
L2CFighterKirby::status::SzerosuitSpecialNShoot_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SZEROSUIT_SPECIAL_N_SHOOT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SZEROSUIT_SPECIAL_N_SHOOT_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SZEROSUIT_SPECIAL_N_SHOOT_FLOAT)
  ;
