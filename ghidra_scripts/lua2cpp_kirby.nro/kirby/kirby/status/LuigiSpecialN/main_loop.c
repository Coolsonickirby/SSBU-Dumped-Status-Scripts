...
void __thiscall
L2CFighterKirby::status::LuigiSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710020a974:
    ...
    lib::L2CValue::_L2CValue(aLStack112);
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack112,_FIGHTER_LUIGI_STATUS_SPECIAL_N_INT_MTRANS);
    ...
    if ((uVar4 & 1) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack144);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((uVar4 & 1) != 0) goto LAB_710020a974;
    }
    lib::L2CValue::L2CValue((L2CValue *)return_value,0);
  }
LAB_710020ac44:
