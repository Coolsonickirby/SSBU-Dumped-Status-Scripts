...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1Fall_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_7100136150(this);
  FUN_710012db40(this);
  lib::L2CValue::L2CValue(aLStack80,PickelSpecialN1Fall_main_loop);
