...
void __thiscall
L2CFighterKirby::status::PickelSpecialN1Fall_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  FUN_710012d860(aLStack120,aLStack136);
  ...
  if ((bVar1 & 1U) == 0) {
    ...
    if ((uVar15 & 1) != 0) {
      ...
      FUN_7100137470(aLStack344,aLStack232);
      lib::L2CValue::operator_(aLStack120,aLStack344);
