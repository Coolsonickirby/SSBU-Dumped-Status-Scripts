...
void __thiscall
L2CFighterKirby::status::PackunSpecialN_pre(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_PACKUN_GENERATE_ARTICLE_SPIKEBALL);
  ...
  if (bVar2) {
    ...
    lib::L2CValue::L2CValue
              (aLStack216,FIGHTER_STATUS_ATTR_DISABLE_TURN_DAMAGE | _FIGHTER_STATUS_ATTR_START_TURN)
    ;
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_KIRBY_STATUS_KIND_PACKUN_SPECIAL_N_FAILURE);
