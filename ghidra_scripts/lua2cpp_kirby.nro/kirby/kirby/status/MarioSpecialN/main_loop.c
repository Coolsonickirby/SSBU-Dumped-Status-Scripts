...
void __thiscall
L2CFighterKirby::status::MarioSpecialN_main_loop(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
    if ((uVar5 & 1) != 0) goto LAB_710021d57c;
  }
  else {
    lib::L2CValue::_L2CValue(aLStack112);
LAB_710021d57c:
...
LAB_710021da00:
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((uVar5 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack96);
      lib::L2CValue::_L2CValue(aLStack112);
      if ((bVar2 & 1U) != 0) goto LAB_710021dc30;
    }
    pLVar6 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x16);
    lib::L2CValue::L2CValue(aLStack96,SITUATION_KIND_AIR);
    uVar5 = lib::L2CValue::operator__(pLVar6,aLStack96);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar6,aLStack96);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((uVar5 & 1) == 0) goto LAB_710021dc30;
