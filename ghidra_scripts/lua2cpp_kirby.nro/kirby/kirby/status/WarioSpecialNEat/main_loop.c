...
void __thiscall
L2CFighterKirby::status::WarioSpecialNEat_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_71001eeda4:
      ...
      uVar3 = lib::L2CValue::operator__(pLVar4,aLStack64);
      lib::L2CValue::_L2CValue(aLStack64);
      if ((uVar3 & 1) == 0) goto LAB_71001eeda4;
...
LAB_71001eee38:
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_71001eee78;
      goto LAB_71001eed0c;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
