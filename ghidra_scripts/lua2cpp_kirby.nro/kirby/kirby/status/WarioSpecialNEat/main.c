...
void __thiscall
L2CFighterKirby::status::WarioSpecialNEat_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,0xdbae2698c);
  ...
  lib::L2CValue::L2CValue(aLStack64,0x115a8fcaa5);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  FUN_71001ee6f0(this);
  lib::L2CValue::L2CValue(aLStack80,0x36b6716d06);
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,WarioSpecialNEat_main_loop);
