...
void __thiscall
L2CFighterKirby::status::JackSpecialNLanding_main_loop(L2CFighterKirby *this,L2CValue *return_value)
    ...
    if ((bVar1 & 1U) == 0) {
      ...
      if ((uVar4 & 1) != 0) {
        ...
        if ((bVar1 & 1U) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack64);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((bVar1 & 1U) == 0) goto LAB_71001552cc;
        }
        else {
          lib::L2CValue::_L2CValue(aLStack64);
          lib::L2CValue::_L2CValue(aLStack80);
        }
        lib::L2CValue::L2CValue(aLStack64,_FIGHTER_KIRBY_STATUS_KIND_JACK_SPECIAL_N);
