...
void __thiscall
L2CFighterKirby::status::SnakeSpecialNHoldDashB_main(L2CFighterKirby *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::operator_(pLVar2,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,SnakeSpecialNHoldDashB_main_loop);
