...
void __thiscall
L2CFighterKirby::status::SpecialSTurn_main_loop(L2CFighterKirby *this,L2CValue *return_value)
...
LAB_710022789c:
    ...
    if ((uVar4 & 1) == 0) {
      ...
      bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((bVar2 & 1U) == 0) goto LAB_7100227944;
...
LAB_7100227940:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar4 & 1) != 0) goto LAB_7100227820;
  }
LAB_7100227944:
  iVar3 = 0;
LAB_710022794c:
