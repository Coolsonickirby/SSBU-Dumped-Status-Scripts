...
void __thiscall
L2CFighterKirby::status::ShizueSpecialNPocket_main_loop
...

{
  ...
  if ((bVar3 & 1U) != 0) {
    ...
    if ((bVar3 & 1U) == 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar3 & 1U) != 0) goto LAB_7100162e9c;
...
LAB_7100162ff0:
      ...
      lib::L2CValue::_L2CValue(aLStack112);
      lib::L2CValue::_L2CValue(aLStack96);
      if ((bVar2 & 1) != 0) goto LAB_7100163008;
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_MURABITO_STATUS_SPECIAL_N_FLAG_TAKEOUT_INPUT);
      iVar4 = lib::L2CValue::as_integer(aLStack80);
      app::lua_bind::WorkModule__on_flag_impl(this->moduleAccessor,iVar4);
      pLVar7 = aLStack80;
...
LAB_71001636d8:
    bVar3 = lib::L2CValue::operator_cast_to_bool(aLStack96);
    if ((bVar3 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack272,_FIGHTER_KIRBY_STATUS_KIND_SHIZUE_SPECIAL_N_TAKE_OUT);
    ...
    if ((uVar8 & 1) != 0) {
      ...
      if ((uVar8 & 1) != 0) {
        ...
        if ((uVar8 & 1) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack304);
          lib::L2CValue::_L2CValue(aLStack112);
          if ((uVar8 & 1) != 0) goto LAB_7100163874;
        }
        lib::L2CValue::L2CValue((L2CValue *)return_value,1);
        goto LAB_7100163ca4;
      }
...
LAB_7100163874:
    ...
    if ((uVar8 & 1) != 0) {
      ...
      if ((bVar3 & 1U) != 0) {
        ...
        if ((bVar3 & 1U) == 0) {
          ...
          lib::L2CValue::_L2CValue(aLStack128);
          lib::L2CValue::_L2CValue(aLStack80);
          lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_SHIZUE_SPECIAL_N_TAKE_OUT);
          lib::L2CValue::operator_(aLStack112,aLStack80);
        }
        lib::L2CValue::_L2CValue(aLStack80);
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KIRBY_STATUS_KIND_SHIZUE_SPECIAL_N);
    uVar8 = lib::L2CValue::operator__(pLVar7,aLStack80);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar8 & 1) == 0) {
    ...
    FUN_7100162490(aLStack352,this,aLStack368,aLStack384,aLStack400,aLStack416,aLStack432,aLStack448
                   ,aLStack464);
    ...
    lib::L2CValue::L2CValue(aLStack240,_FIGHTER_KIRBY_STATUS_KIND_SHIZUE_SPECIAL_N_FAILURE);
