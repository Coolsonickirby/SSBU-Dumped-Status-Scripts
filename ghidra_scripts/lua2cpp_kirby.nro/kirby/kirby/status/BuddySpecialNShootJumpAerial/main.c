...
void __thiscall
L2CFighterKirby::status::BuddySpecialNShootJumpAerial_main
...

{
  ...
  FUN_7100145610(this);
  FUN_7100149de0(this);
  lib::L2CValue::L2CValue(aLStack112,BuddySpecialNShootJumpAerial_main_loop);
