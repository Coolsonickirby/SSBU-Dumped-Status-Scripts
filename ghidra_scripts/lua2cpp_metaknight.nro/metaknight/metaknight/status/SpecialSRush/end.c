...
void __thiscall
L2CFighterMetaknight::status::SpecialSRush_end(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue((L2CValue *)&local_40,_FIGHTER_METAKNIGHT_STATUS_KIND_SPECIAL_S_END);
