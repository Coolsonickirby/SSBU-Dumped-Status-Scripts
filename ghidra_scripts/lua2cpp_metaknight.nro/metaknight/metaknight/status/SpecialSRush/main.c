...
void __thiscall
L2CFighterMetaknight::status::SpecialSRush_main(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xf02f6b392);
  ...
  lib::L2CValue::L2CValue(aLStack80,SpecialSRush_main_loop);
