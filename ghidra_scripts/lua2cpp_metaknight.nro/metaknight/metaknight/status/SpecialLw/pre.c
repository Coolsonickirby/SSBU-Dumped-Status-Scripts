...
void __thiscall
L2CFighterMetaknight::status::SpecialLw_pre(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_METAKNIGHT_SPECIAL_LW);
  ...
  lib::L2CValue::L2CValue
            (aLStack200,
             _FIGHTER_LOG_MASK_FLAG_ATTACK_KIND_NONE | _FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_NONE);
