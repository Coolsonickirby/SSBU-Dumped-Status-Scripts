...
void __thiscall
L2CFighterMetaknight::status::SpecialS_pre(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             _FIGHTER_STATUS_ATTR_DISABLE_GROUND_FRICTION | _FIGHTER_STATUS_ATTR_START_TURN);
