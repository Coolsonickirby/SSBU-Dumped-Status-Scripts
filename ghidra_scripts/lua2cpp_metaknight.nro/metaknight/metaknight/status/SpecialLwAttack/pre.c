...
void __thiscall
L2CFighterMetaknight::status::SpecialLwAttack_pre(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_METAKNIGHT_SPECIAL_LW_ATTACK);
