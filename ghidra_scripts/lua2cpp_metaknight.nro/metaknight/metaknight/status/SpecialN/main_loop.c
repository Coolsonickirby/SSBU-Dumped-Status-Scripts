...
void __thiscall
L2CFighterMetaknight::status::SpecialN_main_loop(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) != 0) {
    lib::L2CValue::L2CValue(aLStack128,_FIGHTER_METAKNIGHT_STATUS_KIND_SPECIAL_N_SPIN);
  ...
  if ((bVar2 & 1U) != 0) {
    ...
    if ((uVar5 & 1) == 0) {
      ...
      uVar5 = lib::L2CValue::operator__(pLVar4,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar5 & 1) == 0) goto LAB_710001e0e4;
