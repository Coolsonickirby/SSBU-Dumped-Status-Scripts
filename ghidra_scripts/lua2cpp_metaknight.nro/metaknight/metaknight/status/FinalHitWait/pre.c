...
void __thiscall
L2CFighterMetaknight::status::FinalHitWait_pre(L2CFighterMetaknight *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack248,FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_HIT);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,_FIGHTER_STATUS_ATTR_FINAL | _FIGHTER_STATUS_ATTR_DISABLE_ITEM_INTERRUPT);
