...
void __thiscall L2CWeaponMetaknightMantle::SetStatusScripts(L2CWeaponMetaknightMantle *this)

{
  ...
  iVar1 = _WEAPON_METAKNIGHT_MANTLE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_METAKNIGHT_MANTLE_STATUS_KIND_DEFAULT);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_INIT_STATUS);
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Default_init);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_METAKNIGHT_MANTLE_STATUS_KIND_FINAL);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_INIT_STATUS);
  lua2cpp::L2CAgentBase::sv_set_status_func
