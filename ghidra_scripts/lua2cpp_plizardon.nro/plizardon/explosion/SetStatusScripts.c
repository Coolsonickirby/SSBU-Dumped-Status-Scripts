...
void __thiscall L2CWeaponPlizardonExplosion::SetStatusScripts(L2CWeaponPlizardonExplosion *this)

{
  ...
  iVar1 = _WEAPON_PLIZARDON_EXPLOSION_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PLIZARDON_EXPLOSION_STATUS_KIND_START);
