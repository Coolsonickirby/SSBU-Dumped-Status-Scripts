...
void __thiscall L2CWeaponPlizardonDaimonji::SetStatusScripts(L2CWeaponPlizardonDaimonji *this)

{
  ...
  iVar1 = _WEAPON_PLIZARDON_DAIMONJI_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PLIZARDON_DAIMONJI_STATUS_KIND_MOVE);
