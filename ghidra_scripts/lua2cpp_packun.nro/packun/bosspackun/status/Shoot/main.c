...
void __thiscall
L2CWeaponPackunBosspackun::status::Shoot_main
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack112,_WEAPON_PACKUN_POISONBREATH_INSTANCE_WORK_ID_FLOAT_CHARGE_RATIO);
  ...
  if ((uVar3 & 1) == 0) {
    lib::L2CValue::L2CValue(aLStack80,0x9557e7353);
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::L2CValue
              (aLStack96,_WEAPON_PACKUN_POISONBREATH_INSTANCE_WORK_ID_FLOAT_CHARGE_RATIO);
  ...
  if ((uVar3 & 1) != 0) {
    ...
    FUN_710003d1f0(aLStack96,this,aLStack112);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack112);
  }
  pLVar5 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x15);
  lib::L2CValue::L2CValue(aLStack80,&DAT_710003d360);
