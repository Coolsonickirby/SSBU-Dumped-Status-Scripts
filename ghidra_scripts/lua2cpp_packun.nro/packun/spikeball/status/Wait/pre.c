...
void __thiscall
L2CWeaponPackunSpikeball::status::Wait_pre(L2CWeaponPackunSpikeball *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_PACKUN_SPIKEBALL_STATUS_WORK_KEEP_FLAG_WAIT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_PACKUN_SPIKEBALL_STATUS_WORK_KEEP_FLAG_WAIT_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_PACKUN_SPIKEBALL_STATUS_WORK_KEEP_FLAG_WAIT_FLOAT);
