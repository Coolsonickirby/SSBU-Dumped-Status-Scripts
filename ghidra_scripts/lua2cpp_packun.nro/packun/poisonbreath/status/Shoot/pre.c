...
void __thiscall
L2CWeaponPackunPoisonbreath::status::Shoot_pre
          (L2CWeaponPackunPoisonbreath *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_WEAPON_PACKUN_POISONBREATH_STATUS_WORK_KEEP_FLAG_SHOOT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_WEAPON_PACKUN_POISONBREATH_STATUS_WORK_KEEP_FLAG_SHOOT_INT);
  lib::L2CValue::L2CValue(aLStack232,_WEAPON_PACKUN_POISONBREATH_STATUS_WORK_KEEP_FLAG_SHOOT_FLOAT);
