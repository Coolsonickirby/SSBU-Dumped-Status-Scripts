...
void __thiscall L2CWeaponPackunPoisonbreath::SetStatusScripts(L2CWeaponPackunPoisonbreath *this)

{
  ...
  iVar1 = _WEAPON_PACKUN_POISONBREATH_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PACKUN_POISONBREATH_STATUS_KIND_START);
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Start_init);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PACKUN_POISONBREATH_STATUS_KIND_START);
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Start_exit);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PACKUN_POISONBREATH_STATUS_KIND_SHOOT);
  lib::L2CValue::L2CValue(aLStack96,LUA_SCRIPT_STATUS_FUNC_INIT_STATUS);
