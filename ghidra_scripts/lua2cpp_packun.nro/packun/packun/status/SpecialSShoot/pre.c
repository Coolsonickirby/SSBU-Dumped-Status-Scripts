...
void __thiscall
L2CFighterPackun::status::SpecialSShoot_pre(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SPECIAL_S_SHOOT_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SPECIAL_S_SHOOT_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SPECIAL_S_SHOOT_FLOAT);
