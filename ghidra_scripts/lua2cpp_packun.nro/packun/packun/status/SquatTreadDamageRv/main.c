...
void __thiscall
L2CFighterPackun::status::SquatTreadDamageRv_main(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0x14a8926acc);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,SquatTreadDamageRv_main_loop);
