...
void __thiscall
L2CFighterPackun::status::SquatTreadDamageRv_pre(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SQUAT_TREAD_DAMAGE_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SQUAT_TREAD_DAMAGE_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SQUAT_TREAD_DAMAGE_FLOAT)
  ;
  ...
  lib::L2CValue::L2CValue(aLStack136,FIGHTER_TREADED_KIND_DISABLE);
  ...
  lib::L2CValue::L2CValue(aLStack232,FIGHTER_POWER_UP_ATTACK_BIT_ATTACK_1);
  lib::L2CValue::L2CValue(aLStack248,0);
