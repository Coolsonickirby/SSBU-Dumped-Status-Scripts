...
void __thiscall
L2CFighterPackun::status::SpecialN_main_loop(L2CFighterPackun *this,L2CValue *return_value)
...
LAB_7100033e88:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((bVar2 & 1U) != 0) {
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PACKUN_STATUS_KIND_SPECIAL_N_LOOP);
    ...
    if ((uVar7 & 1) == 0) {
      ...
      uVar7 = lib::L2CValue::operator__(pLVar5,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar7 & 1) == 0) goto LAB_7100033ef0;
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar7 & 1) == 0) goto LAB_7100034330;
      ...
      if ((bVar2 & 1U) == 0) goto LAB_7100033ef0;
      lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PACKUN_GENERATE_ARTICLE_SPIKEBALL);
...
LAB_7100034330:
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar7 & 1) == 0) goto LAB_7100033e88;
