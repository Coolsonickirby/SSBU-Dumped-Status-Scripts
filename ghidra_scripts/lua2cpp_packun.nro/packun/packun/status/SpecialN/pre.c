...
void __thiscall
L2CFighterPackun::status::SpecialN_pre(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  if (bVar2) {
    ...
    lib::L2CValue::L2CValue(aLStack120,_FIGHTER_PACKUN_STATUS_KIND_SPECIAL_N_FAILURE);
