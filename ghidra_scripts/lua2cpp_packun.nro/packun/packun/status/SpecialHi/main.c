...
void __thiscall
L2CFighterPackun::status::SpecialHi_main(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PACKUN_CLIFF_HANG_DATA_SPECIAL_HI);
