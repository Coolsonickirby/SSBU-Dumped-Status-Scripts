...
void __thiscall
L2CFighterPackun::status::SpecialLw_main_loop(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    if ((uVar5 & 1) == 0) goto LAB_710002bd54;
    ...
    FUN_7100022220(this,aLStack80,aLStack96);
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack80);
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_PACKUN_STATUS_KIND_SPECIAL_LW_CHARGE);
