...
void __thiscall
L2CFighterPackun::status::SpecialLwBite_pre(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_PACKUN_STATUS_WORK_KEEP_FLAG_SPECIAL_LW_FLOAT);
