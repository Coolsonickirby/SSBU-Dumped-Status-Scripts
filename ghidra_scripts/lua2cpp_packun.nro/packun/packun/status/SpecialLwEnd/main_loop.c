...
void __thiscall
L2CFighterPackun::status::SpecialLwEnd_main_loop(L2CFighterPackun *this,L2CValue *return_value)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack176);
    lib::L2CValue::_L2CValue((L2CValue *)&local_90);
    if ((uVar5 & 1) == 0) goto LAB_71000242b4;
  }
  ...
  if ((uVar5 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack272);
    if ((uVar5 & 1) != 0) {
      lib::L2CValue::L2CValue((L2CValue *)&local_90,0x12aaf01d6d);
...
LAB_7100024068:
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((bVar3 & 1U) == 0) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_71000242ac;
      lib::L2CValue::L2CValue(aLStack272,_FIGHTER_KINETIC_ENERGY_ID_CONTROL);
