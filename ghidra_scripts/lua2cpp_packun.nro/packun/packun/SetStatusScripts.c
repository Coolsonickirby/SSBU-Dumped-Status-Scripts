...
void __thiscall L2CFighterPackun::SetStatusScripts(L2CFighterPackun *this)

{
  ...
  iVar1 = _FIGHTER_PACKUN_STATUS_KIND_NUM;
  ...
  FUN_71000009b0(this);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_STATUS_KIND_TREAD_DAMAGE);
  lib::L2CValue::L2CValue(aLStack96,_LUA_SCRIPT_STATUS_FUNC_STATUS_PRE);
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::TreadDamage_pre);
