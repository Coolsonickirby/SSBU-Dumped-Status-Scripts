...
void __thiscall L2CFighterGanon::status::Final_init(L2CFighterGanon *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_GANON_STATUS_WORK_ID_FLAG_BEAST_FINAL_AURA);
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_GANON_STATUS_WORK_ID_INT_BEAST_BEAST_TASK_ID);
  iVar1 = lib::L2CValue::as_integer(aLStack64);
