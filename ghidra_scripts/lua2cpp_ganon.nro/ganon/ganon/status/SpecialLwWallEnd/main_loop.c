...
void __thiscall
L2CFighterGanon::status::SpecialLwWallEnd_main_loop(L2CFighterGanon *this,L2CValue *return_value)
...
LAB_7100011ddc:
        ...
        if ((uVar5 & 1) != 0) {
          ...
          if ((bVar2 & 1U) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack80);
            if ((uVar5 & 1) != 0) goto LAB_7100011f04;
          }
          else {
            lib::L2CValue::_L2CValue(aLStack80);
          }
        ...
        if ((bVar2 & 1U) == 0) {
          ...
          uVar5 = lib::L2CValue::operator__(pLVar6,pLVar7);
          lib::L2CValue::_L2CValue(aLStack80);
          if ((uVar5 & 1) != 0) goto LAB_7100011ddc;
        }
        else {
          lib::L2CValue::_L2CValue(aLStack80);
        }
...
LAB_7100011d30:
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack96);
    if ((uVar5 & 1) != 0) goto LAB_7100011be0;
  }
  iVar3 = 1;
LAB_7100011f0c:
