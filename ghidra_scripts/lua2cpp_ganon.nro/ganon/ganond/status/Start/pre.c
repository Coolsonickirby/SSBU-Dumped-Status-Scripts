...
void __thiscall
L2CWeaponGanonGanond::status::Start_pre(L2CWeaponGanonGanond *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_GANON_GANOND_TRANS_MOVE);
