...
void __thiscall L2CFighterPit::status::SpecialLwHold_pre(L2CFighterPit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_LW_HOLD_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_LW_HOLD_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_LW_HOLD_FLOAT);
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_EFFECT | FS_SUCCEEDS_KEEP_VISIBILITY);
