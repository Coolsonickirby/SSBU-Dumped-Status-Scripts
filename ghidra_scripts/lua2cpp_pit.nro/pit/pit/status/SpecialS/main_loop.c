...
void __thiscall
L2CFighterPit::status::SpecialS_main_loop(L2CFighterPit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack128,_FIGHTER_PIT_STATUS_SPECIAL_S_WORK_ID_INT_START_SITUATION);
  ...
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_PIT_STATUS_SPECIAL_S_WORK_ID_FLAG_APPLIED_POWERUP);
  ...
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_PIT_STATUS_SPECIAL_S_WORK_ID_INT_START_SITUATION);
  iVar3 = lib::L2CValue::as_integer(aLStack144);
  iVar3 = app::lua_bind::WorkModule__get_int_impl(this->moduleAccessor,iVar3);
  ...
  lib::L2CValue::L2CValue(aLStack144,_FIGHTER_PIT_STATUS_SPECIAL_S_WORK_ID_FLAG_HIT);
  iVar3 = lib::L2CValue::as_integer(aLStack144);
  bVar1 = app::lua_bind::WorkModule__is_flag_impl(this->moduleAccessor,iVar3);
  lib::L2CValue::L2CValue(aLStack80,(bool)(bVar1 & 1));
  bVar2 = lib::L2CValue::operator_cast_to_bool(aLStack80);
