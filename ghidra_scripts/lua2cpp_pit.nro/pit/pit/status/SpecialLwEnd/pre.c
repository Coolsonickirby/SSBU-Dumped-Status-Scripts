...
void __thiscall L2CFighterPit::status::SpecialLwEnd_pre(L2CFighterPit *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_LW_END_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_LW_END_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_PIT_SPECIAL_LW_END_FLOAT);
