...
void __thiscall
L2CWeaponEflameEsword::status::SpecialSHop_pre(L2CWeaponEflameEsword *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_WEAPON_KINETIC_TYPE_EFLAME_ESWORD_BRAKE);
