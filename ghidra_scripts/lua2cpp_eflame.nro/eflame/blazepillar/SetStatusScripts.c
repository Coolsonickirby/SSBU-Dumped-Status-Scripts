...
void __thiscall L2CWeaponEflameBlazepillar::SetStatusScripts(L2CWeaponEflameBlazepillar *this)

{
  ...
  iVar1 = _WEAPON_EFLAME_BLAZEPILLAR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_EFLAME_BLAZEPILLAR_STATUS_KIND_FINAL_ATTACK);
