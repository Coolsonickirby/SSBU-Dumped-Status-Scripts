...
void __thiscall
L2CFighterEflame::status::FinalScene02_end(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_EFLAME_STATUS_KIND_FINAL_END);
