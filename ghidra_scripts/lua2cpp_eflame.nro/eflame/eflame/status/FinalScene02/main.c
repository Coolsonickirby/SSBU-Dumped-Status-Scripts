...
void __thiscall
L2CFighterEflame::status::FinalScene02_main(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack112,0x118b2e9bdc);
  ...
  lib::L2CValue::L2CValue(aLStack96,_FIGHTER_ELEMENT_FINAL_MODULE_SCENE_02_INIT);
  pFVar4 = (Fighter *)lib::L2CValue::as_pointer(this_00);
  iVar2 = lib::L2CValue::as_integer(aLStack96);
  app::FighterSpecializer_EFlame::call_final_module(pFVar4,iVar2);
  lib::L2CValue::_L2CValue(aLStack96);
