...
void __thiscall
L2CFighterEflame::status::SpecialNHold_main_loop(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  if ((bVar2 & 1U) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack96);
    lib::L2CValue::_L2CValue(aLStack272);
    lib::L2CValue::L2CValue(aLStack96,_FIGHTER_EFLAME_STATUS_KIND_SPECIAL_N_ATTACK);
