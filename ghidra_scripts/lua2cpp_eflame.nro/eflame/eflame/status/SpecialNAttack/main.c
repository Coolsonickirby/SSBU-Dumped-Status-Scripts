...
void __thiscall
L2CFighterEflame::status::SpecialNAttack_main(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    lib::L2CValue::_L2CValue(aLStack128);
    lib::L2CValue::_L2CValue(aLStack144);
    if ((uVar2 & 1) == 0) goto LAB_7100005e54;
...
LAB_7100005e54:
  ...
  FUN_7100011fa0(this);
  lib::L2CValue::L2CValue(aLStack208,SpecialNAttack_main_loop);
