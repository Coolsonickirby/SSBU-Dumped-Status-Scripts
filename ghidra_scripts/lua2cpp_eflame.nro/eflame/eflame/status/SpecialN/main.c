...
void __thiscall
L2CFighterEflame::status::SpecialN_main(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  FUN_71000142b0(this,aLStack304);
  lib::L2CValue::_L2CValue(aLStack304);
  lib::L2CValue::L2CValue(aLStack320,SpecialN_main_loop);
