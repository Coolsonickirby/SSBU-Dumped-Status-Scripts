...
void __thiscall
L2CFighterEflame::status::SpecialLw_main(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  FUN_7100014e90(aLStack80,this,aLStack112,aLStack96);
  ...
  pvVar8 = (void *)app::lua_bind::FighterManager__get_fighter_information_impl
                             (FIGHTER_STATUS_KIND_ATTACK_S4_HOLD,FVar5);
  ...
  FUN_7100017360(this,aLStack128);
  lib::L2CValue::_L2CValue(aLStack128);
  FUN_7100017720(this);
