...
void __thiscall
L2CFighterEflame::status::SpecialLwOut_main(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  bVar1 = app::lua_bind::FighterManager__is_result_mode_impl(FIGHTER_STATUS_KIND_ATTACK_S4_HOLD);
