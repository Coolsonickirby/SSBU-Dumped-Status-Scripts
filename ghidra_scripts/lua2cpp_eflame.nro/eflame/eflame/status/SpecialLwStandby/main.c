...
void __thiscall
L2CFighterEflame::status::SpecialLwStandby_main(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_ELEMENT_INSTANCE_WORK_ID_FLAG_GENERATE_CHANGER);
