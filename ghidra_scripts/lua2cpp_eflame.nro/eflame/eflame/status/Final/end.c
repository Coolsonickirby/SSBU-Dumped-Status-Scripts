...
void __thiscall L2CFighterEflame::status::Final_end(L2CFighterEflame *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    app::FighterSpecializer_EFlame::detach_esword_diver(pFVar5);
