...
void __thiscall L2CWeaponEflameFirepillar::SetStatusScripts(L2CWeaponEflameFirepillar *this)

{
  ...
  iVar1 = _WEAPON_EFLAME_FIREPILLAR_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_EFLAME_FIREPILLAR_STATUS_KIND_SPECIAL_HI);
