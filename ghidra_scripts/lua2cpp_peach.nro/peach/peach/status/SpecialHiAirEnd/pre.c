...
void __thiscall
L2CFighterPeach::status::SpecialHiAirEnd_pre(L2CFighterPeach *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack152,_FIGHTER_KINETIC_TYPE_FALL);
  ...
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_HI_AIR_END_FLAG);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_HI_AIR_END_INT);
  lib::L2CValue::L2CValue(aLStack248,_FIGHTER_STATUS_WORK_KEEP_FLAG_PEACH_SPECIAL_HI_AIR_END_FLOAT);
