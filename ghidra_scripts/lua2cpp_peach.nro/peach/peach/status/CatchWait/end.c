...
void __thiscall L2CFighterPeach::status::CatchWait_end(L2CFighterPeach *this,L2CValue *return_value)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      uVar4 = lib::L2CValue::operator__(pLVar3,aLStack80);
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar4 & 1) == 0) goto LAB_7100007f78;
      ...
      if ((uVar4 & 1) == 0) {
        ...
        if ((uVar4 & 1) == 0) {
          ...
          if ((uVar4 & 1) == 0) {
            ...
            lib::L2CValue::_L2CValue(aLStack80);
            pLVar3 = aLStack128;
            if ((uVar4 & 1) == 0) goto LAB_7100007f74;
          }
        }
      }
    }
