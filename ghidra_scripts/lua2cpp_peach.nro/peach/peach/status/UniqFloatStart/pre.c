...
void __thiscall
L2CFighterPeach::status::UniqFloatStart_pre(L2CFighterPeach *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_PEACH_UNIQ_FLOAT);
