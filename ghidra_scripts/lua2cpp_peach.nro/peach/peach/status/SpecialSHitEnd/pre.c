...
void __thiscall
L2CFighterPeach::status::SpecialSHitEnd_pre(L2CFighterPeach *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack136,_FIGHTER_KINETIC_TYPE_PEACH_SPECIAL_S_HIT_END);
