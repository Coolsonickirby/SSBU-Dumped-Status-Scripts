...
void __thiscall
L2CFighterPeach::status::FallSpecial_pre(L2CFighterPeach *this,L2CValue *return_value)

{
  ...
  if (bVar1) {
    ...
    lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_PEACH_WORK_KEEP_FLAG_FALL_SPECIAL_FLAG);
    lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_PEACH_WORK_KEEP_FLAG_FALL_SPECIAL_INT);
    lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_PEACH_WORK_KEEP_FLAG_FALL_SPECIAL_FLOAT);
