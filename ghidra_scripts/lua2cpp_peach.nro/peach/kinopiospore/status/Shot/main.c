...
void __thiscall
L2CWeaponPeachKinopiospore::status::Shot_main
          (L2CWeaponPeachKinopiospore *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack96);
  if ((uVar3 & 1) != 0) {
    FUN_710001b5a0(aLStack96,this);
    lib::L2CValue::_L2CValue(aLStack96);
  }
  this_00 = (L2CValue *)lib::L2CValue::operator__((L2CValue *)&this->globalTable,0x14);
  lib::L2CValue::L2CValue(aLStack80,&LAB_710001b710);
