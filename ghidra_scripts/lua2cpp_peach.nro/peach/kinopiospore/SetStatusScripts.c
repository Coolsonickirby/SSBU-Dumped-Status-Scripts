...
void __thiscall L2CWeaponPeachKinopiospore::SetStatusScripts(L2CWeaponPeachKinopiospore *this)

{
  ...
  iVar1 = _WEAPON_PEACH_KINOPIOSPORE_STATUS_KIND_NUM;
  ...
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PEACH_KINOPIOSPORE_STATUS_KIND_SHOT);
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Shot_init);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_PEACH_KINOPIOSPORE_STATUS_KIND_SHOT);
  ...
  lua2cpp::L2CAgentBase::sv_set_status_func
            ((L2CAgentBase *)this,aLStack80,aLStack96,status::Shot_exit);
  lib::L2CValue::_L2CValue(aLStack96);
  lib::L2CValue::_L2CValue(aLStack80);
