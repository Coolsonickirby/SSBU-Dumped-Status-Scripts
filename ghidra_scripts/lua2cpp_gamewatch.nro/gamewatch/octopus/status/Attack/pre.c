...
void __thiscall
L2CWeaponGamewatchOctopus::status::Attack_pre
...

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,
             _FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE | _FS_SUCCEEDS_KEEP_ATTACK |
             FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_HIT);
