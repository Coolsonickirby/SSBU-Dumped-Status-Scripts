...
void __thiscall
L2CWeaponGamewatchOctopus::status::End_pre(L2CWeaponGamewatchOctopus *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue
            (aLStack248,
             FS_SUCCEEDS_KEEP_VISIBILITY | _FS_SUCCEEDS_KEEP_ATTACK_ABSOLUTE | _FS_SUCCEEDS_KEEP_HIT
            );
