...
void __thiscall
L2CFighterGamewatch::status::FinalJumpAerial_main_loop
...
LAB_710002377c:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_71000238b0;
    ...
    if ((bVar2 & 1U) == 0) goto LAB_71000238a8;
    ...
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_71000238b0;
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_GAMEWATCH_STATUS_KIND_FINAL_FALL_AERIAL);
