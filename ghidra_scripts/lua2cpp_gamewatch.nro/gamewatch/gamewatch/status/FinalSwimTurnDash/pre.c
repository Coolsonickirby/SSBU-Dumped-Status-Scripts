...
void __thiscall
L2CFighterGamewatch::status::FinalSwimTurnDash_pre(L2CFighterGamewatch *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack120,_SITUATION_KIND_WATER);
  lib::L2CValue::L2CValue(aLStack136,FIGHTER_KINETIC_TYPE_RESET);
  ...
  lib::L2CValue::L2CValue(aLStack200,_FIGHTER_STATUS_WORK_KEEP_FLAG_SWIM_FLAG);
  lib::L2CValue::L2CValue(aLStack216,_FIGHTER_STATUS_WORK_KEEP_FLAG_SWIM_INT);
  lib::L2CValue::L2CValue(aLStack232,_FIGHTER_STATUS_WORK_KEEP_FLAG_SWIM_FLOAT);
  lib::L2CValue::L2CValue(aLStack248,_FS_SUCCEEDS_KEEP_HIT | _FS_SUCCEEDS_KEEP_SITUATION);
  ...
  lib::L2CValue::L2CValue
            (aLStack216,
             ...
             _FIGHTER_STATUS_ATTR_FINAL | _FIGHTER_STATUS_ATTR_INHERIT_CURSOR |
             _FIGHTER_STATUS_ATTR_INHERIT_CAMERA_RANGE);
