...
void __thiscall
L2CFighterGamewatch::status::FinalTurn_main_loop(L2CFighterGamewatch *this,L2CValue *return_value)
...
LAB_710002483c:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) != 0) goto LAB_7100024968;
...
LAB_7100024934:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) goto LAB_7100024934;
