...
void __thiscall
L2CFighterGamewatch::status::FinalSwimWalk_main(L2CFighterGamewatch *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,&DAT_710001fff0);
  lib::L2CValue::operator_(this_00,aLStack64);
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,FinalSwimWalk_main_loop);
