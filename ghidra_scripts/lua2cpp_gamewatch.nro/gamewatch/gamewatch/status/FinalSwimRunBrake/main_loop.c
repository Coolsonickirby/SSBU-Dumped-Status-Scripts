...
void __thiscall
L2CFighterGamewatch::status::FinalSwimRunBrake_main_loop
...
LAB_710002014c:
    ...
    lib::L2CValue::_L2CValue(aLStack64);
    lib::L2CValue::_L2CValue(aLStack80);
    if ((uVar4 & 1) != 0) goto LAB_7100020244;
    ...
    if ((bVar2 & 1U) == 0) {
      lib::L2CValue::L2CValue(aLStack128,_FIGHTER_STATUS_RUN_BRAKE_WORK_FLOAT_FRAME);
