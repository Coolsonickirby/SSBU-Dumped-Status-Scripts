...
void __thiscall
L2CFighterGamewatch::status::FinalSwimDash_main(L2CFighterGamewatch *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,_FIGHTER_STATUS_TRANSITION_TERM_ID_DASH_TO_RUN);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,FinalSwimDash_main_loop);
