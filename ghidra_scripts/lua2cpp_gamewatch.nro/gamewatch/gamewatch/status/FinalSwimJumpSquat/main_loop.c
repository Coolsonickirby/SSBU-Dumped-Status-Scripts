...
void __thiscall
L2CFighterGamewatch::status::FinalSwimJumpSquat_main_loop
...
LAB_710001eabc:
    ...
    lib::L2CValue::L2CValue(aLStack64,_FIGHTER_GAMEWATCH_STATUS_KIND_FINAL_JUMP);
    ...
    if ((uVar3 & 1) != 0) {
      ...
      lib::L2CValue::_L2CValue(aLStack80);
      if ((uVar3 & 1) == 0) goto LAB_710001eb70;
      goto LAB_710001eabc;
    }
    lib::L2CValue::_L2CValue(aLStack96);
    pLVar4 = aLStack112;
