...
void __thiscall
L2CFighterGamewatch::status::SpecialS_main(L2CFighterGamewatch *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack64,_FIGHTER_INSTANCE_WORK_ID_INT_TRICK_SUB);
            ...
            if ((uVar3 & 1) == 0) {
              ...
              if ((uVar3 & 1) == 0) {
                ...
                if ((uVar3 & 1) == 0) {
                  ...
                  uVar3 = lib::L2CValue::operator__(aLStack96,aLStack64);
                  lib::L2CValue::_L2CValue(aLStack64);
                  if ((uVar3 & 1) == 0) goto LAB_710000bef4;
