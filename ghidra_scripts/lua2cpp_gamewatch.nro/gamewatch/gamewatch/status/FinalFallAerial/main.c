...
void __thiscall
L2CFighterGamewatch::status::FinalFallAerial_main(L2CFighterGamewatch *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::_L2CValue(aLStack64);
  lib::L2CValue::L2CValue(aLStack64,FinalFallAerial_main_loop);
