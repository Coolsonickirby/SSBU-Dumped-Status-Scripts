...
void __thiscall
L2CWeaponGamewatchBreath::status::Fly_main(L2CWeaponGamewatchBreath *this,L2CValue *return_value)

{
  ...
  lib::L2CValue::L2CValue(aLStack80,0xc62eb0c55);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_GAMEWATCH_BREATH_STATUS_WORK_INT_MOVE_FRAME);
  ...
  lib::L2CValue::_L2CValue(aLStack80);
  lib::L2CValue::L2CValue(aLStack80,_WEAPON_GAMEWATCH_BREATH_STATUS_WORK_FLOAT_SPEED_Y);
